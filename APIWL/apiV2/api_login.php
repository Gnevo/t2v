...
if ($process_flag) {
        ...
        if (!empty($cur_user)) {
            ...
            if($error_active == 1){
                ...
                $obj->user_image = $smarty->url.$picture_path;
            ...
            elseif ($cur_user['last_login_time'] != '0000-00-00 00:00:00' && $cur_user['error'] < '4') {
                ...
                $obj->candg         = (int) $company_details['candg'];
                ...
                if(($privileges_general['candg_wi'] == 1 && $privileges_general['candg_wo'] == 0) || ($privileges_general['candg_wi'] == 0 && $privileges_general['candg_wo'] == 0)){
                    $obj->candg = 0;  
                }else{
                    $obj->candg = 1;
                }
...
$obj->version_code = 14; 
$obj->version_name = "1.1.0"; //"3.6.0"; //"3.4.6"; //"3.4.3";
