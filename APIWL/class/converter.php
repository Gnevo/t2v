    ...
    function get_all_leaves_for_report_between_dates($employee, $start_date, $end_date, $mode = null, $debug = NULL) {
        if($mode == 'FOOL'){
            ...
            //echo "<pre>leave_dates".print_r($employee_leave_dates, 1)."</pre>";
                ...
                // if($debug)
            //echo "<pre>non".print_r($employee_non_leave_dates, 1)."</pre>";
            ...
            if($employee_leave_dates[0] == $employee_non_leave_dates[0]){
            ...
            // if($debug)
            //     echo "<br>".$prev_sick_start_date."--".$first_leave_day."<br>";
            ...
            if($check == FALSE){
                // if($debug)
                     //echo "<br>".$start_date."--".$first_leave_day."<br>";
                $period = $this->dates_between($start_date, $first_leave_day);
                // if($debug)
                     //echo "<pre>leave_dates".print_r($period, 1)."</pre>";
            ...
            foreach ($rpt_content as $rpt_date_key => $rpt_date_value) {
                ...
                foreach ($rpt_date_value as $rpt_content_key => $rpt_content_value) {
                    ...
                    if($mode == 'FROM_FORM'){
                        ...
                        if($leave_date_count == 1 && $karens_percentage_deduction > 0){ 
                        ...
                        }elseif($leave_date_count == 1 && $karens_percentage_deduction <= 0){
                            $result_array[$i_for_forms]['non_karens_2_14'][$rpt_date_key][] = $rpt_content_value; 
