...
class employee extends db {
    ...
    function employee_activeinactive_data($key = NULL, $status, $order) {
        ...
        switch ($login_user_role) {
            ...
            case 6:
                $this->flush();
                $this->sql_query = "SELECT e.username, e.code, e.first_name, e.last_name, e.social_security, e.city, e.phone, e.mobile, e.status, e.email, e.address, e.post,
            ...
            case 7:
                $team_members = $this->team_members($login_user);
                // $team_members = $this->team_members('nera001');
                $team_employee_data = '\'' . implode('\', \'', $team_members) . '\'';
                ...
                // echo $this->sql_query;
                $employee_data = $this->query_fetch();
                // echo '<pre>'.print_r($employee_data, 1).'</pre>'; exit();
                break;
            case 3:
            case 5:
                $team_employee_data = '\'' . $login_user . '\'';
...
//                $this->conditions[] = 'timetable.status = 2 AND timetable.date = leave.date AND leave.status= 1';
    ...
    function empgriddata_including_leave($name, $fromdate, $todate, $allowed_leave_types = array()) {
        ...
        $this->fields = array('employee.username', 'employee.first_name AS empfname', 'employee.last_name AS emplname', 'timetable.customer', 'customer.first_name AS custfname', 'customer.last_name AS custlname',
...
//        echo "<pre>". print_r($employee_data, 1)."</pre>";
    ...
    function generate_employee_code() {
        ...
        $this->query_generate();
        //echo "<script>alert(\"".$max_code."\")</script>";
        //echo "<script>alert(\"".$this->sql_query."\")</script>";
        $data = $this->query_fetch();
        $code = '';
        //echo "<script>alert(\"".$data[0]['code_size']."\")</script>";
        if (!empty($data)) {
        ...
        if ($key == NULL) {
            ...
            switch ($login_user_role) {
                ...
                case 6:
                    ...
                    if ($key == "A") {
                        if ($_SESSION['company_sort_by'] == 1)
                            $this->conditions = array('AND', $this->db_name . '.employee.status = 0', array('AND', array('OR', $this->db_name . '.employee.first_name LIKE ?', $this->db_name . '.employee.first_name LIKE ?'), $this->db_name . '.employee.first_name NOT LIKE "ä%"', $this->db_name . '.employee.first_name NOT LIKE "å%"', $this->db_name . '.employee.first_name NOT LIKE "ö%"', $this->db_name . '.employee.first_name NOT LIKE "Ä%"', $this->db_name . '.employee.first_name NOT LIKE "Å%"', $this->db_name . '.employee.first_name NOT LIKE "Ö%"'), $this->db_name . '.employee.username = ' . $this->db_master . '.login.username');
                        elseif ($_SESSION['company_sort_by'] == 2)
                        ...
                        if ($_SESSION['company_sort_by'] == 1)
                            $this->conditions = array('AND', $this->db_name . '.employee.status = 0', array('OR', $this->db_name . '.employee.first_name LIKE ?', $this->db_name . '.employee.first_name LIKE ?'), $this->db_name . '.employee.username = ' . $this->db_master . '.login.username');
                        elseif ($_SESSION['company_sort_by'] == 2)
...
//                    $this->conditions = array('AND', $this->db_name.'.employee.status = 0', array('OR', $this->db_name.'.employee.last_name LIKE ?', $this->db_name.'.employee.last_name LIKE ?'),$this->db_name.'.employee.username = '.$this->db_master.'.login.username');
                ...
                case 7:
                    ...
                    if ($key == "A") {
                        if ($_SESSION['company_sort_by'] == 1)
                            $this->conditions = array('AND', array('IN', $this->db_name . '.employee.username', $team_employee_data), $this->db_name . '.employee.status = 0', array('AND', array('OR', $this->db_name . '.employee.first_name LIKE ?', $this->db_name . '.employee.first_name LIKE ?'), $this->db_name . '.employee.first_name NOT LIKE "ä%"', $this->db_name . '.employee.first_name NOT LIKE "å%"', $this->db_name . '.employee.first_name NOT LIKE "ö%"', $this->db_name . '.employee.first_name NOT LIKE "Ä%"', $this->db_name . '.employee.first_name NOT LIKE "Å%"', $this->db_name . '.employee.first_name NOT LIKE "Ö%"'), $this->db_name . '.employee.username = ' . $this->db_master . '.login.username');
                        elseif ($_SESSION['company_sort_by'] == 2)
                        ...
                        if ($_SESSION['company_sort_by'] == 1)
                            $this->conditions = array('AND', array('IN', $this->db_name . '.employee.username', $team_employee_data), $this->db_name . '.employee.status = 0', array('OR', $this->db_name . '.employee.first_name LIKE ?', $this->db_name . '.employee.first_name LIKE ?'), $this->db_name . '.employee.username = ' . $this->db_master . '.login.username');
                        elseif ($_SESSION['company_sort_by'] == 2)
        ...
        if ($key == NULL) {
            ...
            switch ($login_user_role) {
                ...
                case 6:
                    ...
                    $this->query_generate();
//                    echo $this->sql_query;
//                    echo "<pre>".print_r($this->conditions, 1)."</pre>";
...
//                    $this->conditions = array('AND', array('IN', $this->db_name.'.employee.username', $team_employee_data), $this->db_name.'.employee.status = 1', array('OR', $this->db_name.'.employee.last_name LIKE ?', $this->db_name.'.employee.last_name LIKE ?'),$this->db_name.'.employee.username = '.$this->db_master.'.login.username');
    ...
    function employee_list_exact($login_user = '', $key = NULL, $status = '') {
        ...
        switch ($login_user_role) {
            ...
            case 6:
                $this->tables = array('employee');
                $this->fields = array('username', 'code', 'first_name', 'last_name', 'social_security', 'city', 'phone', 'mobile', 'email');
                if($status == '')    
                    $this->conditions = array('AND', 'status = 1');
        ...
        if ($key != NULL) {
            $this->conditions[] = array('OR', 'LOWER(last_name) LIKE ?', 'LOWER(first_name) LIKE ?');
        ...
        foreach ($week as $day) {
            ...
            if (!empty($slots)) {
                foreach ($slots as $slot) {
                    if ($slot['privileges_gd']['delete_slot'] == 1 || $slot['privileges_gd']['add_customer'] == 1 ||
                            $slot['privileges_gd']['add_employee'] == 1 || $slot['privileges_gd']['fkkn'] == 1 ||
                            $slot['privileges_gd']['slot_type'] == 1 || $slot['privileges_gd']['remove_customer'] == 1 ||
                            $slot['privileges_gd']['remove_employee'] == 1 || $slot['privileges_gd']['add_slot'] == 1
                    ) {
                        $day_privilege = 1;
                        break;
                    }
                ...
                $temp_priv = $this->get_privileges($_SESSION['user_id'], 1);
                if ($temp_priv['delete_slot'] == 1 || $temp_priv['add_customer'] == 1 ||
                        $temp_priv['add_employee'] == 1 || $temp_priv['fkkn'] == 1 ||
                        $temp_priv['slot_type'] == 1 || $temp_priv['remove_customer'] == 1 ||
                        $temp_priv['remove_employee'] == 1 || $temp_priv['add_slot'] == 1
                ) {
                    $day_privilege = 1;
                }
            }
            $datas[$i]['slots'] = $slots;
            $datas[$i]['privileges_gd'] = $day_privilege;
            $i++;
        }*/
        return $datas;
    }
...
//                        $return_flag = FALSE;
    ...
    function employee_add_leave($employee_username, $date_from, $date_to, $type, $comments, $replacer_employee = NULL, $no_pay = 0) {
        /**
    ...
    function employee_add_leave_slot($employee_username, $date, $time_from, $time_to, $type, $comments = NULL, $replacer = NULL, $no_pay = 0) {
//        echo "<pre>args: ".print_r(func_get_args(), 1)."</pre>";
        /**
         * @edited-by: Shamsu<shamsu@arioninfotech.com>
        ...
        if ($data[0]['id'] == "" || $data[0]['id'] == NULL) {
            ...
            if (!empty($slot_datas)) {
                        ...
                        if ($slot_to_time > $time_to) {
                            ...
                            if ($this->query_update()) {
                                ...
                                if ($slot_data['customer']) {
                                    ...
                                    $this->field_values = array($slot_data['customer'], $slot_data['date'], $slot_data['time_from'], (float) $time_to, $slot_data['type'], $slot_data['fkkn'], $slot_data['comment'], $alloc_employee, $slot_id);
                                    if ($replacer != NULL) {
                            ...
                            if ($this->query_update()) {
                                ...
                                if ($slot_data['customer']) {
                                    $this->tables = array('timetable');
                                    $this->fields = array('customer', 'date', 'time_from', 'time_to', 'type', 'fkkn', 'comment', 'alloc_emp', 'relation_id');
                                    $this->field_values = array($slot_data['customer'], $slot_data['date'], $slot_data['time_from'], $slot_data['time_to'], $slot_data['type'], $slot_data['fkkn'], $slot_data['comment'], $alloc_employee, $slot_id);
                                    if ($replacer != NULL) {
                                        $this->fields[] = 'employee';
                                        $this->field_values[] = $replacer;
                                    }
                        ...
                        if ($slot_to_time > $time_to) {
                            ...
                            if ($this->query_update()) {
                                ...
                                if ($slot_data['customer']) {
                                    $this->tables = array('timetable');
                                    $this->fields = array('customer', 'date', 'time_from', 'time_to', 'type', 'fkkn', 'comment', 'alloc_emp', 'relation_id');
                                    $this->field_values = array($slot_data['customer'], $slot_data['date'], (float) $time_from, (float) $time_to, $slot_data['type'], $slot_data['fkkn'], $slot_data['comment'], $alloc_employee, $slot_id);
                                    if ($replacer != NULL) {
                                        $this->fields[] = 'employee';
                                        $this->field_values[] = $replacer;
                                    }
                            ...
                            if ($this->query_update()) {
                                ...
                                if ($slot_data['customer']) {
                                    $this->tables = array('timetable');
                                    $this->fields = array('customer', 'date', 'time_from', 'time_to', 'type', 'fkkn', 'comment', 'alloc_emp', 'relation_id');
                                    $this->field_values = array($slot_data['customer'], $slot_data['date'], $time_from, $slot_data['time_to'], $slot_data['type'], $slot_data['fkkn'], $slot_data['comment'], $alloc_employee, $slot_id); //time_from added by shaju
                                    if ($replacer != NULL) {
                                        $this->fields[] = 'employee';
                                        $this->field_values[] = $replacer;
                                    }
                ...
                if ($flag == 0) {
                    ...
                    $this->field_values = array($new_group_id, $employee_username, $date, (float) $time_from, (float) $time_to, $type, $comments, $alloc_employee, '0', $no_pay);
                    if ($this->query_insert()) {
                        $this->commit_transaction();
                        $recipents = $this->employee_leave_recipients($employee_username, $type);
                        if (!empty($recipents)) {
    ...
    function login_add($secondary_login = FALSE) {
        ...
        if ($this->username != NULL) {
            ...
            // $this->query_insert();
            // echo $this->password;
            // print_r($this->query_error_details); exit('exit');
            if ($this->query_insert()) {
                if($secondary_login) $this->secondary_login_add();
                return TRUE;
            } else {
    ...
    function employee_update() {
        ...
        if ($this->username != NULL) {
            ...
            $this->fields = array('code', 'century', 'social_security', 'first_name', 'last_name', 'gender', 'address', 
                ...
                'care_of', 'office_personal', 'substitute', 'salary_type', 'sem_leave_days', 'vab_leave_days', 'fp_leave_days', 'nopay_leave_days', 'other_leave_days', 'ice');
            $this->field_values = array($this->code, $this->century, $this->social_security, $this->first_name, $this->last_name, $this->gender, $this->address, 
                ...
                $this->care_of, ($this->office_personal != '' ? $this->office_personal : 0), $this->substitute, $this->salary_type, $this->sem_leave_days, $this->vab_leave_days, $this->fp_leave_days, $this->nopay_leave_days, $this->other_leave_days, $this->ice);
            if ($this->use_inconvenient !== NULL) {
                $this->fields[] = 'inconvenient_on';
                $this->field_values[] = $this->use_inconvenient;
            }
...
//        $this->fields = array('ROUND(SUM(CAST(time_to - time_from AS UNSIGNED) + ((time_to - time_from) - CAST(time_to - time_from AS unsigned))/60*100),2) AS total_time');
    ...
    function employee_contract_monthly_normal_hour($employee, $year_month, $return_global_contract = false) {
        /**
         * @author: Shamsudheen <shamsu@arioninfotech.com>
    ...
    function employee_contract_oncall_monthly_hour($employee, $year_month, $return_global_contract = false) {
        /**
         * @author: Shamsudheen <shamsu@arioninfotech.com>
...
//        echo "<pre>data : ".print_r($datas, 1)."</pre>";
...
//        if(!$this->is_ob_on_for_a_employee($employee)) return array();
    ...
    function get_distinct_oncall_inconvenient_btwn_2_dates_for_customer($sdate, $edate, $customer, $get_from_global_if_not_exist = TRUE) {
        ...
        if (trim($customer) == '' && $get_from_global_if_not_exist) {
            ...
            $this->flush();
            $this->tables = array('inconvenient_timing_customer');
            $this->fields = array('id', 'group_id', 'name', 'effect_from', 'effect_to', 'time_from', 'time_to', 'days', 'amount', 'sal_call_training', 'sal_complementary_oncall', 'sal_more_oncall', 'sal_dismissal_oncall', '(SELECT sort_order FROM inconvenient_timing WHERE name=inconvenient_timing_customer.name AND root_id = 0) as sort_order');
            $this->conditions = array('AND', 'root_id = 0', 'customer = ?',
                array('OR', array('AND', 'effect_to is null', 'effect_from <= ?'),
                    array('AND', 'effect_to is not null',
                        array('OR',
...
//                        echo "tmp_global_inconvenients<pre>".print_r($tmp_global_inconvenients, 1)."</pre>";
...
//        $this->condition_values = array($this->username, $this->signing_report_date);
    ...
    function employee_signing_remove($type = NULL) {
        ...
        if ($type == NULL) {          //if no $type, then delete entire row
            ...
            if($this->query_delete()){
                ...
                //echo "<pre>".print_r($employer_signing_details_fk,1)."</pre>";
                ...
                //echo "<pre>".print_r($employer_signing_details_kn,1)."</pre>";
    ...
    function employee_signing_existance_check() {
        ...
        if (!empty($data)) {
            if (($login_user_role == 1 || $isGL) && (trim($data[0]['signin_employee']) == '' || trim($data[0]['signin_tl']) == '' || trim($data[0]['signin_sutl']) == ''))
                return 2;
            else
                return 1;
        }
...
//        echo $this->sql_query;
    ...
    function employee_skills($emp) {
        ...
        $this->fields = array('id', 'employee', 'skill', 'description','attachment1','attachment2','attachment3','alloc_emp');
        $this->conditions = array('employee = ?');
    ...
    function employee_skill_add($skill, $description, $emp,$alloc_emp,$file_names = null) {

        // $attachment_feilds = ['attachment1','attachment2','attachment3'];
        $this->tables = array('employee_skill');
        $this->fields = array('employee', 'skill', 'description','alloc_emp');
        $this->field_values = array($emp, $skill, $description,$alloc_emp);
...
//        $output = "ATL varning " . $employe_data['last_name'] . ' ' . $employe_data['first_name'] . "=>" . $date . " " . sprintf('%05.2f', $time_from) . "-" . sprintf('%05.2f', $time_to);
    ...
    function check_relations_in_timetable_for_leave($id, $is_id_only = FALSE) {
        $this->tables = array('timetable');
        if (!$is_id_only)
            $this->fields = array('id', 'employee', 'customer', 'date', 'time_from', 'time_to', 'type', 'fkkn');
        else
            $this->fields = array('id');
        
        if (is_array($id)) {
            $this_id_string = '\'' . implode('\' , \'', $id) . '\'';
            $this->conditions = array(array('IN', 'relation_id', $this_id_string));
        } else {
...
//        echo "<pre>".print_r($leave_data, 1)."</pre>";
    ...
    function add_previleges_forms($emp) {
        ...
        for ($i = 0; $i < count($emps); $i++) {
            ...
            if ($data) {
                $this->tables = array('privileges_forms');
                $this->fields = array('fkkn', '`leave`', 'certificate', 'form_1', 'form_2', 'form_3', 'form_1_report', 'form_2_report', 'form_3_report', 'form_4','form_5','form_6','form_7');
                $this->field_values = array($this->form_fkkn, $this->form_leave, $this->form_certificate, $this->form_form_1, $this->form_form_2, $this->form_form_3, $this->form_form_1_report, $this->form_form_2_report, $this->form_form_3_report,$this->form_form_4, $this->form_form_5, $this->form_form_6, $this->form_form_7);
                $this->conditions = array('employee = ?');
                $this->condition_values = array($emps[$i]);
                if ($this->query_update()) {
                    $t = 1;
    ...
    function add_previleges_mc($emp) {
        ...
        for ($i = 0; $i < count($emps); $i++) {
            ...
            if ($data) {
                $this->tables = array('privileges_mc');
                $this->fields = array('leave_notification', 'leave_approval', 'leave_rejection', 'leave_edit', 'notes', 'cirrus_mail', 'external_mail', 'sms', 'notes_approval', 'notes_rejection', 'notes_attchment', 'document_archive', 'support');
                $this->field_values = array($this->mc_leave_notification, $this->mc_leave_approval, $this->mc_leave_rejection, $this->mc_leave_edit, $this->mc_notes, $this->cirrus_mail, $this->external_mail, $this->mc_sms, $this->mc_notes_approval, $this->mc_notes_rejection, $this->mc_notes_attchment, $this->mc_document_archive, $this->mc_support);
                $this->conditions = array('employee = ?');
                $this->condition_values = array($emps[$i]);
                if ($this->query_update()) {
                    $t = 1;
    ...
    function get_privileges_forms_employee($employees) {
        ...
        $employees = '\'' . implode('\',\'', $employees) . '\'';
        $this->tables = array('privileges_forms');
        $this->fields = array('employee', 'CONCAT(fkkn,",",`leave`,",",certificate,",",form_1,",",form_2,",",form_3,",",form_1_report,",",form_2_report,",",form_3_report,",",form_4,",",form_5,",",form_6,",",form_7) AS privilege', '(fkkn+`leave`+certificate+form_1+form_2+form_3+form_4+form_5+form_6+form_7+form_1_report+form_2_report+form_3_report)  AS sum_privilege');
        $this->conditions = array('IN', "employee", $employees);
        $this->order_by = array("sum_privilege");
        $this->query_generate();
        $data = $this->query_fetch();
    ...
    function get_privileges_mc_employee($employees) {
        ...
        $employees = '\'' . implode('\',\'', $employees) . '\'';
        $this->tables = array('privileges_mc');
        $this->fields = array('employee', 'CONCAT(leave_notification,",",leave_approval,",",leave_rejection,",",leave_edit,",",notes,",",cirrus_mail,",",external_mail,",",sms,",",notes_approval,",",notes_rejection,",",notes_attchment,",",document_archive,",",support) AS privilege', '(leave_notification+leave_approval+leave_rejection+leave_edit+notes+cirrus_mail+external_mail+sms+notes_approval+notes_rejection+notes_attchment+document_archive+support) AS sum_privilege');
        $this->conditions = array('IN', "employee", $employees);
        $this->order_by = array("sum_privilege");
        $this->query_generate();
        $data = $this->query_fetch();
...
//            $this->condition_values = array($this_customer, $year, $month, $fkkn);
            ...
            if ($this->query_delete()) {
                ...
                if (!empty($all_employer_signed_employees) && !empty($all_employer_signed_employees[0]['employee_data'])) {
                    foreach ($all_employer_signed_employees[0]['employee_data'] as $employee_s) {
...
//            $data = $this->query_fetch(2);
        ...
        switch ($login_user_role) {
            ...
            case 6:
                if ($page_type == 'customer') {
                    ...
                    $this->tables = array('employee');
                    $this->fields = array('username', 'first_name', 'last_name', 'mobile', 'code');
    ...
    function customers_list_for_right_click($page_user) {
        /**
         * @author: Shamsudheen <shamsu@arioninfotech.com>
        ...
        switch ($login_user_role) {
            ...
            case 6:
                if ($page_type == 'customer') {
                    ...
                    $this->fields = array('username', 'first_name', 'last_name', 'mobile', 'email', 'phone');
                    $this->conditions = array('AND', 'status = 1');
                    $this->order_by = array('LOWER(last_name)', 'LOWER(first_name)');
                    $this->query_generate();
    ...
    function get_team_employees_of_customer($this_customer, $status = 1) {
        ...
        $this->fields = array('DISTINCT e.username', 'e.first_name', 'e.last_name', 'e.mobile', 'e.code', 'e.color');
        $this->condition_values = array();
        ...
        if ($_SESSION['company_sort_by'] == 1)
            $this->order_by = array('LOWER(e.first_name)', 'LOWER(e.last_name)');
        elseif ($_SESSION['company_sort_by'] == 2)
...
//        $this->order_by = array('LOWER(e.last_name)', 'LOWER(e.first_name)');
    ...
    function get_team_customers_of_employee($this_employee, $key = NULL, $status = 1) {
        ...
        $this->flush();
        $this->tables = array('team` as `t', 'customer` as `c');
        $this->fields = array('DISTINCT c.username', 'c.first_name', 'c.last_name', 'c.mobile', 'c.email', 'c.phone', 'c.code');
...
//        echo "<pre>".print_r($this->condition_values, 1)."</pre>";
    ...
    function employee_total_work_hours($employee, $date_type, $date, $normal_oncall = NULL) {
        /**
         * @author: Shamsudheen <shamsu@arioninfotech.com>
        ...
        if ($date_type == 'year_week') {
            ...
            $this->tables = array('timetable');
            $this->fields = array('ROUND(SUM(time_to_sec(timediff(time(replace(cast(time_to as char),\'.\',\':\')) , time(replace(cast(time_from as char),\'.\',\':\')))) )/3600,2) AS total_time');
            $this->conditions = array('AND', 'employee = ?', array('BETWEEN', 'date', '?', '?'), array('IN', 'status', '1'), array('IN', 'type', $process_slot_types));
            $this->condition_values = array($employee, $date_from, $date_to);
            $this->query_generate();
            ...
            //     echo $this->sql_query;
            // if($normal_oncall == 3){
            //     echo "<pre>".print_r($this->condition_values, 1)."</pre>";exit();
            // }
            $work_time = $this->query_fetch();
            ...
            $this->tables = array('timetable');
            $this->fields = array('ROUND(SUM(time_to_sec(timediff(time(replace(cast(time_to as char),\'.\',\':\')) , time(replace(cast(time_from as char),\'.\',\':\')))) )/3600,2) AS total_time');
            $this->conditions = array('AND', 'employee = ?', 'date = ?', array('IN', 'status', '1'), array('IN', 'type', $process_slot_types));
            $this->condition_values = array($employee, $date);
            $this->query_generate();
            $work_time = $this->query_fetch();
            $total_work_hours = (empty($work_time) || $work_time[0]['total_time'] == '') ? 0.00 : $work_time[0]['total_time'];
...
//        echo "<pre>list_employees_prev".print_r($this->condition_values, 1)."</pre>";
        $data = $this->query_fetch();
//        echo "<pre>Merge_array".print_r($data, 1)."</pre>";
        return $data;
    }
...
//        echo $this->sql_query;
    ...
    function check_slot_leave($emp, $cust, $date_from, $date_to, $allowed_leave_types = array()) {
        $this->tables = array('timetable', 'leave');
        $this->fields = array('timetable.employee', 'timetable.customer');
        if ($date_from != '0000-00-00' && $date_to != '0000-00-00') {
            $this->conditions = array('AND', array('BETWEEN', 'timetable.date', '?', '?'), 'timetable.status = 2', 'timetable.date = leave.date', 'timetable.employee = leave.employee', 'timetable.employee = ?', 'timetable.customer = ?', 'leave.status = 1');
            $this->condition_values = array($date_from, $date_to, $emp, $cust);
        } elseif ($date_from != '0000-00-00' && $date_to = '0000-00-00') {
            $this->conditions = array('AND', 'timetable.date >= ?', 'timetable.status = 2', 'timetable.date = leave.date', 'timetable.employee = leave.employee', 'timetable.employee = ?', 'timetable.customer = ?', 'leave.status = 1');
            $this->condition_values = array($date_from, $emp, $cust);
        } elseif ($date_from == '0000-00-00' && $date_to != '0000-00-00') {
            $this->conditions = array('AND', 'timetable.date <= ?', 'timetable.status = 2', 'timetable.date = leave.date', 'timetable.employee = leave.employee', 'timetable.employee = ?', 'timetable.customer = ?', 'leave.status = 1');
            $this->condition_values = array($date_to, $emp, $cust);
        } elseif ($date_from == '0000-00-00' && $date_to == '0000-00-00') {
            $this->conditions = array('AND', 'timetable.status = 2', 'timetable.date = leave.date', 'timetable.employee = leave.employee', 'timetable.employee = ?', 'timetable.customer = ?', 'leave.status = 1');
            $this->condition_values = array($emp, $cust);
        }
        
        if (!empty($allowed_leave_types))
                $this->conditions[] = array('IN', 'leave.type', $allowed_leave_types);
//        echo "<pre>". print_r($this->condition_values, 1)."</pre>";
//        $this->condition_values = array($date_from,$date_to,$emp,$cust);
        $this->query_generate();
        $data = $this->query_fetch();
...
//        echo "<pre>".print_r($datas, 1)."</pre>";
    ...
    function employee_skill_update($skill,$description,$id,$alloc_emp,$not_null_array =null){
        $key  = array_keys($not_null_array);
        $this->tables = array('employee_skill');
        $this->fields = array('skill','description','alloc_emp');
        $this->field_values = array($skill,$description,$alloc_emp);
    ...
    function get_available_users_template($customer, $time_from,$time_to,$date,$shcedule_id){
        if ($_SESSION['company_sort_by'] == 1)
            $order_by = 'ORDER BY LOWER(e.first_name),LOWER(e.last_name)';
        elseif ($_SESSION['company_sort_by'] == 2)
            $order_by = 'ORDER BY LOWER(e.last_name),LOWER(e.first_name)';
