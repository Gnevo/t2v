...
class employee extends db {
	...
	function empgriddata($name,$fromdate,$todate)
	{
		...
		if(strlen($name) == 1){ $flag = 1;  }else{ $flag = 2;  }
		...
		{	
			...
			case 6:
				...
				if($name != '-' && $fromdate == '0000-00-00' && $todate == '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"');
					}
					else
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'));
				...
				if($name != '-' && $fromdate != '0000-00-00' && $todate == '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date >= "'.$fromdate.'" ','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"');
					}
					else
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date >= "'.$fromdate.'" ',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'));
					}
				}
				...
				if($name != '-' && $fromdate != '0000-00-00' && $todate != '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date BETWEEN "'.$fromdate.'" AND "'.$todate.'"','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"');
					}
					else
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date BETWEEN "'.$fromdate.'" AND "'.$todate.'"',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'));
					}
				}
				if($name != '-' && $fromdate == '0000-00-00' && $todate != '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date <= "'.$todate.'"','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"');
					}
					else
					{					
						$this->conditions = array('AND','employee.status = 1','customer.status = 1','timetable.status != 0','employee.username = timetable.employee','customer.username = timetable.customer','timetable.date <= "'.$todate.'"',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'));
					}
				}
				if($name == '-' && $fromdate == '0000-00-00' && $todate == '0000-00-00')
				{
				...
				$this->group_by = array('timetable.employee','timetable.customer');
				$this->order_by = array('employee.last_name','employee.first_name','customer.last_name','customer.first_name');
				$this->query_generate();
				$employee_data = $this->query_fetch();
...
*/				
		...
		case 7:
				...
				if($name != '-' && $fromdate == '0000-00-00' && $todate == '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"');
					}
					else
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'));					
					}
				}		
				if($name != '-' && $fromdate != '0000-00-00' && $todate == '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"','timetable.date >= "'.$fromdate.'" ');
					}
					else
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'),'timetable.date >= "'.$fromdate.'" ');
					}
				}
				if($name != '-' && $fromdate == '0000-00-00' && $todate != '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"','timetable.date <= "'.$todate.'" ');
					}
					else
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'),'timetable.date <= "'.$todate.'" ');
					}
				}
				if($name != '-' && $fromdate != '0000-00-00' && $todate != '0000-00-00')
				{
					if($flag == 1)
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer','LCASE(employee.last_name) LIKE "'.strtolower($name).'%"','timetable.date BETWEEN "'.$fromdate.'" AND "'.$todate.'"');
					}
					else
					{
						$this->conditions = array('AND',array('IN', 'employee.username', $team_employee_data),'timetable.status != 0','employee.status = 1','customer.status = 1','employee.username = timetable.employee','customer.username = timetable.customer',array('OR','LCASE(employee.last_name) LIKE "'.urldecode(strtolower($name)).'%"','LCASE(employee.first_name) LIKE "'.urldecode(strtolower($name)).'%"','CONCAT_WS(" ",LCASE(employee.first_name),LCASE(employee.last_name)) LIKE "'.urldecode(strtolower($name)).'%"'),'timetable.date BETWEEN "'.$fromdate.'" AND "'.$todate.'"');
					}
				}
				if($name == '-' && $fromdate == '0000-00-00' && $todate == '0000-00-00')
				{
...
*/
		...
		if($fromdate != '0000-00-00' && $todate == '0000-00-00')
		{			
			$this->conditions = array('AND','timetable.status != 0','leave.employee = "'.$empunm.'"','timetable.employee = "'.$empunm.'"','leave.date >= "'.$fromdate.'" ','timetable.date >= "'.$fromdate.'" ','leave.date = timetable.date',array('OR','leave.type = 2','leave.type = 3','leave.type = 4','leave.type = 7'));				
		}	
		if($fromdate == '0000-00-00' && $todate != '0000-00-00')
		{			
			$this->conditions = array('AND','timetable.status != 0','leave.employee = "'.$empunm.'"','timetable.employee = "'.$empunm.'"','leave.date <= "'.$todate.'" ','timetable.date <= "'.$todate.'" ','leave.date = timetable.date',array('OR','leave.type = 2','leave.type = 3','leave.type = 4','leave.type = 7'));				
		}			
		if($fromdate != '0000-00-00' && $todate != '0000-00-00')
		{			
...
*/
		...
		if($fromdate != '0000-00-00' && $todate == '0000-00-00')
		{			
			$this->conditions = array('AND','timetable.status != 0','leave.employee = "'.$empunm.'"','timetable.employee = "'.$empunm.'"','leave.date >= "'.$fromdate.'" ','timetable.date >= "'.$fromdate.'" ','timetable.date = leave.date');				
		}	
		if($fromdate == '0000-00-00' && $todate != '0000-00-00')
		{			
			$this->conditions = array('AND','timetable.status != 0','leave.employee = "'.$empunm.'"','timetable.employee = "'.$empunm.'"','leave.date <= "'.$todate.'" ','timetable.date <= "'.$todate.'" ','timetable.date = leave.date');				
		}			
		if($fromdate != '0000-00-00' && $todate != '0000-00-00')
		{			
		...
		if($totemp > 0)
		{
			...
			{		
					...
					//if($empuname  == 'mehe001' && $custuname == 'brjo001')
...
//                        echo "<br>";
    ...
    function employee_add() {
        ...
        if ($this->username != NULL) {
            ...
            $this->field_values = array($this->username, $this->century, $this->code, $this->social_security, $this->first_name, $this->last_name, $this->address, $this->city, $this->post, $this->phone, $this->mobile, $this->email, $this->date, $this->color_code, $this->status,$this->inactive_date);
    ...
    function employee_update() {
        ...
        if ($this->username != NULL) {
            ...
            $this->tables = array('employee');
            $this->fields = array('code', 'century', 'social_security', 'first_name', 'last_name', 'address', 'city', 'post', 'phone', 'mobile', 'email', 'date', 'color', 'status','date_inactive');
            $this->field_values = array($this->code, $this->century, $this->social_security, $this->first_name, $this->last_name, $this->address, $this->city, $this->post, $this->phone, $this->mobile, $this->email, $this->date, $this->color_code, $this->status,$this->inactive_date);
            $this->conditions = array('username = ?');
            $this->condition_values = array($this->username);
            if ($this->query_update()) {
    ...
    function employee_detail($username = NULL) {
        ...
        $this->tables = array('employee');
        $this->fields = array('username', 'century', 'code', 'social_security', 'first_name', 'last_name', 'address', 'city', 'post', 'phone', 'mobile', 'email', 'date', 'color', 'status','monthly_salary');
    ...
    function employee_detail_main($username) {
        ...
        $this->tables = array('employee');
        $this->fields = array('username', 'century', 'code', 'social_security', 'first_name', 'last_name', 'address', 'city', 'post', 'phone', 'mobile', 'email', 'date', 'color', 'status','date_inactive','monthly_salary');
...
//calculating start date and end date
    ...
    function employee_timetable_week_time($employee, $year_week, $fkkn = NULL) {
        ...
        if ($fkkn != NULL && $fkkn != '') {
            ...
            $this->conditions = array('AND', 'employee = ?', array('BETWEEN', 'date', '?', '?'), 'fkkn = ?', array('IN', 'status', '1'), array('IN', 'type', '0,1,2,4,5,6,7,8'));
            $this->condition_values = array($employee, $date_from, $date_to, $fkkn);
        } else {

            $this->conditions = array('AND', 'employee = ?', array('BETWEEN', 'date', '?', '?'), array('IN', 'status', '1'), array('IN', 'type', '0,1,2,4,5,6,7,8'));
...
//getting toatal time for perticulal user and cusomer for the date
    ...
    function get_employee_normal_inconvenient_details_by_month_and_year($month, $year, $employee) {
        ...
        $this->conditions = array('AND', 'month(date) = ?', 'year(date) = ?', 'employee = ?', array('IN', 'status', '1,2'), array('IN', 'type', '1,2,0,3,4,5,6,7,8'));
        $this->condition_values = array($month, $year, $employee);
        $this->order_by = array('date');
        $this->query_generate();
        $datas = $this->query_fetch();
...
//        $cust_query = $this->sql_query;
    ...
    function update_leave_status($employee='', $date_from='', $date_to='', $time_from='', $time_to='') {
        $this->begin_transaction();
        $this->tables = array('leave');
        ...
        if ($this->query_update()){
            ...
            //            $r_id = $tt_entry['id'];
                        ...
                        while($flg){
                            $flg = FALSE;
                            if($relations = $this->check_relations_in_timetable_for_leave($r_id)){  //check have substitute exist or not?
...
//        print_r($data);
    ...
    function add_previleges_general($emp){
        ...
        for($i=0;$i<count($emps);$i++){
            ...
            if($data){
                $this->tables = array('privileges_general');
                $this->fields = array('add_employee','add_customer','inconvenient_timing','administration','chat');
                $this->field_values = array($this->general_add_employee,$this->general_add_customer,$this->general_inconvenient_timing,$this->general_administration,$this->general_chat);
                $this->conditions = array('employee = ?');
                $this->condition_values = array($emps[$i]);
    ...
    function add_previleges_mc($emp){
        ...
        for($i=0;$i<count($emps);$i++){
            ...
            if($data){
                $this->tables = array('privileges_mc');
                $this->fields = array('leave_notification','leave_approval','leave_rejection','leave_edit','notes','cirrus_mail','external_mail','sms','notes_approval','notes_rejection');
                $this->field_values = array($this->mc_leave_notification,$this->mc_leave_approval,$this->mc_leave_rejection,$this->mc_leave_edit,$this->mc_notes,$this->cirrus_mail,$this->external_mail,$this->mc_sms,$this->mc_notes_approval,$this->mc_notes_rejection);
                $this->conditions = array('employee = ?');
                $this->condition_values = array($emps[$i]);
                if($this->query_update()){
                     $t = 1;
    ...
    function add_previleges_reports($emp){
        ...
        for($i=0;$i<count($emps);$i++){
            ...
            if($data){
                $this->tables = array('privileges_reports');
                $this->fields = array('customer_schedule','employee_schedule','monthly_work');
                $this->field_values = array($this->customer_schedule,$this->employee_schedule,$this->monthly_work);
                $this->conditions = array('employee = ?');
                $this->condition_values = array($emps[$i]);
                if($this->query_update()){
                     $t = 1;
    ...
    function get_privileges_employee($employees){
        ...
        $employees = '\''.implode('\',\'', $employees).'\'';
        $this->tables = array('privileges');
        $this->fields = array('employee','CONCAT(swap,",",process,",",add_slot,",",fkkn,",",slot_type,",",add_customer,",",add_employee,",",remove_customer,",",remove_employee,",",`leave`,",",copy_single_slot,",",copy_single_slot_option,",",copy_day_slot,",",copy_day_slot_option,",",split_slot,",",delete_slot,",",delete_day_slot) AS privilege');
    ...
    function get_privileges_forms_employee($employees){
        ...
        $employees = '\''.implode('\',\'', $employees).'\'';
        $this->tables = array('privileges_forms');
        $this->fields = array('employee','CONCAT(fkkn,",",`leave`,",",certificate) AS privilege');
        $this->conditions = array('IN',"employee",$employees);
        $this->query_generate();
        $data = $this->query_fetch();
        if($data){
    ...
    function get_privileges_general_employee($employees){
        ...
        $employees = '\''.implode('\',\'', $employees).'\'';
        $this->tables = array('privileges_general');
        $this->fields = array('employee','CONCAT(add_employee,",",add_customer,",",inconvenient_timing,",",administration,",",chat,",",survey) AS privilege');
        $this->conditions = array('IN',"employee",$employees);
        $this->query_generate();
        $data = $this->query_fetch();
        if($data){
    ...
    function get_privileges_mc_employee($employees){
        ...
        $employees = '\''.implode('\',\'', $employees).'\'';
        $this->tables = array('privileges_mc');
        $this->fields = array('employee','CONCAT(leave_notification,",",leave_approval,",",leave_rejection,",",leave_edit,",",notes,",",cirrus_mail,",",external_mail,",",sms,",",notes_approval,",",notes_rejection) AS privilege');
        $this->conditions = array('IN',"employee",$employees);
        $this->query_generate();
        $data = $this->query_fetch();
        if($data){
    ...
    function get_privileges_report_employee($employees){
        ...
        $employees = '\''.implode('\',\'', $employees).'\'';
        $this->tables = array('privileges_reports');
        $this->fields = array('employee','CONCAT(customer_schedule,",",employee_schedule,",",monthly_work) AS privilege');
        $this->conditions = array('IN',"employee",$employees);
        $this->query_generate();
        $data = $this->query_fetch();
        if($data){
