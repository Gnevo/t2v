...
//            }    
    ...
    function employee_add() {
        ...
        if ($this->username != NULL) {
            $this->tables = array('employee');
            $this->fields = array('username', 'century', 'code', 'social_security', 'first_name', 'last_name', 'gender','address', 'city', 'post', 'phone', 'mobile', 'email', 'date', 'color', 'status', 'date_inactive', 'max_hours', 'monthly_salary','start_day');
            $this->field_values = array($this->username, $this->century, $this->code, $this->social_security, $this->first_name, $this->last_name, $this->gender,$this->address, $this->city, $this->post, $this->phone, $this->mobile, $this->email, $this->date, $this->color_code, $this->status, $this->inactive_date, $this->max_hours, $this->monthly_salary,$this->start_day);
...
//				$this->employee_salary($this->username);
    ...
    function employee_update() {
        ...
        if ($this->username != NULL) {
            ...
            $this->tables = array('employee');
            $this->fields = array('code', 'century', 'social_security', 'first_name', 'last_name','gender','address', 'city', 'post', 'phone', 'mobile', 'email', 'date', 'color', 'status', 'date_inactive', 'max_hours', 'monthly_salary','start_day');
            $this->field_values = array($this->code, $this->century, $this->social_security, $this->first_name, $this->last_name,$this->gender, $this->address, $this->city, $this->post, $this->phone, $this->mobile, $this->email, $this->date, $this->color_code, $this->status, $this->inactive_date, $this->max_hours, $this->monthly_salary,$this->start_day);
            $this->conditions = array('username = ?');
            $this->condition_values = array($this->username);
