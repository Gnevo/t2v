...
//                $minute_sixty = intval($minute / 100 * 60);
    ...
    function get_all_employee_leave($year = NULL, $month = NULL, $emp = NULL, $search_text = NULL, $status = NULL) {
        /**
         * Author: Shamsu
         * for: get all employee leave asper their role
         */
...
//        print_r($data);
    ...
    function Customer_pdf_work_report($customer, $month, $year, $fkkn, $this_bargaining = NULL, $txt_other_bargaining = NULL, $this_agreement = array(), $employee = Null, $sam_sida = Null, $provider_of_pa = NULL) {
        /**
         * Author: Shamsu
...
//            $pdf->summery_Sidelabel();
    ...
    function Customer_pdf_work_report_for_kn($customer, $month, $year, $fkkn, $this_bargaining = NULL, $txt_other_bargaining = NULL, $this_agreement = array(), $employee = Null, $sam_sida = Null, $provider_of_pa = NULL) {
        /**
         * Author: Shamsu
         * for: FKKN customer work report
         */
...
//                $pdf->summery_Sidelabel();
    ...
    function get_employee_signing_details($employee, $month, $year, $customer) {
        ...
        $this->fields = array('signin_date', 'signin_employee', 'employee_sign', 'employee_ocs');
...
//                $date_14 = date('Y-m-d', strtotime($date1 . ' +13 day'));
                ...
                $this->make_Financial_payment_pdf_table_header($pdf, $date1, $date2, $customer_details, $company_details, $customer_gardian_details, $emp_details, array(), $all_leave_works, $this->reference[0]);
                $pdf->AddPage();
                $pdf->P2_top($this->collective);
                $pdf->P2_table1($date1, $date2, $this->insurance_word_person, $this->SS_contibution, $incov_details, array(), $leave_times_15_90);
                $this->make_Financial_payment_pdf_table_footer($pdf, $date1, $date2, $additional_overlaped_day_karenses, $Q_work_dates, $company_details);
                $flag = 1;
...
//                echo "<pre>incov_details".print_r($qualifying_day_total_hour, 1)."</pre>---------------------";
                ...
                $this->make_Financial_payment_pdf_table_header($pdf, $table_period_date1, $table_period_date2, $customer_details, $company_details, $customer_gardian_details, $emp_details, array($qualifying_leave_works[$i]['date']), $all_leave_works, $this->reference[$referenses_usage_count+$i]);
                $pdf->AddPage();
                $pdf->P2_top($this->collective);
                ...
                $this->make_Financial_payment_pdf_table_footer($pdf, $table_period_date1, $table_period_date2, $additional_overlaped_day_karenses, $Q_work_dates, $company_details);
...
//                echo "<pre>Inconv: ".print_r($incov_details, 1)."</pre>";
                ...
                $this->make_Financial_payment_pdf_table_header($pdf, $qualifying_leave_works[0]['date'], $date2, $customer_details, $company_details, $customer_gardian_details, $emp_details, array($qualifying_leave_works[0]['date']), $all_leave_works, $this->reference[$referenses_usage_count]);
                $pdf->AddPage();
                $pdf->P2_top($this->collective);
                ...
                $this->make_Financial_payment_pdf_table_header($pdf, NULL, NULL, $customer_details, $company_details, $customer_gardian_details, $emp_details, array(), $all_leave_works, $this->reference[0]);
                $pdf->AddPage();
                $pdf->P2_top($this->collective);
                $pdf->P2_table1(NULL, NULL, $this->insurance_word_person, $this->SS_contibution, array(), array());
                $this->make_Financial_payment_pdf_table_footer($pdf, NULL, NULL, $additional_overlaped_day_karenses, $Q_work_dates, $company_details);
...
//        $pdf->Output();
    ...
    function make_Financial_payment_pdf_table_header($pdf, $date1, $date2, $customer_details, $company_details, $customer_gardian_details, $emp_details, $Q_work_dates, $all_leave_works, $reference){
...
//                $pdf->P1_table_3($this->comp_paid_to_account, $this->reference);
                $pdf->P1_table_3($this->comp_paid_to_account, $reference);
...
//            $pdf->P1_table_3($this->comp_paid_to_account, $this->reference);
    ...
    function make_Financial_payment_pdf_table_footer($pdf, $date_start, $date_end, $additional_overlaped_day_karenses, $Q_work_dates, $company_details){
        ...
        if(!empty($leave_slots)){
            foreach($leave_slots as $leave_slot){
                ...
                if(in_array($leave_slot['type'], $normal_slot_types)){
                    ...
                    $leave_total_sum[$this_day_normal_salary] = (isset($leave_total_sum[$this_day_normal_salary]) ? ($leave_total_sum[$this_day_normal_salary] + $this_slot_hour_60) : $this_slot_hour_60);
                    ...
                    $leave_total_sum[$this_day_normal_salary] = (isset($leave_total_sum[$this_day_normal_salary]) ? ($leave_total_sum[$this_day_normal_salary] + ($this_slot_hour_60 / 4)) : ($this_slot_hour_60/4));
                }
...
//
    ...
    function customer_pdf_report_summery_insert($data) {
        ...
        $this->fields = array('month', 'year', 'customer', 'how_is_asst_provided', 'did_u_hostpilized_this_month', 'hostpilized_date_from', 'hostpilized_date_to',
            'did_u_included_hospitalized_hours', 'hostpitalized_hours', 'hostpitalized_hours_oncall', 'hostpitalized_hours_standby', 
            ...
            'salary_excl_OB_cost', 'salary_excl_OB_period', 'salary_OB_cost', 'salary_OB_period', 'assist_expenses_cost', 'assist_expenses_period', 'training_cost', 'training_period', 'staff_expense_cost', 'staff_expense_period',
            'administration_cost', 'administration_period', 'working_hours_4_customer', 'compensation_payback');
        $this->field_values = array($data['month'], $data['year'], $data['customer'], $data['section_3_choice'], $data['did_u_hostpilized_this_month'], $data['hospital_date_from'], $data['hospital_date_to'],
            $data['did_u_included_hospitalized_hours'], $data['hostpitalized_hours'], $data['hostpitalized_hours_oncall'], $data['hostpitalized_hours_standby'], 
    ...
    function customer_pdf_report_summery_update($data) {
        ...
        $this->field_values = array($data['section_3_choice'], $data['section_3_org_no'], $data['did_u_hostpilized_this_month'], $data['hospital_date_from'], $data['hospital_date_to'], $data['hospital'],
            ...
            $data['excl_ob_cost'], $data['excl_ob_period'], $data['ob_cost'], $data['ob_period'], $data['asst_exp_cost'], $data['asst_exp_period'], $data['training_cost'], $data['training_period'], $data['staff_expense_cost'], $data['staff_expense_period'],
            $data['admin_cost'], $data['admin_period'], $data['working_hours_4_customer']);*/
        $this->fields = array('how_is_asst_provided', 'did_u_hostpilized_this_month', 'hostpilized_date_from', 'hostpilized_date_to',
            'did_u_included_hospitalized_hours', 'hostpitalized_hours', 'hostpitalized_hours_oncall', 'hostpitalized_hours_standby', 
            'signed_customer_phno', 'signature_options', 'sign_date', 'signed_employer_name', 'signed_employer_ssn', 'have_money_left_not_to_purchase1', 'money_left1',
            'money_left_not_to_purchase2', 'money_left2', 'accounting_date_from', 'accounting_date_to',
            'salary_excl_OB_cost', 'salary_excl_OB_period', 'salary_OB_cost', 'salary_OB_period', 'assist_expenses_cost', 'assist_expenses_period', 'training_cost', 'training_period', 'staff_expense_cost', 'staff_expense_period',
            'administration_cost', 'administration_period', 'working_hours_4_customer', 'compensation_payback');
        $this->field_values = array($data['section_3_choice'], $data['did_u_hostpilized_this_month'], $data['hospital_date_from'], $data['hospital_date_to'],
            $data['did_u_included_hospitalized_hours'], $data['hostpitalized_hours'], $data['hostpitalized_hours_oncall'], $data['hostpitalized_hours_standby'], 
            $data['section6_phone'], $data['signature_options'], $data['sign_date'], $data['signed_customer_name'], $data['signed_customer_ssn'], $data['rd_money_left_1'], $data['txt_money_left_1'], 
            $data['rd_money_left_2'], $data['txt_money_left_2'], $data['acc_date_from'], $data['acc_date_to'],
            $data['excl_ob_cost'], $data['excl_ob_period'], $data['ob_cost'], $data['ob_period'], $data['asst_exp_cost'], $data['asst_exp_period'], $data['training_cost'], $data['training_period'], $data['staff_expense_cost'], $data['staff_expense_period'],
...
//        echo "<pre>Final sick_details".print_r($sick_details, 1)."</pre>";
        $sick_details_partition = array_chunk($sick_details, 20);   //array split as 23 rows
...
//        echo "_SESSION<pre>".print_r($_SESSION, 1)."</pre>";
        ...
        $this->sql_query = "SELECT count(DISTINCT l.group_id) as unread_leave_count
                                FROM `leave` AS l
                                LEFT JOIN `mc_leave` AS mcl ON ( mcl.leave_id = l.group_id )
                                WHERE (mcl.read_users NOT LIKE '%$login_user%' OR mcl.leave_id IS NULL)
                ";
...
//        $pdf->report_title();
    ...
    function make_fk_export_xml($sel_year, $sel_month, $cust_key, $emp_key) {
        ...
        <ns:Tidredovisning xmlns:ns="http://schema.forsakringskassan.se/integration/isassistansersattning/tidredovisning/1">
                ...
                <ns:assistansanordnare>
                    <ns:anordnareNamn>' . $company_data['name'] . '</ns:anordnareNamn>
                    <ns:organisationsnummer>' . $company_data['org_no'] . '</ns:organisationsnummer>
                    <ns:kontaktperson>' . ($company_data['contact_person1'] != '' ? $company_data['contact_person1'] : $company_data['contact_person2']) . '</ns:kontaktperson>
                    <ns:telefonnummer>' . ($company_data['phone'] != '' ? $company_data['phone'] : $company_data['mobile']) . '</ns:telefonnummer>
                    <ns:assistentAnstalldAvAnordnare>true</ns:assistentAnstalldAvAnordnare>
                </ns:assistansanordnare>
                <ns:tidrapport>
                    ' . $xml_work_details . '
                </ns:tidrapport>
                <ns:telefonnummerAnordnare>1933211234</ns:telefonnummerAnordnare>
                <ns:telefonnummerAssistent>' . ($emp_data_set['phone'] != '' ? $emp_data_set['phone'] : $emp_data_set['mobile']) . '</ns:telefonnummerAssistent>
        </ns:Tidredovisning>';
