...
//        return TRUE;
    ...
    function recruitment_selectall() {
        ...
        $this->fields = array('ap.id','ap.personal_number', 'ap.first_name', 'ap.last_name', 'ap.gender', 'ap.address', 'ap.post_no', 'ap.city', 'ap.telephone', 'ap.mobile');
    ...
    function recruitment_personal_check($personal_number,$type_recruitment) {
        if($type_recruitment == 0){
            ...
            $this->fields = array('ap.id','ap.personal_number', 'ap.first_name', 'ap.last_name', 'ap.gender', 'ap.address', 'ap.post_no', 'ap.city', 'ap.telephone', 'ap.mobile','ic.status','ic.date_of_interview');
...
//        }
    ...
    function recruitment_select_applicant($type_recruitment){
        ...
        $query = $this->sql_query;
        $this->tables = array('applicant` AS `ap','interview_candidates` AS `ic');
        $this->fields = array('ap.id','ap.personal_number', 'ap.first_name', 'ap.last_name', 'ap.gender', 'ap.address', 'ap.post_no', 'ap.city', 'ap.telephone', 'ap.mobile','ic.date_of_interview');
