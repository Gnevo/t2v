...
$form_data_report = $customer_forms->get_form_3_report($customer_id);
$form_data_descriptions = $customer_forms->get_form_3_description_report($customer_id);
...
if(isset($_REQUEST['customer'])) {
	$smarty->display('forms/form_3_report.tpl');
} else {
	$smarty->display('extends:layouts/dashboard.tpl|forms/form_3_report.tpl');
}
