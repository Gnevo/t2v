...
//   $inconvinient_timings =  $employee->employee_inconvenient_time_month($emp,$year,$month,$inconvinient_details,$works_in,$inconvinient_details_holiday,$inconvenient_block,2);
//   $totals =  $employee->employee_inconvenient_time_month($emp,$year,$month,$inconvinient_details,$works_in,$inconvinient_details_holiday,$inconvenient_block,3);
// 
//   $smarty->assign('report_inconv',$totals);
//   $smarty->assign('reports_totals',$inconvinient_timings);
...
//$smarty->display('extends:layouts/dashboard.tpl|inconvinient_timings_report.tpl');
?>