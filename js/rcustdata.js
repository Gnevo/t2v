...
function changeorder(order)
{
	...
	var url = host+"report/customerdata/qstr/"; 	
...
function pdfdownload()
{
	...
	var host = document.getElementById("url").value;		
	//var url = host+"customerdata_old/pdfdownload/qstr/"; 
	var url = host+"customerdata/pdfdownload/qstr/"; 
	...
	//myWindow=window.open(url,'Customer Dataa PDF','width=200,height=100');
...
function exceldownload()
{
	...
	var host = document.getElementById("url").value;		
	//var url = host+"customerdata_old/pdfdownload/qstr/"; 
	var url = host+"customerdata/exceldownload/qstr/"; 
...
function csvdownload()
{
	...
	var host = document.getElementById("url").value;		
	//var url = host+"customerdata_old/pdfdownload/qstr/"; 
	var url = host+"customerdata/csvdownload/qstr/"; 
