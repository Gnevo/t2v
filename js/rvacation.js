...
{	
	...
	var url = host+"vacation/planningdata/emp/";	
...
function pdfdownload()
{
	...
	var host = document.getElementById("url").value;
	var url = host+"vacationplanningdata/pdfdownload/emp/";
	...
	//	myWindow=window.open(url,'Vacation Planning PDF','width=200,height=100');
