...
AmCharts.Cuboid = AmCharts.Class({
    ...
    draw: function () {
        ...
        var q, v, u, t, x, y, w, A, z;
        if (0 < e || 0 < f) w = s, s = AmCharts.adjustLuminosity(p, -0.2), s = AmCharts.adjustLuminosity(p, -0.2), q = AmCharts.polygon(b, [0, e, c + e, c, 0], [0, f, f, 0, 0], s, h, 0, 0, 0, n), 0 < m && (z = AmCharts.line(b, [0, e, c + e], [0, f, f], l, m, k)), v = AmCharts.polygon(b, [0, 0, c, c, 0], [0, d, d, 0, 0], s, h, 0, 0, 0, 0, n), v.translate(e, f), 0 < m && (u = AmCharts.line(b, [e, e], [f, f + d], l, 1, k)), t = AmCharts.polygon(b, [0, 0, e, e, 0], [0, d, d + f, f, 0], s, h, 0, 0, 0, n), x = AmCharts.polygon(b, [c, c, c + e, c + e, c], [0, d, d + f, f, 0], s, h, 0, 0, 0, n), 0 < m && (y = AmCharts.line(b, [c, c + e, c + e, c], [0, f, d + f, d], l, m, k)), s = AmCharts.adjustLuminosity(w, 0.2), w = AmCharts.polygon(b, [0, e, c + e, c, 0], [d, d + f, d + f, d, d], s, h, 0, 0, 0, n), 0 < m && (A = AmCharts.line(b, [0, e, c + e], [d, d + f, d + f], l, m, k));
        1 > Math.abs(d) && (d = 0);
        1 > Math.abs(c) && (c = 0);
        b = 0 === d ? AmCharts.line(b, [0, c], [0, 0], p, m, k) : 0 === c ? AmCharts.line(b, [0, 0], [0, d], p, m, k) : 0 < r ? AmCharts.rect(b, c, d, g, h, k, l, m, r, n) : AmCharts.polygon(b, [0,
            0, c, c, 0
        ], [0, d, d, 0, 0], g, h, k, l, m, n);
        d = 0 > d ? [q, z, v, u, t, x, y, w, A, b] : [w, A, v, u, t, x, q, z, y, b];
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function () {
        ...
        for (t = 0; t < v.length; t++) {
            ...
            u = A.getBBox();
            var z;
            this.equalWidths ? z = f + y * (r + m + this.markerLabelGap) : (z = w, w = w + u.width + f + m);
            z + u.width > n && (0 <
                t && 0 != y) && (x++, y = 0, z = f, w = z + u.width + f + m, skipNewRow = !0);
            A.translate(z, (p + l) * x);
            y++;
            !isNaN(k) && y >= k && (y = 0, x++);
            s.push(A)
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var s = this.horizontalPadding,
                    ...
                    t = d.fontFamily,
                    x = this.fontSize;
                void 0 == x && (x = d.fontSize);
                d = AmCharts.text(e, this.text, this.color, t, x, c);
                f.push(d);
                var y;
                void 0 != m && (y = AmCharts.text(e, this.text, m, t, x, c, !1, 0.4), f.push(y));
                t = d.getBBox();
                m = t.height + 2 * n;
                t = t.width + 2 * s;
                window.opera && (m += 2);
                ...
                d.translate(w, x);
                y && y.translate(w + 1, x + 1);
                "H" != v ? (w = a - t / 2, c = b < h + m + 10 && "down" != v ? b + q : b - m - q) : (2 * q > m && (q = m / 2), c = b - m / 2, w = a < g + (k - g) / 2 ? a + q : a - t - q);
                c + m >= l && (c = l - m);
                c < h &&
                    (c = h);
                w < g && (w = g);
                w + t > k && (w = k - t);
                0 < u || 0 === q ? (p = AmCharts.rect(e, t, m, r, this.fillAlpha, this.borderThickness, p, this.borderAlpha, this.cornerRadius), this.showBullet && (e = AmCharts.circle(e, this.bulletSize, r, this.fillAlpha), e.translate(a, b), this.pointer = e)) : (l = [], u = [], "H" != v ? (g = a - w, g > t - q && (g = t - q), g < q && (g = q), l = [0, g - q, a - w, g + q, t, t, 0, 0], u = b < h + m + 10 && "down" != v ? [0, 0, b - c, 0, 0, m, m, 0] : [m, m, b - c, m, m, 0, 0, m]) : (h = b - c, h > m - q && (h = m - q), h < q && (h = q), u = [0, h - q, b - c, h + q, m, m, 0, 0], l = a < g + (k - g) / 2 ? [0, 0, w < a ? 0 : a - w, 0, 0, t, t, 0] : [t, t, w + t > a ? t : a -
                    w, t, t, 0, 0, t
                ]), p = AmCharts.polygon(e, l, u, r, this.fillAlpha, this.borderThickness, p, this.borderAlpha));
                f.push(p);
                p.toFront();
                y && y.toFront();
                d.toFront();
...
AmCharts.AmCoordinateChart = AmCharts.Class({
                ...
                for (v = 0; v < q.length; v++) {
                    ...
                    for (t = 0; t < a.length; t++) {
                        ...
                        if (b.valueAxis.id == u) {
                            ...
                            w.index = r;
                            b.dataProvider && (s = c);
                            w.values = this.processValues(s, b, y);
    ...
    processValueAxes: function () {
        ...
        for (b = 0; b < a.length; b++) {
            ...
            if (!0 === this.usePrefixes || !1 ===
                this.usePrefixes) c.usePrefixes = this.usePrefixes
        }
    },
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function () {
        ...
        p && !t && (isNaN(s) || (d = p.getCoordinate(s)), isNaN(q) || (e = p.getCoordinate(q)));
...
AmCharts.AmSerialChart = AmCharts.Class({
    ...
    countColumns: function () {
        ...
        for (h = 0; h < b; h++) {
            ...
            var k = e.stackType;
            if ("100%" == k || "regular" == k)
                for (f = !1, g = 0; g < c; g++) d = this.graphs[g], d.hidden || (d.valueAxis != e || "column" != d.type) || (!f && d.stackable && (a++, f = !0), d.stackable ||
                    a++, d.columnIndex = a - 1);
            if ("none" == k || "3d" == k)
                ...
                if (0 < y) {
                    ...
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        var A = x[d],
                            ...
                            G = A.above;
                        isNaN(A.toValue) ||
                            (z = this.getCoordinate(A.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, A), this.pushAxisItem(t, G));
                        var H = NaN;
                        isNaN(A.value) || (H = this.getCoordinate(A.value), t = new this.axisItemRenderer(this, H, A.label, !0, NaN, (z - H) / 2, A), this.pushAxisItem(t, G));
                        isNaN(z - H) || (t = new this.guideFillRenderer(this, H, z, A), this.pushAxisItem(t, G), t = t.graphics(), A.graphics = t, A.balloonText && this.addEventListeners(t, A))
                    }
                    this.fillAlpha = w
                }
                x = !1;
                for (d = p; d < s; d += r) t = AmCharts.roundTo(this.step * d + this.min, c), -1 != String(t).indexOf("e") &&
                    (x = !0, String(t).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                for (d = p; d < s; d += r)
                    if (p = this.step * d + this.min, p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p)
                        if (isNaN(v) || Number(AmCharts.toFixed(p, v)) == p) {
                            !0 === h && (0 === p && (p = this.minReal), 2 < q && (p = Math.pow(10, d)), x = -1 != String(p).indexOf("e") ? !0 : !1);
                            this.useScientificNotation && (x = !0);
                            this.usePrefixes && (x = !1);
                            x ? (t = -1 == String(p).indexOf("e") ? p.toExponential(15) : String(p), t = t.split("e"),
                            ...
                            if (p == this.baseValue && "radar" != k) {
                                var O, I, y = this.viW,
                                    ...
                                    p = this.viX;
                                t = this.viY;
                                "H" == this.orientation ? 0 <= c && c <= y + 1 && (O = [c, c, c + e], I = [w, 0, f]) : 0 <= c && c <= w + 1 && (O = [0, y, y + e], I = [c, c, c + f]);
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (this.parseDates && !this.equalSpacing) {
                if (this.timeDifference = this.endTime -
                    this.startTime, d = this.choosePeriod(0), e = d.period, n = d.count, a = AmCharts.getPeriodDuration(e, n), a < l && (e = m.period, n = m.count, a = l), r = e, "WW" == r && (r = "DD"), this.stepWidth = this.getStepWidth(this.timeDifference), g = Math.ceil(this.timeDifference / a) + 1, m = AmCharts.resetDateToMin(new Date(this.startTime - a), e, n, v).getTime(), r == e && 1 == n && (p = a * this.stepWidth), this.cellWidth = l * this.stepWidth, b = Math.round(m / a), d = -1, b / 2 == Math.round(b / 2) && (d = -2, m -= a), 0 < this.gridCount)
                    for (b = d; b <= g; b++) {
                        s = m + 1.5 * a;
                        s = AmCharts.resetDateToMin(new Date(s),
                            e, n, v).getTime();
                        l = (s - this.startTime) * this.stepWidth;
                        q = !1;
                        this.nextPeriod[r] && (q = this.checkPeriodChange(this.nextPeriod[r], 1, s, m));
                        t = !1;
                        q ? (m = this.dateFormatsObject[this.nextPeriod[r]], t = !0) : m = this.dateFormatsObject[r];
                        u || (t = !1);
                        m = AmCharts.formatDate(new Date(s), m);
                        if (b == d && !h || b == g && !k) m = " ";
                        this.labelFunction && (m = this.labelFunction(m, new Date(s), this));
                        m = new this.axisItemRenderer(this, l, m, !1, p, 0, !1, t);
                        this.pushAxisItem(m);
                        m = s
                    }
            } else if (!this.parseDates) {
                if (this.cellWidth = this.getStepWidth(b), b < g &&
                    (g = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < g)
                    for (u = Math.floor(b / g), b = f, b / 2 == Math.round(b / 2) && b--, 0 > b && (b = 0), g = 0; b <= this.end + 2; b++)
                        if (0 <= b && b < this.data.length ? (r = this.data[b], m = r.category) : m = "", b / u == Math.round(b / u) || r.forceShow) {
                            ...
                            v = this.cellWidth;
                            n && (v = NaN);
                            this.labelFunction && (m = this.labelFunction(m, r, this));
                            m = AmCharts.fixNewLines(m);
                            m = new this.axisItemRenderer(this, l, m, !0, v, p, void 0, !1, p);
                            this.pushAxisItem(m)
                        }
            } else if (this.parseDates && this.equalSpacing)
                for (f = this.start, this.startTime = this.data[this.start].time, this.endTime = this.data[this.end].time, this.timeDifference = this.endTime - this.startTime, d = this.choosePeriod(0), e = d.period, n = d.count, a = AmCharts.getPeriodDuration(e, n), a < l && (e = m.period, n = m.count, a = l), r = e, "WW" == r && (r = "DD"), this.stepWidth = this.getStepWidth(b), g = Math.ceil(this.timeDifference / a) + 1, m = AmCharts.resetDateToMin(new Date(this.startTime -
                    a), e, n, v).getTime(), this.cellWidth = this.getStepWidth(b), b = Math.round(m / a), d = -1, b / 2 == Math.round(b / 2) && (d = -2, m -= a), b = this.start, b / 2 == Math.round(b / 2) && b--, 0 > b && (b = 0), p = this.end + 2, p >= this.data.length && (p = this.data.length), v = !1, this.end - this.start > this.gridCount && (v = !0), this.previousPos = 0; b < p; b++)
                    if (s = this.data[b].time, this.checkPeriodChange(e, n, s, m)) {
                        l = this.getCoordinate(b - this.start);
                        q = !1;
                        this.nextPeriod[r] && (q = this.checkPeriodChange(this.nextPeriod[r], 1, s, m));
                        t = !1;
                        q ? (m = this.dateFormatsObject[this.nextPeriod[r]],
                            t = !0) : m = this.dateFormatsObject[r];
                        m = AmCharts.formatDate(new Date(s), m);
                        if (b == d && !h || b == g && !k) m = " ";
                        v ? v = !1 : (u || (t = !1), 40 < l - this.previousPos && (this.labelFunction && (m = this.labelFunction(m, new Date(s), this)), m = new this.axisItemRenderer(this, l, m, void 0, void 0, void 0, void 0, t), a = m.graphics(), this.pushAxisItem(m), this.previousPos = l + a.getBBox().width));
                        m = s
                    }
            for (b = 0; b < this.data.length; b++)
                if (h = this.data[b]) k = this.parseDates && !this.equalSpacing ? Math.round((h.time - this.startTime) * this.stepWidth + this.cellWidth /
                    2) : this.getCoordinate(b - f), h.x[this.id] = k;
            h = this.guides.length;
            for (b = 0; b < h; b++) k = this.guides[b], l = l = l = g = u = NaN, d = k.above, k.toCategory && (l = c.getCategoryIndexByValue(k.toCategory), isNaN(l) || (u = this.getCoordinate(l - f), m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k), this.pushAxisItem(m, d))), k.category && (l = c.getCategoryIndexByValue(k.category), isNaN(l) || (g = this.getCoordinate(l - f), l = (u - g) / 2, m = new this.axisItemRenderer(this, g, k.label, !0, NaN, l, k), this.pushAxisItem(m, d))), k.toDate && (this.equalSpacing ? (l =
                c.getClosestIndex(this.data, "time", k.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(l) || (u = this.getCoordinate(l - f))) : u = (k.toDate.getTime() - this.startTime) * this.stepWidth, m = new this.axisItemRenderer(this, u, "", !0, NaN, NaN, k), this.pushAxisItem(m, d)), k.date && (this.equalSpacing ? (l = c.getClosestIndex(this.data, "time", k.date.getTime(), !1, 0, this.data.length - 1), isNaN(l) || (g = this.getCoordinate(l - f))) : g = (k.date.getTime() - this.startTime) * this.stepWidth, l = (u - g) / 2, m = "H" == this.orientation ? new this.axisItemRenderer(this,
                g, k.label, !1, 2 * l, NaN, k) : new this.axisItemRenderer(this, g, k.label, !1, NaN, l, k), this.pushAxisItem(m, d)), u = new this.guideFillRenderer(this, g, u, k), g = u.graphics(), this.pushAxisItem(u, d), k.graphics = g, g.index = b, k.balloonText && this.addEventListeners(g, k)
        }
        this.axisCreated = !0;
        c = this.x;
        f = this.y;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k) {
        ...
        var s = a.axisThickness,
            ...
            da = a.offset,
            ea, fa;
        g ? (G = !0, isNaN(g.tickLength) || (u = g.tickLength), void 0 != g.lineColor && (y = g.lineColor), void 0 != g.color && (n = g.color), isNaN(g.lineAlpha) || (t = g.lineAlpha), isNaN(g.dashLength) || (w = g.dashLength), isNaN(g.lineThickness) || (x = g.lineThickness), !0 === g.inside && (I = !0), isNaN(g.labelRotation) || (H = g.labelRotation), isNaN(g.fontSize) || (m = g.fontSize), g.position && (R = g.position)) : "" === c && (u = 0);
        fa = "start";
        e && (fa = "middle");
        var X =
            H * Math.PI / 180,
        ...
        if ("H" == sa) {
            if (0 <= b && b <= la + 1 && (0 < u && (0 < v && b + k <= la + 1) && (ea = AmCharts.line(r, [b + k, b + k], [0, u], q, v, x), p.push(ea)), 0 < t && (fa = AmCharts.line(r, [b, b + W, b + W], [P, P + U, U], y, t, x, w), p.push(fa))), E = 0, F = b, g && 90 == H && (F -= m), !1 === d ? (fa = "start", E = "bottom" == R ? I ? E + u : E - u : I ? E - u : E + u, F += 3, e && (F += e / 2, fa = "middle"), 0 < H && (fa = "middle")) : fa = "middle", 1 == O && (0 < z && !g && T < la) && (d = AmCharts.fitToBounds(b, 0, la), T = AmCharts.fitToBounds(T,
                0, la), V = d - T, 0 < V && (fill = AmCharts.rect(r, V, a.height, A, z), fill.translate(d - V + W, U), p.push(fill))), "bottom" == R ? (E += P + m / 2 + da, I ? 0 < H ? (E = P - B / 2 * Math.sin(X) - u - 3, F += B / 2 * Math.cos(X)) : E -= u + m + 3 + 3 : 0 < H ? (E = P + B / 2 * Math.sin(X) + u + 3, F -= B / 2 * Math.cos(X)) : E += u + s + 3 + 3) : (E += U + m / 2 - da, F += W, I ? 0 < H ? (E = B / 2 * Math.sin(X) + u + 3, F -= B / 2 * Math.cos(X)) : E += u + 3 : 0 < H ? (E = -(B / 2) * Math.sin(X) - u - 6, F += B / 2 * Math.cos(X)) : E -= u + m + 3 + s + 3), "bottom" == R ? V = (I ? P - u - 1 : P + s - 1) + da : ($ = W, V = (I ? U : U - u - s + 1) - da), f && (F += f), U = F, 0 < H && (U += B / 2 * Math.cos(X)), Y && (R = 0, I && (R = B / 2 * Math.cos(X)),
                U + R > la + 1 || 0 > U)) Y.remove(), Y = null
        } else {
            0 <= b && b <= P + 1 && (0 < u && (0 < v && b + k <= P + 1) && (ea = AmCharts.line(r, [0, u], [b + k, b + k], q, v, x), p.push(ea)), 0 < t && (fa = AmCharts.line(r, [0, W, la + W], [b, b + U, b + U], y, t, x, w), p.push(fa)));
            fa = "end";
            ...
            E += m / 2;
            "right" == R ? (F += W + la + da, E += U, I ? (F -= u + 4, f || (E -=
                m / 2 + 3)) : (F += u + 4 + s, E -= 2)) : I ? (F += u + 4 - da, f || (E -= m / 2 + 3), g && (F += W, E += U)) : (F += -u - s - 4 - 2 - da, E -= 2);
            ea && ("right" == R ? ($ += W + da + la, V += U, $ = I ? $ - s : $ + s) : ($ -= da, I || ($ -= u + s)));
            f && (E += f);
            I = -3;
            "right" == R && (I += U);
        ...
        Y && (Y.attr({
            "text-anchor": fa
        }), Y.translate(F, E), 0 !== H && Y.rotate(-H), a.allLabels.push(Y), " " != c && (this.label = Y));
        a.counter = 0 === O ? 1 : 0;
        a.previousCoord = b;
        ...
        if (b) {
            ...
            for (p = 0; p < r; p++) {
                ...
                if (k) {
                    ...
                    180 == s && (v -= 5);
                    0 === s && (v += 5);
                    s = AmCharts.text(b.container, a[p].category, n, l, m, u);
                    s.translate(q + 5, v);
                    this.set.push(s);
                    s.getBBox()
                }
...
AmCharts.RadItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g) {
        ...
        g ? (y = !0, isNaN(g.tickLength) ||
            (p = g.tickLength), void 0 != g.lineColor && (v = g.lineColor), isNaN(g.lineAlpha) || (s = g.lineAlpha), isNaN(g.dashLength) || (u = g.dashLength), isNaN(g.lineThickness) || (q = g.lineThickness), !0 === g.inside && (w = !0)) : c || (s /= 3, p /= 2);
        var O = "end",
            I = -1;
        w && (O = "start", I = 1);
        var W;
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        var a = this.chart,
            ...
            q = [],
            v = [],
            u, t, x = this.chart.graphs.length,
            y, w = this.dx / this.depthCount,
            ...
            W = this.categoryAxis,
            U = this.baseCoord,
            sa = this.negativeBase,
            R = this.columnIndex,
            T = this.lineThickness,
            P = this.lineAlpha,
            la = this.lineColor,
            da = this.dashLength,
            ea = this.set;
        ...
        var V = this.chart.columnSpacing,
            F = W.cellWidth,
            E = (F * h - r) / r;
        V > E && (V = E);
        var $, B, Y, Wa = l + 1,
        ...
        if (!I && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && ("step" != g && "none" == this.bullet) && (this.bullet = "round", this.resetBullet = !0), Fa || void 0 != ya)) {
            ...
            var ta = f.getCoordinate(Ca),
                ob = f.getCoordinate(f.max);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) {
            if (0 < H)
                for (M = H - 1; - 1 < M; M--)
                    if ($ = d[M], B = $.axes[f.id].graphs[b], Y = B.values.value) {
                        H = M;
                        break
                    }
            if (O <
                d.length - 1)
                for (M = O + 1; M < d.length; M++)
                    if ($ = d[M], B = $.axes[f.id].graphs[b], Y = B.values.value) {
                        O = M;
                        break
                    }
        ...
        for (M = H; M <= O; M++) {
            ...
            if (ra) {
                ...
                switch (g) {
                case "line":
                    isNaN(S) ? s || (this.drawLineGraph(q, v, ga, ha), q = [], v = [], ga = [], ha = []) : (B.isNegative = S < sa ? !0 : !1, q.push(D), v.push(C), Z = D, ca = C, oa = D, pa = C, !Ia || (isNaN(N) || isNaN(Q)) || (ga.push(Q), ha.push(N)));
                    break;
                case "smoothedLine":
                    isNaN(S) ?
                        s || (this.drawSmoothedGraph(q, v, ga, ha), q = [], v = [], ga = [], ha = []) : (B.isNegative = S < sa ? !0 : !1, q.push(D), v.push(C), Z = D, ca = C, oa = D, pa = C, !Ia || (isNaN(N) || isNaN(Q)) || (ga.push(Q), ha.push(N)));
                    break;
                case "step":
                    isNaN(S) ? s || (t = NaN, this.drawLineGraph(q, v, ga, ha), q = [], v = [], ga = [], ha = []) : (B.isNegative = S < sa ? !0 : !1, n ? (isNaN(u) || (q.push(u), v.push(C - wa)), v.push(C - wa), q.push(D), v.push(C + Ma), q.push(D), !Ia || (isNaN(N) || isNaN(Q)) || (ga.push(Q), ha.push(N - wa), ga.push(Q), ha.push(N + Ma))) : (isNaN(t) || (v.push(t), q.push(D - wa)), q.push(D -
                        wa), v.push(C), q.push(D + Ma), v.push(C), !Ia || (isNaN(N) || isNaN(Q)) || (ga.push(Q - wa), ha.push(N), ga.push(Q + Ma), ha.push(N))), u = D, t = C, Z = D, ca = C, oa = D, pa = C);
                    break;
                case "column":
                    ka = ma;
                    ...
                    if (!isNaN(S)) {
                        ...
                        var pb = f.min,
                            qb = f.max;
                        if (!(S < pb && ia < pb || S > qb && ia > qb))
                            if (n) {
                                "3d" == z ? (L = C - 0.5 * (h + V) + V / 2 + A * R, K = Q + w * R) : (L = C - (r / 2 - R) * (h + V) + V / 2, K = Q);
                                J = h;
                                Z = D;
                                ca = L + h / 2;
                                oa = D;
                                ...
                                aa += Db - K;
                                aa = AmCharts.fitToBounds(aa, -K, k - K + w * R);
                                if (L < l && 0 < J && (ja = new AmCharts.Cuboid(e, aa, J, w - a.d3x, A - a.d3y, va, La, T, ka, P, X, p, n), "bottom" != G))
                                    if (G = f.reversed ? "left" : "right", 0 > S) G = f.reversed ? "right" : "left";
                                    else if ("regular" == z || "100%" == z) Z += this.dx
                            } else {
                                "3d" == z ? (K = D - 0.5 * (h + V) + V / 2 + w * R, L = N + A * R) : (K = D - (r / 2 - R) * (h + V) + V / 2, L = N);
                                J = h;
                                Z = K + h / 2;
                                ca = C;
                                oa = K + h / 2;
                                ...
                                aa += Eb - L;
                                aa = AmCharts.fitToBounds(aa, -L + A * R, l - L);
                                if (K < k + R * w && 0 < J)
                                    if (ja = new AmCharts.Cuboid(e, J, aa, w - a.d3x, A - a.d3y, va, La, T, ka, this.lineAlpha, X, p, n), 0 > S && "middle" != G) G = "bottom";
                                    else if (G = fa, "regular" == z || "100%" == z) ca += this.dy
                            }
                        if (ja && (qa = ja.set, qa.translate(K, L), this.columnsSet.push(qa), (B.url || this.showHandOnHover) && qa.setAttr("cursor", "pointer"), !I)) {
                            "none" == z && (y = n ? (this.end + 1 - M) * x - c : x * M + c);
                            "3d" == z && (n ? (y = (x - c) * (this.end + 1 - M), Z += w * this.columnIndex, oa += w * this.columnIndex, B.y += w * this.columnIndex) : (y = (x - c) * (M + 1), Z += 3, ca += A * this.columnIndex +
                                7, pa += A * this.columnIndex, B.y += A * this.columnIndex));
                            if ("regular" == z || "100%" == z) G = "middle", y = n ? 0 < ra.value ? (this.end + 1 - M) * x + c : (this.end + 1 - M) * x - c : 0 < ra.value ? x * M + c : x * M - c;
                ...
                case "ohlc":
                    if (!(isNaN(ia) || isNaN(ab) || isNaN(bb) || isNaN(S))) {
                        ...
                        if (n) {
                            var kb = C - h / 2,
                                kb = AmCharts.fitToBounds(kb, 0, l),
                                rb = AmCharts.fitToBounds(C, 0, l),
                                lb = C + h / 2,
                                lb = AmCharts.fitToBounds(lb, 0, l);
                            ib =
                            ...
                            var mb = D - h / 2,
                                mb = AmCharts.fitToBounds(mb, 0, k),
                                sb = AmCharts.fitToBounds(D, 0, k),
                                nb = D + h / 2,
                                nb = AmCharts.fitToBounds(nb, 0, k);
                ...
                if (!I && !isNaN(S)) {
                    ...
                    if (this.end - this.start <= tb || 0 === tb) {
                        ...
                        if (ub) {
                            var ba = this.createLabel(B, 0, 0, ub),
                                xa = 0,
                                Ba = 0,
                                vb = ba.getBBox(),
                                Ua = vb.width,
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                n && "column" == g ? (Z = U, 0 > S ? (xa = -6, ba.attr({
                                    "text-anchor": "end"
                                })) : (xa = 6, ba.attr({
                                    "text-anchor": "start"
                                }))) : (Ba = Da / 2 + Va / 2, ba.x = -(Ua / 2 + 2));
                                break;
                            case "middle":
                                "column" == g && (n ? (Ba = -(Va /
                                    2) + this.fontSize / 2, xa = -(D - Q) / 2 - w, 0 > aa && (xa += w), Math.abs(D - Q) < Ua && !this.showAllValueLabels && (ba.remove(), ba = null)) : (Ba = -(C - N) / 2, 0 > aa && (Ba -= A), Math.abs(C - N) < Va && !this.showAllValueLabels && (ba.remove(), ba = null)))
                            }
                            if (ba) {
                                if (isNaN(ca) || isNaN(Z)) ba.remove(), ba = null;
                                else if (Z += xa, ca += Ba, ba.translate(Z, ca), n) {
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g) "smoothedLine" == g ? this.drawSmoothedGraph(q, v, ga, ha) : this.drawLineGraph(q, v, ga, ha), I || this.launchAnimation()
    },
    ...
    createLabel: function (a, b, c, d, e) {
        ...
        f = AmCharts.text(this.container, a, g, f.fontFamily,
            e);
        f.translate(b, c);
    ...
    drawLineGraph: function (a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            if (0 < f || 0 < v)
                if (l = a.join(";").split(";"), m = b.join(";").split(";"), "serial" == e.chartType && (0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), m = b.concat(d)) : e.rotate ? (m.push(m[m.length - 1]), l.push(u), m.push(m[0]), l.push(u), m.push(m[0]), l.push(l[0])) : (l.push(l[l.length - 1]), m.push(u), l.push(l[0]),
                    m.push(u), l.push(a[0]), m.push(m[0]))), 0 < f && (a = AmCharts.polygon(g, l, m, p, f, 0, 0, 0, this.gradientRotation), h.push(a)), q || void 0 !== s) isNaN(v) && (v = f), q || (q = s), g = AmCharts.polygon(g, l, m, q, v, 0, 0, 0, this.gradientRotation), k.push(g), k.click(function () {
                    e.handleGraphClick()
                });
            e.applyMask(k, h)
        }
    ...
    drawSmoothedGraph: function (a, b, c, d) {
        if (1 < a.length) {
            ...
            var k = this.lineAlpha,
                ...
                q = this.baseCoord,
                v = new AmCharts.Bezier(f, a, b, this.lineColor, k, l, n, 0, e);
            g.push(v.path);
            void 0 !== r && (k = new AmCharts.Bezier(f, a, b, r, k, l, n, 0, e), h.push(k.path));
            0 < m && (l = a.join(";").split(";"), v = b.join(";").split(";"), k = "", 0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), v = b.concat(d)) : (this.rotate ? (k +=
                " L" + q + "," + b[b.length - 1], k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + q, k += " L" + a[0] + "," + q), k += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, l, v, NaN, 0, 0, n, m, e, k), g.push(c.path), p || void 0 !== r) && (s || (s = m), p || (p = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, p, s, e, k), h.push(a.path));
            this.applyMask(h, g)
        }
    },
                ...
                if (c.mouseIsOver || A || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        ...
                        0 !== d && (g = {
                            type: "zoomed",
                            target: this
                        }, g.chart = this.chart, f.parseDates && !f.equalSpacing ? (c + d > x && (d = x - c), A + d < t && (d =
                            t - A), g.start = A + d, g.end = c + d, this.fire(g.type, g)) : O + d >= this.data.length || 0 > k + d || (g.start = k + d, g.end = O + d, this.fire(g.type, g)))
                    } else {
                        ...
                        0 < this.cursorAlpha && (t = this.line, s ? t.translate(0, p + h) : t.translate(p, 0), t.show());
                        this.linePos = s ? p + h :
                            p;
                        A && (s ? this.updateSelectionSize(NaN, p) : this.updateSelectionSize(p, NaN));
                        t = !0;
                        A && (t = !1);
                        this.categoryBalloonEnabled && t ? (s ? (q && ("right" == w ? u.setBounds(k, l + h, k + m + g, l + p + h) : u.setBounds(k, l + h, k + m + g, l + p)), "right" == w ? q ? u.setPosition(k + m + g, l + p + h) : u.setPosition(k + m + g + H, l + p + h) : q ? u.setPosition(k, l + p) : u.setPosition(k - H, l + p)) : "top" == w ? q ? u.setPosition(k + p + g, l + h) : u.setPosition(k + p + g, l + h - H + 1) : q ? u.setPosition(k + p, l + n) : u.setPosition(k + p, l + n + H - 1), f.parseDates ? (f = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, r.category)), u.showBalloon(f)) : u.showBalloon(r.category)) : u.hide();
                        G && this.bulletsEnabled && this.showBullets();
                        this.destroyValueBalloons();
                        if (G && this.valueBalloonsEnabled && t && c.balloon.enabled) {
                            this.valueBalloons = t = [];
                            if (this.oneBalloonOnly) {
                                h = Infinity;
                                for (f = 0; f < G.length; f++) v = G[f], v.showBalloon && (!v.hidden && v.balloonText) && (u = r.axes[v.valueAxis.id].graphs[v.id], x = u.y, isNaN(x) || (s ? Math.abs(d - x) < h && (h = Math.abs(d - x), O = v) : Math.abs(e - x) < h && (h = Math.abs(e -
                                    x), O = v)));
                                this.mostCloseGraph && (O = this.mostCloseGraph)
                            }
                            for (f = 0; f < G.length; f++)
                                if (v = G[f], (!this.oneBalloonOnly || v == O) && (v.showBalloon && !v.hidden && v.balloonText) && (u = r.axes[v.valueAxis.id].graphs[v.id], x = u.y, !isNaN(x))) {
                                    p = u.x;
                                    q = !0;
                                    if (s) {
                                        if (h = x, 0 > p || p > n) q = !1
                                    } else if (h = p, p = x, 0 > h || h > m + g) q = !1;
                                    q && (q = v.valueBalloon, w = c.getBalloonColor(v, u), q.setBounds(k, l, k + m, l + n), q.pointerOrientation = "H", q.changeColor(w), void 0 !== v.balloonAlpha && (q.fillAlpha = v.balloonAlpha), void 0 !== v.balloonTextColor && (q.color = v.balloonTextColor),
                                        q.setPosition(h + k, p + l), v = c.formatString(v.balloonText, u, v), "" !== v && q.showBalloon(v), !s && q.set && q.set.hide(), t.push({
                                            yy: x,
                                            balloon: q
                                        }))
                                }
                        ...
                        b ? (g = {
                            type: "changed"
                        }, g.index = a, g.target = this, g.chart = this.chart, g.zooming = A, g.mostCloseGraph = O, g.position = s ? e : d, g.target = this, c.fire("changed", g), this.fire("changed", g), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
    ...
    draw: function () {
        ...
        if (l = a.graph) {
            ...
            for (p = 0; p < c.length; p++) {
                var s = c[p].axes[r.id].graphs[l.id].values,
                    q;
                for (q in s)
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    var q = 1 / 180 * Math.PI,
        ...
        u = b + Math.cos(d * q) * f,
        t = c + Math.sin(-d * q) * g,
        x = b + Math.cos((d + e) * q) * f,
        y = c + Math.sin((-d - e) * q) * g,
        w = b + Math.cos((d + e) * q) * h,
    ...
    d = a.set();
    var G;
    p && (s = n(10 * s), u = n(10 * u), x =
        n(10 * x), w = n(10 * w), v = n(10 * v), t = n(10 * t), y = n(10 * y), q = n(10 * q), b = n(10 * b), k = n(10 * k), c = n(10 * c), f *= 10, g *= 10, h *= 10, r *= 10, 1 > Math.abs(e) && (1 >= Math.abs(x - u) && 1 >= Math.abs(y - t)) && (G = !0));
    e = "";
    if (0 < k) {
        p ? (path = " M" + s + "," + (v + k) + " L" + u + "," + (t + k), G || (path += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + u + "," + (t + k) + "," + x + "," + (y + k)), path += " L" + w + "," + (q + k), 0 < h && (G || (path += " B" + (b - h) + "," + (k + c - r) + "," + (b + h) + "," + (k + c + r) + "," + w + "," + (k + q) + "," + s + "," + (k + v)))) : (path = " M" + s + "," + (v + k) + " L" + u + "," + (t + k), path += " A" + f + "," + g + ",0," + z +
            ",1," + x + "," + (y + k) + " L" + w + "," + (q + k), 0 < h && (path += " A" + h + "," + r + ",0," + z + ",0," + s + "," + (v + k)));
        path += " Z";
        var H = a.path(path, void 0, void 0, "1000,1000").attr(A);
        d.push(H);
        H = a.path(" M" + s + "," + v + " L" + s + "," + (v + k) + " L" + u + "," + (t + k) + " L" + u + "," + t + " L" + s + "," + v + " Z", void 0, void 0, "1000,1000").attr(A);
        k = a.path(" M" + x + "," + y + " L" + x + "," + (y + k) + " L" + w + "," + (q + k) + " L" + w + "," + q + " L" + x + "," + y + " Z", void 0, void 0, "1000,1000").attr(A);
        d.push(H);
        d.push(k)
    }
    p ? (G || (e = " A" + n(b - f) + "," + n(c - g) + "," + n(b + f) + "," + n(c + g) + "," + n(u) + "," + n(t) + "," +
        n(x) + "," + n(y)), f = " M" + n(s) + "," + n(v) + " L" + n(u) + "," + n(t) + e + " L" + n(w) + "," + n(q)) : f = " M" + s + "," + v + " L" + u + "," + t + (" A" + f + "," + g + ",0," + z + ",1," + x + "," + y) + " L" + w + "," + q;
    0 < h && (p ? G || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + w + "," + q + "," + s + "," + v) : f += " A" + h + "," + r + ",0," + z + ",0," + s + "," + v);
                ...
                for (m = 0; m < b.length; m++)
                    if (e = b[m], !0 !== e.hidden && 0 < e.percents) {
                        var k = 360 * -e.percents / 100,
                            ...
                            v = Math.sin((-f - k / 2) / 180 * Math.PI) * (l / p),
                            h = {
                                fill: e.color,
                        ...
                        if (a.labelsEnabled && a.labelText && e.percents >= a.hideLabelsPercent) {
                            ...
                            if (0 <= k) {
                                var y;
                                90 >= t && 0 <= t ? (y = 0, x = "start", u = 8) : 360 >= t && 270 < t ? (y = 1, x = "start", u = 8) : 270 >= t && 180 < t ? (y = 2, x = "end", u = -8) : 180 >= t && 90 < t && (y = 3, x = "end", u = -8);
                                e.labelQuarter = y
                            } else x = "middle";
                            var t = a.formatString(a.labelText, e),
                                w = e.labelColor;
                            void 0 == w && (w = a.color);
                            t = AmCharts.text(d, t, w, a.fontFamily, a.fontSize, x);
    ...
    checkOverlapping: function (a, b, c, d, e) {
        ...
        if (l) {
            if (!0 === d)
                ...
                for (g = a - 1; 0 <= g; g--)(f = this.checkOverlappingReal(b, h[g], c)) &&
                    (g = 0);
