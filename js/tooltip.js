...
var tooltip = function (v) {
    var h = "length",
        Fb = "addEventListener",
        S, hc, bc = function () {}, rb = function (a, c, b) {
            if (a[Fb]) a[Fb](c, b, false);
            else a.attachEvent && a.attachEvent("on" + c, b);
        }, c = {}, K = function (a) {
            if (a && a.stopPropagation) a.stopPropagation();
//            else window.event.cancelBubble = true;    //SDN
        }, gc = function (a) {
            ...
            var a = d.childNodes,
                c = [];
            if (a)
                for (var b = 0, e = a[h]; b < e; b++) a[b].nodeType == 1 && c.push(a[b]);
            return c;
        }, Z = {
            a: 0,
            b: 0
        ...
        zb = Q.msMaxTouchPoints || Q.maxTouchPoints,
        bb = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch,
        Kb = (Q.msPointerEnabled || Q.pointerEnabled) && zb;
    ...
    var gb = new Jb,
        ...
        pb = function () {
            ...
            if (b) {
                b.op = c;
                if (vb) b[a].filter = "alpha(opacity=" + c * 100 + ")";
                else b[a][D] = c;
            }
            ...
            c[B](e);
            b[B](c);
//            e[a][E] = e[n] + (f ? 1 : 0) + "px";  //SDN - width
//            e[a][P] = e[s] + (f ? 1 : 0) + "px";  //SDN - height
        ...
        Wb = {
                ...
                l.onreadystatechange = function () {
                    if (l && l.readyState === 4) {
                        ...
                        if (l.status === 200) {
                            if (j == d && O) {
                                u();
                                var k = c.toLowerCase() == "xml" ? l.responseXML : l.responseText,
                                    m = k;
                                ...
                                if (c == "html") {
                                    ...
                                    if (p) {
                                        var s = function (e, b) {
                                            var d = null;
                                            if (b.id == e) return b;
                                            for (var c = b[mb]("*"), a = 0, f = c[h]; a < f; a++)
                                                if (c[a].id == e) {
                                                    d = c[a];
                                                    break
                                                }
            ...
            var a = r[mb]("FORM");
//            console.log(a);
//            var a = $("#external_wrapper");   //by shamsudheen
//            console.log(a);
//            console.log(d);
//            Mb = a[h] && a[0][n] ? a[0] : jb;
            Mb = jb;    //by shamsudheen
            Mb[B](d);
            b = d[C];
            d.cW = d.cH = d.cO = 0;
            this.a(v);
...
//                console.log(g);
        ...
        n: function (h, u, t) {
            /*console.log(d);
            console.log(a);*/
            //$('#mcTooltipWrapper').css('display','block');
            d[a][X] = "block";
            b.cW = b[qb] - c.l;
            b.cH = b[ob] - c.m;
            e = Yb(h.maxWidth, u, t);
            b.tw = e[n];
            b.th = e[s];
            var m = b.tw + c.l + c.b + c.b,
                l = b.th + c.m + c.b + c.b,
                j = this.p(h, m, l);
            if (h.smartPosition) var g = Sb(m + c.f, l + c.f, j.x, j.y);
            else g = {
                l: j.x,
                t: j.y
            };
            ...
            if (h.smartPosition && i < 4) {
                var q = g.l - j.x,
                    r = g.t - j.y;
                if (i == 0 || i == 2) k[0] -= q;
                else if (q) f[a][o] = "hidden";
                if (i == 1 || i == 3) k[1] -= r;
                else if (r) f[a][o] = "hidden";
            }
            this.m(i, h[V]);
            var p = Vb();
            g.l = g.l + p[0];
    ...
    var Cb = function () {
        ...
        H, Ib = function (b) {
            if (!b) {
                b = m(T, "mcttDummy");
                /*if (!b) { //remove purchase remainder
                    //alert("mcttDummy");
                    b = m(J, "div");
                    b.id = "mcttDummy";
                    b[a][X] = "none";
