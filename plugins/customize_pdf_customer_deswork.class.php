...
class PDF_Customer_insurance extends FPDI {
    ...
    function customer_des_work($data, $dt, $created_by_name) {
...
//        $this->Cell(190, 4, utf8_decode($dt), 'LRB', 1, 'L');
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(190, 6, utf8_decode($this->smarty->translate['works']), 'LR', 1, 'L');
        $this->SetFont('Arial', 'B', 10);
//        $this->MultiCell(190,4,utf8_decode($data[0]['work']),'LRB',1,'L'); 
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(190, 6, utf8_decode($this->smarty->translate['background_history']), 'LR', 1, 'L');
        $this->SetFont('Arial', 'B', 10);
//        $this->MultiCell(190,4,utf8_decode($data[0]['history']),'LRB',1,'L'); 
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(190, 6, utf8_decode($this->smarty->translate['figure_disease'].'/'.  $this->smarty->translate['symptoms'].'/'.  $this->smarty->translate['allergy']), 'LR', 1, 'L');
        $this->SetFont('Arial', 'B', 10);
//        $this->MultiCell(190,4,utf8_decode($data[0]['clinical_picture']),'LRB',1,'L'); 
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(190, 6, utf8_decode($this->smarty->translate['medications']), 'LR', 1, 'L');
...
//        $this->MultiCell(190,4,utf8_decode($data[0]['medications']),'LRB',1,'L'); 
        ...
        $this->SetFont('Arial', '', 9);
        $this->Cell(190, 6, utf8_decode($this->smarty->translate['particular_diet']), 'LR', 1, 'L');
        $this->SetFont('Arial', 'B', 10);
