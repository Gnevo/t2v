...
//copied class definition from plugins/pdf_emp_cust_work_report_for_sick_rpt.class.php
//definetely both class definitions should be same

require_once('./plugins/pdf_sick_details_report.class.php');

class PDF_work_and_sick_details_report extends PDF_sick_report {
