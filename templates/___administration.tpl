                    ...
                    <div class="span12 icons-group">
                        ...
                        <div class="span12 icons-group">
                            ...
                            <ul>        
                                ...
                                {/if}
                                {if $previlages.administration_fk_export == 1}  <li><a href="javascript:void(0);" onclick="loadFkExport()"><div class="administration-icon-export"></div><label>{$translate.emp_to_cust_fkkn_export}</label></a></li>{/if}                              
