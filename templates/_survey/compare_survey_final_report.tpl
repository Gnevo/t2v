        ...
        <div class="final_report">
            <div class="survey_graph">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="5" class="graph_hdr">{$report.question}</td>
                    </tr>
                    <tr class="graph_heading">
                        <td width="3%">&nbsp;</td>
                    ...
                    <tr class="graph_question">
                        ...
                        <td>{if isset($answer.count)}{($answer.count/$report.ans_count)*100}{else}{(0/$report.ans_count)*100}{/if}%</td>
                        <td><div class="finalreport_percentage" style="width:{if isset($answer.count)}{($answer.count/$report.ans_count)*100}{else}{(0/$report.ans_count)*100}{/if}%;"></div></td>
                    </tr>
                    {/foreach}
                   
                    <tr class="graph_totalblock">
                        <td colspan="2" >Total</td>
                        <td>{$report.ans_count}</td>
                        <td>100%</td>
                        <td>&nbsp;</td>
                    </tr>
