    ...
    {if $count>1}
        {if $page >= 2 && $page != $count}
             <li><a href="javascript:void(0)" onclick="paginateDisplay('1')"><img src="{$url_path}images/first.png"  /></a></li>
                <li><a class="prev" href="javascript:void(0)" onclick="paginateDisplay('{$page-1}')"><img src="{$url_path}images/prev.png"  /></a></li>
             ...
             <li><a href="javascript:void(0)" onclick="paginateDisplay('{$page+1}')">{$page+1}</a></li>
             <li><a class="nxt" href="javascript:void(0)" onclick="paginateDisplay('{$page+1}')"><img src="{$url_path}images/nxt.png"  /></a></li>
