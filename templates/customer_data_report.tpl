...
{/block} 
{block name="script"}
<script src="{$url_path}js/rcustdata.js" type="text/javascript" ></script>
{/block}
{block name="content"}
    <div class="row-fluid">
    <div class="span12 main-left">
    <div class="tbl_hd"><span class="titles_tab">{$translate.cutomer_report}</span>
    ...
    {else}
        ...
        <div class="option_strip">
            ...
            {$translate.show_customer}&nbsp;&nbsp;<input type="checkbox" name="check1" id="check1" value="1" style="padding-top:3px;"/>&nbsp;&nbsp;{$translate.active}&nbsp;&nbsp;
