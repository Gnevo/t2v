...
if(isset($_POST['username'])){
    ...
    //commented by sanket remove strip_tag for text editor issue 
   ...
   // strip_tags($customer->medications) != '' ? $customer->medications = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.strip_tags($customer->medications).'</p>': $customer->medications = '' ;
    ...
    strip_tags($customer->work) != '' ? $customer->work = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$customer->work.'</p>': $customer->work = '' ;
    strip_tags($customer->history) != '' ? $customer->history = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$customer->history.'</p>': $customer->history = '' ;
    strip_tags($customer->clinical_picture) != '' ? $customer->clinical_picture = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$customer->clinical_picture.'</p>': $customer->clinical_picture = '' ;
    strip_tags($customer->medications) != '' ? $customer->medications = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$customer->medications.'</p>': $customer->medications = '' ;
    strip_tags($customer->special_diet) != '' ? $customer->special_diet = '<p class="note_block_head mt ml mr">'.$smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$customer->special_diet.'</p>': $customer->special_diet = '' ;
    ...
    function striphtml($value){
        global $___smarty;
        return strip_tags($value) != '' ? $value = '<p class="note_block_head mt ml mr">'.$___smarty->translate['customer_deswork_date'].': '.date('Y-m-d H:i').'   '.$___smarty->translate['user_name'].': '. $_SESSION['user_name'] .'</p></br/><p class="ml">'.$value.'</p>': $value = '' ;
