...
global $___smarty;
$___smarty = $smarty;
if(isset ($_POST['val']) && $_POST['val'] == 'save'){
    //    echo $_POST['history'].'----------'.stripslashes($_POST['diagnosis']);
    //    echo "<pre>\n".print_r($_POST, 1)."</pre>";
    $new_implan_update_description = array();
    $new_implan_description        = $_POST['new_implan_description'];
    $customer_ai->new_implan_name  = $_POST['new_implan_name'];
    $new_implan_update_description = $_POST['new_implan_update'];
    ...
    // var_dump($new_implan_update_description);
    // exit('qqwqwwqqw');
    ...
    if(isset ($_POST['date']) && $_POST['date'] != ''){
       ...
       // echo "<pre>".print_r($tmp_implan_details, 1)."</pre>"; exit();
        ...
        if($customer_ai->customer_implementation_update($_POST['read_write'])) {
            if(!empty($customer_ai->new_implan_name)){
        ...
        // var_dump($_POST['read_write']);
        // var_dump($customer_ai->implementation_history);
        if($customer_ai->customer_implementation_add($_POST['read_write'])) {
           
            $customer_ai->implementation_id = $customer_ai->last_insert_id;
...
else if(/*array_key_exists(1, $query_string) && */$query_string[1] != "new"){
