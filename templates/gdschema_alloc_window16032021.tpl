                                                                                    ...
                                                                                    <div class="span7">
                                                                                        ...
                                                                                        <div class="row-fluid">
                                                                                            <div class="span12 customer-names-wrpr">
                                                                                                <span class="span12 day-customer-name no-min-height">{if $slot_det.employee neq ''}{$slot_det.emp_name}{/if} <i style="display: none;" class="glyphicons icon-remove pull-right delete-customer"></i></span>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="span5">
