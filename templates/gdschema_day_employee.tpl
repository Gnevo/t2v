...
<style type="text/css">
    ...
    .dayview_head .cal-employee {
        background: #dee793 !important;
        border-color: #9EAD35 !important;
    }
    ...
    .slot-calender-employee .scroll_tabs_theme_light .scroll_tab_left_button, .day-select-employee {
        background: #bbc860!important;
        background: -moz-linear-gradient(top,rgb(164, 177, 78) 0%,rgb(164, 179, 51) 100%)!important;
        background: -webkit-linear-gradient(top,rgb(164, 177, 78) 0%,rgb(164, 179, 51) 100%)!important;
        background: linear-gradient(to bottom,rgb(164, 177, 78) 0%,rgb(164, 179, 51) 100%)!important;
        filter: progid: DXImageTransform.Microsoft.gradient(startColorstr='#bbc860',endColorstr='#c7d36f',GradientType=0)!important;
        border-color: #9fa767!important;
    }

    .slot-calender-employee .active-week .colorchange {
        background: rgba(0,0,0,0) linear-gradient(to bottom,#aec318 0%,#b6c73a 100%) repeat scroll 0 0 !important;
        color: #505050 !important;
        border: 1px solid #a7b345!important;
   ...
   /* .dayview_raw:nth-last-child(-n+3) ul li .absolute_div, .dayview_raw:nth-last-child(-n+3) ul li .absolute_div_for_newslot {
    ...
    .slot-calender-employee .day_view_style .week__view_day .full_week li:hover {
        background: rgba(0,0,0,0) linear-gradient(to bottom,#aec318 0%,#b6c73a 100%) repeat scroll 0 0 !important;
        color: #505050 !important;
        border: 1px solid #a7b345!important;
        box-sizing: border-box;
                    ...
                    <div class="dayview_common">
                        <div class="full_hdr">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title panel-title-employee clearfix">
                                           <div class="pull-left" style="padding:5px;">{$translate.day_view} {$translate.employee}: {$employee_details.first_name|cat: ' '|cat:$employee_details.last_name}</div>
                                            <div class="pull-right no-print">
                                                <ul class="pull-right">
                                                    ...
                                                    <li onclick="navigatePage('{$url_path}month/gdschema/employee/{$current_year}/{$current_month}/{$selected_employee}/',1);"><span class="icon-calendar"></span><a href="javascript:void(0);"><span>{$translate.monthly_view}</span></a></li>
                                                    <li onclick="navigatePage('{$url_path}gdschema_alloc_window_employee.php?date={$selected_date}&employee={$selected_employee}',1);"><span class="icon-calendar"></span><a href="javascript:void(0);"><span>{$translate.day_view}</span></a></li>
                            ...
                            <div class="header_day_view">
                                <div class="dayview_head">
                                    ...
                                    <div class="cal slot-calender-employee" style="background-image: none;">
                                        <div id="tabs2-copy" class="scroll_tabs_theme_light day_view_style scroll_tabs_container scroll_tabs_theme_light_employee">
                                            <div class="scroll_tab_left_button" title="{$translate.prev}" onclick="navigatePage('{$url_path}gdschema_day_employee.php?date={$alloc_prev_week_day}&year_week=&employee={$selected_employee}&action=1',1);" style="position: absolute; left: 0px; top: 0px; cursor: pointer; display: block; width: 5% ! important; text-align: center; box-sizing: border-box; border: 1px solid rgb(204, 204, 204);"></div>
                                            <div class="scroll_tab_inner clearfix" style="overflow: hidden; font-size: 0px; position: absolute; left: 5% ! important; margin: 0px; text-overflow: clip; top: 0px; white-space: nowrap; width: 90%;">
                                                ...
                                                {foreach $week_numbers as $week}
                                                     <div class="week__view_day">
                                                         <div class="week_hd" onclick="navigatePage('{$url_path}employee/gdschema/{$week.id}/{$selected_employee}/',1);">{$translate.week} {$week.id}
                                                         </div>
                                                         <ul class="full_week">
                                                            {foreach $week['week_days'] as $days} 
                                                                 <li  {if $days['date'] == $selected_date}class="colorchange"{/if} onclick="navigatePage('{$url_path}gdschema_day_employee.php?date={$days.date}&year_week={$week.id}&employee={$selected_employee}&action=1',1);" {if (($days.date|date_format:'%u') eq 7) || ($days.date|in_array:$holidays)} style="color:red !important;"{/if}>
                                            ...
                                            <div class="scroll_tab_right_button" title="{$translate.next}" onclick="navigatePage('{$url_path}gdschema_day_employee.php?date={$alloc_next_week_day}&year_week=&employee={$selected_employee}&action=1',1);" style="position: absolute; right: 0px; top: 0px; cursor: pointer; display: block; width: 5% ! important; text-align: center; box-sizing: border-box; border: 1px solid rgb(204, 204, 204);"></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dayview_chart">
                            <div class="dayview_employee">
                                <ul>
                                    {foreach from=$customer_day_slots key=cust_key item=customer_data}
                                        <li class="emp_entry" data-cust='{$cust_key}'><a href="javascript:void(0);" {if $customer_data['show_details'] == 1}onclick="navigatePage('{$url_path}gdschema_alloc_window.php?date={$selected_date}&customer={$cust_key}',1);"{/if}>{$customer_data['name']}</a></li>
                                    {/foreach}
                            ...
                            <div class="dayview_timeshow">
                                ...
                                {foreach $customer_day_slots key=cust_key item=customer_data}
                                    {assign var=emp_index value=$emp_index+1}
                                    <div class="dayview_raw {if $emp_index gt 8}tooltip_upper{/if}" data-cust='{$cust_key}'>
                                        <ul class="slots_all">
                                            {if $customer_data['slots']|count gt 0}
                                                {*foreach $customer_data['slots'] as $slot_det*}
                                                {foreach from=$customer_data['slots'] key=slot_index item=slot_det name=slot_data}
                                                                    ...
                                                                    <div class="slot-hover-popup span12 slot-theme-complete">
                                                                        ...
                                                                        <div class="editsection">
                                                                            <input type="hidden" class="new_slot_details_hub" 
                                                                                        data-time-from='{if $smarty.foreach.slot_data.first}0.00{else}{$customer_data['slots'][$slot_index-1]['slot_to']}{/if}'
                                                                                ...
                                                                                <div class="slot-wrpr span12 time_slots_theme" id="slot-wrpr-month" style="margin-bottom:5px !important;">
                                                                                    ...
                                                                                    <div class="span12" style="margin-left: 0px;">
                                                                                        <div class="input-prepend">
                                                                                            ...
                                                                                            <input class="form-control span5 custom_slot slot_from time-input-text" id="new_slot_from" name="slot_from" value="{if $smarty.foreach.slot_data.first}0.00{else}{$customer_data['slots'][$slot_index-1]['slot_to']}{/if}" placeholder="{$translate.from}" type="text" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px; margin-right: -1px;">
                                                                                    ...
                                                                                    <h2 class="span12 no-mb no-padding"><span class="icon-user" title="{$translate.customer}"></span> 
                                                                                        <span id="sdCustomer">{$slot_det.cust_name}</span>
                                                                                    </h2>
                                                                                    <div class="span12" style="margin-left: 0px;">
                                                            ...
                                                            <div class="slot-hover-popup span12 slot-theme-complete">
                                                                ...
                                                                <div class="editsection">
                                                                    <input type="hidden" class="new_slot_details_hub" 
                                                                                data-time-from='0'
                                                                                data-time-to='24.00'
                                                                                data-customer-id='{$customer_data.username}'
                                                                                data-customer-name='{$customer_data.name|escape:'html'}'
                                                                                />
                                                                    <div class="span12" style="margin-left: 0px;">
                                                                        <div class="slot-wrpr span12 time_slots_theme" id="slot-wrpr-month" style="margin-bottom:5px !important;">
                                                                            <div class="span12" style="margin:0;">
                                                                            ...
                                                                            <h2 class="span12 no-mb no-padding"><span class="icon-user" title="{$translate.customer}"></span> 
                                                                                <span id="sdCustomer">{$customer_data.name}</span>
                                                                            </h2>
                                                                            <div class="span12" style="margin-left: 0px;">
                                                                                <div class="input-prepend span11">
                                                                                    <span class="add-on icon-group" title="{$translate.employee}"></span>
                                ...
                                {if $unmanned_day_slots|count gt 0}
                                    {foreach from=$unmanned_day_slots key=slot_index item=slot_det name=slot_data}
                                        {assign var=emp_index value=$emp_index+1}
                                        <div class="dayview_raw unmanned_row {if $emp_index gt 8}tooltip_upper{/if}" data-cust=''>
                                            <ul class="slots_all">
                                                {if $slot_det['slot_difference'] != 0}
                                                    <li style="width:{$slot_det['slot_difference']*4.16}%" class="raw1 opasity_zero">
                                                    </li>
                                                    ...
                                                    <div class="absolute_div {if $slot_det.status eq 2}slot-theme-leave{elseif $slot_det.status eq 4}slot-theme-candg{elseif $slot_det.status eq 0 or $slot_det.status eq 3}slot-theme-incomplete{elseif $slot_det.status eq 1 and $slot_det.created_status eq 1}slot-theme-candg-accept{elseif $slot_det.type eq 10}slot-theme-pm{else}slot-theme-complete{/if}">
                                                        <div class="slot-hover-popup span12">
                                                            ...
                                                            <div class="viewsecton {if $slot_det.signed eq 1}striped{/if}">
                                                                ...
                                                                <ul class="abs_conent">
                                                                    <li><h1>{$slot_det['slot_from']}-{$slot_det['slot_to']} ({$slot_det['slot_hour']})</h1></li>
                                                                    <li><span class="icon-group"></span> {*$slot_det['cust_name']*}<i>[{$translate.no_customer}]</i></li>
                                                                    <li><span class="icon-user"></span> {$slot_det['emp_name']}</li>
                                                                    {if $slot_det['comment'] neq ''}<li class="hover-popup-comment"><span class="icon-comment"></span>{$slot_det['comment']}</li>{/if}
                                                                </ul>
                                                                <span class='pull-left'>
                    ...
                    <div class="span12 slots-full-view-body1" style="overflow-y: auto; padding-right: 5px !important;">
                        <div id="goto-customers-list" class="row-fluid span12" style="padding-bottom: 8px !important; padding-right: 4px; margin-left: 0;">
                            {foreach $righclick_customers_for_goto AS $rcust}
                                <div style="margin-left: 0px;" class="span12">
                                    <div style="margin-top: 4px;" class="span12 child-slots">
                                        <label onclick="navigatePage('{$url_path}gdschema_day_customer.php?date={$selected_date}&year_week={$selected_week}&customer={$rcust.username}&action=1',1);">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        {if $privileges_gd.add_slot == 1}
            ...
            $(".slots_all li.opasity_zero").dblclick(function(e) {
                ...
                load_not_signed_employees_of_customer(this_obj, selected_date);
        ...
        $('#slot_details_main_wraper_group #sdDate, #slot_details_main_wraper_group #sdTFrom, #slot_details_main_wraper_group #sdTTo, \n\
            #slot_details_main_wraper_group #sdCustomer').keypress(function(e) { //, #slot_details_main_wraper_group #sdComment
                if(e.which == 13) {
    ...
    function sort_employee_slots(from_time){
        navigatePage('{$url_path}gdschema_day_employee.php?date={$selected_date}&year_week={$selected_week}&employee={$selected_employee}&action=1&filter_time_from='+$.trim(from_time),1);
    }

    function sort_by_timeline(arg){
        if(arg =='CUST' || arg =='EMP' || arg =='TIME'){
            navigatePage('{$url_path}gdschema_day_employee.php?date={$selected_date}&year_week={$selected_week}&employee={$selected_employee}&action=1&sort_by='+arg, 1);
        }
    }
    ...
    function reload_content(data_values){
        ...
        navigatePage('{$url_path}gdschema_day_employee.php?date={$selected_date}&year_week={$selected_week}&employee={$selected_employee}&action=1{if $filter_time_from neq ''}&filter_time_from={$filter_time_from}{/if}{if $sort_by neq ''}&sort_by={$sort_by}{/if}',1);
    }
    ...
    function load_not_signed_employees_of_customer(root_obj, selected_date){

        var slot_data       = root_obj.find('.editsection').find('input.new_slot_details_hub');
        var slot_customer_id= slot_data.attr('data-customer-id');

        var temp_previous_selected_emp = root_obj.find('.editsection').find('#custom_slot_employee').val();

        //load team customers of this employee
        root_obj.find(".editsection").find('#custom_slot_employee').html('<option value="">{$translate.select}</option>');
        $.ajax({
            url:"{$url_path}ajax_alloc_action_month.php",
            type:"POST",
            dataType: "json",
            data:{ 'customer'  : slot_customer_id, 'action' : 'get_team_not_signed_employees', 'date': selected_date },
            success:function(data){
                        root_obj.find(".editsection").find('#custom_slot_employee').html('<option value="">{$translate.select}</option>');
                        var default_page_employee_exists = false;
                        var previous_selected_employee_exists = false;
                        if(data && data.employees){
                            root_obj.find(".editsection").find('#custom_slot_employee').html('<option value="">{$translate.select}</option>');
                            $.each(data.employees, function(i, value) {
                                if(value.username == '{$selected_employee}') default_page_employee_exists = true;
                                if(temp_previous_selected_emp != '' && value.username == temp_previous_selected_emp) previous_selected_employee_exists = true;
                                root_obj.find(".editsection").find('#custom_slot_employee').append(
                                    $('<option>')
                                        .text(value.last_name+' '+value.first_name)
                                        .attr('value', value.username));
                            });

                            if(temp_previous_selected_emp == '' && default_page_employee_exists){
                                root_obj.find(".editsection").find('#custom_slot_employee').val('{$selected_employee}');
                            }
                            else if(temp_previous_selected_emp != '' && previous_selected_employee_exists){
                                root_obj.find(".editsection").find('#custom_slot_employee').val(temp_previous_selected_emp);
                            }
                        }
                    },
    ...
    {if $privileges_gd.add_slot == 1}
        ...
        function manEntryFromTimeLine(this_obj){
            ...
            var selected_customer = $.trim($saveFormParent.find('input.new_slot_details_hub').attr('data-customer-id'));
        ...
        function manEntryFromTimeLine_proceed(data_obj, this_obj){
            ...
            if(tmp_slot_from !== false && tmp_slot_to !== false){
                ...
                var tmp_slot_employee = $.trim($saveFormParent.find('#custom_slot_employee').val());
    ...
    function modify_slot_details(){
        ...
        if(slot_date == ''){
            ...
            proceed_flag = false;
            return false;
        } else if(old_customer_id != '' && slot_customer_id == ''){
    ...
    function modify_slot_details_confirm(){
        ...
        // console.log(slot_customer_id ,old_customer_id , slot_timefrom , old_time_from , slot_time_to , old_time_to);
    ...
    $(document).ready(function() {
        ...
        $(".monthPicker").datepicker({
            ...
            //if(ev.viewMode == 'months'){
                ...
                navigatePage('{$url_path}gdschema_day_employee.php?date='+this_date+'&year_week='+year_week+'&employee={$selected_employee}&action=1',1);
            //}
        });
    });
                            ...
                            case "go_to_customer":
                                ...
                                if(ids_temp.length == 1){
                                    ...
                                    if(slot_details_hub.length == 1){
                                        ...
                                        if(temp_cust_id != ''){
                                            navigatePage('{$url_path}gdschema_day_customer.php?date={$selected_date}&customer='+temp_cust_id+'&action=1',1);
                                        }
                                    }
                                }
                                if(temp_cust_id == ''){
...
<script type="text/javascript">
    ...
    function close_right_panel(){
        ...
        $("#slot-dela-pass, #Franvaro-box, #kopierapass-box").addClass('hide');
        $("#change-employee-customer-options, #replace-employee-week-basis, #goto-employees-options, #goto-customers-options,#change_time_of_slots").addClass('hide');
