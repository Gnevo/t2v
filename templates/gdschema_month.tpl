                                ...
                                {if $login_user_role neq 3}
                                    <div class="pull-right count-info-switch-phone" id="count-info-switch">
                                        <a href="javascript:void(0)" class="widget-stats widget-stats-1 span12 " style="height:auto;" onclick="showcontractdet()">
                                            ...
                                            {/if}
                                            {if '3'|in_array:$fkkn_ar}
                                            <div class="pull-left">
                                                 <span class="glyphicons shield"><i></i><span class="txt">{$translate.tu}</span></span>
                                                 <span class="count {if $customer_hours.work.tu gt $customer_hours.contract.tu}overflow_contract{else if $customer_hours.work.tu lt $customer_hours.contract.tu}underflow_contract{/if}">{$customer_hours.work.tu}h {if $customer_hours.contract.tu neq 0}<span style="color: green;">({$customer_hours.contract.tu}h)</span>{/if}
                                                     {if $customer_hours.work.tu - $customer_hours.contract.tu gt 0}<span style="color: red;">({number_format($customer_hours.work.tu - $customer_hours.contract.tu, 2)}h)</span>{/if}
                                                     {if $customer_hours.work.tu - $customer_hours.contract.tu lt 0}<span style="color: green;">({number_format($customer_hours.contract.tu - $customer_hours.work.tu, 2)}h)</span>{/if}     
                                                 </span>
                                            </div>
                                            {/if}
                                            {else}
                            ...
                            <table class="footable table table-striped table-bordered table-white table-primary" style="margin-bottom: 0px;">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-hide="phone">{$translate.salary_time}</th>
                                        <th data-hide="phone">{$translate.salary_total_time}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {foreach $employee_work_summery_array as $summery}
                                        <tr>
                                            ...
                                            <td>{($summery.normal + ($summery.oncall / 4))|round:2}</td>
                                            <td>{($summery.normal + $summery.oncall)|round:2}</td>
                                        </tr>
                                    {foreachelse}
                                        <tr><td colspan='7' style='text-align:center;'>{$translate.no_data}</td></tr>
                                    {/foreach}
                                </tbody>
                            </table>
                        </div>
                                        ...
                                        {else}
                                            <td class="monthly_day {if $week_day.date eq $today_date}selected_date{/if} clearfix" data-date='{$week_day.date}' >
                                                ...
                                                <div class="monthly_strips clearfix">
                                                    {assign var='table_count' value='0'}
                                                            ...
                                                            <span class="collapse-slot clearfix" id="slot_thread_{$slot.id}">
                                                                <div class="slot monthlyslotview span12 {if $slot.status eq 2}slot-theme-leave{elseif $slot.status eq 4}slot-theme-candg{elseif $slot.status eq 0 or $slot.status eq 3}slot-theme-incomplete{elseif $slot.status eq 1 and $slot.created_status eq 1}slot-theme-candg-accept{elseif $slot.type eq 10}slot-theme-pm{else}slot-theme-complete{/if} {if $slot.signed eq 1}signed_slot{/if}{if $swap_copied_slot eq $slot.id} objblink{/if} {if $login_user_role neq 3 or ($login_user_role eq 3 and $slot.employee eq $login_user)}monthlyslotview-draggable{/if}"  
                                                                    ...
                                                                    <div class="{if $slot.signed eq 1}striped{/if} span12 slot_bountery">
                                                                        ...
                                                                        {if (int)$slot.relation_id gte 1}
                                                                            {foreach $week_day.slots as $slotN}
                                                                                {if (int)$slot.relation_id eq $slotN.id}
                                                                                    <div class="slot-notification-wrpr" style="background-color: {$slotN.emp_color};margin-right: 2px;">
                                                                        ...
                                                                        <div class="notification-info-customer">{$slot.slot} ({$slot.slot_hour}){if trim($slot.emp_name) neq ''} <br/><span class='spn-slot-emp-name' title="{htmlspecialchars($slot.emp_name)}" style="margin-left: 0px;text-overflow: ellipsis; overflow: hidden;">{$slot.emp_name}</span>{else}<br/><label class="unmanned_slot">{$translate.gdschema_unmanned_slot}</label>{/if}</div>
                            ...
                            <div class="widget-body">
                                <div class="tab-content">
                                    ...
                                    <div id="tabLeaveTimePeriod" class="tab-pane widget-body-regular active clearfix" style="background:#fff;">
                                        ...
                                        {if $privileges_gd.no_pay_leave eq 1 && $login_user_role eq 1}
                            ...
                            new_content += '<span class="collapse-slot clearfix" id="slot_thread_'+$slot.id+'">\n\
                                                <div class="slot monthlyslotview monthlyslotview-draggable span12 '+special_slot_class_name+' '+($slot.signed == 1 ? 'signed_slot' : '')+' '+($swap_copied_slot == $slot.id ? 'objblink' : '')+'" \n\
                                                    ...
                                                    '+(isvisible == true ? '<div class="slot-notification-wrpr" style="background-color: '+empColor+';margin-right: 2px;">\n\
                                                        ...
                                                        <div class="notification-info-customer">'+$slot.slot+' ('+ $slot.slot_hour +')<br/>'+( $.trim($slot.emp_name) != '' && $slot.emp_name != null ? '<span title="'+$slot.emp_name+'" style="white-space: normal;">'+$slot.emp_name+'</span>' : '<label class="unmanned_slot">{$translate.gdschema_unmanned_slot}</label>')+'</div>\n\
                            ...
                            //slot dragging
                                ...
                                if(this_slot_date != target_date){
                                    //$(ui.draggable).parents('.collapse-slot').fadeOut('slow', function() {
                                        ...
                                        var url_atl = 'date='+target_date+'&employee='+selected_employee+'&customer={$selected_customer}'+
    ...
    <script>
                                            ...
                                            <table class="footable table table-striped table-bordered table-white table-primary" style="margin-bottom: 1px;">\n\
                                                <thead>\n\
                                                    ...
                                                    if(data.customer_hours.actual_hours.fk.normal != 0 || data.customer_hours.actual_hours.fk.oncall != 0){
                                                        html += '<th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;">{$translate.fk} '+data.customer_hours.actual_hours.fk.normal+'h '+(data.customer_hours.actual_hours.fk.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.fk.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
                                                    if(data.customer_hours.actual_hours.kn.normal != 0 || data.customer_hours.actual_hours.kn.oncall != 0){
                                                        html += '<th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;">{$translate.kn} '+data.customer_hours.actual_hours.kn.normal+'h '+(data.customer_hours.actual_hours.kn.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.kn.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
                                                    if(data.customer_hours.actual_hours.tu.normal != 0 || data.customer_hours.actual_hours.tu.oncall != 0){
                                                        html += '<th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;">{$translate.tu} '+data.customer_hours.actual_hours.tu.normal+'h '+(data.customer_hours.actual_hours.tu.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.tu.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
                        ...
                        if(data.customer_contract_period_hours.fk.length > 0 || data.customer_contract_period_hours.kn.length > 0 || data.customer_contract_period_hours.tu.length > 0 ){
                            ...
                            data.customer_contract_period_hours.fk.forEach(function(entry) {
                                html += '<tr>\n\
                                            ...
                                            <td  class="table-col-center"><input type="checkbox" value="1" name="values_of" id="tu_values" {if '1'|in_array:$fkkn_ar}checked{/if}></td>\n\
                                        </tr>';
                                });
                            ...
                            data.customer_contract_period_hours.kn.forEach(function(entry) {
                                html += '<tr>\n\
                                            ...
                                            <td  class="table-col-center">'+(entry.unmanned_hour != null ? (Math.round(entry.unmanned_hour*100)/100)+'h' : '')+'</td>\n\
                                            <td  class="table-col-center"><input type="checkbox" value="2" name="values_of" id="tu_values" {if '2'|in_array:$fkkn_ar}checked{/if}></td>\n\
                                        </tr>';
                            });
                            ...
                            data.customer_contract_period_hours.tu.forEach(function(entry) {
                                html += '<tr>\n\
                                            ...
                                            <td  class="table-col-center">'+(entry.unmanned_hour != null ? (Math.round(entry.unmanned_hour*100)/100)+'h' : '')+'</td>\n\
                                            <td  class="table-col-center"><input type="checkbox" value="3" name="values_of" id="tu_values" {if '3'|in_array:$fkkn_ar}checked{/if}></td>\n\
                                        </tr>';
                            });    
        ...
        function selected_values(){
            ...
            $.ajax({
                async:true,
                cache: true,
                url:'{$url_path}month/gdschema/{$selected_year}/{$selected_month}/{$selected_customer}/'+text+'/',
            ...
            //navigatePage('{$url_path}month/gdschema/{$selected_year}/{$selected_month}/{$selected_customer}/'+text+'/',1);
        }
