{block name='style'}
    ...
    <style type="text/css">
        ...
        .modal .modal-header { padding: 9px 15px; border-bottom: 1px solid #eeeeee; height: auto; background: none;}
        .modal .modal-header .close { background: none !important;}
        .modal-body form { margin-bottom: 0px;}
        .modal .modal-header h4 { color: #4d4d4d;}
        .cursor_hand{ cursor: pointer; }
        .font-bold{ font-weight:bold; }
        .col_numeric{ text-align: right; }
        .col_left_align{ text-align: left; }
...
{*        main-left*}
        <div class="span12 main-left">
            ...
            <div class="row-fluid theme-add-wrpr">
                <div class="span12 template-customize-wrpr mb">
                        ...
                        <div style="" class="panel-heading">
                            <h4  class="panel-title panel-title-employee clearfix">
                                ...
                                <ul class="pull-right no-print">
                                    ...
                                    <li onclick="navigatePage('{$url_path}month/gdschema/employee/{$selected_year}/{$selected_month}/{$selected_employee}/',1);"><i class="{*icon-arrow-left*}icon-power-off"></i><a href="javascript:void(0);"><span>{*$translate.back*}{$translate.hide_template}</span></a></li>
...
{*                                    <li onclick="conformScheduleSave()"><i class=" icon-save "></i></span><a href="javascript:void(0);"><span>{$translate.apply_template}</span></a></li>*}
                ...
                <div class="span12 option-panel-wrpr" style="margin-left: 0px;">
                    <div style="margin-top: 0px; margin-bottom: 8px !important;" class="widget">
                        <div class="widget-body" style="padding: 7px 13px;">
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="span4">
                                        <label style="float: left;" class="span12 template_label">{$translate.employee}: </label>
                                        <b>{$employee_details.last_name|cat:' '|cat:$employee_details.first_name}</b>
                                    </div>
                                    <div class="span8">
                                        ...
                                        <div class="pull-left" style="margin-right: 10px;">
                                            ...
                                            <button type="button" class="btn btn-success" onclick="conformScheduleSave()" style="margin-top: -6px;"><span class="icon-save"></span> {$translate.apply_template}</button>
                                        </div>*}
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="span4 mt">
                                        <div class="widget-stats widget-stats-1 span12" style="height:auto;border: 1px solid #A0611C;">
                                            <div class="span6 pt text-left">
                                                <strong>{$translate.actual_slot_working_hours}</strong>
                                            </div>
                                            <div class="span6">
                                                <div class="span6">
                                    ...
                                    <div class="span4 mt">
                                        <div class="widget-stats widget-stats-1 span12" style="height:auto;border: 1px solid #A0611C;">
                                            <div class="span6 pt text-left">
                                                <strong>{$translate.template_hours}</strong>
                                            </div>
                                            <div class="span6">
                                                <div class="span6">
                                                    <span class="glyphicons shield"><i></i><span class="txt">{$translate.normal_report_short}</span></span>
                                                    <span class="count">{$normal_template_total_slot_hours}h</span>
                                                </div>
                                                <div class="span6">
                                                    <span class="glyphicons shield"><i></i><span class="txt">{$translate.oncall_report_short}</span></span>
                                                    <span class="count">{$oncall_template_total_slot_hours}h</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span4 mt">
                                        <div class="widget-stats widget-stats-1 span12" style="height:auto;border: 1px solid #A0611C;">
                                            <div class="span6 pt text-left">
                                                <strong>{$translate.hour_difference}</strong>
                                            </div>
                                            <div class="span6">
                                                <div class="span6">
                                                    <span class="glyphicons shield"><i></i><span class="txt">{$translate.normal_report_short}</span></span>
                                                    <span class="count">{$normal_difference_og_and_tmpl}h</span>
                                                </div>
                                                <div class="span6">
                                                    <span class="glyphicons shield"><i></i><span class="txt">{$translate.oncall_report_short}</span></span>
                                                    <span class="count">{$oncall_difference_og_and_tmpl}h</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <table style="margin:0;" class="table table-bordered table-white table-responsive table-primary table-Anställda slot-calender slot-calender-employee">
                        ...
                        <thead>
                            <tr>
                                <th class="no-print table-col-center" style="border: 0 none;"><span class="btn btn-block btn-default span12"><i class="icon-calendar monthPicker" data-date="{$selected_year|cat:'-'|cat:$selected_month}" data-date-format="yyyy-mm" ></i></span></th>
                                <th class="no-print table-col-center" style="width:30px; border: 0 none;"></th>
                                ...
                                <th class="no-print table-col-center" colspan="2" style="border: 0 none;"></th>
                            </tr>
                        </thead>
                        <thead>
                            <tr class="no-print">
                                <th class="table-col-center"><span class="btn btn-block btn-default span12" onclick="navigatePage('{$url_path}schedule/employee/month/gdschema/{$selected_year-1}/{$selected_month}/{$selected_employee}/',1);"  title="{$translate.tltp_goto_previous_year}"><<</span></th>
                                <th class="table-col-center"><span class="btn btn-block btn-default span12" onclick="navigatePage('{$url_path}schedule/employee/month/gdschema/{$prv_year}/{$prv_month}/{$selected_employee}/',1);" title="{$translate.tltp_goto_previous_month}"><</span></th>
                                <th class="table-col-center" colspan="4"><span class="btn btn-block btn-default span12 calender-today" onclick="navigatePage('{$url_path}schedule/employee/month/gdschema/{$today_year}/{$today_month}/{$selected_employee}/',1);" title="{$translate.tltp_goto_todays_month}"><i></i>{$translate.today}</span></th>
                                <th class="table-col-center"><span class="btn btn-block btn-default span12" onclick="navigatePage('{$url_path}schedule/employee/month/gdschema/{$next_year}/{$next_month}/{$selected_employee}/',1);" title="{$translate.tltp_goto_next_month}">></span></th>
                                <th class="table-col-center"><span class="btn btn-block btn-default span12" onclick="navigatePage('{$url_path}schedule/employee/month/gdschema/{$selected_year+1}/{$selected_month}/{$selected_employee}/',1);" title="{$translate.tltp_goto_next_year}">>></span></th>
                            </tr>
                        </thead>
                    </table>
                        ...
                        <tbody>
                            {foreach $month_weeks as $month_week}
                                <tr class="gradeX expandable week_row "  style="height: 150px;">
                                    <td class="week_no_td" data-yearweek='{$selected_year}|{$month_week.week.week}' style="background:#f6fccf !important;">
                                        <ul class="calender-col-header span12" id="toggle-view" style="border-bottom: none; background: none;">
                                            <li class="no-print" title="{$translate.tltp_mini_maxi_week}"><input class="btn-mini btn-default btn-collapse-table-row btn-mini-employee" type="button" value="-" /></li>
                                                ...
                                                <div class="monthly_strips clearfix">
                                                    {foreach $week_day.slots as $slot}
                                                        <span class="collapse-slot clearfix">
                                                            <div class="slot monthlyslotview span12 {if $slot.is_from_schedule and $slot.is_from_schedule}special_template_slots{else if $slot.status eq 2}slot-theme-leave{elseif $slot.status eq 4}slot-theme-candg{elseif $slot.status eq 0 or $slot.status eq 3}slot-theme-incomplete{elseif $slot.status eq 1 and $slot.created_status eq 1}slot-theme-candg-accept{elseif $slot.type eq 10}slot-theme-pm{else}slot-theme-complete{/if}"  
                                                                 onmouseover="tooltip.pop(this, '#slot_details_{$slot.id}', { position:1, offsetX:-20, effect:'slade'{*, overlay:true*} });" data-slot-id="{$slot.id}" >
                                                                <div class="{if $slot.signed eq 1}striped{/if}{*if !isset($slot.is_from_schedule) or !$slot.is_from_schedule}striped{/if*} span12 slot_bountery">
                                                                    {if !isset($slot.is_from_schedule) or !$slot.is_from_schedule}
                ...
                {foreach $month_week.days as $week_day}
                    {foreach $week_day.slots as $slot}
                        <div style="display:none;" data-id="{$slot.id}">
                            <div id="slot_details_{$slot.id}" class="clearfix slot-hover-popup span4 {if $slot.is_from_schedule and $slot.is_from_schedule}special_template_slots{else if $slot.status eq 2}slot-theme-leave{elseif $slot.status eq 4}slot-theme-candg{elseif $slot.status eq 0 or $slot.status eq 3}slot-theme-incomplete{elseif $slot.status eq 1 and $slot.created_status eq 1}slot-theme-candg-accept{elseif $slot.type eq 10}slot-theme-pm{else}slot-theme-complete{/if}">
                                <div class="clearfix {if $slot.signed eq 1}striped{/if}{*if !isset($slot.is_from_schedule) or !$slot.is_from_schedule}striped{/if*}" style="padding: 15px;">
                                    <ul class="clearfix">
...
{block name='script'}
    ...
    <script src="{$url_path}js/bootbox.js?v={filemtime('js/bootbox.js')}"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $(".datepicker").datepicker({
                ...
                calendarWeeks: true, 
                language: '{$lang}',
                startDate: "{$this_month_start_date}",
                endDate: "{$this_month_end_date}"
            });
            ...
            $(".monthPicker").datepicker({
                ...
                navigatePage('{$url_path}schedule/employee/month/gdschema/'+year+'/'+month+'/{$selected_employee}/',1);
            });
        });
        ...
        function conformScheduleSave(){
            ...
            if(PreviewStartDate != ''){
                var main_obj = { 'employee': '{$selected_employee}', 'month': '{$selected_month}', 'year': '{$selected_year}', 'PreviewStartDate': PreviewStartDate };

                wrapLoader('#external_wrapper');
                $.ajax({
                    url:"{$url_path}ajax_apply_monthly_employee_schedule.php",
                    type:"POST",
                    dataType: 'json',
                    data: main_obj,
        ...
        {if $privileges_general.create_template eq 1}
            function delete_template(){
                if(confirm('{$translate.confirm_delete_template}')){
                    var main_obj = { 'employee': '{$selected_employee}', 'month': '{$selected_month}', 'year': '{$selected_year}', 'action': 'delete' };
