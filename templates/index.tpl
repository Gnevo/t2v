...
<div class="wrapper">
    <div class="widget widget-heading-simple widget-body-gray">
        ...
        <div class="widget-body">
            <form id="form" name="form" method="post" action="{$url_path}{*auth.php*}{if isset($redirect) && $redirect neq ''}?redirect={$redirect}{/if}">
                <label for="username">{$translate.username_login}</label>
...
{*                <input name="password" id="password" type="password" tabindex="2" class="input-block-level margin-none required medium"/>*}
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <button name="login" id="loginbtn" class="btn btn-inverse logn_btn pull-right ml" value="{$translate.login_continue}" type="submit" >{$translate.login_continue}</button>
