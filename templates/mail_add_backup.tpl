...
<script type="text/javascript" src="{$url_path}js/jquery.ui.datepicker.js"></script>
    ...
    function attachAnother() {             
       ...
       $("#attach").height(heights+26);
       $('#file_count').val(file_count);
       $('#attach').append('<input style="margin-left:86px;width:360px;" type="file" name="file_'+file_count+'" id="file_'+file_count+'" class="time_fld_dt_pick"  style="width: 360px" />');
    }
        ...
        <div class="incnvnt_dv">
            ...
            <div class="incnvnt_dv_dtl">
                ...
                <div class="mail_dtl_dvs"> 
                    ...
                    <input name="subject" id="subject" type="text" class="time_fld_dt_pick"  style="width: 360px" {if isset($mails) && $method == 2} value="{$mails.subject}" {/if}{if isset($mails) && $method == 1} value="RE: {$mails.subject}"{/if}/>
                </div>  
                ...
                <div class="mail_dtl_dvs"> 
                    ...
                    {foreach $attachments as $attachment}
                        <div class="time_fld_dt_pick"><input type="checkbox" name="check_{$i}" onclick="file_names('{$attachment}')"/><a href="{$url_path}download.php?{$folder}{$attachment}">{$attachment}</a></div>
                        {assign i $i+1}
                    {/foreach} 
                </div>
                <div class="mail_dtl_dvs"> 
                    <div class="incnvnt_lft_nme" >{$translate.attach_a_file}:</div>
                    <input type="file" name="file_0" id="file_0" class="time_fld_dt_pick"  style="width: 360px" /> 
                    <a style="color: slateblue" href="javascript:void(0);" onclick="attachAnother()">more attachments</a>
                    <a style="color: slateblue" href="javascript:void(0);" onclick="removeFile()">removeFile</a>
