<?php /* Smarty version Smarty-3.1.8, created on 2021-03-16 12:05:14
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/message_center_leave.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7804630086034e898f15f36-81490069%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '044e6c774930b7b598bc5952d4fcd39dcee9e388' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/message_center_leave.tpl',
      1 => 1615896309,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7804630086034e898f15f36-81490069',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_6034e8993bbcc2_92484652',
  'variables' => 
  array (
    'app_name' => 0,
    'url_path' => 0,
...
<?php if ($_valid && !is_callable('content_6034e8993bbcc2_92484652')) {function content_6034e8993bbcc2_92484652($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
...
" class="gradeX <?php echo smarty_function_cycle(array('values'=>"even,odd"),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['entry']->value['status']=='1'){?>col-highlight-primary<?php }?>" <?php if ($_smarty_tpl->tpl_vars['flag']->value==1){?>style="font-weight: bold"<?php }?>>
                                    ...
                                    <td><?php if ($_smarty_tpl->tpl_vars['entry']->value['type']==1){?><?php echo $_smarty_tpl->tpl_vars['leave_type']->value[1];?>
                                        ...
                                        <?php }elseif($_smarty_tpl->tpl_vars['entry']->value['type']==9){?><?php echo $_smarty_tpl->tpl_vars['leave_type']->value[9];?>

                                        <?php }elseif($_smarty_tpl->tpl_vars['entry']->value['type']==10){?><?php echo $_smarty_tpl->tpl_vars['leave_type']->value[10];?>

                                        <?php }elseif($_smarty_tpl->tpl_vars['entry']->value['type']==11){?><?php echo $_smarty_tpl->tpl_vars['leave_type']->value[11];?>
<?php }?></td>
