<?php /* Smarty version Smarty-3.1.8, created on 2021-03-01 05:38:27
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/horizontal_customer_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:898307503603c7dd333f8a8-87974611%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0fe19f08f58363017cb61b6d6dffb9f200efe921' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/horizontal_customer_report.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '898307503603c7dd333f8a8-87974611',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603c7dd35d2732_61681615',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603c7dd35d2732_61681615')) {function content_603c7dd35d2732_61681615($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['horizontal_customer_report'];?>
</span>
    <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
    ...
    <?php }else{ ?>
       ...
       <div class="option_strip span12">
       		<div style="color:red; display:none;" align="center" id="errormsg" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['todate_greaterthan_fromdate_error'];?>
                ...
                <div class="span3">    
                <?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_name'];?>
...
" />
 ...
 : <select id="cmb_year" name="year" style="width:80px;">
        ...
        <option value="0" <?php if (smarty_modifier_date_format(time(),"%m")==''){?> selected = "selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value['select'];?>
</option>
        <option value="1" <?php if (smarty_modifier_date_format(time(),"%m")==1){?> selected = "selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value['jan'];?>
</option>
        <option value="2" <?php if (smarty_modifier_date_format(time(),"%m")==2){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['feb'];?>
</option>
        <option value="3" <?php if (smarty_modifier_date_format(time(),"%m")==3){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['mar'];?>
</option>
        <option value="4" <?php if (smarty_modifier_date_format(time(),"%m")==4){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['apr'];?>
</option>
        <option value="5" <?php if (smarty_modifier_date_format(time(),"%m")==5){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['may'];?>
</option>
        <option value="6" <?php if (smarty_modifier_date_format(time(),"%m")==6){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['jun'];?>
</option>
        <option value="7" <?php if (smarty_modifier_date_format(time(),"%m")==7){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['jul'];?>
</option>
        <option value="8" <?php if (smarty_modifier_date_format(time(),"%m")==8){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['aug'];?>
</option>
        <option value="9" <?php if (smarty_modifier_date_format(time(),"%m")==9){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['sep'];?>
</option>
        ...
        <?php }else{ ?>
        <option value="0" <?php if ($_smarty_tpl->tpl_vars['month']->value==''){?> selected = "selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value['select'];?>
</option>
        <option value="1" <?php if ($_smarty_tpl->tpl_vars['month']->value==1){?> selected = "selected" <?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value['jan'];?>
</option>
        <option value="2" <?php if ($_smarty_tpl->tpl_vars['month']->value==2){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['feb'];?>
</option>
        <option value="3" <?php if ($_smarty_tpl->tpl_vars['month']->value==3){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['mar'];?>
</option>
        <option value="4" <?php if ($_smarty_tpl->tpl_vars['month']->value==4){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['apr'];?>
</option>
        <option value="5" <?php if ($_smarty_tpl->tpl_vars['month']->value==5){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['may'];?>
</option>
        <option value="6" <?php if ($_smarty_tpl->tpl_vars['month']->value==6){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['jun'];?>
</option>
        <option value="7" <?php if ($_smarty_tpl->tpl_vars['month']->value==7){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['jul'];?>
</option>
        <option value="8" <?php if ($_smarty_tpl->tpl_vars['month']->value==8){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['aug'];?>
</option>
        <option value="9" <?php if ($_smarty_tpl->tpl_vars['month']->value==9){?> selected = "selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['sep'];?>
</option>
        ...
        <div class="span2">    
        <?php echo $_smarty_tpl->tpl_vars['translate']->value['week'];?>
...
<script src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/rhorizontalcustrpt.js" type="text/javascript" ></script>
<script>
    $(document).ready(function() {
...
images/date_pic.gif",
	...
	getweek(<?php echo smarty_modifier_date_format(time(),"%m");?>
);
