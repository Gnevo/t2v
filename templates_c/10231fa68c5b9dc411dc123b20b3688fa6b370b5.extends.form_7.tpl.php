<?php /* Smarty version Smarty-3.1.8, created on 2020-12-07 14:09:07
         compiled from "/home/time2view/public_html/cirrus/templates/forms/form_7.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17564030325fce3783829226-13606933%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '10231fa68c5b9dc411dc123b20b3688fa6b370b5' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/forms/form_7.tpl',
      1 => 1539176060,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17564030325fce3783829226-13606933',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fce3783b67434_89604204',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fce3783b67434_89604204')) {function content_5fce3783b67434_89604204($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
                ...
                <div class="panel panel-default span12 no-ml" style="margin: 5px 0px 0px ! important;">
                    <div class="panel-heading" style="">
                        <h4 class="panel-title no-mb clearfix" style="border-radius: 0px;">
                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['form_7'];?>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                        	<td><?php if ($_smarty_tpl->tpl_vars['review_data']->value['created_by']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['created_name'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['created_user_name']->value;?>
<?php }?></td>
                                        	<td><?php if ($_smarty_tpl->tpl_vars['review_data']->value['modified_by']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['modified_name'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['created_user_name']->value;?>
<?php }?></td>
                                        	<td><?php if ($_smarty_tpl->tpl_vars['review_data']->value['created_date']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['created_date'];?>
<?php }else{ ?><?php echo smarty_modifier_date_format(time(),"%Y-%m-%d");?>
<?php }?></td>
                                        	<td><input type="text" name="utgava" value="<?php if ($_smarty_tpl->tpl_vars['review_date']->value['utgava']){?><?php echo $_smarty_tpl->tpl_vars['review_date']->value['utgava'];?>
<?php }else{ ?>1<?php }?>" /></td>
                                            <td>
                                                <input type="checkbox" name="r" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['r']){?>checked="true"<?php }?> />
                                            </td>
                                            <td>
                                                <input type="checkbox" name="s" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['s']){?>checked="true"<?php }?> />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($_smarty_tpl->tpl_vars['review_data']->value['customer']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['customer_name'];?>
...
<?php }?><?php }?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if ($_smarty_tpl->tpl_vars['review_data']->value['customer']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['customer_century'];?>
 <?php echo substr_replace($_smarty_tpl->tpl_vars['review_data']->value['customer_social_security'],"-",6,0);?>
<?php }elseif($_smarty_tpl->tpl_vars['customerid']->value){?><?php echo $_smarty_tpl->tpl_vars['customers']->value[$_smarty_tpl->tpl_vars['customerid']->value]['century'];?>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                    	...
                                    	<?php $_smarty_tpl->tpl_vars["other"] = new Smarty_variable(0, null, 0);?>
...
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['field']->value['name'];?>
                                        		...
                                        		<?php if ($_smarty_tpl->tpl_vars['field']->value['other']){?>
                                        			<?php $_smarty_tpl->tpl_vars["other"] = new Smarty_variable($_smarty_tpl->tpl_vars['other']->value+1, null, 0);?>
                                        				<?php if ($_smarty_tpl->tpl_vars['other']->value==1){?>
			                                    			<td style="text-align: center;">
			                                        			<input type="radio" class="center" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]==''){?>checked="true"<?php }?> />
			                                        		</td>
			                                        		<td style="text-align: center;">
			                                        			<input type="radio" class="center" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="0" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]!=''){?>checked="true"<?php }?> />
			                                        		</td>
		                                        		<?php }else{ ?>
		                                        			<td style="text-align: center;">
			                                        			<input type="radio" class="center" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
...
" value="0" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]==''){?>checked="true"<?php }?> />
		                                			...
		                                			<tr>
		                                				...
		                                				<td colspan="2">
		                                					<input type="text" class="span12" name="field_<?php echo $_smarty_tpl->tpl_vars['field_id']->value;?>
_other" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']];?>
" />
		                                				</td>
		                            				</tr>
                                				<?php }else{ ?>
	                                					<td style="text-align: center;">
	                                        			<input type="radio" class="center" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]==1){?>checked="true"<?php }?> />
		                                        		</td>
		                                        		<td style="text-align: center;">
		                                        			<input type="radio" class="center" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="0" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]===0){?>checked="true"<?php }?> />
		                                        		</td>
	                                        		</tr>
                                        		<?php }?>
                                        <?php } ?>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            ...
                                            <td><input type="text" class="span12 datepicker" name="datum_for_delgivning" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['datum_for_delgivning'];?>
" /></td>
                                        </tr>
                                        <tr>
                                            <td width="40%">Månad och år för nästa delgivning :</td>
                                            <td><input type="text" class="span12 datepicker" name="manad_och_ar_for_nasta_delgivning" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['manad_och_ar_for_nasta_delgivning'];?>
" /></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                        	<td>
                                        		<input type="text" name="narvarande_person_1" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_1'];?>
" />
                                        	</td>
                                        	<td>
                                        		<input type="text" name="narvarande_person_roll_1" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_roll_1'];?>
" />
                                        	</td>
                                        </tr>
                                        <tr>
                                        	<td>
                                        		<input type="text" name="narvarande_person_2" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_2'];?>
" />
                                        	</td>
                                        	<td>
                                        		<input type="text" name="narvarande_person_roll_2" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_roll_2'];?>
" />
                                        	</td>
                                        </tr>
                                        <tr>
                                        	<td>
                                        		<input type="text" name="narvarande_person_3" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_3'];?>
" />
                                        	</td>
                                        	<td>
                                        		<input type="text" name="narvarande_person_roll_3" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['narvarande_person_roll_3'];?>
" />
                                        	</td>
                                        </tr>
                                    </table>
...
form_7.php?customer=' + customer_id;
            }
        });
...
function selectReview(){
    ...
    document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_7.php?review=' + reviewid +'&customer=' + customer;
}
...
function addNew() {
    ...
    if(customerid != "" && customerid != 0){
        document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_7.php?customer=' + customerid;
    }
}
</script>
