<?php /* Smarty version Smarty-3.1.8, created on 2020-12-11 23:07:36
         compiled from "/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15323880735fd3fbb84d7bc0-67389343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '23788d51baab1200c23977e8775c0be3dde2fad2' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl',
      1 => 1588177878,
      2 => 'file',
    ),
    '8c0ebc7c05fc5789b2476172dd5568cf8d79f6cc' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/employee_notification.tpl',
      1 => 1569903782,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15323880735fd3fbb84d7bc0-67389343',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd3fbb8871944_09432285',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd3fbb8871944_09432285')) {function content_5fd3fbb8871944_09432285($_smarty_tpl) {?><!DOCTYPE html>
...
employee/non-prefered/timing/%%C-UNAME%%/1/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_non_preferred_time'];?>
                                ...
                                <div class="widget-header widget-header-options tab-option">
                                    <div class="span4 day-slot-wrpr-header-left span3">
                                        <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['notification'];?>
</h1>
                                    </div>
...
employee/notification/<?php echo $_smarty_tpl->tpl_vars['employee_username']->value;?>
/" style="float:left;" >
                                        <input type="hidden" name="username" id="username" value="<?php echo $_smarty_tpl->tpl_vars['employee_username']->value;?>
" />
                                                        ...
                                                        <div id="mCSB_7_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                                            <table class="footable table table-striped table-bordered table-white table-primary" style="margin:0;">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="thead-light table-col-center">
                                                                            <input style="margin: 3px 5px 0px ! important;" type="checkbox" name="mails"id="mails" onclick="nofifyLeave()" value="1" <?php if ($_smarty_tpl->tpl_vars['total']->value==2){?>checked="checked"<?php }?> /><br/>
                                                                            <?php echo $_smarty_tpl->tpl_vars['employee_detail']->value[0]['email'];?>

                                                                        </th>

                                                                        <th class="thead-light table-col-center" style="width: 140px;">
                                                                            <input style="margin: 3px 5px 0px ! important;" type="checkbox" name="phone" id="phone" onclick="nofifyLeave()" value="1" <?php if ($_smarty_tpl->tpl_vars['notification']->value['sjuk_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/><br/>
                                                                            <?php echo $_smarty_tpl->tpl_vars['employee_detail']->value[0]['mobile'];?>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['sickness'];?>

                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="sjuk_mail" id="sjuk_mail"  value="1" <?php if ($_smarty_tpl->tpl_vars['notification']->value['sjuk_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/>
                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="sjuk_mob" id="sjuk_mob"  value="1" <?php if ($_smarty_tpl->tpl_vars['notification']->value['sjuk_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['sem'];?>

                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="sem_mail" id="sem_mail" value="2" <?php if ($_smarty_tpl->tpl_vars['notification']->value['sem_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/>
                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="sem_mob" id="sem_mob" value="2" <?php if ($_smarty_tpl->tpl_vars['notification']->value['sem_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['vab'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="vab_mail" id="vab_mail" value="3" <?php if ($_smarty_tpl->tpl_vars['notification']->value['vab_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="vab_mob" id="vab_mob" value="3" <?php if ($_smarty_tpl->tpl_vars['notification']->value['vab_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['fp'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="fp_mail" id="fp_mail" value="4" <?php if ($_smarty_tpl->tpl_vars['notification']->value['fp_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="fp_mob" id="fp_mob" value="4" <?php if ($_smarty_tpl->tpl_vars['notification']->value['fp_mob']==1){?>checked="checked"<?php }?>/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['p_mote'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="pmote_mail" id="pmote_mail" value="5" <?php if ($_smarty_tpl->tpl_vars['notification']->value['pmote_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="pmote_mob" id="pmote_mob" value="5" <?php if ($_smarty_tpl->tpl_vars['notification']->value['pmote_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['education'];?>

                                                                        </td>
                                                                         <td class="center"><input type="checkbox" name="utbild_mail" id="utbild_mail" value="6" <?php if ($_smarty_tpl->tpl_vars['notification']->value['utbild_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                          <td class="center"><input type="checkbox" name="utbild_mob" id="utbild_mob" value="6" <?php if ($_smarty_tpl->tpl_vars['notification']->value['utbild_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['other'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="ovright_mail" id="ovright_mail" value="7" <?php if ($_smarty_tpl->tpl_vars['notification']->value['ovrigt_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="ovright_mob" id="ovright_mob" value="7" <?php if ($_smarty_tpl->tpl_vars['notification']->value['ovrigt_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['leave_permission'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="leave_permission_mail" id="leave_permission_mail" value="12" <?php if ($_smarty_tpl->tpl_vars['notification']->value['leave_permission_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="leave_permission_mob" id="leave_permission_mob" value="12" <?php if ($_smarty_tpl->tpl_vars['notification']->value['leave_permission_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['bandwidth'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="byte_mail" id="byte_mail" value="8" <?php if ($_smarty_tpl->tpl_vars['notification']->value['byte_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="byte_mob" id="byte_mob" value="8" <?php if ($_smarty_tpl->tpl_vars['notification']->value['byte_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['atl_fail'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="atl_mail" id="atl_mail" value="9" <?php if ($_smarty_tpl->tpl_vars['notification']->value['atl_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="atl_mob" id="atl_mob" value="9" <?php if ($_smarty_tpl->tpl_vars['notification']->value['atl_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_hour_overflow'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="emp_overtime_mail" id="emp_overtime_mail" value="10" <?php if ($_smarty_tpl->tpl_vars['notification']->value['emp_overtime_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="emp_overtime_mob" id="emp_overtime_mob" value="10" <?php if ($_smarty_tpl->tpl_vars['notification']->value['emp_overtime_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_hour_overflow'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="cust_overtime_mail" id="cust_overtime_mail" value="11" <?php if ($_smarty_tpl->tpl_vars['notification']->value['cust_overtime_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td class="center"><input type="checkbox" name="cust_overtime_mob" id="cust_overtime_mob" value="11" <?php if ($_smarty_tpl->tpl_vars['notification']->value['cust_overtime_mob']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                        ...
                                                                        <td class="center"><input type="checkbox" name="employee_profile_mail" id="employee_profile_mail" value="25" <?php if ($_smarty_tpl->tpl_vars['notification']->value['employee_profile_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td></td>

                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_profile'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="customer_profile_mail" id="customer_profile_mail" value="26" <?php if ($_smarty_tpl->tpl_vars['notification']->value['customer_profile_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="center"><input type="checkbox" name="employee_non_preferred_time_mail" id="employee_non_preferred_time_mail" value="27" <?php if ($_smarty_tpl->tpl_vars['notification']->value['employee_non_preferred_time_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_contract_mail'];?>

                                                                        </td>
                                                                        <td class="center"><input type="checkbox" name="employee_contract_mail" id="employee_contract_mail" value="28" <?php if ($_smarty_tpl->tpl_vars['notification']->value['employee_contract_mail']==1){?>checked="checked"<?php }?> onclick="makeChange()"/></td>
                                                                        <td></td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
