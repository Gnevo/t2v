<?php /* Smarty version Smarty-3.1.8, created on 2020-12-06 14:03:10
         compiled from "/home/time2view/public_html/cirrus/templates/customer_overlapped_slot_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10129197205fcce49e12a7e0-51976763%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25c45c8395ce01d9322484f4b0b8e15fd8bfbce8' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/customer_overlapped_slot_report.tpl',
      1 => 1515587236,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10129197205fcce49e12a7e0-51976763',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcce49e45a311_61615056',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcce49e45a311_61615056')) {function content_5fcce49e45a311_61615056($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
...
css/gdschema.css?v=<?php echo filemtime('css/gdschema.css');?>
" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/datepicker_btstrap.css?v=<?php echo filemtime('css/datepicker_btstrap.css');?>
" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/contextMenu.css?v=<?php echo filemtime('css/contextMenu.css');?>
" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/contract_tooltip_info.css?v=<?php echo filemtime('css/contract_tooltip_info.css');?>
" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/jquery.jscrollpane.css?v=<?php echo filemtime('css/jquery.jscrollpane.css');?>
" media="all" />
    <link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/jquery.jscrollpane.lozenge.css?v=<?php echo filemtime('css/jquery.jscrollpane.lozenge.css');?>
" media="all" />
<!--[if IE]>
...
<style type="text/css">
    ...
    #slot_add_group .time_slots_theme .close {
        background-image: url("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/close_icons_small.png");
...
<div class="tbl_hd">
    <span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['monthly_overlap_report'];?>
</span>
...
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['month']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['month']->value['id']==$_smarty_tpl->tpl_vars['selected_month']->value){?>selected="selected"<?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['month']->value['label']];?>
</option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div id="fkkn_types" style="float:left; margin-top: 4px;" class="mr">
                <div class="clearfix mr pull-left">
                    <label><input type="checkbox" name="fk_check" id="fk_check" <?php if (in_array(1,$_smarty_tpl->tpl_vars['filter_insurance']->value)){?>checked="checked"<?php }?> value="1" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['fk'];?>
" class="leave_type"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['fk'];?>
</label>
                </div>
                <div class="clearfix mr pull-left">
                    <label><input type="checkbox" name="kn_check" id="kn_check" <?php if (in_array(2,$_smarty_tpl->tpl_vars['filter_insurance']->value)){?>checked="checked"<?php }?> value="1" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['kn'];?>
" class="leave_type"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['kn'];?>
</label>
                </div>
                <div class="clearfix mr pull-left">
                    <label><input type="checkbox" name="tu_check" id="tu_check" <?php if (in_array(3,$_smarty_tpl->tpl_vars['filter_insurance']->value)){?>checked="checked"<?php }?> value="1" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['tu'];?>
" class="leave_type"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['tu'];?>
</label>
                </div>
                <input type="hidden" id="selected_insurances_merged" value="<?php echo implode(',',$_smarty_tpl->tpl_vars['filter_insurance']->value);?>
" />
            </div>

            <div style="float:left; margin-top: 6px;" class="span1">
                <input type="submit" name="get_data" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
" id="get_data" />
            </div>
             <div style="float:right; margin-top: 6px;" class="span4">
                 <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['total_colliding_hours_month'];?>
<?php echo $_smarty_tpl->tpl_vars['tot_colliding_hours']->value;?>
...
<div style="cursor: default;" class="monthlyslot slot_calendar span12">
    ...
    <div class="monthyear_block span12">
        ...
        <div class="middle_section span8"><span data-year-month="2014|9" class="cur_month_header"><?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['month_label']->value];?>
    ...
    <table width="100%">
        <tbody><tr class="headrow">
                <td colspan="1" class="button nav cursor_hand">
                    <div style="text-align:center;" unselectable="on"><span title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['prev_year'];?>
" class="Calender_header_btns" onclick="move_prev_year()">«</span></div>
                </td>
                <td colspan="1" class="button nav cursor_hand">
                    <div unselectable="on"><span title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['prev_month'];?>
" class="Calender_header_btns" onclick="move_prev_month()">‹</span></div>
                </td>
                ...
                <td style="text-align:right;" colspan="1" class="button nav cursor_hand">
                    <div unselectable="on"><span title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['next_month'];?>
" class="Calender_header_btns" onclick="move_next_month()">›</span></div>
                </td>
                <td  style="text-align:center;" colspan="1" class="button nav cursor_hand">
                    <div unselectable="on"><span title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['next_year'];?>
" class="Calender_header_btns" onclick="move_next_year()">»</span></div>
                </td>
            </tr>
        </tbody></table>
</div>
...
?>
                    <td class="day name"><?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['week_day']->value['label']];?>
</td>
                <?php } ?>
            </tr>
...
'>
                        <div class="slote_plusicon cursor_hand"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/monthly_slot_minus.png" width="13" height="13" title=""></div>
                        <div class="slote_date cursor_hand"  title=""><?php echo $_smarty_tpl->tpl_vars['month_week']->value['week']['week'];?>
</div>
...
?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['week_day']->value['type']=='old'){?>
                            <td  class="monthly_day" style="position: relative;background: url('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/ui-bg_glass_100_e4f1fb_1x400.png') repeat-x scroll 50% 50% #E4F1FB;" data-date='<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
'>
                            <div class="monthlyslot_date cursor_hand <?php if ($_smarty_tpl->tpl_vars['week_day']->value['type']=='normal'){?>day<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='old'){?>disabled<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='current'){?>selected<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='holiday'){?>holiday<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='redday'){?>redday<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='bigday'){?>bigday<?php }?>"  title="">
                                    
                                    <?php echo $_smarty_tpl->tpl_vars['week_day']->value['day'];?>

                                </div></td>
                        <?php }else{ ?>
                            <td class="monthly_day<?php if ($_smarty_tpl->tpl_vars['week_day']->value['date']==$_smarty_tpl->tpl_vars['today_date']->value){?> selected_date<?php }?>" style="position: relative;background: url('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/ui-bg_glass_100_e4f1fb_1x400.png') repeat-x scroll 50% 50% #E4F1FB;" data-date='<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
' onclick="popupWorkingSummery('<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
','<?php echo $_smarty_tpl->tpl_vars['selected_cust']->value;?>
')">
                                <div class="monthlyslot_date cursor_hand <?php if ($_smarty_tpl->tpl_vars['week_day']->value['type']=='normal'){?>day<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='old'){?>disabled<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='current'){?>selected<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='holiday'){?>holiday<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='redday'){?>redday<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='bigday'){?>bigday<?php }?>"  title="">
                                ...
                                <div class="monthly_strips clearfix" onclick="popupWorkingSummery()">
                                    <?php if (count($_smarty_tpl->tpl_vars['week_day']->value['slots'])>0){?>
...
?>
                                                    <li style="background-color:<?php echo $_smarty_tpl->tpl_vars['slot']->value['color'];?>
;width:<?php echo $_smarty_tpl->tpl_vars['slot']->value['width'];?>
px;margin-left: <?php echo $_smarty_tpl->tpl_vars['slot']->value['margin_left'];?>
px;" title="<?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['slot']->value['first_name'];?>
...
ajax_customers_overlapping.php",
                        data:"month="+month+"&year="+year,
                        type:"POST",
                        dataType: 'json',
                        success:function(data){
                            $('#cmb_customer').html('');
                            $('#cmb_customer').append($('<option>').text('<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_customer'];?>
').attr('value', ''));
                            $.each(data, function(i, value) {
                                if('<?php echo $_smarty_tpl->tpl_vars['sort_by_name']->value;?>
' == 1)
                                    name = value.first_name+" "+value.last_name;
                                else
                                    name = value.last_name+" "+value.first_name;
                                if('<?php echo $_smarty_tpl->tpl_vars['select_customer']->value;?>
' == value.customers)
...
ajax_customer_overlap_report.php?date='+date+'&cust='+cust+'&insurances='+selected_insurances);
        dialog_box_new.dialog({
            title: '<?php echo $_smarty_tpl->tpl_vars['translate']->value['overlap_slot_report_detail'];?>
:&nbsp '+date,
            position: 'top,right',
            modal: true,
            //width: 'auto',
