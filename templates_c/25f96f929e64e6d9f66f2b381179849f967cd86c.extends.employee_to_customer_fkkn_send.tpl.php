<?php /* Smarty version Smarty-3.1.8, created on 2021-03-05 09:10:17
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_to_customer_fkkn_send.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6837727786035f738077f79-41022223%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '25f96f929e64e6d9f66f2b381179849f967cd86c' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_to_customer_fkkn_send.tpl',
      1 => 1614935404,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '6837727786035f738077f79-41022223',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_6035f7383134e7_13619762',
  'variables' => 
  array (
    'app_name' => 0,
    'url_path' => 0,
...
<?php if ($_valid && !is_callable('content_6035f7383134e7_13619762')) {function content_6035f7383134e7_13619762($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
...
<div class="row-fluid">
    <div class="span12 main-left">
        <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['emp_to_cust_fkkn_export'];?>
</span>
            <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
administration/" class="back"><span class="btn_name"><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</span></a>
        </div>
...
:</label>
 ...
 $_from = $_smarty_tpl->tpl_vars['year_option_values']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['lv']->key => $_smarty_tpl->tpl_vars['lv']->value){
$_smarty_tpl->tpl_vars['lv']->_loop = true;
?>
                                       <option value="<?php echo $_smarty_tpl->tpl_vars['lv']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['lv']->value==$_smarty_tpl->tpl_vars['lst_year']->value||$_smarty_tpl->tpl_vars['lv']->value==$_smarty_tpl->tpl_vars['list_year']->value){?>selected="selected"<?php }?> ><?php echo $_smarty_tpl->tpl_vars['lv']->value;?>
</option>
                                    <?php } ?>
                                </select>
                            </span>
                            <span class="span6">
                                <label class="pull-left span3"><?php echo $_smarty_tpl->tpl_vars['translate']->value['month'];?>
:</label>
                                ...
                                <select name=cmb_month id=cmb_month>
                                    ...
                                    <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['month_option_values']->value,'selected'=>$_smarty_tpl->tpl_vars['list_month']->value,'output'=>$_smarty_tpl->tpl_vars['month_option_output_full']->value),$_smarty_tpl);?>
                            ...
                            <div class="search_selected span12"  id="search_type_div" >
                                <div class="clearfix" style="padding-top: 3px; float: left;">
                                    <div class="all_rb_div">
                                        <label>
                                            <p style="float: left;margin-right: 3px;"><input type="radio" <?php if ($_smarty_tpl->tpl_vars['search_type']->value=='all'||$_smarty_tpl->tpl_vars['search_type']->value==''){?>checked="checked"<?php }?> id="rb_all_emps" name="search_type" class="search_type" value="3" /></p>
                                            <p style="float: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</p>
                                        </label>
                                    </div>
                                    ...
                                    <div class="selected_textfiled search_type_customer_div" style="<?php if ($_smarty_tpl->tpl_vars['search_type']->value!='customer'){?>display: none;<?php }?>">
 ...
 $_from = $_smarty_tpl->tpl_vars['load_customers']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['lc']->key => $_smarty_tpl->tpl_vars['lc']->value){
$_smarty_tpl->tpl_vars['lc']->_loop = true;
?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['lc']->value['customer_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['search_type']->value=='customer'&&$_smarty_tpl->tpl_vars['lc']->value['customer_id']==$_smarty_tpl->tpl_vars['sel_customer']->value){?>selected="selected"<?php }?> ><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['lc']->value['cust_ff'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['lc']->value['cust'];?>
<?php }?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div  class="selected_textfiled search_type_employee_div" style="<?php if ($_smarty_tpl->tpl_vars['search_type']->value!='employee'){?>display: none;<?php }?>">
                                        <select name=cmb_employee id=cmb_employee>
                                            <option value="" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                            <?php  $_smarty_tpl->tpl_vars['le'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['le']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['load_employees']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['le']->key => $_smarty_tpl->tpl_vars['le']->value){
$_smarty_tpl->tpl_vars['le']->_loop = true;
?>
                                                <option value="<?php echo $_smarty_tpl->tpl_vars['le']->value['employee_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['search_type']->value=='employee'&&$_smarty_tpl->tpl_vars['le']->value['employee_id']==$_smarty_tpl->tpl_vars['sel_employee']->value){?>selected="selected"<?php }?> ><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['le']->value['emp_ff'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['le']->value['emp'];?>
<?php }?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
...
" onclick="getList();"/>
        ...
        <?php if (count($_smarty_tpl->tpl_vars['employees_group']->value)>0){?>
            <div class="row-fluid">
                <div class="span12">
                    <div style="margin:0px !important;" class="widget">
                        <div class="widget-header span12">
                            <div class="clearfix" style="padding: 10px !important;min-height: 15px;">
                                ...
                                <label for="recipient_check_all" class="pull-left" style="margin: 0px 16px 0px 10px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</label>

                                <input type="checkbox" name="chk_show_unsend_contacts_only" id="chk_show_unsend_contacts_only" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['show_unsend_users_only'];?>
" class="pull-left" />
                                <label for="chk_show_unsend_contacts_only" class="pull-left" style="margin: 0px 0px 0px 10px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['show_unsend_users_only'];?>
</label>
                                
                                <?php if (count($_smarty_tpl->tpl_vars['employees_group']->value)>0){?><input type="button" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['send'];?>
" onclick="dataSend();" class="pull-right no-mb btn-success btn-small" style="margin: 0px 0px 0px 10px;"/><?php }?>
                                <label class="pull-right margin-right"><b><?php echo $_smarty_tpl->tpl_vars['translate']->value['export_sent_users_count'];?>
: <?php echo $_smarty_tpl->tpl_vars['total_send_users_count']->value;?>
</b></label>
                                <label class="pull-right margin-right"><b><?php echo $_smarty_tpl->tpl_vars['translate']->value['export_unsent_users_count'];?>
: <?php echo $_smarty_tpl->tpl_vars['total_unsend_users_count']->value;?>
</b></label>
                                <label class="pull-right margin-right"><b><?php echo $_smarty_tpl->tpl_vars['translate']->value['export_users_count'];?>
: <?php echo $_smarty_tpl->tpl_vars['total_users_count']->value;?>
</b></label>
                            </div>
                        </div>
                    </div>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['get_page']->value){?>
            <div class="row-fluid">
                <div class="span12">
                    <div style="margin:0px !important;" class="widget">
                        <div class="widget-header span12">
...
: <?php echo $_smarty_tpl->tpl_vars['total_users_count']->value;?>
        ...
        <div class="tab-content-con" style="border: 1px solid #e3e3e3;">
            <form id="send_form" name="send_form" action="" method="post" class="">
                ...
                <input type="hidden" name="cmb_customer" value="<?php echo $_smarty_tpl->tpl_vars['sel_customer']->value;?>
" />
                <input type="hidden" name="cmb_employee" value="<?php echo $_smarty_tpl->tpl_vars['sel_employee']->value;?>
" />
                <input type="hidden" name="cmb_year" value="<?php echo $_smarty_tpl->tpl_vars['list_year']->value;?>
" />
                <input type="hidden" name="cmb_month" value="<?php echo $_smarty_tpl->tpl_vars['list_month']->value;?>
" />
                <input type="hidden" name="search_type" value="<?php if ($_smarty_tpl->tpl_vars['search_type']->value=='customer'){?>1<?php }elseif($_smarty_tpl->tpl_vars['search_type']->value=='employee'){?>2<?php }else{ ?>3<?php }?>" />
                <div class="row-fluid">
                    <?php  $_smarty_tpl->tpl_vars['eg_set'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['eg_set']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['employees_group']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['eg_set']->key => $_smarty_tpl->tpl_vars['eg_set']->value){
$_smarty_tpl->tpl_vars['eg_set']->_loop = true;
?>
                        <?php  $_smarty_tpl->tpl_vars['eg'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['eg']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['eg_set']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['eg']->key => $_smarty_tpl->tpl_vars['eg']->value){
$_smarty_tpl->tpl_vars['eg']->_loop = true;
?>
                            <?php if (count($_smarty_tpl->tpl_vars['eg']->value['employee_customers'])>0){?>
                                    ...
                                    <div style="margin:0px !important;" class="widget">
                                        <div class="widget-header span12">
                                            <div style="border-bottom:solid 1px #fff; padding: 10px !important;min-height: 15px;">
                                                <input value="<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
"  id="cch_<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
" class="pull-left check_recipient_groups" type="checkbox">
                                                <label for="cch_<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
" class="pull-left" style="margin: 0px 0px 0px 10px;"><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_fname'];?>
 <?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_lname'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_lname'];?>
 <?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_fname'];?>
<?php }?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="widget-body-section lists input-group">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <?php  $_smarty_tpl->tpl_vars['egc'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['egc']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['eg']->value['employee_customers']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['egc']->key => $_smarty_tpl->tpl_vars['egc']->value){
$_smarty_tpl->tpl_vars['egc']->_loop = true;
?>
                                                    <span class="export_user badge <?php if ($_smarty_tpl->tpl_vars['egc']->value['exported_count']>0&&$_smarty_tpl->tpl_vars['egc']->value['exported_count']>=2){?>badge-important<?php }elseif($_smarty_tpl->tpl_vars['egc']->value['exported_count']>0&&$_smarty_tpl->tpl_vars['egc']->value['last_exported_date']>=$_smarty_tpl->tpl_vars['egc']->value['employer_sign_date']){?>badge-success<?php }else{ ?>unsend<?php }?>">
                                                        <?php if (($_smarty_tpl->tpl_vars['egc']->value['exported_count']==0||$_smarty_tpl->tpl_vars['egc']->value['last_exported_date']<$_smarty_tpl->tpl_vars['egc']->value['employer_sign_date'])&&$_smarty_tpl->tpl_vars['egc']->value['exported_count']<2){?>
                                                            <input id="cch_<?php echo $_smarty_tpl->tpl_vars['egc']->value['username'];?>
_<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
" name="send_data_set[<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
][<?php echo $_smarty_tpl->tpl_vars['egc']->value['username'];?>
]" value="<?php echo $_smarty_tpl->tpl_vars['egc']->value['username'];?>
_<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
" class="badgebox pull-left check_recipient_emp checkbox" style="margin-right: 5px;" type="checkbox"/> 
                                                        <?php }?>
                                                        <label class="pull-left pl" for="cch_<?php echo $_smarty_tpl->tpl_vars['egc']->value['username'];?>
_<?php echo $_smarty_tpl->tpl_vars['eg']->value['employee_username'];?>
">
                                                            <?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['egc']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['egc']->value['last_name'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['egc']->value['last_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['egc']->value['first_name'];?>
<?php }?> 
                                                            
                                                            <?php if ($_smarty_tpl->tpl_vars['egc']->value['last_exported_date']!=''){?>(<?php echo $_smarty_tpl->tpl_vars['egc']->value['exported_count'];?>
)<br/><small><i><?php echo $_smarty_tpl->tpl_vars['egc']->value['last_exported_date'];?>
</i></small><?php }?>
                                                        </label>
                                                    </span>
                                                <?php } ?>
