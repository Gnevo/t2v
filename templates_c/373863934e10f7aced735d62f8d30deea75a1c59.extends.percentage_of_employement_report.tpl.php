<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:54:51
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/percentage_of_employement_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:163144046035f83ba91b35-05272280%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '373863934e10f7aced735d62f8d30deea75a1c59' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/percentage_of_employement_report.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '163144046035f83ba91b35-05272280',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f83bcbd264_68103727',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f83bcbd264_68103727')) {function content_6035f83bcbd264_68103727($_smarty_tpl) {?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['percentage_of_employment_report'];?>
</span>
        <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
                        ...
                        <div class="clearfix" style="padding-top: 3px; float: left;">
                            <div class="customer_block">
                                <label>
                                    ...
                                    <p style="float: left; margin: 4px 0 10px"><?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
</p>
                                </label>
                            </div>
                            <div class="selected_textfiled search_type_customer_div" style="display: none;">
                                <input type="text" id="txt_customer" name="txt_customer" value="" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_customer'];?>
"/>
                            ...
                            <div class="employ_block">
                                <label>
                                    ...
                                    <p style="float: left;margin: 4px 0 10px"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</p>
                                </label>
                            </div>
                            <div  class="selected_textfiled search_type_employee_div">
                                <input type="text" id="emp" name="emp" value="" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_employee'];?>
"/>
...
js/jquery.ui.datepicker.js" type="text/javascript" ></script>
    <script src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/rperofemployement.js" type="text/javascript" ></script>
    <script type="text/javascript">
        $(document).ready(function() {
