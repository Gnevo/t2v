<?php /* Smarty version Smarty-3.1.8, created on 2021-02-23 11:35:48
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/message_center.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18363232196034e894d4b3f6-14620970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c40d7132b15de225eb48c4907571fc6f5d8cfd0' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/message_center.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18363232196034e894d4b3f6-14620970',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6034e8950745e8_17904539',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6034e8950745e8_17904539')) {function content_6034e8950745e8_17904539($_smarty_tpl) {?><!DOCTYPE html>
    ...
    <div class="span12 main-left slot-form">
        ...
        <div style="margin: 15px 0px 0px ! important;" class="widget">
            <div class="widget-header span12">
                <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['message_center'];?>
</h1>
            </div>
        </div>
        <div class="span12 widget-body-section input-group">
            <div class="row-fluid">
                <div class="span12 icons-group">
                    <ul>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['leave_notification']==1||$_smarty_tpl->tpl_vars['privileges_mc']->value['leave_approval']==1||$_smarty_tpl->tpl_vars['privileges_mc']->value['leave_rejection']==1||$_smarty_tpl->tpl_vars['privileges_mc']->value['leave_edit']==1){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
message/center/leave/';">
                                <div class="messagecenter-icon-leave "></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['leave'];?>
<?php if ($_smarty_tpl->tpl_vars['unread_leaves_count']->value>0){?> <span title="<?php echo $_smarty_tpl->tpl_vars['unread_leaves_count']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['unread_leaves'];?>
">(<?php echo $_smarty_tpl->tpl_vars['unread_leaves_count']->value;?>
)</span><?php }?></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['notes']==1||$_smarty_tpl->tpl_vars['privileges_mc']->value['notes_approval']==1||$_smarty_tpl->tpl_vars['privileges_mc']->value['notes_rejection']==1){?>   
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
notes/list/';">
                                <div class="messagecenter-icon-notes"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['notes'];?>
<?php if ($_smarty_tpl->tpl_vars['unread_notes_count']->value>0){?> <span title="<?php echo $_smarty_tpl->tpl_vars['unread_notes_count']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['unread_notes'];?>
">(<?php echo $_smarty_tpl->tpl_vars['unread_notes_count']->value;?>
)</span><?php }?></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['cirrus_mail']==1){?>    
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
mail/list/';">
                                <div class="messagecenter-icon-mail"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['mail'];?>
<?php if ($_smarty_tpl->tpl_vars['mail_count']->value>0){?> <span title="<?php echo $_smarty_tpl->tpl_vars['mail_count']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['unread_mails'];?>
">(<?php echo $_smarty_tpl->tpl_vars['mail_count']->value;?>
)</span><?php }?></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['external_mail']==1){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
email/';">
                                <div class="messagecenter-icon-email"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['email'];?>
</label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['sms']==1){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
leave_sms_system.php';">
                                <div class="messagecenter-icon-SMS"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_leave'];?>
</label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['document_archive']==1||$_smarty_tpl->tpl_vars['emp_role']->value==4||($_smarty_tpl->tpl_vars['privileges_mc']->value['document_archive']==0&&$_smarty_tpl->tpl_vars['count_of_categorys']->value==true)){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
documents/archive/';">
                                <div class="messagecenter-icon-documents"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['documents'];?>
<?php if ($_smarty_tpl->tpl_vars['unread_doc_count']->value>0&&$_smarty_tpl->tpl_vars['emp_role']->value!=1&&$_smarty_tpl->tpl_vars['emp_role']->value!=6){?> <span title="<?php echo $_smarty_tpl->tpl_vars['unread_doc_count']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['unread_docs'];?>
">(<?php echo $_smarty_tpl->tpl_vars['unread_doc_count']->value;?>
)</span><?php }?></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['support']==1||$_smarty_tpl->tpl_vars['emp_role']->value==1){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/list/';">
                                <div class="messagecenter-icon-tickets"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['support'];?>
<?php if ($_smarty_tpl->tpl_vars['open_ticket_count']->value>0){?> <span title="<?php echo $_smarty_tpl->tpl_vars['open_ticket_count']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['open_tickets'];?>
">(<?php echo $_smarty_tpl->tpl_vars['open_ticket_count']->value;?>
)</span><?php }?></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['emp_role']->value!=1&&$_smarty_tpl->tpl_vars['emp_role']->value!=6&&$_smarty_tpl->tpl_vars['surveys']->value>0){?>
                            <li onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
user/survey/';">
                                <div class="administration-icon-surveys"></div>
                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['surveys'];?>
 <span title="<?php echo $_smarty_tpl->tpl_vars['surveys']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['unattended_surveys'];?>
">(<?php echo $_smarty_tpl->tpl_vars['surveys']->value;?>
)</span></label>
                            </li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['emp_role']->value==1||$_smarty_tpl->tpl_vars['emp_role']->value==6||$_smarty_tpl->tpl_vars['candg_on']->value==1){?>
                            <li><a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
comengo/"><div class="administration-icon-come-and-go"></div><label><?php echo $_smarty_tpl->tpl_vars['translate']->value['comengo'];?>
<br></label></a></li>
                        <?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['privileges_mc']->value['sms_general']==1){?>
                            <li><a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
sms/"><div class="administration-icon-sms-general"></div><label><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms'];?>
<br></label></a></li>
                        <?php }?>
                    </ul>
                </div>
