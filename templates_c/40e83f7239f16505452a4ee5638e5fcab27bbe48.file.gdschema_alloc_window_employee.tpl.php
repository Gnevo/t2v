<?php /* Smarty version Smarty-3.1.8, created on 2020-12-06 11:55:50
         compiled from "/home/time2view/public_html/cirrus/templates/gdschema_alloc_window_employee.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15537390565fccc6c606f105-23857343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '40e83f7239f16505452a4ee5638e5fcab27bbe48' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/gdschema_alloc_window_employee.tpl',
      1 => 1584621400,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15537390565fccc6c606f105-23857343',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fccc6c6808d62_68503247',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fccc6c6808d62_68503247')) {function content_5fccc6c6808d62_68503247($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus/libs/plugins/modifier.date_format.php';
...
<?php $_smarty_tpl->tpl_vars['url_val'] = new Smarty_variable((((((($_smarty_tpl->tpl_vars['url_path']->value).('ajax_alloc_action.php?date=')).($_smarty_tpl->tpl_vars['cur_date']->value)).('&employee=')).($_smarty_tpl->tpl_vars['employee']->value['userid'])).('&emp_alloc=')).($_smarty_tpl->tpl_vars['emp_alloc']->value), null, 0);?>
<?php $_smarty_tpl->tpl_vars['url_val_slot'] = new Smarty_variable((((((('date=').($_smarty_tpl->tpl_vars['cur_date']->value)).('&employee=')).($_smarty_tpl->tpl_vars['employee']->value['userid'])).('&customer=')).('&emp_alloc=')).($_smarty_tpl->tpl_vars['emp_alloc']->value), null, 0);?>
<?php $_smarty_tpl->tpl_vars['url_val_reload'] = new Smarty_variable((((((($_smarty_tpl->tpl_vars['url_path']->value).('gdschema_alloc_window_employee.php?date=')).($_smarty_tpl->tpl_vars['cur_date']->value)).('&employee=')).($_smarty_tpl->tpl_vars['employee']->value['userid'])).('&emp_alloc=')).($_smarty_tpl->tpl_vars['emp_alloc']->value), null, 0);?>
<?php $_smarty_tpl->tpl_vars['url_val_self'] = new Smarty_variable((((($_smarty_tpl->tpl_vars['url_path']->value).('gdschema_alloc_window_employee.php?&employee=')).($_smarty_tpl->tpl_vars['employee']->value['userid'])).('&emp_alloc=')).($_smarty_tpl->tpl_vars['emp_alloc']->value), null, 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['s_employee']->value['username']==$_smarty_tpl->tpl_vars['employee']->value['userid']){?>selected='selected'<?php }?>><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo (($_smarty_tpl->tpl_vars['s_employee']->value['first_name']).(' ')).($_smarty_tpl->tpl_vars['s_employee']->value['last_name']);?>
...
<?php }?></a><?php }?>
                            <button class="btn btn-default btn-normal pull-right" type="button" onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
/<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
/', 1);" style="margin-left: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['monthly_view'];?>
</button>
                            <button class="btn btn-default btn-normal pull-right" type="button" onclick="navigatePage('<?php echo ($_smarty_tpl->tpl_vars['url_path']->value).($_smarty_tpl->tpl_vars['back_url']->value);?>
', 1);" style="margin-left: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['weekly_view'];?>
</button>
                            <button class="btn btn-default btn-normal pull-right" type="button" onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_day_employee.php?date=<?php echo $_smarty_tpl->tpl_vars['cur_date']->value;?>
&employee=<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
...
" <?php if (((smarty_modifier_date_format($_smarty_tpl->tpl_vars['week_day']->value['date'],'%u'))==7)||(in_array($_smarty_tpl->tpl_vars['week_day']->value['date'],$_smarty_tpl->tpl_vars['holidays_week']->value))){?> style="color:red !important; font-weight: bold;"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['week_day']->value['label']];?>
 ...
 | <?php echo $_smarty_tpl->tpl_vars['cur_date']->value;?>
                                                        ...
                                                        <?php if (count($_smarty_tpl->tpl_vars['employee_running_tasks']->value)>0&&$_smarty_tpl->tpl_vars['today_date']->value==$_smarty_tpl->tpl_vars['cur_date']->value){?>
...
?>
                                                            ...
                                                            <?php } ?>
                                                            <div class="cursor_help pull-right ml" title="<?php echo $_smarty_tpl->tpl_vars['employee_running_task_title']->value;?>
...
"><?php echo $_smarty_tpl->tpl_vars['translate']->value['check_all'];?>
                                            ...
                                            <div tabindex="2" class="span12 slots-full-view-body input-group no-min-height" id="slot_display_wraper" data-date='<?php echo $_smarty_tpl->tpl_vars['cur_date']->value;?>
'>
                                                <div class="row-fluid">
...
" class="slot-day <?php if ($_smarty_tpl->tpl_vars['slot_det']->value['type']==10&&$_smarty_tpl->tpl_vars['slot_det']->value['status']==1){?>slot-theme-pm<?php }elseif($_smarty_tpl->tpl_vars['slot_det']->value['status']==1&&$_smarty_tpl->tpl_vars['slot_det']->value['created_status']==1){?>slot-theme-candg-accept<?php }elseif($_smarty_tpl->tpl_vars['slot_det']->value['status']==1){?>slot-theme-complete<?php }elseif($_smarty_tpl->tpl_vars['slot_det']->value['status']==2){?>slot-theme-leave<?php }elseif($_smarty_tpl->tpl_vars['slot_det']->value['status']==4){?>slot-theme-candg<?php }else{ ?>slot-theme-incomplete<?php }?> <?php if ($_smarty_tpl->tpl_vars['slot_det']->value['signed_in']==1){?>signed_slot<?php }?> span12<?php if ($_smarty_tpl->tpl_vars['swap_copied_slot']->value==$_smarty_tpl->tpl_vars['slot_det']->value['id']){?> objblink<?php }?> <?php if ($_smarty_tpl->tpl_vars['slot_det']->value['show_details']!=1){?>donot_show_slot<?php }?>">
 ...
 (<?php echo $_smarty_tpl->tpl_vars['slot_det']->value['slot_hour'];?>
                                                                                        ...
                                                                                        <div class="row-fluid">
                                                                                            <div class="span12 customer-names-wrpr">
                                                                                                <span class="span12 day-customer-name"><?php if ($_smarty_tpl->tpl_vars['slot_det']->value['cust_name']!=''){?><?php echo $_smarty_tpl->tpl_vars['slot_det']->value['cust_name'];?>
...
" <?php if (($_smarty_tpl->tpl_vars['slot_det']->value['privileges_gd']['add_customer']==1||$_smarty_tpl->tpl_vars['slot_det']->value['privileges_gd']['copy_day_slot']==1||$_smarty_tpl->tpl_vars['slot_det']->value['privileges_gd']['delete_day_slot']==1)&&$_smarty_tpl->tpl_vars['slot_det']->value['customer']==''){?>onclick="cust_assign_slot('<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
"><i class="icon-comment"/> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slot_det']->value['comment'], ENT_QUOTES, 'UTF-8', true);?>
                                                    ...
                                                    <div class="box-generic">
                                                        <div class="tabsbar tabsbar-2" style="margin: -5px 0 7px;">
                                                            <ul class="row-fluid row-merge">
                                                                <li class="span4<?php if (!isset($_smarty_tpl->tpl_vars['right_panel']->value)||$_smarty_tpl->tpl_vars['right_panel']->value==''||$_smarty_tpl->tpl_vars['right_panel']->value=='emp_assign_list'){?> active<?php }?>"><a href="#tab-assign-emp-list" data-toggle="tab" id="tb_assign_emp_list"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
</a></li>
 ...
 $_from = $_smarty_tpl->tpl_vars['customers_to_assign']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cust']->key => $_smarty_tpl->tpl_vars['cust']->value){
$_smarty_tpl->tpl_vars['cust']->_loop = true;
?>
                                                                            <div class="customer-name-slots" data-cust-name='<?php echo $_smarty_tpl->tpl_vars['cust']->value['username'];?>
' style="float: none;">
                                                                                <span class="widget-stats-emplyee widget-stats-2 employees" onclick="loadPopupSchemaCustomerAssignment('<?php echo $_smarty_tpl->tpl_vars['url_val_slot']->value;?>
&cust=<?php echo $_smarty_tpl->tpl_vars['cust']->value['username'];?>
&action=multiple_slot_assign_cust');">
                                                                                    <span><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo (($_smarty_tpl->tpl_vars['cust']->value['first_name']).(' ')).($_smarty_tpl->tpl_vars['cust']->value['last_name']);?>
<?php }elseif($_smarty_tpl->tpl_vars['sort_by_name']->value==2){?><?php echo (($_smarty_tpl->tpl_vars['cust']->value['last_name']).(' ')).($_smarty_tpl->tpl_vars['cust']->value['first_name']);?>
<?php }?> (<?php echo $_smarty_tpl->tpl_vars['cust']->value['code'];?>
)</span>
                                                                                </span>
                                                                            </div>
                                                                        <?php } ?>
                                                                            ...
                                                                            <div class="widget-body" style="padding:5px;">
                                                                                <div class="row-fluid">
                                                                                    <div class="span8 customer-name no-mb no-min-height" style="margin:5px;"> 
                                                                                        <span style="margin-right: 5px;" class="icon-group"></span><?php echo $_smarty_tpl->tpl_vars['employee']->value['name'];?>
...
"></span> 
                                                            <span id="sdEmployee"><?php echo $_smarty_tpl->tpl_vars['employee']->value['name'];?>
</span>
                                                            <input class="this_slot_employee_id" id="sdEmployeeID" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
"/>
                                                        </h2>
                                                        <div class="span12" style="margin-left: 0px;">
                                                            <div class="input-prepend span11">
...
gdschema_alloc_window_employee.php?date=<?php echo $_smarty_tpl->tpl_vars['cur_date']->value;?>
&employee='+selected_employee+'&emp_alloc=<?php echo $_smarty_tpl->tpl_vars['emp_alloc']->value;?>
',1);
                }
            });
...
');
        ...
        function loadPopupSchemaCustomerAssignment(url) {
            ...
            if(slots_array.length == 0){
                alert("<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_one_slot'];?>
");
            }else if(over_lap == 1){
...
');
                ...
                $( '.add-new-slots-month .create-slotes-panel .time_slots_theme' ).each(function( index ) {
                    ...
                    if(tmp_slot_from !== false && tmp_slot_to !== false){
                        ...
                        var temp_obj = { 'time_from': tmp_slot_from, 'time_to': tmp_slot_to, 'employee': '<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
...
', function(result){ });
        ...
        function manEntry_proceed(data_obj){
            ...
            var main_obj = { 'selected_date': slot_date,
                            'selected_employee': '<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
',
...
',
            ...
            var url_atl = 'date='+slot_date+'&employee=<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
...
',
                                        'pEmployee': '<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
',
                                        'ids': ids,
...
ajax_customers_employees_change.php",
 ...
 " + data, function(result){ });
            ...
            function saveChangeUserMultipleConfirm(){
                ...
                var url = "employee=<?php echo $_smarty_tpl->tpl_vars['employee']->value['userid'];?>
