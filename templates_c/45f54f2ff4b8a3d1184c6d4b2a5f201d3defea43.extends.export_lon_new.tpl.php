<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 10:57:34
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/export_lon_new.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18386684616036311ebad125-31075061%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '45f54f2ff4b8a3d1184c6d4b2a5f201d3defea43' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/export_lon_new.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18386684616036311ebad125-31075061',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6036311ee4bc30_72016046',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6036311ee4bc30_72016046')) {function content_6036311ee4bc30_72016046($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
...
images/sgo-loading.gif"  />
            ...
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div class="widget-header span12">
                    <div class="span10"><h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['export_title'];?>
</h1></div>
                    <?php if ($_smarty_tpl->tpl_vars['fkkn_split']->value){?><div class="span2" ><h1 style="margin: 0px ! important; background-color:#9da0a5; text-align: center; float: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['fkkn_split'];?>
</h1></div><?php }?>
                </div>
                                ...
                                <div class="span12 widget-body-section input-group">
                                    <div class="span12">
                                        ...
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
</label>
                                            <div style="margin-left: 0px; float: left;" class="input-prepend span11 hasDatepicker" id="datepicker"> <span class="add-on icon-pencil" data-icon=""></span>
                                                ...
                                                <select class="form-control span10" name="customer" id="customer">
                                                    <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['all_clients'];?>
</option>
                                                    <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['customer_list']->value,'selected'=>$_smarty_tpl->tpl_vars['post_customer']->value,'output'=>$_smarty_tpl->tpl_vars['customer_list_n']->value),$_smarty_tpl);?>
                                        ...
                                        <div class="span2" style="margin: 0px;">
                                            <label class="span3" style="float: left;" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['month'];?>
</label>
 ...
 $_from = $_smarty_tpl->tpl_vars['monthsn']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['m']->key => $_smarty_tpl->tpl_vars['m']->value){
$_smarty_tpl->tpl_vars['m']->_loop = true;
 $_smarty_tpl->tpl_vars['id']->value = $_smarty_tpl->tpl_vars['m']->key;
?>
                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['months']->value[$_smarty_tpl->tpl_vars['id']->value];?>
" <?php if ($_smarty_tpl->tpl_vars['month']->value==$_smarty_tpl->tpl_vars['months']->value[$_smarty_tpl->tpl_vars['id']->value]){?> selected="selected"<?php }?>>
                                                            <?php echo $_smarty_tpl->tpl_vars['id']->value+sprintf("%02d",1);?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['m']->value];?>
</option>
                                                        <?php } ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['year'];?>
</label>
                                            <div style="margin-left: 0px; float: left;" class="input-prepend span11 hasDatepicker" id="datepicker"> <span class="add-on icon icon-calendar"></span>
                                                <select class="form-control span10" id="cmb_year" name="year" onchange="javascript:this.form.submit();">
                                                    <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['years']->value,'selected'=>$_smarty_tpl->tpl_vars['year']->value,'output'=>$_smarty_tpl->tpl_vars['years']->value),$_smarty_tpl);?>
    
                                                </select>
                                            </div>
                                        </div>

                                        <?php if ($_smarty_tpl->tpl_vars['salary_code']->value>0){?>        
                                            <div class="span2" style="margin: 0px;">
                                                <label style="float: left;" class="span12" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['export_type'];?>
</label>
                                                <div style="margin-left: 0px; float: left;" class="input-prepend span11 hasDatepicker" id="datepicker"> <span class="add-on icon icon-file-text"></span>
                                                    <select class="form-control span10" id="cmb_year" name="app">
                                                        <?php if ($_smarty_tpl->tpl_vars['salary_code']->value==1){?>
                                                            <option value="visma600"><?php echo $_smarty_tpl->tpl_vars['translate']->value['lbl_export_visma600'];?>
</option>
                                                        <?php }elseif($_smarty_tpl->tpl_vars['salary_code']->value==2){?>    
                                                            <option value="visma"><?php echo $_smarty_tpl->tpl_vars['translate']->value['lbl_export_visma_lon'];?>
</option>
                                                        <?php }elseif($_smarty_tpl->tpl_vars['salary_code']->value==3){?>    
                                                            <option value="hogia"><?php echo $_smarty_tpl->tpl_vars['translate']->value['lbl_export_hogia_lon'];?>
</option>
                                                        <?php }elseif($_smarty_tpl->tpl_vars['salary_code']->value==4){?>    
                                                            <option value="crona"><?php echo $_smarty_tpl->tpl_vars['translate']->value['lbl_export_crona'];?>
</option>
                                                        <?php }elseif($_smarty_tpl->tpl_vars['salary_code']->value==6){?>    
                                                            <option value="bl"><?php echo $_smarty_tpl->tpl_vars['translate']->value['lbl_export_bl'];?>
</option>
                                                        <?php }?>    
                                                    </select>
                                                </div>
                                        ...
                                        <div class="span3" style="margin: 0px;">
                                            <input type="hidden" name="export_data" value='<?php echo $_smarty_tpl->tpl_vars['export_data']->value;?>
'>
                                            <input type="hidden" name='export_data_users' value='<?php echo $_smarty_tpl->tpl_vars['export_data_users']->value;?>
'>
                                            <?php if ($_smarty_tpl->tpl_vars['company_id']->value==14){?><button class="btn btn-default  btn-margin-set" style="margin: 16px 8px 0px ! important; text-align: center;" type="submit" name="verify" value="verify"><?php echo $_smarty_tpl->tpl_vars['translate']->value['verify'];?>
</button><?php }?>
                                            <button class="<?php if ($_smarty_tpl->tpl_vars['export_data_flag']->value){?>btn btn-success<?php }else{ ?>btn btn-default<?php }?>  btn-margin-set" style="margin: 16px 8px 0px ! important; text-align: center;" type="submit" name="export" value="export" <?php if ($_smarty_tpl->tpl_vars['export_data_flag']->value!=1){?>disabled<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['export'];?>
</button>
                                            <a style="margin: 16px 0px 0px ! important; text-align: center; background-color:#9da0a5; display:block; padding: 4px; float: right;" href="javascript:document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
export_lon-config/'"><?php echo $_smarty_tpl->tpl_vars['translate']->value['config'];?>
</a>
                                            <?php if ($_smarty_tpl->tpl_vars['company_id']->value==14){?><button class="btn btn-default  btn-margin-set" style="margin: 16px 0px 0px ! important; text-align: center;" type="button" name="Send" disabled><?php echo $_smarty_tpl->tpl_vars['translate']->value['send_export'];?>
</button><?php }?>
                                        </div>    
                                    </div>
                                </div>
                            ...
                            <div class="widget" style="margin-top:0;">
                                ...
                                <div class="span12 widget-body-section input-group">
                                    ...
                                    <div class="alerts-export-wrpr">
                                            ...
                                            <?php echo $_smarty_tpl->tpl_vars['export_error']->value;?>

                                        
                                    </div>
                                    
                                  <div class="row-fluid">
                                        <div class="span4 top-customer-info"><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['num_employees'];?>
</strong><?php echo $_smarty_tpl->tpl_vars['num_employees']->value;?>
</div>
                                        <div class="span4 top-customer-info"><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['num_signed'];?>
</strong><?php echo $_smarty_tpl->tpl_vars['num_signed']->value;?>
</div>
                                        <div class="span4 top-customer-info"><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['num_not_signed'];?>
</strong><?php echo $_smarty_tpl->tpl_vars['num_not_signed']->value;?>
</div>
                                    </div>
                                    <div class="span7" style="padding: 0px ! important; margin: 0px ! important;">

                                        <form id="mail_sms" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
export_lon/">
                                            ...
                                            <table class="table table-bordered table-condensed table-hover table-responsive table-primary t" style="margin: 10px 0px 0px; top: 0px;">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_customer'];?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['phone_mobile'];?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms'];?>
<br><center><input type="checkbox" name="sms_check_all" id="sms_check_all"></center></th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['email'];?>
<br><center><input type="checkbox" name="email_check_all" id="email_check_all"></center></th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['last_send'];?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['count'];?>
</th>
                                                ...
                                                <!-- Table body -->
                                                <tbody>
                                                    <?php echo $_smarty_tpl->tpl_vars['not_signed']->value;?>
                                                ...
                                                <div style="border-radius: 0px 0px 4px 4px ! important;" class="span12 widget-body-section input-group">
                                                    <div class="span8" style="margin: 0px ! important;">
                                                        ...
                                                        <div style="margin: 0px;" class="input-prepend date hasDatepicker span12"> <span class="add-on icon-envelope"></span>
                                                            <input class="form-control span11"  name="textfield" id="textfield" type="text"> </div>
                                                    </div>
                                                    <div class="span4">
                                                        <button class="btn btn-default span12 btn-margin-set" name="sms" type="submit" id="sms">
                                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['btn_sms_email'];?>
                                        ...
                                        <table class="table table-bordered table-condensed table-hover table-responsive table-primary t" style="margin: 10px 0px 0px; top: 0px;">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="5"><?php echo $_smarty_tpl->tpl_vars['translate']->value['num_exported'];?>
 <?php echo $_smarty_tpl->tpl_vars['num_exported']->value;?>
</th>
                                                </tr>
                                            </thead>
                                            <!-- // Table heading END -->
...
$_smarty_tpl->tpl_vars['export']->_loop = true;
 $_smarty_tpl->tpl_vars['id']->value = $_smarty_tpl->tpl_vars['export']->key;
?>
                                                <tr class="gradeX">
...
" />
                                                            <input type="hidden" name="filename" value="<?php echo $_smarty_tpl->tpl_vars['export']->value['filename'];?>
" />
                                                            <input type="hidden" name="download" value=" <?php echo $_smarty_tpl->tpl_vars['translate']->value['download'];?>
 " />
                                                            <a id="link_<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
" href="javascript:void(0);" onclick="$(this).parents('form').get(0).submit();" style="text-decoration:underline; cursor:pointer;" ><?php echo $_smarty_tpl->tpl_vars['export']->value['year'];?>
<?php echo sprintf("%02d",$_smarty_tpl->tpl_vars['export']->value['month']);?>
</a>
                                                        </form>
                                                    </td>
                                                    <td><?php echo $_smarty_tpl->tpl_vars['export']->value['employee'];?>
<?php if ($_smarty_tpl->tpl_vars['export']->value['customers']){?>/<?php echo $_smarty_tpl->tpl_vars['export']->value['customers'];?>
<?php }?></td>
                                                    <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['export']->value['timestamp'],"%Y-%m-%d %H:%M:%S");?>
</td>
                                                    <td class="table-col-center small-col">
                                                        <form name="customer_report" id="customer_report" method="post"  class="table-form">
                                                            <input type="hidden" name="del_file" value="<?php echo $_smarty_tpl->tpl_vars['export']->value['filename'];?>
" />    
                                                            <input type="hidden" name="month" value="<?php echo $_smarty_tpl->tpl_vars['month']->value;?>
" />
                                                            <input type="hidden" name="year" value="<?php echo $_smarty_tpl->tpl_vars['year']->value;?>
" />
                                                        ...
                                                        <button type="button" class="btn btn-default delete-exported-table-row" id="del_<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
" onclick="sub_customer_del($(this).parents('form').get(0));" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['btn_delete'];?>
"><span class="icon-remove"></span></button>
                            ...
                            <div class="span7">
                                <div style="margin: 15px 0px 15px ! important;" class="widget">
                                    <div class="span12 top-customer-info"><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['employees_exported'];?>
: <?php echo count($_smarty_tpl->tpl_vars['employees_exported']->value);?>
</strong></div>
                                </div>
                                <table class="table table-bordered table-primary table-condensed table-striped table-vertical-center">
                                    <thead>
                                        <tr>
                                            <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['serial_no'];?>
</th>
                                            <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</th>
                                            <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php  $_smarty_tpl->tpl_vars['employee_det'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['employee_det']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['employees_exported']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['employee_det']->key => $_smarty_tpl->tpl_vars['employee_det']->value){
$_smarty_tpl->tpl_vars['employee_det']->_loop = true;
?>
                                            <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->tpl_vars['i']->value+1, null, 0);?>
                                            <tr class="gradeX">
                                                <td><?php echo $_smarty_tpl->tpl_vars['i']->value;?>
</td>
                                                <td><?php echo $_smarty_tpl->tpl_vars['employee_det']->value['employee'];?>
</td>
                                                <td><?php echo implode(",",$_smarty_tpl->tpl_vars['employee_det']->value['customers']);?>
</td>
        ...
        $(document).ready(function() {
            ...
            $("#mail_sms").submit(function() {
                ...
                if($('#sms_num').val() != '' || $('#email_num').val() != ''){
                    ...
                    alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['check_atleast_one_mail_sms'];?>
');
                    return false;
                }
            });
        ...
        function sub_customer_del(obj){
            if(confirm('<?php echo $_smarty_tpl->tpl_vars['translate']->value['confirm_delete_file'];?>
')){
                $("#sms_month").val($("#month").val());
                $("#sms_year").val($("#cmb_year").val());
                obj.submit();
