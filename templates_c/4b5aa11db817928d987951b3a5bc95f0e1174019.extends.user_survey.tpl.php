<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:46:20
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/survey/user_survey.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2151703596035f63cdaa3b8-57329034%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4b5aa11db817928d987951b3a5bc95f0e1174019' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/survey/user_survey.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2151703596035f63cdaa3b8-57329034',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f63d05b473_17799919',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f63d05b473_17799919')) {function content_6035f63d05b473_17799919($_smarty_tpl) {?><!DOCTYPE html>
            ...
            <div style="margin: 15px 0px 0px ! important;" class="widget no-ml">
                <div style="" class="widget-header span12">
                    <div class="span4 day-slot-wrpr-header-left span6">
                        <h1 style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['survey'];?>
</h1>
                    </div>
                    <div class="pull-right day-slot-wrpr-header-left span8" style="padding: 5px;">
                        <button onclick="javascript:location='<?php if ($_smarty_tpl->tpl_vars['user_role']->value==1){?><?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
surveys/<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
message/center/<?php }?>';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><i class="icon-arrow-left"></i> <?php echo $_smarty_tpl->tpl_vars['translate']->value['back'];?>
</button>
                    </div>
                </div>
            </div>
...
user/question/survey/<?php echo $_smarty_tpl->tpl_vars['survey']->value['id'];?>
/';" class="btn btn-success btn-normal pull-right btn_survey_start" style="margin: 5px; padding-left: 5px; padding-right: 5px;" type="button">
                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['go_to_questions'];?>
...
: <?php echo $_smarty_tpl->tpl_vars['survey']->value['created_date'];?>
</span>
                                            <span class="label label-important"><?php echo $_smarty_tpl->tpl_vars['translate']->value['expiry_date'];?>
: <?php echo $_smarty_tpl->tpl_vars['survey']->value['expire_date'];?>
</span>
...
: <?php echo $_smarty_tpl->tpl_vars['survey']->value['form_count'];?>
                ...
                <?php }else{ ?>
                    <div class="message"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_surveys_to_attend'];?>
</div>
                <?php }?>
            </div>
        </div>
