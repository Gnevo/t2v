<?php /* Smarty version Smarty-3.1.8, created on 2021-03-01 05:37:47
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_leave_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:454211429603c7dab7f9f53-80706623%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '521a28425f5025c9f9d851fed79988e93dc0354f' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_leave_report.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '454211429603c7dab7f9f53-80706623',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603c7daba08a12_18509561',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603c7daba08a12_18509561')) {function content_603c7daba08a12_18509561($_smarty_tpl) {?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="span12 main-left">  
        <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_absence_report'];?>
</span>
    <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
?>
                        <div class="clearfix mr pull-left">
                            <label><input type="checkbox" checked="checked" value="<?php echo $_smarty_tpl->tpl_vars['leave_type_key']->value;?>
" title="<?php echo $_smarty_tpl->tpl_vars['leave_type']->value;?>
" class="leave_type" /> <?php echo $_smarty_tpl->tpl_vars['leave_type']->value;?>
</label>
                        </div>
                    <?php } ?>
                    <div class="clearfix pull-left">
                        <label style="margin-left: 25px;"><input type="checkbox" checked="checked" onclick="select_all_types()" value="1" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_all_type'];?>
" id="select_all_check" name="select_all_check" style="margin-top: 5px;"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['check'];?>
</label>
                    </div>
                </div>

                <?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_name'];?>
 <input type="text" name="emp" id="emp" maxlength="150"  autocomplete="off" aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input" />
...
" />
 ...
 : <input type="text" name="frmdate" id="frmdate" maxlength="11" style="margin-top:5px;"/>
                <?php echo $_smarty_tpl->tpl_vars['translate']->value['to_date'];?>
 : <input type="text" name="todate" id="todate" maxlength="11" style="margin-top:5px;"/>
...
<script src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/rcustomerleavereport.js" type="text/javascript" ></script>
<script>
    $(document).ready(function() {
