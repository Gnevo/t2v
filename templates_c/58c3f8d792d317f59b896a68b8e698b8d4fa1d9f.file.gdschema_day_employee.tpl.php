<?php /* Smarty version Smarty-3.1.8, created on 2020-12-07 08:27:41
         compiled from "/home/time2view/public_html/cirrus/templates/gdschema_day_employee.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4046980835fcde77d468776-79871739%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '58c3f8d792d317f59b896a68b8e698b8d4fa1d9f' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/gdschema_day_employee.tpl',
      1 => 1566968690,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4046980835fcde77d468776-79871739',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcde77de2a128_78342333',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcde77de2a128_78342333')) {function content_5fcde77de2a128_78342333($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus/libs/plugins/modifier.date_format.php';
...
: <?php echo (($_smarty_tpl->tpl_vars['employee_details']->value['first_name']).(' ')).($_smarty_tpl->tpl_vars['employee_details']->value['last_name']);?>
</div>
...
month/gdschema/employee/<?php echo $_smarty_tpl->tpl_vars['current_year']->value;?>
...
gdschema_day_employee.php?date=<?php echo $_smarty_tpl->tpl_vars['alloc_prev_week_day']->value;?>
&year_week=&employee=<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
...
employee/gdschema/<?php echo $_smarty_tpl->tpl_vars['week']->value['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
...
gdschema_day_employee.php?date=<?php echo $_smarty_tpl->tpl_vars['days']->value['date'];?>
...
" onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_day_employee.php?date=<?php echo $_smarty_tpl->tpl_vars['alloc_next_week_day']->value;?>
&year_week=&employee=<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
&action=1',1);" style="position: absolute; right: 0px; top: 0px; cursor: pointer; display: block; width: 5% ! important; text-align: center; box-sizing: border-box; border: 1px solid rgb(204, 204, 204);"></div>
                        ...
                        <div class="dayview_chart">
                            <div class="dayview_employee">
                                <ul>
                                    <?php  $_smarty_tpl->tpl_vars['customer_data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['customer_data']->_loop = false;
 $_smarty_tpl->tpl_vars['cust_key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['customer_day_slots']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['customer_data']->key => $_smarty_tpl->tpl_vars['customer_data']->value){
$_smarty_tpl->tpl_vars['customer_data']->_loop = true;
 $_smarty_tpl->tpl_vars['cust_key']->value = $_smarty_tpl->tpl_vars['customer_data']->key;
?>
                                        <li class="emp_entry" data-cust='<?php echo $_smarty_tpl->tpl_vars['cust_key']->value;?>
'><a href="javascript:void(0);" <?php if ($_smarty_tpl->tpl_vars['customer_data']->value['show_details']==1){?>onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_alloc_window.php?date=<?php echo $_smarty_tpl->tpl_vars['selected_date']->value;?>
&customer=<?php echo $_smarty_tpl->tpl_vars['cust_key']->value;?>
',1);"<?php }?>><?php echo $_smarty_tpl->tpl_vars['customer_data']->value['name'];?>
</a></li>
                                    <?php } ?>
...
?>
                                    ...
                                    <div class="dayview_raw <?php if ($_smarty_tpl->tpl_vars['emp_index']->value>8){?>tooltip_upper<?php }?>" data-cust='<?php echo $_smarty_tpl->tpl_vars['cust_key']->value;?>
'>
                                        <ul class="slots_all">
                                            <?php if (count($_smarty_tpl->tpl_vars['customer_data']->value['slots'])>0){?>
 ...
 $_from = $_smarty_tpl->tpl_vars['customer_data']->value['slots']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
"></i>
                                                                        <div class="editsection">
                                                                            <input type="hidden" class="new_slot_details_hub" 
                                                                                        data-time-from='<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['slot_data']['first']){?>0.00<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['customer_data']->value['slots'][$_smarty_tpl->tpl_vars['slot_index']->value-1]['slot_to'];?>
<?php }?>'
...
"></span>
                                                                                            <input class="form-control span5 custom_slot slot_from time-input-text" id="new_slot_from" name="slot_from" value="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['slot_data']['first']){?>0.00<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['customer_data']->value['slots'][$_smarty_tpl->tpl_vars['slot_index']->value-1]['slot_to'];?>
...
" type="text" style="margin-left: -1px;width: 43%;">
                                                                                    ...
                                                                                    <h2 class="span12 no-mb no-padding"><span class="icon-user" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
"></span> 
                                                                                        <span id="sdCustomer"><?php echo $_smarty_tpl->tpl_vars['slot_det']->value['cust_name'];?>
</span>
                                                                                    </h2>
                                                                                    <div class="span12" style="margin-left: 0px;">
...
"></i>
                                                                <div class="editsection">
                                                                    <input type="hidden" class="new_slot_details_hub" 
                                                                                data-time-from='0'
                                                                                data-time-to='24.00'
                                                                                data-customer-id='<?php echo $_smarty_tpl->tpl_vars['customer_data']->value['username'];?>
'
                                                                                data-customer-name='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer_data']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
'
                                                                                />
                                                                    <div class="span12" style="margin-left: 0px;">
                                                                        <div class="slot-wrpr span12 time_slots_theme" id="slot-wrpr-month" style="margin-bottom:5px !important;">
...
" type="text" style="margin-left: -1px;width: 43%;">
                                                                            ...
                                                                            <h2 class="span12 no-mb no-padding"><span class="icon-user" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['customer'];?>
"></span> 
                                                                                <span id="sdCustomer"><?php echo $_smarty_tpl->tpl_vars['customer_data']->value['name'];?>
</span>
                                                                            </h2>
                                                                            <div class="span12" style="margin-left: 0px;">
                                                                                <div class="input-prepend span11">
...
?>
                                        <?php $_smarty_tpl->tpl_vars['emp_index'] = new Smarty_variable($_smarty_tpl->tpl_vars['emp_index']->value+1, null, 0);?>
                                        <div class="dayview_raw unmanned_row <?php if ($_smarty_tpl->tpl_vars['emp_index']->value>8){?>tooltip_upper<?php }?>" data-cust=''>
                                            <ul class="slots_all">
                                                <?php if ($_smarty_tpl->tpl_vars['slot_det']->value['slot_difference']!=0){?>
                                                    <li style="width:<?php echo $_smarty_tpl->tpl_vars['slot_det']->value['slot_difference']*4.16;?>
%" class="raw1 opasity_zero">
...
-<?php echo $_smarty_tpl->tpl_vars['slot_det']->value['slot_to'];?>
 (<?php echo $_smarty_tpl->tpl_vars['slot_det']->value['slot_hour'];?>
                                                                    ...
                                                                    <li><span class="icon-group"></span> <i>[<?php echo $_smarty_tpl->tpl_vars['translate']->value['no_customer'];?>
]</i></li>
                                                                    <li><span class="icon-user"></span> <?php echo $_smarty_tpl->tpl_vars['slot_det']->value['emp_name'];?>
</li>
                                                                    <?php if ($_smarty_tpl->tpl_vars['slot_det']->value['comment']!=''){?><li class="hover-popup-comment"><span class="icon-comment"></span><?php echo $_smarty_tpl->tpl_vars['slot_det']->value['comment'];?>
...
?>
                                    <?php if ($_smarty_tpl->tpl_vars['cust']->value['accessibility']==true){?>
...
&customer=<?php echo $_smarty_tpl->tpl_vars['rcust']->value['username'];?>
&action=1',1);">
...
<?php }?>',1);
    ...
    function load_not_signed_employees_of_customer(root_obj, selected_date){
        ...
        //load team customers of this employee
        root_obj.find(".editsection").find('#custom_slot_employee').html('<option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select'];?>
</option>');
        $.ajax({
            url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_alloc_action_month.php",
            ...
            success:function(data){
                        ...
                        if(data && data.employees){
                            ...
                            $.each(data.employees, function(i, value) {
                                if(value.username == '<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
') default_page_employee_exists = true;
                            ...
                            if(temp_previous_selected_emp == '' && default_page_employee_exists){
                                root_obj.find(".editsection").find('#custom_slot_employee').val('<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
');
                            }
...
',
            ...
            //if(ev.viewMode == 'months'){
                ...
                navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_day_employee.php?date='+this_date+'&year_week='+year_week+'&employee=<?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
&action=1',1);
            //}
        });
    });
                                ...
                                if(ids_temp.length == 1){
                                    ...
                                    if(slot_details_hub.length == 1){
                                        ...
                                        if(temp_cust_id != ''){
                                            navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_day_customer.php?date=<?php echo $_smarty_tpl->tpl_vars['selected_date']->value;?>
&customer='+temp_cust_id+'&action=1',1);
                                        }
                                    }
                                }
                                if(temp_cust_id == ''){
