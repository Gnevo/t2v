<?php /* Smarty version Smarty-3.1.8, created on 2021-03-01 05:25:01
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_work_report_listing_signed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:828012204603c7aad678c80-33777661%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60689106d7b2d40d60405b7f120afaf983d72a4d' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_work_report_listing_signed.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '828012204603c7aad678c80-33777661',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603c7aad904be9_91202903',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603c7aad904be9_91202903')) {function content_603c7aad904be9_91202903($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['signing_report'];?>
</span>
        <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
                ...
                <div class="search_types">
                    ...
                    <div class="search_selected span12"  id="search_type_div" >
                        <div class="clearfix pull-left" style="padding-top: 3px;">
                            <div class="pull-left mr"><?php echo $_smarty_tpl->tpl_vars['translate']->value['sign_type'];?>
: </div>
                            <div class="sign_type_block ml pull-left" style="margin-top: 2px;">
                                <label class="clearfix pull-left mr">
                                    <p style="float: left;margin-right: 3px;"><input type="checkbox" <?php if ($_smarty_tpl->tpl_vars['selected_sign_with_bankID']->value){?>checked="checked"<?php }?> id="sign_type_with_bankID" name="sign_type_with_bankID" value="1" /></p>
                                    <p style="float: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['with_bankid'];?>
</p>
                                </label>
                                <label class="clearfix pull-left pl">
                                    <p style="float: left;margin-right: 3px;"><input type="checkbox" <?php if ($_smarty_tpl->tpl_vars['selected_sign_without_bankID']->value){?>checked="checked"<?php }?> id="sign_type_without_bankID" name="sign_type_without_bankID" value="1" /></p>
                                    <p style="float: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['without_bankid'];?>
</p>
                                </label>
                            </div>
                        </div>
                        <div class="clearfix pull-left mr">
                            <div style="margin-left: 25px;">
                                <?php echo $_smarty_tpl->tpl_vars['translate']->value['sign_user_level'];?>
:
                                <select name=cmb_sign_level id=cmb_sign_level>
                                    <option value="1" <?php if ($_smarty_tpl->tpl_vars['selected_signing_user_level']->value==1){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</option>
                                    <option value="2" <?php if ($_smarty_tpl->tpl_vars['selected_signing_user_level']->value==2){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['tl'];?>
</option>
                                    <option value="3" <?php if ($_smarty_tpl->tpl_vars['selected_signing_user_level']->value==3){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['super_tl'];?>
</option>
                                </select>
                            </div>
                        </div>
...
" onclick="getList();"/>
                            <?php if ($_smarty_tpl->tpl_vars['request_access']->value&&$_smarty_tpl->tpl_vars['selected_signing_user_level']->value==1&&$_smarty_tpl->tpl_vars['selected_sign_without_bankID']->value&&!$_smarty_tpl->tpl_vars['selected_sign_with_bankID']->value&&count($_smarty_tpl->tpl_vars['report_list']->value)>0){?>
                                <input type="button" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['fk_3059'];?>
" onclick="get3059(1);"/>
                                <input type="button" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['kn_3059'];?>
" onclick="get3059(2);"/>
        ...
        <?php if ($_smarty_tpl->tpl_vars['request_access']->value){?>
            ...
            <table class="table_list work_report no-ml table table-bordered table-responsive">
                <tbody>
                    <tr>
                        <th width="113" height="50" colspan="1" style="text-align: center;"><?php echo (($_smarty_tpl->tpl_vars['translate']->value['total_signing_count']).(': ')).($_smarty_tpl->tpl_vars['total_signings_count']->value);?>
</th>
                        <th width="113" height="50" colspan="2" style="text-align: center;"><?php echo (($_smarty_tpl->tpl_vars['translate']->value['signing_with_bankid_count']).(': ')).($_smarty_tpl->tpl_vars['signing_with_bankID_count']->value);?>
</th>
                        <th width="113" height="50" colspan="2" style="text-align: center;"><?php echo (($_smarty_tpl->tpl_vars['translate']->value['signing_without_bankid_count']).(': ')).($_smarty_tpl->tpl_vars['signing_without_bankID_count']->value);?>
</th>
                    </tr>
                    <tr>
...
/">
                                        <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_employee']!=''){?>
                                            <span class="userlevel_1">
                                                <span class='pull-left pr'><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signing_employee_name'];?>
</span>
                                                <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['employee_sign_with_bankID']!=''){?><img class='pull-left' style="height: 18px;" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/banck_id_signing.jpg"><?php }?>
                                                <span class='pull-left span12' style="color: teal;"><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_date'];?>
</span>
                                            </span>
                                        <?php }else{ ?><span class="userlevel_2"><?php echo $_smarty_tpl->tpl_vars['translate']->value['unsigned'];?>
</span><?php }?>
                                    </a>
                                </td>
                                <td class="txt_align_center">
...
/<?php echo $_smarty_tpl->tpl_vars['customer']->value['user_name'];?>
/">
                                        <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_tl']!=''){?>
                                            <span class="userlevel_1">
                                                <span class='pull-left pr'><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_tl_name'];?>
</span>
                                                <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['tl_sign_with_bankID']!=''){?><img class='pull-left' style="height: 18px;" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/banck_id_signing.jpg"><?php }?>
                                                <span class='pull-left span12' style="color: teal;"><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_tl_date'];?>
</span>
                                            </span>
                                        <?php }else{ ?><span class="userlevel_2"><?php echo $_smarty_tpl->tpl_vars['translate']->value['unsigned'];?>
</span><?php }?>
...
/<?php echo $_smarty_tpl->tpl_vars['customer']->value['user_name'];?>
/">
                                        <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_sutl']!=''){?>
                                            <span class="userlevel_1">
                                                <span class='pull-left pr'><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_sutl_name'];?>
</span>
                                                <?php if ($_smarty_tpl->tpl_vars['customer']->value['signing_details']['sutl_sign_with_bankID']!=''){?><img class='pull-left' style="height: 18px;" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/banck_id_signing.jpg"><?php }?>
                                                <span class='pull-left span12' style="color: teal;"><?php echo $_smarty_tpl->tpl_vars['customer']->value['signing_details']['signin_sutl_date'];?>
</span>
                                            </span>
                                        <?php }else{ ?><span class="userlevel_2"><?php echo $_smarty_tpl->tpl_vars['translate']->value['unsigned'];?>
</span><?php }?>
...
');
        ...
        alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_signing_user_level'];?>
');
    else if(sign_type_with_bankID == 0 && sign_type_without_bankID == 0)
        alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_atleast_one_signing_type'];?>
');
    else
        window.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
report/work/employee/signed/list/'+year+'/'+month_label+'/'+sign_type_with_bankID+'/'+sign_type_without_bankID+'/'+sign_level_label+'/-/';
