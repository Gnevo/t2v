<?php /* Smarty version Smarty-3.1.8, created on 2021-03-01 05:24:48
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/contract_employee_report_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1908092865603c7aa0964719-72197184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6410f3a66e094f2de2402c587c7477bcca87c40a' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/contract_employee_report_list.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1908092865603c7aa0964719-72197184',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603c7aa0bc0ac0_59816607',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603c7aa0bc0ac0_59816607')) {function content_603c7aa0bc0ac0_59816607($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12 main-left">
            <div style="margin: 15px 0px 0px;" class="widget-header span12">
                <div class="span4 day-slot-wrpr-header-left span6">
                    <h1 style="margin: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Contract_Employee_List'];?>
</h1>
                </div>
...
reports/'"><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['contract_details']->value){?>
                    	<button type="button" class="btn pull-right mr" onclick="print_pdf()"><i class="icon-print"><?php echo $_smarty_tpl->tpl_vars['translate']->value['print'];?>
</i></button>
                    <?php }?>
                </div>
            </div>
                ...
                <div class="span12 widget-body-section input-group">
                    <div class="widget-body" style="padding:5px;">
                    	 ...
                    	 <div class="row-fluid" style="margin-bottom:15px;">
                    	 	<form name="contract_emp_form" id="contract_emp_form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
contract/employee/report/list/" target="_self">
	                    	 	<input type="hidden" name="action" id="action" value="">
	                    	 	<div class="span3">
	                	 			<input type="radio" name="contract_employee" <?php if ($_smarty_tpl->tpl_vars['type_of_contract']->value==1){?> checked="true" <?php }?>  value="1">
	                	 			<span style="margin-left: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Employee_With_Active_Contract'];?>
</span>
	                    	 	</div>
	                    	 	<div class="span3">
	                	 			<input type="radio" name="contract_employee"  value="2" <?php if ($_smarty_tpl->tpl_vars['type_of_contract']->value==2){?> checked="true" <?php }?>>
	                	 			<span style="margin-left: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Employee_With_Contract_Expired'];?>
</span>
	                    	 	</div>
	                    	 	<div class="span3">
	                	 			<input type="radio" name="contract_employee"  value="3" <?php if ($_smarty_tpl->tpl_vars['type_of_contract']->value==3){?> checked="true" <?php }?>>
	                	 			<span style="margin-left: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Employee_Without_Contract'];?>
</span>
	                    	 	</div>
...
:</label> -->
                                    <div style="margin: 0px; float:left" class="input-prepend date hasDatepicker datepicker span10 no-padding"> 
                                        ...
                                        <input class="form-control span12" type="text" name="expiry_date" id="expiry_date" value="<?php echo $_smarty_tpl->tpl_vars['current_date']->value;?>
" />
                                    </div>
                                </div>
	                    	 	...
	                    	 	<div class="span1">
	                	 			<button type="button" name="show_contract" class="btn btn-primary"  onclick="contract()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
</button>
	                    	 	</div>
	                    	 </form>
                    	 </div>
	                                                    ...
	                                                    <table class="table table-bordered table-primary table-striped table-vertical-center">
	                                                        <thead>
	                                                            <tr>
	                                                                ...
	                                                                <?php if ($_smarty_tpl->tpl_vars['contract_details']->value['expired_contract']||$_smarty_tpl->tpl_vars['contract_details']->value['active_contract']){?>
	                                                                	<th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Contract_Start_Date'];?>
</th>
	                                                                	<th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['Contract_Expiry_Date'];?>
</th>
	                                                                <?php }?>
	                                                            </tr>
	                                                        </thead>
	                                                        ...
	                                                        <tbody>
	                                                        	<?php if ($_smarty_tpl->tpl_vars['contract_details']->value['expired_contract']){?>
		                                                            <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['contract_details']->value['expired_contract']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
																	  		<?php if ($_smarty_tpl->tpl_vars['key2']->value=='date_from'){?>
																			  	<td>
																			  		<a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employment/contract/pdf/<?php echo $_smarty_tpl->tpl_vars['value']->value['employee'];?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
/" target="_blank" style="color: #1414a5;text-decoration-line: underline;"><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</a>
																			  	</td>
																			<?php }else{ ?>
																			...
																			<?php }?>
																			<?php if ($_smarty_tpl->tpl_vars['key2']->value=='contract_expiry_date'){?> 		<?php break 1?> 
																			<?php }?>
																	  	<?php } ?>
																	  </tr>
																	<?php } ?>
																...
																<?php if ($_smarty_tpl->tpl_vars['contract_details']->value['active_contract']){?>
																	<?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable(1, null, 0);?>
		                                                            <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['contract_details']->value['active_contract']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['value']->key;
?>
...
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['key2']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
																	  		<?php if ($_smarty_tpl->tpl_vars['key2']->value=='emp_name'){?>
																	  			<?php if ($_smarty_tpl->tpl_vars['item']->value!=$_smarty_tpl->tpl_vars['old_value']->value){?>
																	  				<td rowspan="<?php echo $_smarty_tpl->tpl_vars['value']->value['count'];?>
"><?php echo $_smarty_tpl->tpl_vars['i']->value++;?>
</td>
																		  			<td rowspan="<?php echo $_smarty_tpl->tpl_vars['value']->value['count'];?>
">
																			  			<?php echo $_smarty_tpl->tpl_vars['value']->value['emp_name'];?>

																			  		</td>
																			  		<?php $_smarty_tpl->tpl_vars['old_value'] = new Smarty_variable($_smarty_tpl->tpl_vars['item']->value, null, 0);?>
																		  		<?php }else{ ?>
																		  		<?php }?>
																		  	<?php }else{ ?>
																		  			<?php if ($_smarty_tpl->tpl_vars['key2']->value=='date_from'){?>
																		  				<td>
																		  					<?php if ($_smarty_tpl->tpl_vars['contract_privilege']->value==1){?><a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employment/contract/pdf/<?php echo $_smarty_tpl->tpl_vars['value']->value['employee'];?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
/" style="color: #1414a5;text-decoration-line: underline;" target="_blank"><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</a><?php }else{ ?> <?php echo $_smarty_tpl->tpl_vars['item']->value;?>
<?php }?>
																		  					<!-- <?php echo $_smarty_tpl->tpl_vars['contract_privilege']->value==1;?>
 ? <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employment/contract/pdf/<?php echo $_smarty_tpl->tpl_vars['value']->value['employee'];?>
/<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
...
; -->
																		  			...
																		  			<?php }?>
																			  	<?php if ($_smarty_tpl->tpl_vars['key2']->value=='contract_expiry_date'){?> <?php break 1?> <?php }?>	
																...
																<?php if ($_smarty_tpl->tpl_vars['contract_details']->value['without_contract']){?>
		                                                            <?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['contract_details']->value['without_contract']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['value']->key;
?>
