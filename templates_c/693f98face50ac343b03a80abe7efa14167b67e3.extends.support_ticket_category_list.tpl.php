<?php /* Smarty version Smarty-3.1.8, created on 2021-02-04 09:31:41
         compiled from "/home/time2view/public_html/cirrus/templates/support_ticket_category_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1175842736601bbefdd35f66-55307100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '693f98face50ac343b03a80abe7efa14167b67e3' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/support_ticket_category_list.tpl',
      1 => 1436164486,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1175842736601bbefdd35f66-55307100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_601bbefe021744_88475627',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_601bbefe021744_88475627')) {function content_601bbefe021744_88475627($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/time2view/public_html/cirrus/libs/plugins/function.cycle.php';
?><!DOCTYPE html>
...
<div class="row-fluid">
    <div class="span12 main-left">
        <div class="tbl_hd">
            <span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_categories'];?>
</span>
            <a class="add" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/category/add/" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new_ticket_category'];?>
"><?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new'];?>
</a>
            <a class="back" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/list/" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</a>
        </div>
                ...
                <form name="ticket_category_form" id="ticket_category_form" method="post">
                    ...
                    <div class="span12 table-responsive no-ml">
                        <table class="table_list table table-bordered table-condensed table-hover table-responsive table-primary t" id="tbl1" style="width:100%">
                            <tbody>
                                <tr>
                                    <th width="50"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category_order'];?>
</th>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category_type'];?>
</th>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category_name'];?>
</th>
                                    <th width="50"><?php echo $_smarty_tpl->tpl_vars['translate']->value['edit'];?>
</th>
                                    <th width="50"><?php echo $_smarty_tpl->tpl_vars['translate']->value['delete'];?>
</th>
                                </tr>
...
" id="status_<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
">
                                        <td><?php echo $_smarty_tpl->tpl_vars['list']->value['order'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['support_category_types']->value[$_smarty_tpl->tpl_vars['list']->value['type']];?>
</td>
...
supporttickets/category/add/<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
/" class="settings"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/btn_edit.gif" border="0" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['edit'];?>
" /></a></td>
                                            <td><a href="javascript:void(0)" class="settings" onclick="delete_category(<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
)"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/btn_delete.png" border="0" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['delete'];?>
" /></a></td>
                                                <?php }elseif($_smarty_tpl->tpl_vars['list']->value['company_id']==$_smarty_tpl->tpl_vars['company_id']->value){?>
                                            <td><a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/category/add/<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
/" class="settings"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/btn_edit.gif" border="0" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['edit'];?>
...
downloads/'+filename+'&embedded=true');
    ...
    <script type="text/javascript">
        function delete_category(cat_id) {
            if (confirm("<?php echo $_smarty_tpl->tpl_vars['translate']->value['sure_to_delete_category_data'];?>
")) {
                alert(cat_id);
                $('#cat_id').val(cat_id);
                $("#ticket_category_form").attr("action", "<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/category/list/delete/");
