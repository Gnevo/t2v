<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:46:33
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/survey/surveys_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14031674286035f64997a753-94579804%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a78c16d084040cf86907523e1a27ab602d9c46d' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/survey/surveys_list.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14031674286035f64997a753-94579804',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f649c38178_32257664',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f649c38178_32257664')) {function content_6035f649c38178_32257664($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
            ...
            <div style="margin: 15px 0px 0px ! important;" class="widget no-ml">
                <div style="" class="widget-header span12">
                    <div class="span4 day-slot-wrpr-header-left span6">
                        <h1 style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['surveys'];?>
</h1>
                    </div>
                    <div class="pull-right day-slot-wrpr-header-left span8" style="padding: 5px;">
                        <button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
S_survey_report_types.php';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right" type="button"><i class="icon-arrow-left"></i> <?php echo $_smarty_tpl->tpl_vars['translate']->value['back'];?>
</button>
                    </div>
                </div>
            </div>
            ...
            <div class="span12 widget-body-section input-group">
                <div class="widget-body pb">
                    <div class="row-fluid">
                        <div class="span12 widget-body-section input-group">
                            <form method="post" id="search_survey_form" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
S_surveys_list.php"  class=''>
                                <div style="margin: 0px ! important; padding: 0px;" class="pull-left span3">
                                    <label for="search_emp" style="float: left;" class="span12"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_surveys'];?>
</label>
                                ...
                                <div class="pull-left span2">
                                    <label for="search_emp" style="float: left;" class="span12 no-mb"><?php echo $_smarty_tpl->tpl_vars['translate']->value['date_range'];?>
</label>
                                    <div class="input-prepend span10" style="margin: 0px; float:left;"> 
                                        <div style="margin: 0px;" class="input-prepend date hasDatepicker datepicker no-pt no-pl"> 
                                            ...
                                            <input type="text" name="date_from" id="textfield1" value="<?php echo $_smarty_tpl->tpl_vars['date_from']->value;?>
" class="form-control span12 text-box" autocomplete="off"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="pull-left span2">
                                    <label for="search_emp" style="float: left;" class="span12 no-mb"><?php echo $_smarty_tpl->tpl_vars['translate']->value['to'];?>
</label>
                                    <div class="input-prepend span10" style="margin: 0px; float:left;"> 
                                        <div style="margin: 0px;" class="input-prepend date hasDatepicker datepicker no-pt no-pl"> 
                                            <span class="add-on icon-calendar"></span>
                                            <input type="text" name="date_to" id="textfield2" value="<?php echo $_smarty_tpl->tpl_vars['date_to']->value;?>
" class="form-control span12 text-box" autocomplete="off"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="pull-left">
                                    <label for="search_emp" style="float: left;" class="span12 no-mb"><?php echo $_smarty_tpl->tpl_vars['translate']->value['survey_status'];?>
</label>
                                    <ol class="radio-group">
                                        <li><input name="expired" id="expired" type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['expire']->value==1){?>checked="checked"<?php }?> class="check-box" />
                                            <label class="radio label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['expired'];?>
 </label></li>
                                        <li>  
                                            <input name="valued" id="valued" type="checkbox" value="2" <?php if ($_smarty_tpl->tpl_vars['valid']->value==1){?>checked="checked"<?php }?> class="check-box" />
                                            <label class="radio label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['valued'];?>
</label></li>
                                    </ol>
                                </div> 
                                <div style="padding-top: 15px;" class="pull-right">
                                    <input type="hidden" name="status" id="status" value="" />
                                    <button name="get_survey" id="get_survey" onclick="getSurveys()" class="btn btn-default btn-margin-set btn-option-panel pull-right btn-margin-lft" type="button"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['get_survey'];?>
</button>
                                </div>
                            </form>
                        </div>
                ...
                <?php if (count($_smarty_tpl->tpl_vars['surveys']->value)>0){?>
...
?>
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    <a class="accordion-toggle glyphicons right_arrow" data-toggle="collapse" data-parent="#tabAccountAccordion" href="#collapse-<?php echo $_smarty_tpl->tpl_vars['survey']->value['id'];?>
">
                                        <i></i><?php echo $_smarty_tpl->tpl_vars['survey']->value['survey_title'];?>

                                        <button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
custom/survey/report/<?php echo $_smarty_tpl->tpl_vars['survey']->value['id'];?>
/';" class="btn btn-success btn-normal pull-right btn_survey_start" style="margin: 5px; padding-left: 5px; padding-right: 5px;" type="button">
                                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['go_to_report'];?>
 <span class="icon-arrow-right"></span>
                                        </button>
                                        <div class="pull-right mr"><?php if (smarty_modifier_date_format(time(),'%Y-%m-%d')>smarty_modifier_date_format($_smarty_tpl->tpl_vars['survey']->value['expire_date'],'%Y-%m-%d')){?><span class="badge badge-important " style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['expired_1'];?>
</span><?php }else{ ?><span class="badge badge-success " style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['valid'];?>
</span><?php }?></div>
                                    </a>
                                </div>
                                <div style="height: 0px;" id="collapse-<?php echo $_smarty_tpl->tpl_vars['survey']->value['id'];?>
" class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        <div class="margin-none">
                                            <span class="label label-success"><?php echo $_smarty_tpl->tpl_vars['translate']->value['created_on'];?>
: <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['survey']->value['created_date'],'%A, %B %d , %Y');?>
</span>
                                            <span class="label label-important"><?php echo $_smarty_tpl->tpl_vars['translate']->value['expiry_date'];?>
: <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['survey']->value['expire_date'],'%Y-%m-%d');?>
</span>
                                            <span class="label label-info"><?php echo $_smarty_tpl->tpl_vars['translate']->value['number_of_forms'];?>
: <?php echo $_smarty_tpl->tpl_vars['survey']->value['form_count'];?>
</span>
                                            <span class="label label-inverse"><?php echo $_smarty_tpl->tpl_vars['translate']->value['survey_status'];?>
: <?php if (smarty_modifier_date_format(time(),'%Y-%m-%d')>smarty_modifier_date_format($_smarty_tpl->tpl_vars['survey']->value['expire_date'],'%Y-%m-%d')){?><?php echo $_smarty_tpl->tpl_vars['translate']->value['expired_1'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['translate']->value['valid'];?>
<?php }?></span>
                                            <span class="label label-warning"><?php echo $_smarty_tpl->tpl_vars['translate']->value['response_count'];?>
: <?php echo $_smarty_tpl->tpl_vars['survey']->value['user_count'];?>
</span><br> 
                                            <?php if ($_smarty_tpl->tpl_vars['survey']->value['description']!=''){?><p style="margin: 10px 0px 0px;" class=""><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['description'];?>
</strong><br><?php echo $_smarty_tpl->tpl_vars['survey']->value['description'];?>
</p><?php }?>
                                        </div>
                                    </div>
                ...
                <?php }else{ ?>
                    <div class="message"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_surveys'];?>
</div>
                <?php }?>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){	
        ...
        var availableTags = [
            <?php  $_smarty_tpl->tpl_vars['surve'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['surve']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['surveys']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['surve']->key => $_smarty_tpl->tpl_vars['surve']->value){
$_smarty_tpl->tpl_vars['surve']->_loop = true;
?>
                 "<?php echo $_smarty_tpl->tpl_vars['surve']->value['survey_title'];?>
",       
                <?php } ?>
                    ""
        ];
...
?>  
                    {
                    value: "<?php echo $_smarty_tpl->tpl_vars['surve']->value['id'];?>
",
                    label: "<?php echo $_smarty_tpl->tpl_vars['surve']->value['survey_title'];?>
"
                    },
            <?php } ?>
    ...
    function getSurveys(){
        ...
        if((date_from != "" && date_to == "") || (date_from == "" && date_to != "")){
            if(date_from == ""){
                error = 1;
                alert("<?php echo $_smarty_tpl->tpl_vars['translate']->value['please_enter_date_from'];?>
");
                $("#textfield1").focus();
            }
            if(date_to == ""){
                error = 1;
                alert("<?php echo $_smarty_tpl->tpl_vars['translate']->value['please_enter_date_to'];?>
");
                $("#textfield2").focus();
            }
        }
