<?php /* Smarty version Smarty-3.1.8, created on 2021-01-27 14:29:33
         compiled from "/home/time2view/public_html/cirrus/templates/privilege_employee_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:853554885601178cd0a80d1-68658638%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7639528c7fe156ccbc65be19f47a6c949ca6a756' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/privilege_employee_add.tpl',
      1 => 1558425500,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '853554885601178cd0a80d1-68658638',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_601178cd43c697_99278619',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_601178cd43c697_99278619')) {function content_601178cd43c697_99278619($_smarty_tpl) {?><!DOCTYPE html>
    ...
    <div class="span12 main-left">
        ...
        <div style="margin: 0px 15px 0px 0px;" class="widget-header span12">
            ...
            <div class="pull-right day-slot-wrpr-header-left" style="padding: 5px;">
                <button style="" class="btn btn-default btn-normal pull-right" type="button" onclick="setPrivilege()"><span class="icon-save"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</button>
                <button style="" class="btn btn-default btn-normal pull-right" type="button" onclick="privilegeEmployeeSelect()"><span class="icon-arrow-left"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</button>
            </div>
            <form id="empls_select" name="empls_select" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
privilege/employee/">
...
" />
                <input type="hidden" name="pre_role" id="pre_role" value="<?php echo $_smarty_tpl->tpl_vars['pre_role']->value;?>
" />
            </form>
        </div>
                    ...
                    <div class="span12 widget-body-section input-group">
                        <div style="margin: 0px 0px 20px ! important;" class="span12 day-deatiles-employee">
                            ...
                            <ul class="selected-previlege-list">
                                <?php if ($_smarty_tpl->tpl_vars['select_all']->value=='1'){?>
...
</a><a href="javascript:void(0);" onclick="removeEmployee('<?php echo $_smarty_tpl->tpl_vars['employee']->value['username'];?>
...
": function() {
                                $( this ).dialog( "close" );
                                 $.ajax({
                                    ...
                                    url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privileges.php",
                                    data:"selected="+selected_emp+"tab=<?php echo $_smarty_tpl->tpl_vars['tab']->value;?>
"+"&role="+role,
                                    type:"POST",
                                    success:function(data){
                                            $("#tabDetails").html(data);
