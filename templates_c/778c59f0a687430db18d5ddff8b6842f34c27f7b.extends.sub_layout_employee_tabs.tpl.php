<?php /* Smarty version Smarty-3.1.8, created on 2020-12-11 23:12:28
         compiled from "/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7946160145fd3fcdcf2fc87-16141618%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '778c59f0a687430db18d5ddff8b6842f34c27f7b' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl',
      1 => 1588177878,
      2 => 'file',
    ),
    '850d776fde8d392fc9b38640445e09393ee5036e' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/employee_skills.tpl',
      1 => 1551790398,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7946160145fd3fcdcf2fc87-16141618',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd3fcdd365c05_14761768',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd3fcdd365c05_14761768')) {function content_5fd3fcdd365c05_14761768($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12 main-left boxscroll">
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div class="widget-header span12">
                    <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['skills'];?>
</h1>
                </div>
            </div>
...
employee/non-prefered/timing/%%C-UNAME%%/1/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_non_preferred_time'];?>
                            ...
                            <div class="widget-header widget-header-options tab-option">
                                    ...
                                    <button class="btn btn-default btn-normal pull-right" type="button" onclick="addNewSkill()"><span class="icon-plus" s></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new'];?>
</button>
                                 </div>
                                </div>
                        </div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="clearfix" id="forms_container_new">
                                        <div class="new_skill" id="new_skill" style="display: none;">
                                            ...
                                            <div class="widget-header span12">
                                                <div class="skill_botton" style="padding:5px 10px 5px 0;float: right;"><button type="button" class="btn btn-success" name="save_skill" id="save_skill" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
" onclick="saveForm()"><span class="icon-save"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</span></button></div>
                                                <div style="padding:5px 10px 5px 0;float: right;"><button class="btn btn-default" onclick="hide_form('new')" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cancel'];?>
</button></div>
                                                
                                            </div>
                                                <div class="clearfix"><span style="float: left;display: block;padding-top: 20px; margin-bottom: 20px;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_title'];?>
</span><span style="padding-top: 20px; padding-left: 27px; display: block; float: left;margin-left: 102px;"><input type="text" name="title" id="title" onchange="makeChange()"  required="true" style="width: 212px;" /></span></div>
                                                <div class="clearfix"><span style="float: left;display: block;margin-left: 34px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_description'];?>
</span><span style="float: right;display: block;margin:auto;margin-bottom: 13px;width: 61.5%"><textarea name="skill_desc" id="skill_desc" onchange="makeChange()" required="true" /></textarea></span></div>
                                                <div class="clearfix"><span style="float: left;display: block;padding-top: 20px; margin-bottom: 20px;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_date_of_exam'];?>
</span><span style="padding-top: 20px; display: block; float: left;margin-left: 85px;"><input type="text" name="date_of_qualification" value="<?php echo $_smarty_tpl->tpl_vars['current_date']->value;?>
" data-date-format="yyyy-mm-dd"  id="date_of_qualification" onchange="makeChange()"  required="true" style="width: 212px;" /></span></div>
                                                <div class="clearfix"></div><div id="attachment1" ><label style="margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_document'];?>
</label><input type="file" name="file[]" id="file1" style="margin:auto;line-height: 25px;float: right;width: 61%"> </div>
                                                <div class="clearfix"></div><div id="attachment2" style="padding: 10px 0 0 0 ;"><label style="margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_document'];?>
</label><input type="file" name="file[]" id="file2" style="margin:auto;line-height: 25px;float: right;width: 61%"></div>
                                                <div class="clearfix"></div><div id="attachment3" style="padding: 10px 0 0 0 ;"><label style="margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_document'];?>
</label><input type="file" name="file[]" id="file3" style="margin:auto;line-height: 25px;float: right;width: 61%"></div>
                                                <div class="clearfix"></div>
                                                <div class="span12" style="padding:10px 0 0 10px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_doc_tyepe_on_emp_skills'];?>
</div>
...
?>
                                            <table class="footable table table-striped table-bordered table-white table-primary " style="margin-top:5px;">
                                                <thead>
                                                    <tr>
                                                        <th class="thead-light"  title="Edit Skill"><a href="javascript:void(0);" onclick="toggle_edit('<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
')"><?php echo $_smarty_tpl->tpl_vars['skill']->value['skill'];?>
</a></th>
                                                        <th class="thead-light table-col-center"><a href="javascript:void(0);" class="btn btn-default" onclick="deleteSkill('<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
')"><i class="icon-trash"></i></a></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php  $_smarty_tpl->tpl_vars['desc'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['desc']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['skill']->value['description']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['desc']->key => $_smarty_tpl->tpl_vars['desc']->value){
$_smarty_tpl->tpl_vars['desc']->_loop = true;
?>
                                                        <tr>
                                                            <td ><?php echo $_smarty_tpl->tpl_vars['desc']->value['desc'];?>
</td>
                                                            <td></td>
                                                        </tr>
                                                    <?php } ?>
                                                        <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment1']!=''||$_smarty_tpl->tpl_vars['skill']->value['attachment2']!=''||$_smarty_tpl->tpl_vars['skill']->value['attachment3']!=''){?>
                                                        <tr><td>
                                                            <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment1']!=''){?>
                                                                    <label onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
')"><i class="icon icon-download"></i><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
</label>
                                                            </br>
                                                            <?php }?>
                                                            <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment2']!=''){?>
                                                             <label onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
')"><i class="icon icon-download"></i><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment2'];?>
</label>
                                                              </br>
                                                            <?php }?>
                                                            <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment3']!=''){?>
                                                                    <label onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
')"><i class="icon icon-download"></i><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment3'];?>
</label>
                                                             </br>
                                                            <?php }?>
                                                             <td></td>
                                    ...
                                    <div id="edit_skill<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
" style="display: none;" >
                                        <form action=""  method="post" name="edit<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
" id="edit<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
" enctype="multipart/form-data">   
                                        <input type="hidden" value="" id="action<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
" name="action">
                                           <div class="widget" style="width:500px;height:380px;">
                                                <div class="widget-header span12">
                                                    <div class="skill_botton" style="padding:5px 10px 5px 0;float: right;"><button type="button" class="btn btn-success" name="edit_skill" id="edit_skill" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
" onclick="save_edit_form('<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
')"><span class="icon-save"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</button></div>
                                                    <div style="padding:5px 10px 5px 0;float: right;"><button class="btn btn-default" onclick="hide_form('edit','<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
')" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cancel'];?>
</button></div>
                                                </div>
                                                <div class="clearfix"><span style="float: left;display: block;padding-top: 20px;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_title'];?>
</span><span style="padding-top: 20px; padding-left: 27px; display: block;float: left;margin-left: 92px;"><input type="text" name="title" id="edit_title" onchange="makeChange()" value="<?php echo $_smarty_tpl->tpl_vars['skill']->value['skill'];?>
...
$_smarty_tpl->tpl_vars['desc']->_loop = true;
?>
                                                    <div class="clearfix"><span style="float: left;display: block;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_description'];?>
</span><span style="float: right;display: block;margin:auto;margin-bottom: 13px;width: 63.5%"><textarea name="skill_desc" id="edit_skill_desc" onchange="makeChange()" required="true" /><?php echo $_smarty_tpl->tpl_vars['desc']->value['desc'];?>
</textarea></span></div>
                                                <?php } ?>
                                                    <div class="clearfix"><span style="float: left;display: block;padding-top: 20px; margin-bottom: 20px;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_date_of_exam'];?>
</span><span style="padding-top: 20px; display: block; float: left;margin-left: 75px;"><input type="text" name="date_of_qualification" value="<?php echo $_smarty_tpl->tpl_vars['skill']->value['exam_date'];?>
" data-date-format="yyyy-mm-dd"  id="date_of_qualification_edit" onchange="makeChange()"  required="true" style="width: 212px;" /></span></div>
                                                    <div class="clearfix"><span style="float: left;display: block;padding-top: 5px; margin-bottom: 20px;margin-left: 38px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_document'];?>
</span>
                                                   
                                                   <div  style="padding-left:183px;width: 300px;"> 
                                                   <table >
                                                        <tr id="first_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
">
                                                            <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment1']!=''){?>
                                                                <td><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
</td>
                                                                <td ><a href="javascript:void(0);" class="btn btn-default" onclick="delete_skill_doc('first_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment1'];?>
','attachment1')"><i class="icon-trash"></i></a></td>
                                                            <?php }else{ ?>
                                                                <td colspan="2"><input type="file" name="file[]"></td>
                                                            <?php }?>
                                                        </tr>
                                                
                                                    <tr id="second_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
">
                                                        <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment2']!=''){?>
                                                            <td><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment2'];?>
</td>
                                                            <td ><a  href="javascript:void(0);" class="btn btn-default" onclick="delete_skill_doc('second_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment2'];?>
','attachment2')"><i class="icon-trash"></i></a></td>
                                                        <?php }else{ ?>
                                                             <td colspan="2"><input type="file" name="file[]"></td>
                                                        <?php }?>
                                                    </tr>
                                                    <tr id="third_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
">
                                                        <?php if ($_smarty_tpl->tpl_vars['skill']->value['attachment3']!=''){?>
                                                            <td><?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment3'];?>
 </td>
                                                            <td><a  href="javascript:void(0);" class="btn btn-default" onclick="delete_skill_doc('third_del_<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['skill']->value['attachment3'];?>
','attachment3')"><i class="icon-trash"></i></a></td>
                                                        <?php }else{ ?>
                                                            <td colspan="2"><input type="file" name="file[]"></td>
                                                        <?php }?>
                                                    <tr>
                                                ...
                                                <div class="clearfix"></div>
                                                <div style="padding:10px 0 0 10px; "><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_doc_tyepe_on_emp_skills'];?>
</div>
                                                    <input type="hidden" name="skill_h_id" value="<?php echo $_smarty_tpl->tpl_vars['skill']->value['id'];?>
">
                                                </div> 
                                        </div>
...
?>
                                            <div class="alert alert-error" id="error_div"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data_available'];?>
</div>
                                        <?php } ?>
