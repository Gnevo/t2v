<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:51:21
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/forms/form_5.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20429457246035f7697be801-68134767%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d5df902971418e670e5fea7e31cea1474c00224' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/forms/form_5.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20429457246035f7697be801-68134767',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f769a8ec57_33619330',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f769a8ec57_33619330')) {function content_6035f769a8ec57_33619330($_smarty_tpl) {?><!DOCTYPE html>
                ...
                <div class="panel panel-default span12 no-ml" style="margin: 5px 0px 0px ! important;">
                    <div class="panel-heading" style="">
                        <h4 class="panel-title no-mb clearfix" style="border-radius: 0px;">
                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['form_5'];?>
...
form_5.php"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['translate']->value['reset'];?>
</span></a></li>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            ...
                                            <td><input type="text" class="datepicker" name="deviation_date" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['deviation_date'];?>
" /></td>
                                            <td>(klockslag)</td>
                                            <td>
                                                <div class="input-group bootstrap-timepicker timepicker">
                                                    <input type="text" class="form-control" name="deviation_time" id="deviation_time" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['deviation_time'];?>
" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group bootstrap-timepicker timepicker">
                                                    <input type="text" name="error_from" id="error_from" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['error_from'];?>
" />
                                                </div>
                                            </td>
                                            <td>(till)</td>
                                            <td>
                                                <div class="input-group bootstrap-timepicker timepicker">
                                                    <input type="text" name="error_to" id="error_to" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['error_to'];?>
" />
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="3"><input type="text" class="span12" name="where_did_deviation" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['where_did_deviation'];?>
" /></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            ...
                                            <td colspan="5"><input type="text" class="span12" name="username" value="<?php if ($_smarty_tpl->tpl_vars['review_data']->value['customer']){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['customer_name'];?>
...
<?php }?><?php }?>" /></td>
                                        ...
                                        <tr>
                                            <td>Personnummer:</td>
                                            <td colspan="2"><?php if ($_smarty_tpl->tpl_vars['review_data']->value['social_security']){?> <?php echo substr_replace($_smarty_tpl->tpl_vars['review_data']->value['social_security'],"-",6,0);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['customers']->value[$_smarty_tpl->tpl_vars['customerid']->value]['century'];?>
 <?php echo substr_replace($_smarty_tpl->tpl_vars['customers']->value[$_smarty_tpl->tpl_vars['customerid']->value]['social_security'],"-",6,0);?>
<?php }?></td>
                                            <td>Huvuddiagnos:</td>
                                            <td colspan="2"><input type="text" name="main_diagnosis" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['main_diagnosis'];?>
" /></td>
                                        </tr>
                                        <tr>
                                            <td>Anhörig underrättad</td>
                                            <td>
                                                <input type="radio" name="relatives_informed" id="relatives_informed" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['relatives_informed']==1){?>checked="true"<?php }?>/>Ja
                                            </td>
                                            <td>
                                                <input type="radio" name="relatives_informed" id="relatives_informed" value="0" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['relatives_informed']!=1&&$_smarty_tpl->tpl_vars['review_data']->value['relatives_informed']!=''){?>checked="true"<?php }?>/>Nej
                                            </td>
                                            <td>God man underrättad</td>
                                            <td>
                                                <input type="radio" name="good_man_informed" id="good_man_informed" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['good_man_informed']==1){?>checked="true"<?php }?>/>Ja
                                            </td>
                                            <td>
                                                <input type="radio" name="good_man_informed" id="good_man_informed" value="0" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['good_man_informed']!=1&&$_smarty_tpl->tpl_vars['review_data']->value['good_man_informed']!=''){?>checked="true"<?php }?>/>Nej
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="type_fall" id="type_fall" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['type_fall']==1){?>checked="true"<?php }?>/> Fall (fyll i sidan för fallavvikelse)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="type_hot_vald" id="type_hot_vald" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['type_hot_vald']==1){?>checked="true"<?php }?>/> Hot/våld (fyll i sidan för hot/våld)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="type_lakemedel" id="type_lakemedel" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['type_lakemedel']==1){?>checked="true"<?php }?>/> Läkemedel (fyll i sidan för läkemedelsfel)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="type_mtp" id="type_mtp" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['type_mtp']==1){?>checked="true"<?php }?>/> MTP (tekniska hjälpmedel) (fyll i delen för MTP avvikelse)</td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="type_utebliven_felaktig" id="type_utebliven_felaktig" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['type_utebliven_felaktig']==1){?>checked="true"<?php }?>/> Utebliven/felaktig LSS insats (fyll i delen för utebliven/felaktig LSS insats)</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <td><textarea name="vad_hande_och_varfor_hande_det" id="vad_hande_och_varfor_hande_det" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['vad_hande_och_varfor_hande_det'];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <td><textarea name="vad_har_du_ni_gjort_for_att_det_inte_ska_ske_igen" id="vad_har_du_ni_gjort_for_att_det_inte_ska_ske_igen" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['vad_har_du_ni_gjort_for_att_det_inte_ska_ske_igen'];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <td><textarea name="vad_blev_resultatet_av_ovanstaende_atgarder" id="vad_blev_resultatet_av_ovanstaende_atgarder" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['vad_blev_resultatet_av_ovanstaende_atgarder'];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
...
?>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                            <tr><td colspan="2"><?php echo utf8_encode($_smarty_tpl->tpl_vars['group']->value['name']);?>
</td></tr>
                                            <tr>
                                                <?php $_smarty_tpl->tpl_vars["cols"] = new Smarty_variable(1, null, 0);?>
...
?>
                                                                ...
                                                                <tr>
                                                                    <td width="5%"><input type="radio" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" id="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['opt_val']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]==$_smarty_tpl->tpl_vars['opt_val']->value){?>checked="true"<?php }?> /></td>
                                                                    <td>
                                                                        <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                                            <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['option_id']->value;?>
" class="labelopt editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['option']->value;?>
</a>
                                                                        <?php }else{ ?>
                                                            ...
                                                            <?php } ?>
                                                            <?php if ($_smarty_tpl->tpl_vars['field']->value['other']){?>
                                                                <?php $_smarty_tpl->tpl_vars['opt_val'] = new Smarty_variable($_smarty_tpl->tpl_vars['opt_val']->value+1, null, 0);?>
                                                                <tr>
                                                                    <td><input type="radio" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" id="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['opt_val']->value;?>
" <?php if (!is_numeric($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']])&&$_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']]!=''){?>checked="true"<?php }?>/></td>
                                                                    <td>Annat <input type="text" name="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
_other" id="field_<?php echo $_smarty_tpl->tpl_vars['field']->value['id'];?>
_other" value="<?php if (!is_numeric($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']])){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['field']->value['id']];?>
<?php }?>" /></td>
                                                                </tr>
                                                            <?php }?>
                                                        </table>
                                                    </td>
                                                    <?php $_smarty_tpl->tpl_vars['cols'] = new Smarty_variable($_smarty_tpl->tpl_vars['cols']->value+1, null, 0);?>
                                                    <?php if ($_smarty_tpl->tpl_vars['cols']->value%2){?>
                                                        </tr><tr>
                                                    <?php }?>
                                                <?php } ?>
                                            </tr>
...
form_5.php?customer=' + customer_id;
            }
        });
...
function selectReview(){
    ...
    document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_5.php?review=' + reviewid +'&customer=' + customer;
}
...
function addNew() {
    ...
    if(customerid != "" && customerid != 0){
        document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_5.php?customer=' + customerid;
    }
}
</script>
