<?php /* Smarty version Smarty-3.1.8, created on 2020-12-11 21:40:59
         compiled from "/home/time2view/public_html/cirrus/templates/forms/form_6.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4190264725fd3e76bd56d79-24342281%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83979baef3c239c1d51aeadb555fc6a93f36bec5' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/forms/form_6.tpl',
      1 => 1539176060,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '4190264725fd3e76bd56d79-24342281',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd3e76c19e560_43452756',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd3e76c19e560_43452756')) {function content_5fd3e76c19e560_43452756($_smarty_tpl) {?><!DOCTYPE html>
...
<link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/plugins/forms/bootstrap-timepicker/css/bootstrap-timepicker.css" />
<link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
                ...
                <div class="panel panel-default span12 no-ml" style="margin: 5px 0px 0px ! important;">
                    <div class="panel-heading" style="">
                        <h4 class="panel-title no-mb clearfix" style="border-radius: 0px;">
                            <?php echo $_smarty_tpl->tpl_vars['translate']->value['form_6'];?>
...
form_6.php"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['translate']->value['reset'];?>
</span></a></li>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            ...
                                            <td><input type="text" name="avsandarens_diarienummer" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['avsandarens_diarienummer'];?>
" /></td>
                                            <td>
                                                <input type="checkbox" name="ett_allvarligt_missforhallande" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['ett_allvarligt_missforhallande']){?>checked="true"<?php }?> />
                                                ett allvarligt missförhållande<br/>
                                                <input type="checkbox" name="en_pataglig_risk_for_ett_allvarligt_missforhallande" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['en_pataglig_risk_for_ett_allvarligt_missforhallande']){?>checked="true"<?php }?> />
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="field_1" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[1]['id']]){?>checked="true"<?php }?> /> 
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[2]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[2]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[2]['name'];?>

                                                <?php }?>
                                            </td>
                                            <td><input type="text" class="span12" name="field_2" value="<?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[2]['id']]){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[2]['id']];?>
...
<?php }?><?php }?>" /></td>
                                            <td>I</td>
                                            <td><input type="text" class="span12" name="field_3" value="<?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[3]['id']]){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[3]['id']];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['customers']->value[$_smarty_tpl->tpl_vars['customerid']->value]['city'];?>
<?php }?>" /></td>
                                            <td>
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[3]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[3]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[3]['name'];?>

                                                <?php }?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><input type="checkbox" name="field_4" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[4]['id']]){?>checked="true"<?php }?> /> 
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[5]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[5]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[5]['name'];?>

                                                <?php }?>
                                            </td>
                                            <td colspan="3"><input type="text" class="span12" name="field_5" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[5]['id']];?>
" /></td>
                                            <td>(namnet på t.ex. bolaget, stiftelsen)</td>
                                        </tr>
                                        <tr>
                                            <td colspan="5"><input type="checkbox" name="field_6" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[6]['id']]){?>checked="true"<?php }?> /> 
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[6]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[6]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[6]['name'];?>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['i']->step = 1;$_smarty_tpl->tpl_vars['i']->total = (int)ceil(($_smarty_tpl->tpl_vars['i']->step > 0 ? 14+1 - (7) : 7-(14)+1)/abs($_smarty_tpl->tpl_vars['i']->step));
...
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                                                <td width="50%">
                                                    <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                        <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[$_smarty_tpl->tpl_vars['i']->value]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[$_smarty_tpl->tpl_vars['i']->value]['name'];?>
</a>
                                                    <?php }else{ ?>
                                                        <?php echo $_smarty_tpl->tpl_vars['fields']->value[$_smarty_tpl->tpl_vars['i']->value]['name'];?>

                                                    <?php }?>
                                                    <br/>
                                                    <input type="text" class="span12" name="field_<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[$_smarty_tpl->tpl_vars['i']->value]['id']];?>
" />
                                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        ...
                                        <tr>
                                            <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;$_smarty_tpl->tpl_vars['i']->step = 1;$_smarty_tpl->tpl_vars['i']->total = (int)ceil(($_smarty_tpl->tpl_vars['i']->step > 0 ? 21+1 - (15) : 15-(21)+1)/abs($_smarty_tpl->tpl_vars['i']->step));
if ($_smarty_tpl->tpl_vars['i']->total > 0){
for ($_smarty_tpl->tpl_vars['i']->value = 15, $_smarty_tpl->tpl_vars['i']->iteration = 1;$_smarty_tpl->tpl_vars['i']->iteration <= $_smarty_tpl->tpl_vars['i']->total;$_smarty_tpl->tpl_vars['i']->value += $_smarty_tpl->tpl_vars['i']->step, $_smarty_tpl->tpl_vars['i']->iteration++){
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration == 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration == $_smarty_tpl->tpl_vars['i']->total;?>
                                                <td width="50%">
                                                    <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                        <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[$_smarty_tpl->tpl_vars['i']->value]['id'];?>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td>
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[22]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[22]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[22]['name'];?>

                                                <?php }?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><textarea name="field_22" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[22]['id']];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="field_23" value="1" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[23]['id']]){?>checked="true"<?php }?> /> 
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[23]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[23]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[23]['name'];?>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td colspan="2">
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['name'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['fields']->value[24]['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['option']->key => $_smarty_tpl->tpl_vars['option']->value){
$_smarty_tpl->tpl_vars['option']->_loop = true;
 $_smarty_tpl->tpl_vars['option_id']->value = $_smarty_tpl->tpl_vars['option']->key;
?>
                                            <?php $_smarty_tpl->tpl_vars["opt_val"] = new Smarty_variable($_smarty_tpl->tpl_vars['option_id']->value+1, null, 0);?>
                                            <tr>
                                                <td width="5%"><input type="radio" name="field_<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['opt_val']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[24]['id']]==$_smarty_tpl->tpl_vars['opt_val']->value){?>checked="true"<?php }?> /></td>
                                                <td>
                                                    <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                        <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
" data-name="<?php echo $_smarty_tpl->tpl_vars['option_id']->value;?>
" class="labelopt editable editable-click" style="display: inline;"><?php echo mb_convert_encoding($_smarty_tpl->tpl_vars['option']->value, 'UTF-8', 'HTML-ENTITIES');?>
</a>
                                                    <?php }else{ ?>
                                                        <?php echo mb_convert_encoding($_smarty_tpl->tpl_vars['option']->value, 'UTF-8', 'HTML-ENTITIES');?>

                                                    <?php }?>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        <?php if ($_smarty_tpl->tpl_vars['fields']->value[24]['other']){?>
                                            <?php $_smarty_tpl->tpl_vars['opt_val'] = new Smarty_variable($_smarty_tpl->tpl_vars['opt_val']->value+1, null, 0);?>
                                            <tr>
                                                <td><input type="radio" name="field_<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
" id="field_<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['opt_val']->value;?>
" <?php if (!is_numeric($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[24]['id']])&&$_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[24]['id']]!=''){?>checked="true"<?php }?>/></td>
                                                <td>Övrigt <input type="text" name="field_<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
_other" id="field_<?php echo $_smarty_tpl->tpl_vars['fields']->value[24]['id'];?>
_other" value="<?php if (!is_numeric($_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[24]['id']])){?><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[24]['id']];?>
<?php }?>" /></td>
                                            </tr>
                                        <?php }?>
                                    </table>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td>
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[25]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[25]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[25]['name'];?>

                                                <?php }?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><textarea name="field_25" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[25]['id']];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td>
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[26]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[26]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[26]['name'];?>

                                                <?php }?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><textarea name="field_26" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[26]['id']];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td>
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td>
                                                <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6){?>
                                                    <a href="#" data-type="text" data-pk="<?php echo $_smarty_tpl->tpl_vars['fields']->value[27]['id'];?>
" class="labelval editable editable-click" style="display: inline;"><?php echo $_smarty_tpl->tpl_vars['fields']->value[27]['name'];?>
</a>
                                                <?php }else{ ?>
                                                    <?php echo $_smarty_tpl->tpl_vars['fields']->value[26]['name'];?>
                                        ...
                                        <tr>
                                            <td><textarea name="field_27" class="span12"><?php echo $_smarty_tpl->tpl_vars['review_data']->value['answers'][$_smarty_tpl->tpl_vars['fields']->value[27]['id']];?>
</textarea></td>
                                        </tr>
                                    </table>
                                </td>
...
<script src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/plugins/forms/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
<script>
...
form_6.php?customer=' + customer_id;
            }
        });
...
function selectReview(){
    ...
    document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_6.php?review=' + reviewid +'&customer=' + customer;
}
...
function addNew() {
    ...
    if(customerid != "" && customerid != 0){
        document.location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
form_6.php?customer=' + customerid;
    }
}
</script>
