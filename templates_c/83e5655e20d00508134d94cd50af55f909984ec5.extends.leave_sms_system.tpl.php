<?php /* Smarty version Smarty-3.1.8, created on 2021-03-17 12:56:20
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/leave_sms_system.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3490208276051fc74337446-55892470%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83e5655e20d00508134d94cd50af55f909984ec5' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/leave_sms_system.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3490208276051fc74337446-55892470',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6051fc745acf75_51938837',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6051fc745acf75_51938837')) {function content_6051fc745acf75_51938837($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
...
css/message-center.css" media="all" />
    <style type="text/css">
        .scroll-pane,
        .scroll-pane-arrows
        {
            ...
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div style="" class="widget-header span12">
                    <div class="span4 day-slot-wrpr-header-left span6">
                        <h1 style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_leave'];?>
</h1>
                    </div>
                    <div class="pull-right day-slot-wrpr-header-left span8" style="padding: 5px;">
                        <button style="" class="btn btn-default btn-normal span2 pull-right" type="button" onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
message/center/';"><?php echo $_smarty_tpl->tpl_vars['translate']->value['back'];?>
</button>
                    </div>
                </div>
            </div>
                ...
                <div class="widget" style="margin-top:0;">
                    ...
                    <div class="span12 widget-body-section input-group">
                        ...
                        <div class="span2 sms-month" style="margin: 0px;">
                            <label style="float: left;" class="span12" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['month'];?>
:</label>
...
:</label>
                        ...
                        <button class="btn btn-default btn-margin-set" style="margin-top: 15px; text-align: center;" type="submit" name="add" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
                    ...
                    <div class="span3 slotsms">
                        <div style="margin: 0px ! important;" class="widget">
                            <div class="widget-header span12">
                                <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['workers_on_leave'];?>
</h1>
                            </div>
                        ...
                        <div style="" class="span12 widget-body-section input-group sms-widget-body-height-fixed">
                            ...
                            <?php  $_smarty_tpl->tpl_vars['leave_detail'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['leave_detail']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['leave_details']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['leave_detail']->key => $_smarty_tpl->tpl_vars['leave_detail']->value){
$_smarty_tpl->tpl_vars['leave_detail']->_loop = true;
?>
                            <div class="row-fluid sms_slot_bt" id="sms_slot_btn<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
" onclick="loadLeaveSlots('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_leave_sms.php?start_date=<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['start_date'];?>
&end_date=<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['end_date'];?>
&employee=<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['employee'];?>
&time_from=<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_from'];?>
&time_to=<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_to'];?>
&action=slots','<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['process_status'];?>
')">
                                <div class="span12">
                                    <ul class="workers-on-leave-list-wrpr <?php if ($_smarty_tpl->tpl_vars['leave_detail']->value['process_status']==0){?>sms-slot-completed<?php }else{ ?>sms-slot-selected<?php }?>">
                                        <li>
                                            <strong>
                                            <?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['empname_ff'];?>
<?php }elseif($_smarty_tpl->tpl_vars['sort_by_name']->value==2){?><?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['empname'];?>
<?php }?>
                                            </strong>
                                        </li>
                                        <li>
                                            <?php if ($_smarty_tpl->tpl_vars['leave_detail']->value['start_date']==$_smarty_tpl->tpl_vars['leave_detail']->value['end_date']){?>
                                                <?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['start_date'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_from'];?>
 - <?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_to'];?>

                                            <?php }else{ ?>
                                                <?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['start_date'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_from'];?>
 - <?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['end_date'];?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['leave_detail']->value['time_to'];?>

                                            <?php }?>    
                                        </li>
                                        <li>
                                            <?php if ($_smarty_tpl->tpl_vars['leave_detail']->value['type']==1){?>Sjuk
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==2){?>Sem
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==3){?>VAB
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==4){?>FP
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==5){?>möte
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==6){?>Utbild
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==7){?>Övrigt
                                            <?php }elseif($_smarty_tpl->tpl_vars['leave_detail']->value['type']==8){?>Byte
                                            <?php }?>
                                        </li>
                                    </ul>
                                </div>
...
downloads/'+filename+'&embedded=true');
    ...
    <script>
        ...
        function loadLeaveSlots(url, id, status) {
            ...
            if (status == 1) {
                var n = <?php echo count($_smarty_tpl->tpl_vars['leave_details']->value);?>
;
                for (i = 0; i < n; i++) {
        ...
        function deleteSlots(url) {
            if (confirm('<?php echo $_smarty_tpl->tpl_vars['translate']->value['confirm_delete_slot'];?>
')) {
                wrapLoader(".add_contract_main_2");
                $('#leave_slots').load(url, function(response, status, xhr) {
                    uwrapLoader(".add_contract_main_2");
