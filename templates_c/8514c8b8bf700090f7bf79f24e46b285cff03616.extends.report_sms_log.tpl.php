<?php /* Smarty version Smarty-3.1.8, created on 2020-12-05 19:23:57
         compiled from "/home/time2view/public_html/cirrus/templates/report_sms_log.tpl" */ ?>
<?php /*%%SmartyHeaderCode:164644105fcbde4d616a61-43538985%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8514c8b8bf700090f7bf79f24e46b285cff03616' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/report_sms_log.tpl',
      1 => 1493375554,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '164644105fcbde4d616a61-43538985',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcbde4d857589_77793566',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcbde4d857589_77793566')) {function content_5fcbde4d857589_77793566($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
        ...
        <div class="span12 main-left">
            <div style="margin: 15px 0px 0px;" class="widget-header span12">
                <div class="span4 day-slot-wrpr-header-left span6">
                    <h1 style="margin: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_log_report'];?>
</h1>
                </div>
                ...
                <div class="span12 widget-body-section input-group" >
                    <div class="widget-body" style="padding:5px;">
                        <div class="row-fluid" style="margin-bottom:15px;">
                            <div class="span12 widget-body-section input-group">
                                <form name="sms_log_form" id="sms_log_form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
report/log/sms/">
...
:</label>
                                        <div style="margin: 0px; float:left" class="input-prepend date hasDatepicker span10"> <span class="add-on icon icon-calendar"></span>
                                            <select class="form-control span12" style="margin: 0px;" name=cmb_year id=cmb_year>
                                                ...
                                                <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['year_option_values']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_year']->value,'output'=>$_smarty_tpl->tpl_vars['year_option_values']->value),$_smarty_tpl);?>
                                    ...
                                    <div class="span2">
                                        <label class="span12" style="float: left;" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['month'];?>
:</label>
                                        <div style="margin: 0px; float:left;" class="input-prepend date hasDatepicker span10"> <span class="add-on icon icon-calendar"></span>
                                            <select style="margin: 0px;" class="form-control span10" name=cmb_month id=cmb_month>
                                                ...
                                                <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['month_option_values']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_month']->value,'output'=>$_smarty_tpl->tpl_vars['month_option_output_full']->value),$_smarty_tpl);?>

                                            </select>
                                        </div>
                                    </div>
                                    <div class="span2">
                                        <label class="span12" style="float: left;" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_type'];?>
:</label>
                                        <div style="margin: 0px; float:left;" class="input-prepend span10"> <span class="add-on icon icon-search"></span>
                                            <select style="margin: 0px;" class="form-control span10" name=cmb_type id=cmb_type>
                                                <option value="1" <?php if ($_smarty_tpl->tpl_vars['selected_type']->value==1){?>selected="selected"<?php }?> ><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_incoming'];?>
</option>
                                                <option value="2" <?php if ($_smarty_tpl->tpl_vars['selected_type']->value==2){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_outgoing'];?>
</option>
                                            </select>
                                        </div>
                                    </div>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 58%;">
                                                                        <div class="billing-logo">
                                                                            <img style="" class="media-object pull-left thumb billing-logo" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/t2v_billing_logo.png" alt="t2v">
                                                ...
                                                <div style="margin: 0px 0px 20px;" class="row-fluid">
                                                    <div class="span12">
                                                        <center>
                                                            <h1><strong><?php echo $_smarty_tpl->tpl_vars['company_name']->value;?>
<br><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_log_report'];?>
</strong></h1>
                                                        </center>            
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="width:10%; padding-left: 15px;">
                                                                                <ol class="bill-list">
                                                                                    <li><div class="bill-col mt"><?php echo $_smarty_tpl->tpl_vars['translate']->value['total_sms_count'];?>
 : <span><?php echo $_smarty_tpl->tpl_vars['log_sms_count']->value;?>
</span></div></li>
                                                                                </ol>
                                                                            </td>
                                                                        </tr>
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span12">
                                                        <?php if ($_smarty_tpl->tpl_vars['selected_type']->value==1){?>
                                                            <table class="table table-bordered table-primary table-striped table-vertical-center">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['serial_no'];?>
</th>
                                                                        <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['date'];?>
</th>
                                                                        ...
                                                                        <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['sms_message'];?>
</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable(0, null, 0);?>
                                                                    <?php  $_smarty_tpl->tpl_vars['sms'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['sms']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['log_result']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sms']->key => $_smarty_tpl->tpl_vars['sms']->value){
$_smarty_tpl->tpl_vars['sms']->_loop = true;
?>
                                                                        <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->tpl_vars['i']->value+1, null, 0);?>
                                                                        <tr>
                                                                            <td><?php echo $_smarty_tpl->tpl_vars['i']->value;?>
</td>
                                                                            <td><?php echo $_smarty_tpl->tpl_vars['sms']->value['date'];?>
</td>
                                                                            <td><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['sms']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['sms']->value['last_name'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['sms']->value['last_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['sms']->value['first_name'];?>
<?php }?></td>
                                                                            <td><?php echo $_smarty_tpl->tpl_vars['sms']->value['mobile'];?>
</td>
                                                                            <td style="white-space: pre-wrap; width: 40%;"><?php echo $_smarty_tpl->tpl_vars['sms']->value['message'];?>
</td>
                                                                        </tr>
                                                                    <?php }
if (!$_smarty_tpl->tpl_vars['sms']->_loop) {
?>
                                                        ...
                                                        <?php }elseif($_smarty_tpl->tpl_vars['selected_type']->value==2){?>
                                                            <table class="table table-bordered table-primary table-striped table-vertical-center">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="header"><?php echo $_smarty_tpl->tpl_vars['translate']->value['serial_no'];?>
...
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['sms']->value['last_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['sms']->value['first_name'];?>
<?php }?></td>
                                                                            <td><?php echo $_smarty_tpl->tpl_vars['sms']->value['to_no'];?>
</td>
                                                                            <td style="white-space: pre-wrap; width: 50%;"><?php echo $_smarty_tpl->tpl_vars['sms']->value['message'];?>
</td>
                                                                        </tr>
                                                                    <?php }
if (!$_smarty_tpl->tpl_vars['sms']->_loop) {
