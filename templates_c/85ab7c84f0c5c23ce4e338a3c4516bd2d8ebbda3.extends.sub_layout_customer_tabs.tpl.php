<?php /* Smarty version Smarty-3.1.8, created on 2020-12-14 14:00:33
         compiled from "/home/time2view/public_html/cirrus/templates/layouts/sub_layout_customer_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7163422585fd77001546410-53368070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85ab7c84f0c5c23ce4e338a3c4516bd2d8ebbda3' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/layouts/sub_layout_customer_tabs.tpl',
      1 => 1536921822,
      2 => 'file',
    ),
    '1880708975026eaab91b7485c22e77e18c248d8f' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/customer_privilege.tpl',
      1 => 1539777116,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7163422585fd77001546410-53368070',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd770019fee47_00811148',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd770019fee47_00811148')) {function content_5fd770019fee47_00811148($_smarty_tpl) {?><!DOCTYPE html>
...
<div id="dialog-confirm-emp" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['confirm'];?>
" style="display:none;">
	<br><p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_employee'];?>
</p>
</div>
<div id="dialog-confirm_change" title="" style="display:none;">
    <br><p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['different_privileges'];?>
</p>
</div>
<div id="dialog-cantsave" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['confirm'];?>
" style="display:none;">
	<br><p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_employee'];?>
</p>
</div>
                                 ...
                                 <div class="span4 day-slot-wrpr-header-left span3">
                                        <div style="margin: 8px 0px 0px ! important;" class="input-prepend span2 pull-right"> <span class="add-on icon-pencil"></span>
                                            <select class="" name="pre_role" id="pre_role" onchange="selectEmployee()">
                                                <option value="3" <?php if ($_smarty_tpl->tpl_vars['role']->value==3){?>selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</option>
                                                <option value="2" <?php if ($_smarty_tpl->tpl_vars['role']->value==2){?>selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['tl'];?>
</option>
                                                <option value="7" <?php if ($_smarty_tpl->tpl_vars['role']->value==7){?>selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['super_tl'];?>
</option>
                                            </select>
                                        </div>

                                        <form style="margin: 0px !important">
                                            <input type="hidden" name="selected_emp" id="selected_emp" value="<?php echo $_smarty_tpl->tpl_vars['selected_emp']->value;?>
" />
                                            <input type="hidden" name="role_privilage" id="role_privilage" value="<?php echo $_smarty_tpl->tpl_vars['pre_role']->value;?>
" />
                                ...
                                <div class="pull-right day-slot-wrpr-header-left span5" style="padding: 0px 5px;">
                                    <button class="btn btn-default btn-normal pull-right" type="button" onclick="setPrivilege()"><span class="icon-wrench" style="color:#000;"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['set_privilege'];?>
</button>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['employee']->value!=''){?>
                            <li class="widget-stats-emplyee-green widget-stats-2 employees"><?php echo $_smarty_tpl->tpl_vars['employee']->value['last_name'];?>
...
';
    if(tabs == 1){
        ...
        $("#privilege_selected_employee").load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?empl="+selected+"&cust=<?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['username'];?>
'");
    });
...
ajax_privilege_report.php?selected="+selected_emp+"&role="+role);
...
ajax_privilege_forms.php",
        ...
        success:function(data){
         ...
         //$("#tabDetails").load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_forms.php?selected="+selected_emp+"&role="+role);
    }else if(made_change == 1){
        $( "#dialog-confirm" ).dialog({
            resizable: false,
            height:140,
...
ajax_privilege_general.php",
        ...
        success:function(data){
         ...
         //$("#tabDetails").load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_general.php?selected="+selected_emp+"&role="+role);
    }else if(made_change == 1){
        $( "#dialog-confirm" ).dialog({
            resizable: false,
            height:140,
...
ajax_privilege_mc.php",
        ...
        success:function(data){
         ...
         //$("#tabDetails").load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_mc.php?selected="+selected_emp+"&role="+role);
    }else if(made_change == 1){
        $( "#dialog-confirm" ).dialog({
            resizable: false,
            height:140,
...
ajax_privileges.php",
        ...
        // $("#tabDetails").load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privileges.php?selected="+selected_emp+"&role="+role);
    }else if(made_change == 1){
        $( "#dialog-confirm" ).dialog({
            resizable: false,
            height:140,
...
';
    ...
    $.ajax({
        url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php",
        type:"GET",
