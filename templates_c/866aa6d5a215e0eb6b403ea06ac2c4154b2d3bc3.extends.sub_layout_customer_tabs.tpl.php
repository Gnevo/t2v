<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 07:03:57
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/layouts/sub_layout_customer_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12075938986035fa5deec1d3-98137966%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '866aa6d5a215e0eb6b403ea06ac2c4154b2d3bc3' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/layouts/sub_layout_customer_tabs.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
    '115fafb18eed55dcb6d36449a248e8a07177d16a' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_locations.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12075938986035fa5deec1d3-98137966',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035fa5e2d0467_77054876',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035fa5e2d0467_77054876')) {function content_6035fa5e2d0467_77054876($_smarty_tpl) {?><!DOCTYPE html>
...
customer/locations/%%C-UNAME%%/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location'];?>
                        ...
                        <div class="widget-header widget-header-options tab-option">
                            <div class="span4 day-slot-wrpr-header-left span3">
                                <h1 style=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location'];?>
</h1>
                            </div>
                                            ...
                                            <table id="inconv_table" class="table table-white table-bordered table-hover table-responsive table-primary table-Anställda" style="margin: 0px; top: 0px;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 100px;"><?php echo utf8_encode($_smarty_tpl->tpl_vars['translate']->value['location_name']);?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location_lat'];?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location_lon'];?>
</th>
                                                        <th style="width:124px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['is_default'];?>
</th>
 ...
 $_from = $_smarty_tpl->tpl_vars['map_locations']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['list']->key => $_smarty_tpl->tpl_vars['list']->value){
$_smarty_tpl->tpl_vars['list']->_loop = true;
?>
                                                    <?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->tpl_vars['i']->value+1, null, 0);?>
                                                    <tbody>
                                                        <tr class="gradeX this-row" data-index="<?php echo $_smarty_tpl->tpl_vars['i']->value-1;?>
">
                                                            <td style="width: 20px;" class="center"><?php echo $_smarty_tpl->tpl_vars['i']->value;?>
</td>
                                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
</td>
                                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['list']->value['lat'];?>
</td>
                                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['list']->value['lon'];?>
</td>
                                                            <td class="text-left"><?php if ($_smarty_tpl->tpl_vars['list']->value['is_default']){?><?php echo $_smarty_tpl->tpl_vars['translate']->value['yes'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['translate']->value['no'];?>
<?php }?></td>
...
" onclick="warning_delete_location(<?php echo $_smarty_tpl->tpl_vars['i']->value-1;?>
...
</strong>:  <?php echo $_smarty_tpl->tpl_vars['translate']->value['no_location_found'];?>
            ...
            <div class="span12 oncall-box" style="margin-left: 0px; display: block;">
                <div style="margin: 0px ! important;" class="widget">
                    <div class="widget-header span12">
                        <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location'];?>
</h1>
                        ...
                        <div class="row-fluid" id="edit_form_section">
                            <div class="span12 form-left" style="padding: 0px; margin: 0px;">
                                <div style="margin: 6px 0px 0px ! important;" class="span8">
                                    <label style="float: left;" class="span12" for="location_title"><?php echo $_smarty_tpl->tpl_vars['translate']->value['name'];?>
</label>
                                    <div style="margin: 0px;" class="input-prepend  span12">
                                        <span class="add-on icon-pencil"></span>
                                        <input name="location_title" id="location_title" type="text" class="form-control span11" value="<?php echo $_smarty_tpl->tpl_vars['timing']->value['sal_call_training'];?>
" />
                                    </div>
                                </div>
                                <div style="margin: 25px 0px 0px ! important;" class="span4">
                                    <div class="pull-right">
                                        ...
                                        <label for="is_default_location"><?php echo $_smarty_tpl->tpl_vars['translate']->value['is_default'];?>
</label>
                                    </div>
                                </div>
                                <div style="margin: 10px 0px 0px ! important;" class="span12 hide">
                                    <label style="float: left;" class="span12" for="location_search"><?php echo $_smarty_tpl->tpl_vars['translate']->value['location'];?>
</label>
                                    <div style="margin: 0px;" class="input-prepend span12">
                                ...
                                <div style="margin: 6px 0px 0px ! important;" class="span6">
                                    <label style="float: left;" class="span12" for="location_lat"><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location_lat'];?>
</label>
                                    <div style="margin: 0px;" class="input-prepend span12" >
                                        <span class="add-on icon-map-marker"></span>
                                        <input name="location_lat" class="form-control span11" id="location_lat" type="text" value="<?php echo $_smarty_tpl->tpl_vars['timing']->value['sal_complementary_oncall'];?>
" />
                                    </div>
                                </div>
                                <div style="margin: 6px 0px 0px ! important;" class="span6">
                                    <label style="float: left;" class="span12" for="location_lon"><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location_lon'];?>
</label>
                                    <div style="margin: 0px;" class="input-prepend span12">
                                        <span class="add-on icon-map-marker"></span>
                                        <input name="location_lon" id="location_lon" type="text"  class="form-control span11" value="<?php echo $_smarty_tpl->tpl_vars['timing']->value['sal_more_oncall'];?>
" />
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    var map_locations_stored = <?php echo $_smarty_tpl->tpl_vars['map_locations_json']->value;?>
;
    $(document).ready(function() {
        ...
        $(".btn-addnew-inconvtiming").click(function() {  
            ...
            $("#location_title").val('');
            $("#location_lat").val('<?php echo $_smarty_tpl->tpl_vars['STATIC_MAP_LOCATION_LAT']->value;?>
');
            $("#location_lon").val('<?php echo $_smarty_tpl->tpl_vars['STATIC_MAP_LOCATION_LON']->value;?>
').trigger('input');
...
customer/locations/"+username+"/"+index+"/delete/";
        }
    }
    var change = 0;
    var confirm_ask = 0;
...
<script>
    function addMapPicker() {
        var mapCenter = [<?php echo $_smarty_tpl->tpl_vars['STATIC_MAP_LOCATION_LAT']->value;?>
, <?php echo $_smarty_tpl->tpl_vars['STATIC_MAP_LOCATION_LON']->value;?>
];
        ...
        // var bingGeocoder = new L.Control.BingGeocoder('AsaKzgbo2GW8wrcv0mLCyVvEx2Q8V1N54Gpmizw-fzHIKOAjAMMy4TdNfKdS71vs', { text: '<?php echo $_smarty_tpl->tpl_vars['translate']->value['locate'];?>
'});
        ...
        var updateMarker = function(lat, lng) {
            marker
                .setLatLng([lat, lng])
                .bindPopup("<?php echo $_smarty_tpl->tpl_vars['translate']->value['your_location'];?>
