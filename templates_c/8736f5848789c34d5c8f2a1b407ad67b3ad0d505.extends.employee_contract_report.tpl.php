<?php /* Smarty version Smarty-3.1.8, created on 2021-03-01 05:26:46
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_contract_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1635779758603c7b160b91b9-74181145%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8736f5848789c34d5c8f2a1b407ad67b3ad0d505' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_contract_report.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1635779758603c7b160b91b9-74181145',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603c7b1641c981_50460727',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603c7b1641c981_50460727')) {function content_603c7b1641c981_50460727($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_contract_report'];?>
</span>
        <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
                    ...
                    <ul id="pagination"> 
                        <?php if ($_smarty_tpl->tpl_vars['count']->value>1){?>
                            <?php if ($_smarty_tpl->tpl_vars['page']->value>=2&&$_smarty_tpl->tpl_vars['page']->value!=$_smarty_tpl->tpl_vars['count']->value){?>
                                <li><a href="javascript:void(0)" onclick="paginateDisplay('1', '<?php echo $_smarty_tpl->tpl_vars['alph']->value;?>
')"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
', '<?php echo $_smarty_tpl->tpl_vars['alph']->value;?>
')"><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
images/last.png"  /></a></li>
        ...
        <table class="table_list work_report">
            <tbody><tr>
                    <th width="113" height="50"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</th>
                    <th width="10"></th>
                    <?php  $_smarty_tpl->tpl_vars['title_months'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['title_months']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['month_option_output']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                        <th width="55"><?php echo $_smarty_tpl->tpl_vars['title_months']->value;?>
</th> 
                    <?php } ?>
                </tr>
                <?php  $_smarty_tpl->tpl_vars['report'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['report']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['contract_reports']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                    <tr class="even customer_reportbg" style="height: 58px;">
                        <td class="usertdname" rowspan="2"><span class="workreport_name"><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['report']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['report']->value['last_name'];?>
<?php }elseif($_smarty_tpl->tpl_vars['sort_by_name']->value==2){?><?php echo $_smarty_tpl->tpl_vars['report']->value['last_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['report']->value['first_name'];?>
<?php }?></span></td>
                        
                        <td class="usertdname" style="text-align: center;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['normal_report_short'];?>
</td>
                        <?php  $_smarty_tpl->tpl_vars['title_months'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['title_months']->_loop = false;
...
?>
                            <td>
                                <a onclick ="detailReport('<?php echo ($_smarty_tpl->tpl_vars['k']->value+1);?>
', '<?php echo $_smarty_tpl->tpl_vars['report']->value['username'];?>
');" href="javascript:void(0);">
                                    <span class="userlevel_2" style="color: #0090ff; <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp1=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['report']->value['work_hours']['normal'][$_tmp1]==0.00){?> margin-bottom: 12px;<?php }?>"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['report']->value['contract_hours']['normal'][$_tmp2];?>
</span>
                                    <span class="userlevel_2"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp3=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['report']->value['work_hours']['normal'][$_tmp3]!=0.00){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp4=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['report']->value['work_hours']['normal'][$_tmp4];?>
<?php }?></span></a>
                            </td>
                        <?php } ?>
                    </tr>
                    <tr class="odd customer_reportbg odd_bottom_seperator">
                        <td class="usertdname" style="text-align: center;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['oncall_report_short'];?>
</td>
                        <?php  $_smarty_tpl->tpl_vars['title_months'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['title_months']->_loop = false;
 $_smarty_tpl->tpl_vars['k'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['month_option_output']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
');" href="javascript:void(0);">
                                    <span class="userlevel_2" style="color: #0090ff; <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp5=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['report']->value['work_hours']['oncall'][$_tmp5]==0.00){?> margin-bottom: 12px;<?php }?>"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp6=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['report']->value['contract_hours']['oncall'][$_tmp6];?>
</span>
                                    <span class="userlevel_2"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp7=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['report']->value['work_hours']['oncall'][$_tmp7]!=0.00){?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['k']->value+1;?>
<?php $_tmp8=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['report']->value['work_hours']['oncall'][$_tmp8];?>
<?php }?></span></a>
                            </td>
                        <?php } ?>
                    </tr>
...
employee/report/contract/"+year+"/1/"+alph+"/";
}

function getContractLists(){
    var year = $("#cmb_year").val();
    document.location.href = "<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/report/contract/"+year+"/1/";
}

function detailReport(month,user){
    var year = $("#cmb_year").val();
    document.location.href = "<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/report/detail/contract/"+user+"/"+month+"-"+year+"-<?php echo $_smarty_tpl->tpl_vars['page']->value;?>
/";
}
function paginateDisplay(page,alph){
    ...
    if(alph == "" || alph == null){
        document.location.href = "<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/report/contract/"+year+"/"+page+"/";
    }else{
        document.location.href = "<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/report/contract/"+year+"/"+page+"/"+alph+"/";;
    }
}
