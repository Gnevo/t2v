<?php /* Smarty version Smarty-3.1.8, created on 2021-03-22 14:53:32
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/layouts/sub_layout_customer_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20177175460333ca04b0d95-88600364%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '98fdf40bfa596e850863df12276c31ef42bd31c7' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/layouts/sub_layout_customer_tabs.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
    'ef8f1111265b98a3e580847d93517bbdbfed5a02' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_to_employee_3066.tpl',
      1 => 1616420726,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20177175460333ca04b0d95-88600364',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_60333ca08c2966_77063217',
  'variables' => 
  array (
    'app_name' => 0,
    'url_path' => 0,
...
<?php if ($_valid && !is_callable('content_60333ca08c2966_77063217')) {function content_60333ca08c2966_77063217($_smarty_tpl) {?><!DOCTYPE html>
...
customer/locations/%%C-UNAME%%/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value['map_location'];?>
 ...
 - 3066</h1>
                                        ...
                                        <div class="pull-right day-slot-wrpr-header-left span10" style="padding: 5px;">
                                            ...
                                            <label style="margin:10px 10px 0 0"><?php echo $_smarty_tpl->tpl_vars['translate']->value['send_to_fk'];?>
</label>
                                            <div style="float: left; margin: 0 ! important;" class="input-prepend span3"> 
                                                <select class="form-control span11" id="semp_employee" name="semp_employee" multiple="multiple">
                                                    <?php if ((count($_smarty_tpl->tpl_vars['send_to_fk']->value)>0)){?>
                                                    <option value="all"><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                                        <?php  $_smarty_tpl->tpl_vars['te'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['te']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['send_to_fk']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['te']->value['employee']==$_smarty_tpl->tpl_vars['sel_employee']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['te']->value['re_fname'];?>
 <?php echo $_smarty_tpl->tpl_vars['te']->value['re_lname'];?>
</option>
                                                        <?php } ?>
                                                    <?php }else{ ?>
                                                          <option value="">--<?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data_available'];?>
--</option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                            <button class="btn btn-default pull-left" type="button" onclick="send_to_fk()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['send_to_fk'];?>
</button>
                                            <label class="pull-left" style="margin:10px 10px 0 20px"><?php echo $_smarty_tpl->tpl_vars['translate']->value['sent'];?>
(<?php echo count($_smarty_tpl->tpl_vars['allready_send_to_fk']->value);?>
)</label>
                                                                ...
                                                                <div class="span12 widget-body-section input-group">
                                                                    <div class="span12">
                                                                        <div class="span3" style="margin: 0px;">
                                                                            <label class="span12" style="float: left;" for="employee"><?php echo $_smarty_tpl->tpl_vars['translate']->value['all_send_to_fk'];?>
</label>
                                                                            <div style="float: left; margin: 0px ! important;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                                                <select class="form-control span11" id="cmb_employee" name="cmb_employee">
                                                                                    <?php if ((count($_smarty_tpl->tpl_vars['allready_send_to_fk']->value)>0)){?>
                                                                                    <?php  $_smarty_tpl->tpl_vars['te'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['te']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['allready_send_to_fk']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['te']->key => $_smarty_tpl->tpl_vars['te']->value){
$_smarty_tpl->tpl_vars['te']->_loop = true;
?>
                                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['te']->value['employee'];?>
" <?php if ($_smarty_tpl->tpl_vars['te']->value['employee']==$_smarty_tpl->tpl_vars['sel_employee']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['te']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['te']->value['last_name'];?>
</option>
                                                                                    <?php } ?>
                                                                                    <?php }else{ ?>
                                                                                        <option value="">--<?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data_available'];?>
--</option>
                                                                        ...
                                                                        <div class="span4 pull-right" style="margin: 0px;">
                                                                            <label class="span12" style="float: left;" for="employee"><?php echo $_smarty_tpl->tpl_vars['translate']->value['need_to_sign'];?>
</label>
                                                                            <div style="float: left; margin: 0px ! important;" class="input-prepend span8">
                                                                                <select class="form-control span11" id="need_employee" name="need_employee" multiple>
                                                                                    <?php if ((count($_smarty_tpl->tpl_vars['emp_unsigned']->value)>0)){?>
                                                                                    <option value="all"><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                                                                    <?php  $_smarty_tpl->tpl_vars['te'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['te']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['emp_unsigned']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['te']->key => $_smarty_tpl->tpl_vars['te']->value){
$_smarty_tpl->tpl_vars['te']->_loop = true;
?>
                                                                                        <option value="<?php echo $_smarty_tpl->tpl_vars['te']->value['employee'];?>
"><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo (($_smarty_tpl->tpl_vars['te']->value['first_name']).(' ')).($_smarty_tpl->tpl_vars['te']->value['last_name']);?>
...
" type="text" disabled="disabled"/>
                                                                            ...
                                                                            <div class="span2" style="margin: 5px 0 0 0;">
                                                                                <label><?php echo $_smarty_tpl->tpl_vars['translate']->value['signed_emp'];?>
(<?php echo count($_smarty_tpl->tpl_vars['emp_signed']->value);?>
)</label>
                                                                            </div>
                                                                            <?php if ((count($_smarty_tpl->tpl_vars['emp_signed']->value)>0)){?>
                                                                            <div class="span5" style="margin: 5px 0 0 0;">
                                                                                <ul class="signed_emp">
                                                                                <?php  $_smarty_tpl->tpl_vars['te'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['te']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['emp_signed']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['te']->key => $_smarty_tpl->tpl_vars['te']->value){
$_smarty_tpl->tpl_vars['te']->_loop = true;
?>
                                                                                        <li><a href="javascript:void(0)" onclick="sign_remove('<?php echo $_smarty_tpl->tpl_vars['te']->value['employee'];?>
')"><?php echo $_smarty_tpl->tpl_vars['te']->value['re_fname'];?>
 <?php echo $_smarty_tpl->tpl_vars['te']->value['re_lname'];?>
 (X)</a></li>
                                                                                        <?php $_smarty_tpl->tpl_vars["unsign_val"] = new Smarty_variable($_smarty_tpl->tpl_vars['te']->value['employee'], null, 0);?>
                                                                                <?php } ?>
                                                                                </ul>
                                                                            </div>
                                                                            <div class="span1" style="margin: 0px;">
                                                                                <a name="login" id="login" style="width:100%" class="delete" href="javascript:void(0)" onclick="unsign_all('<?php echo $_smarty_tpl->tpl_vars['unsign_val']->value;?>
')" title="Delete"><?php echo $_smarty_tpl->tpl_vars['translate']->value['unsign_all'];?>
</a>
...
" value="<?php if ($_smarty_tpl->tpl_vars['emp_data']->value['saved_data']['changes_applies_from']){?><?php echo $_smarty_tpl->tpl_vars['emp_data']->value['saved_data']['changes_applies_from'];?>
<?php }else{ ?><?php echo date('Y-m-d');?>
<?php }?>" onchange="markchange()" type="text" required/> </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
...
$_smarty_tpl->tpl_vars['emp_data']->_loop = true;
?>
    $('input:radio[name=is_assi_resi_outside_ees_<?php echo $_smarty_tpl->tpl_vars['emp_data']->value['employee'];?>
]').change(function() {
        if (this.value == '1') {
            $("#assi_resi_outside_ees_<?php echo $_smarty_tpl->tpl_vars['emp_data']->value['employee'];?>
").attr('required',true);
            //$("#changes_applies_from_<?php echo $_smarty_tpl->tpl_vars['emp_data']->value['employee'];?>
").attr('required',true);
        }
...
function check(flag){  
            ...
            var customer = "<?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['username'];?>
";
            var security_no = "<?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['social_security'];?>
";
            var customer_name = "<?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['last_name'];?>
"
            var remove=0;
...
ajax_employee_signing_3066.php",
                        data:"emp="+employee+"&customer="+customer+"&security_no="+security_no+"&customer_name="+customer_name+"&consolidated="+'<?php echo $_smarty_tpl->tpl_vars['rpt_consolidated']->value;?>
'+'&bank_id_flag='+flag,
                        type:"POST",
                        success:function(data){
                                console.log(data);
...
"
            ...
            if(customer == ""){
                ...
                $.ajax({
                        async:false,
                        url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_employee_signing_remove_3066.php",
...
";
            ...
            if(count == 0){
                ...
                $.ajax({
                        async:false,
                        url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_employee_send_fk_3066.php",
                        data:"emps="+employee+"&customer="+customer+"&security_no="+security_no+"&customer_name="+customer_name+"&consolidated="+'<?php echo $_smarty_tpl->tpl_vars['rpt_consolidated']->value;?>
'+'&bank_id_flag='+flag,
                        type:"POST",
                        dataType: "json",
                        success:function(data){
