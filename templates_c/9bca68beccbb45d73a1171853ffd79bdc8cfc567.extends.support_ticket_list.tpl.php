<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 07:00:45
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/support_ticket_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11209439246035f99d2eedb3-68981894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9bca68beccbb45d73a1171853ffd79bdc8cfc567' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/support_ticket_list.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11209439246035f99d2eedb3-68981894',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f99d5c8667_54045703',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f99d5c8667_54045703')) {function content_6035f99d5c8667_54045703($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
            ...
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div style="" class="widget-header span12">
                    ...
                    <div class="pull-right day-slot-wrpr-header-left span8" style="padding: 5px;">
                        <button  style="margin: 0px 0px 0px 5px;" onclick="goto_ticket_add()" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new_ticket'];?>
</button>
                        <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?><button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/mails/';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"  title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new_ticket'];?>
"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_mails'];?>
</button><?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1){?><button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/category/list/';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category'];?>
</button><?php }?>
                        <button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
message/center/';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</button>
                    </div>
                </div>
            </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <form name="ticket_form" id="ticket_form" method="post">
                            <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)||$_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6||$_smarty_tpl->tpl_vars['user_role']->value==2||$_smarty_tpl->tpl_vars['user_role']->value==7){?>
                                <div class="widget" style="margin: 0px 0px 15px ! important;">
                                    <div class="span12 widget-body-section input-group">
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="sprt_status"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_status'];?>
:</label>
                                            <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                <select name="sprt_status" id="sprt_status" class="form-control span11">
                                                    <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['all_active'];?>
</option>
                                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_status']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_status']->value),$_smarty_tpl);?>
                                        ...
                                        <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?>
                                            <div class="span1" style="margin: 0px;">
                                                <label style="float: left;" class="span12" for="sprt_priority"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_priority'];?>
:</label>
                                                <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                    <select name="sprt_priority" id="sprt_priority" class="form-control span8">
                                                        ...
                                                        <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_priority']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_priority']->value),$_smarty_tpl);?>
                                        ...
                                        <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?>
                                            <div class="span2" style="margin: 0px;">
                                                <label style="float: left;" class="span12" for="sprt_company"><?php echo $_smarty_tpl->tpl_vars['translate']->value['company'];?>
:</label>
                                                <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                    <select name="sprt_company" id="sprt_company" class="form-control span11">
                                                        <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                                        <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['companies']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_company']->value),$_smarty_tpl);?>

                                                    </select>
                                                </div>
                                            </div>
                                        <?php }elseif($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6||$_smarty_tpl->tpl_vars['user_role']->value==2||$_smarty_tpl->tpl_vars['user_role']->value==7){?>
                                            <div class="span2" style="margin: 0px;">
                                                <label style="float: left;" class="span12" for="sprt_admin_user"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_admin'];?>
:</label>
                                                <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                    <select name="sprt_admin_user" id="sprt_admin_user" class="form-control span11">
                                                        <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                                        <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_admin_users']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_admin_user']->value),$_smarty_tpl);?>
                                        ...
                                        <?php }?>
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="sprt_user"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_created_user'];?>
:</label>
                                            <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                <select name="sprt_user" id="sprt_user" class="form-control span11">
                                                    <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['all'];?>
</option>
                                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['users']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_user']->value),$_smarty_tpl);?>

                                                </select>
                                            </div>
                                        </div>
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="sprt_category_type"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category'];?>
:</label>
                                            <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                                <select name="sprt_category_type" id="sprt_category_type" class="form-control span11">
                                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_category_types']->value,'selected'=>$_smarty_tpl->tpl_vars['selected_category_type']->value),$_smarty_tpl);?>

                                                </select>
                                            </div>
                                        </div>
                                        <div class="span2" style="margin: 0px;">
                                            <label style="float: left;" class="span12" for="sprt_search_key"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_search_key'];?>
:</label>
                                            <div style="margin: 0px;" class="input-prepend span12"> <span class="add-on icon-search"></span>
                                                <input name="sprt_search_key" id="sprt_search_key" value="<?php echo $_smarty_tpl->tpl_vars['selected_search_key']->value;?>
" maxlength="100" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_search_word'];?>
" class="form-control span11" type="text"/> </div>
                                        </div>
                                        <button name="go" id="go" onclick="get_report();" class="btn btn-default span1 btn-margin-set" style="margin-top: 15px; text-align: center;" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
</button>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?>
                                            <div class="span1 pull-right" style="margin: 25px 0px 0px;">
                                                <input name="is_hidden" id="is_hidden" value="1" <?php if ($_smarty_tpl->tpl_vars['selected_hidden']->value==1){?> checked="true"<?php }?> style="margin: 0px 5px ! important;" type="checkbox" /> <?php echo $_smarty_tpl->tpl_vars['translate']->value['hidden'];?>

                                            </div>
                                        <?php }?>
                                        <div class="span2 pull-right" style="margin: 25px 0px 0px;">
                                            <label class="pull-right"><strong><?php echo $_smarty_tpl->tpl_vars['translate']->value['total_records'];?>
: <?php echo $_smarty_tpl->tpl_vars['total_records']->value;?>
</strong></label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-bordered table-condensed table-hover table-responsive table-primary t" style="margin: 0px ! important; top: 0px;">
                            <thead>
                                <tr>
                                    ...
                                    <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?><th><?php echo $_smarty_tpl->tpl_vars['translate']->value['company'];?>
</th><?php }?>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_priority'];?>
</th>
                                    <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||$_smarty_tpl->tpl_vars['user_role']->value==6||in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?><th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_created_user'];?>
</th><?php }?>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category'];?>
</th>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_title'];?>
</th>
                                    <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_status'];?>
</th>
                                    <?php if ($_smarty_tpl->tpl_vars['selected_category_type']->value==1){?>
                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['affected_user'];?>
</th>
                                    <?php }?>
                                    <th style="width:15px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['view'];?>
</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php  $_smarty_tpl->tpl_vars['list'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['list']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['tickets_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['list']->key => $_smarty_tpl->tpl_vars['list']->value){
$_smarty_tpl->tpl_vars['list']->_loop = true;
?>
                                    <?php $_smarty_tpl->tpl_vars['cat_type'] = new Smarty_variable('I', null, 0);?>
                                    <?php if ($_smarty_tpl->tpl_vars['list']->value['category_type']=='External'){?><?php $_smarty_tpl->tpl_vars['cat_type'] = new Smarty_variable('C', null, 0);?><?php }?>
                                    <tr class="gradeX" id="status_<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['list']->value['status']==1){?> style="font-weight: bold" <?php }?>>
                                        <td class="table-col-center" style="width:20px;"><?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
</td>
                                        <td><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['list']->value['date'],"%Y-%m-%d %H:%M");?>
</td>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?><td><?php echo $_smarty_tpl->tpl_vars['list']->value['company'];?>
</td><?php }?>
                                        <td><?php echo $_smarty_tpl->tpl_vars['support_priority']->value[$_smarty_tpl->tpl_vars['list']->value['priority']];?>
</td>
                                        <?php if ($_smarty_tpl->tpl_vars['user_role']->value==1||in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?><td><?php echo $_smarty_tpl->tpl_vars['list']->value['created_user'];?>
</td><?php }?>
                                        <td><?php echo $_smarty_tpl->tpl_vars['list']->value['category'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
</td>
                                        <td><?php echo $_smarty_tpl->tpl_vars['support_status']->value[$_smarty_tpl->tpl_vars['list']->value['status']];?>
</td>
                                        <?php if ($_smarty_tpl->tpl_vars['selected_category_type']->value==1){?>
                                            <td><?php echo $_smarty_tpl->tpl_vars['list']->value['affected_user'];?>
</td>
                                        <?php }?>
                                        <td class="table-col-center center" style="width:15px;">
                                            <button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/detail/<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
/<?php echo $_smarty_tpl->tpl_vars['list']->value['company_id'];?>
/<?php echo $_smarty_tpl->tpl_vars['selected_status']->value;?>
...
/';" class="btn btn-default span12" style="text-align: center;" type="button" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['view'];?>
...
?>
                                    <tr><td <?php if (in_array($_smarty_tpl->tpl_vars['loggedin_user']->value,$_smarty_tpl->tpl_vars['cirrus_admins']->value)){?>colspan='9'<?php }elseif($_smarty_tpl->tpl_vars['user_role']->value==1){?>colspan='8'<?php }else{ ?>colspan='7'<?php }?>><div class="message"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data_available'];?>
</div></td></tr>
                                <?php } ?>
                            </tbody>
                        </table>
