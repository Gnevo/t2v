<?php /* Smarty version Smarty-3.1.8, created on 2020-12-07 12:42:43
         compiled from "/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12713821655fce23437b1172-79173948%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9bfee9d9ee8a55f2ae34035453c0c18cbf49d9b7' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/layouts/sub_layout_employee_tabs.tpl',
      1 => 1588177878,
      2 => 'file',
    ),
    '9b6f0186ddcae6a19f5918321de91fb441acd65a' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/employee_documentations.tpl',
      1 => 1543219312,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '12713821655fce23437b1172-79173948',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fce2343b08310_08856258',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fce2343b08310_08856258')) {function content_5fce2343b08310_08856258($_smarty_tpl) {?><!DOCTYPE html>
...
" style="display:none; padding-top: 20px;padding-left: 13px;">
    ...
    <div id="dialog-confirm_delete" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['status_confirm_title_msg'];?>
" style="display:none;">
    ...
    <div id="dialog-confirm_status" title="Status Change" style="display:none;">
        <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['status_confirm_msg'];?>
</p> 
    </div>
...
employee/non-prefered/timing/%%C-UNAME%%/1/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_non_preferred_time'];?>
                            ...
                            <div class="widget-header widget-header-options tab-option">
                                    <div class="span4 day-slot-wrpr-header-left span3">
                                      <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['documents'];?>
</h1>
                                    </div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['documents']->value){?>
                                        <table class="footable table table-striped table-bordered table-white table-primary" style="margin:0;">
                                            <thead>
                                                <tr>
                                                    <th class="thead-light" style="width:40%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['files'];?>
</th>
                                                     <th class="thead-light small-col"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_user'];?>
</th>
                                                    <th class="thead-light" style="width:15%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['date_on_emp_doc'];?>
</th>
                                                    <th class="thead-light small-col"><?php echo $_smarty_tpl->tpl_vars['translate']->value['delete'];?>
</th>
                                                    <th class="thead-light small-col"><?php echo $_smarty_tpl->tpl_vars['translate']->value['status'];?>
</th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
?>
                                                    <?php if ($_smarty_tpl->tpl_vars['user_roles_login']->value==7||$_smarty_tpl->tpl_vars['user_roles_login']->value==1||$_smarty_tpl->tpl_vars['document']->value['alloc_emp']==$_smarty_tpl->tpl_vars['user_id']->value){?>
                                                        <?php $_smarty_tpl->tpl_vars['check'] = new Smarty_variable(1, null, 0);?>
                                                    <?php }?>
                                                    <?php if ($_smarty_tpl->tpl_vars['user_roles_login']->value==7||$_smarty_tpl->tpl_vars['user_roles_login']->value==1||$_smarty_tpl->tpl_vars['document']->value['status']==1||$_smarty_tpl->tpl_vars['document']->value['alloc_emp']==$_smarty_tpl->tpl_vars['user_id']->value){?>
                                                        <tr>
                                                            <td ><a href="javascript:void(0)" onclick="downloadFile('<?php echo $_smarty_tpl->tpl_vars['document']->value['documents'];?>
')"><?php echo $_smarty_tpl->tpl_vars['document']->value['documents'];?>
</a></td>
                                                            <td ><?php echo $_smarty_tpl->tpl_vars['document']->value['alloc_emp'];?>
</td>
                                                            <td ><?php echo $_smarty_tpl->tpl_vars['document']->value['date'];?>
</td>
                                                            
                                                            <td class="small-col"><?php if ($_smarty_tpl->tpl_vars['check']->value==1){?><a href="javascript:void(0);" class="btn btn-default" onclick="deleteDocument('<?php echo $_smarty_tpl->tpl_vars['document']->value['id'];?>
')"><i class="icon-trash"></i></a><?php }?></td>
                                                            <td><?php if ($_smarty_tpl->tpl_vars['check']->value==1){?><a href="javascript:void(0);" <?php if ($_smarty_tpl->tpl_vars['document']->value['status']==1){?> class="btn btn-default"<?php }else{ ?> class="btn btn-danger" <?php }?>onclick="document_visibility('<?php echo $_smarty_tpl->tpl_vars['document']->value['id'];?>
')">
                                                                <?php if ($_smarty_tpl->tpl_vars['document']->value['status']==1){?><?php echo $_smarty_tpl->tpl_vars['translate']->value['hide_status'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['translate']->value['show_status'];?>
<?php }?></a><?php }?></td>
                                    ...
                                    <?php }else{ ?>
                                        <div style="margin: 0px 0px 10px;" class="alert alert-error">
                                            ...
                                            <strong><i class="icon-ban-circle"></i></strong> <?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data_available'];?>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <span style="background: none repeat scroll 0px center transparent; margin-right: 0px ! important; margin-bottom: 0px ! important; margin-left: 0px ! important; padding: 0px; float: left;" class="btn btn-default btn-file">
                                                <span style="margin-right: 8px;" class="fileupload-new"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_document'];?>
</span>
