<?php /* Smarty version Smarty-3.1.8, created on 2020-12-05 10:35:47
         compiled from "/home/time2view/public_html/cirrus/templates/gdschema_month.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178896425fcb62837328b5-80069547%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d374aff036fd37c440a92313bef392f3c06eba0' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/gdschema_month.tpl',
      1 => 1590137612,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178896425fcb62837328b5-80069547',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcb62842d2725_73077184',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcb62842d2725_73077184')) {function content_5fcb62842d2725_73077184($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus/libs/plugins/modifier.date_format.php';
...
h)</span><?php }?>     
                                             ...
                                             <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']!=0||$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']!=0){?>
                            ...
                            new_content += '<span class="collapse-slot clearfix" id="slot_thread_'+$slot.id+'">\n\
                                                <div class="slot monthlyslotview monthlyslotview-draggable span12 '+special_slot_class_name+' '+($slot.signed == 1 ? 'signed_slot' : '')+' '+($swap_copied_slot == $slot.id ? 'objblink' : '')+'" \n\
                                                    ...
                                                    <div class="'+($slot.signed == 1 ? 'striped' : '')+' span12 slot_bountery">\n\
                                                        ...
                                                        <div class="notification-info-customer">'+$slot.slot+' ('+ $slot.slot_hour +')<br/>'+( $.trim($slot.emp_name) != '' && $slot.emp_name != null ? '<span title="'+$slot.emp_name+'" style="white-space: normal;">'+$slot.emp_name+'</span>' : '')+'</div>\n\
