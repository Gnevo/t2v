<?php /* Smarty version Smarty-3.1.8, created on 2020-12-07 13:47:29
         compiled from "/home/time2view/public_html/cirrus/templates/layouts/sub_layout_customer_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17278782565fce24618581d4-19489570%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'af0c2b16e311ff67b31a33a0c0475b2f6b4c5844' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/layouts/sub_layout_customer_tabs.tpl',
      1 => 1536921822,
      2 => 'file',
    ),
    '904b27c352e94ddd2ee7350cdd7786e675ab33d8' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/customer_deswork.tpl',
      1 => 1542978354,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17278782565fce24618581d4-19489570',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fce2461d20125_73382959',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fce2461d20125_73382959')) {function content_5fce2461d20125_73382959($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
...
')"><span class="icon-print"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['print'];?>
                             ...
                             <div class="tab-content-con boxscroll">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab-6">
                                    <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
customer/deswork/<?php echo $_smarty_tpl->tpl_vars['customer_detail']->value['username'];?>
...
" onclick="toggle_form()"><span class="icon-search"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['search'];?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['description_of_work'];?>
" onclick="resetForm()"><span class="icon-plus"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new'];?>
 <?php echo $_smarty_tpl->tpl_vars['translate']->value['description_of_work'];?>
</button>
                                                            </div>
                                                            <div class="span3" style="padding: 8px; margin: 0px ! important;">
                                                                <div class="input-prepend span12" style="margin: 0px;"> <span class="add-on icon-pencil"></span>
                                                                    <select class="form-control" name="date" id="date" onchange="getWorkDiscription()"  >
...
" <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['date']==$_smarty_tpl->tpl_vars['date']->value['date']){?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['date']->value['date'];?>
</option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
...
" onclick="get_search()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['get'];?>
                                                        ...
                                                        <div class="span12 widget-body-section input-group">
                                                            <div class="span12">
                                                                ...
                                                                <div class="row-fluid">
                                                                    <div class="span12"><label  class="label_caption" for="file_upload"><?php echo $_smarty_tpl->tpl_vars['translate']->value['deswork_file_upload_head'];?>
</label></div>
                                                                    <div class="span12 widget-body-section input-group">
                                                                        <input type="hidden" name="tdocs" id="tdocs" value="<?php echo $_smarty_tpl->tpl_vars['customer_deswork_document_string']->value;?>
" />
                                                                        ...
                                                                        <div class="span12" style="margin:0">
                                                                            <ul class="list-group list-group-form uploaded-files-box span12" style="float: left; height: 90px;">
                                                                                <?php if ($_smarty_tpl->tpl_vars['customer_deswork_document_string']->value!=''){?>
                                                                                    <?php  $_smarty_tpl->tpl_vars['customer_document'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['customer_document']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['customer_deswork_documents']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                                                ...
                                                                <div class="row-fluid">
                                                                    <div class="edit-div"><label  class="label_caption" for="work"><?php echo $_smarty_tpl->tpl_vars['deswork_field_names']->value['work'];?>
                                                                    ...
                                                                    <div class="pull-left span6 no-ml">
                                                                        <textarea rows="1" class="form-control span12 wysiwyg-editor" name="work" cols="32" id="work" onchange="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?>></textarea>
                                                                    </div>
                                                                    <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                        <?php echo $_smarty_tpl->tpl_vars['data']->value[0]['work'];?>

                                                                    </div>
                                                                    <input name="person_num" id="person_num" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['person_num']->value;?>
" />
                                                                    <input name="id" id="id" type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[0]['id'];?>
" />
                                                                </div>

                                                                <div class="row-fluid" style="margin:10px 0 0 0; ">
                                                                    <div class="edit-div"><label  class="label_caption" for="history"><?php echo $_smarty_tpl->tpl_vars['deswork_field_names']->value['history'];?>
                                                                    ...
                                                                    <div class="pull-left span6 no-ml">
                                                                        <textarea rows="1" class="form-control span12 wysiwyg-editor" name="history" id="history" onchange="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?> ></textarea>
                                                                    </div>
                                                                    <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                        <?php echo $_smarty_tpl->tpl_vars['data']->value[0]['history'];?>

                                                                    </div>
                                                                </div>
                                                                <div class="row-fluid" style="margin:10px 0 0 0; ">
                                                                    <div class="edit-div"><label  class="label_caption" for="clinical_picture"><?php echo $_smarty_tpl->tpl_vars['deswork_field_names']->value['clinical_picture'];?>
</label><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.5em; margin-left: 10px;" id="label_edit" data-tag="clinical_picture"></i></div>
                                                                    <div class="pull-left span6 no-ml">
                                                                        <textarea rows="1" class="form-control span12 wysiwyg-editor" name="clinical_picture" id="clinical_picture" onchange="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?>></textarea>
                                                                    </div>
                                                                    <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                        <?php echo $_smarty_tpl->tpl_vars['data']->value[0]['clinical_picture'];?>

                                                                    </div>
                                                                </div>

                                                                <div class="span12" style="margin: 0px;">
                                                                <div class="edit-div"><label  class="label_caption" for="medications"><?php echo $_smarty_tpl->tpl_vars['deswork_field_names']->value['medications'];?>
</label><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.5em; margin-left: 10px;" id="label_edit" data-tag="medications"></i></div>
                                                                    <div style="margin: 0px; float: left;" class="input-prepend span11"> 
                                                                        <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['devolution']!=''){?> 
                                                                            <div class="span12">

                                                                                <ol class="radio-group">
                                                                                    <li><input style="float: left;" type="radio" name="ja" value="ja" id="ja" class="clear_chek" onclick="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['devolution']=="ja"){?> checked="checked" <?php }?>  <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?>/>
                                                                                        <label for="ja" class="label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['yes'];?>
</label>
                                                                                    </li>
                                                                                    <li>  <input style="float: left;" type="radio" name="ja" value="nej" id="nej" class="clear_chek" onclick="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['devolution']=="nej"){?> checked="checked" <?php }?> <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?> />
                                                                                        <label  for="nej" class="label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no'];?>
</label></li>
                                                                                </ol>
                                                                            </div>
                                                                        <?php }else{ ?>
                                                                            <div class="span12">
                                                                                <ol class="radio-group">
                                                                                    ...
                                                                                    <li> <input style="float: left;" type="radio" name="ja" value="nej" id="nej" class="clear_chek" onclick="makeChange()" />
                                                                                        <label  for="nej" span class="label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no'];?>
</label></li></ol>
                                                                            </div>
                                                                        <?php }?>
                                                                    </div>
                                                                ...
                                                                <div class="pull-left span6 no-ml">
                                                                    <textarea rows="1" class="form-control  span12 wysiwyg-editor" name="medication" cols="32" id="medication" onchange="makeChange()" <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?> ></textarea>
                                                                </div>
                                                                <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                    <?php echo $_smarty_tpl->tpl_vars['data']->value[0]['medications'];?>

                                                                </div>

                                                                <div class="row-fluid" style="margin-top:10px;">
                                                                    <div class="edit-div"><label  class="label_caption" for="special_diet"><?php echo $_smarty_tpl->tpl_vars['deswork_field_names']->value['special_diet'];?>
</label><i class="fa fa-pencil-square-o" aria-hidden="true" style="font-size: 1.5em; margin-left: 10px;" id="label_edit" data-tag="special_diet"></i></div>
                                                                    <div class="pull-left span6 no-ml">
                                                                        <textarea rows="1" class="form-control span12 wysiwyg-editor" name="special_diet" cols="32" id="special_diet" onchange="makeChange()" <?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?> ></textarea>
                                                                    </div>
                                                                    <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                        <?php echo $_smarty_tpl->tpl_vars['data']->value[0]['special_diet'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['new_deswork_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" aria-hidden="true" style="font-size: 1.5em; margin-left: 10px;"></i>
                                                                        ...
                                                                        <div class="pull-left span6 no-ml">
                                                                            <textarea rows="1" class="form-control span12 wysiwyg-editor new_deswork_description" name="new_deswork_update[<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
]"  onchange="makeChange()"<?php if ($_smarty_tpl->tpl_vars['data']->value[0]['writable']){?> readonly="readonly"<?php }?>></textarea>
                                                                        </div>
                                                                        <div class="span6 input-group" style="height: 23.5em;overflow: auto;">
                                                                            <?php echo $_smarty_tpl->tpl_vars['new_deswork_description_show_div']->value[$_smarty_tpl->tpl_vars['value']->value['id']]['description'];?>
...
customer/deswork/<?php echo $_smarty_tpl->tpl_vars['customer_username']->value;?>
/",
            type:"POST",
            dataType: 'json',
...
/"+filename;
    ...
    function docRemove(doc, this_obj) {
        bootbox.confirm('<?php echo $_smarty_tpl->tpl_vars['translate']->value['do_you_want_to_delete_customer_deswork_file'];?>
', function (result) {
            if (result) {
                makeChange()
...
customer_deswork_print.php?search_val="+search_radio+"&month="+month+"&year="+year+"&date_from="+dates_from+"&date_to="+dates_to+"&username="+username+"&search_text="+search_text,"_blank","toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=440");
...
");
             ...
             if(change_var == 1 || $('#work').val() != "" || $('#history').val() != "" || $('#clinical_picture').val() != "" || $('#medication').val() != "" || $('#special_diet').val() != "" || des_status == 1 ){
                if(name_exist == 0 ){
                    ...
                    name_status == 1 ? $('#form1').submit() : alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_name_not_empty'];?>
');
                }
            }
            else{
...
//    var work=$("#work option:selected").text(); 
    ...
    window.open("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
pdf_customer_deswork.php?username="+username+"&date="+date+"&dt="+dt+'&_'+Date.now());
 }
...
',
    ...
    $('#btn_add_new_implan').click(function(){
        var html = ' <div class="row-fluid remove_class" style="margin-top:10px;">\n\
                        <div class="edit-div" style="margin-bottom:3px;"><input style="margin:0; height:28px;" type="text" placeholder = "Name" class = "cus_desworknew_name" name = "new_deswork_name[]"><input type = "button" class="btn btn-default ml save_new_work" value ="<?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
" ><input type="button"  class="btn btn-default ml cancel_new_work" value="cancel" ></div>\n\
                        <div class="pull-left span6 no-ml">\n\
                            <textarea rows="1" class="form-control span12 wysiwyg-editor" name="new_deswork_description[]" id="comment_travel" onchange="makeChange()"<?php if ($_smarty_tpl->tpl_vars['implementation']->value['writable']){?> readonly="readonly"<?php }?>></textarea>\n\
                        </div>\n\
                        <div class="span6 input-group" style="height: 23.5em;overflow: auto;">\n\
                            \n\
                        </div>\n\
