<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:58:09
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_attendance_day.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19408966836035f90132dee6-17265156%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b01d6977d4eb5e4cd34fb3f57222928a0e8ee104' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_attendance_day.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '19408966836035f90132dee6-17265156',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f9015b46b3_58391440',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f9015b46b3_58391440')) {function content_6035f9015b46b3_58391440($_smarty_tpl) {?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
    ...
    <div class="row-fluid">
        <div class="span12 main-left">
            <div class="tbl_hd"><span class="titles_tab"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_attendance'];?>
</span>
                <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
                    ...
                    <div class="span10">
                        <form name="data_form" id="data_form" method="post" action="">
                             ...
                             <table width="100%" cellpadding="2" cellspacing="2">
                                <tr>
                                    <td width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['from_date'];?>
</td>
                                    <td width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['to_date'];?>
</td>
                                    <td width="10%"></td>
                                    <td width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['year'];?>
</td>
                                    <td width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['month'];?>
</td>
                                    <td></td>
                                </tr>
                                 <tr>
                                    <td>
                                        <input type="text" class="span12 datepicker" name="from_date" value="<?php echo date('Y-m-d',strtotime($_smarty_tpl->tpl_vars['from_date']->value));?>
" />
                                    </td>
                                    <td>
                                        <input type="text" class="span12 datepicker" name="to_date" value="<?php echo date('Y-m-d',strtotime($_smarty_tpl->tpl_vars['to_date']->value));?>
" />
                                    </td>
                                    <td></td>
...
" <?php if ($_smarty_tpl->tpl_vars['yrs']->value['year']==$_smarty_tpl->tpl_vars['year']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['yrs']->value['year'];?>
                                    ...
                                    <td style="vertical-align: top;">
                                     ...
                                     <td style="vertical-align: top;"><input type="button" name="btn_submit" onclick="show_datas()" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
" /></td>
                                 </tr>
                             </table>
                         </form>  
                    ...
                    <div class="span2">
                        <span style=" float:right;">
                            <a href="javascript:void(0);" onclick="csvdownload();" title="CSV" class="mr" ><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/csv-download.png" height="30" width="30" /></a>
                            <a href="javascript:void(0);" onclick="exceldownload();" title="Excel" class="mr" ><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/excel-download.png" height="30" width="30" /></a>
                            <a href="javascript:void(0);" onclick="pdfdownload();" title="PDF" ><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/pdf-download.gif" height="30" width="30" /></a>
                 ...
                 <?php if ($_smarty_tpl->tpl_vars['absence_datas']->value||$_smarty_tpl->tpl_vars['attendance_datas']->value){?>
                     <div id="showdata" >
                        <div class="row-fluid">
                            <div class="span12" style="background-color: #FFF;">
                                <table class="table_list tbl_padding_fix" cellpadding="2" cellspacing="2" style="width:100%;">
                                    <tr>
                                        <th colspan="8"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_attendance'];?>
</th>
                                    </tr>
                                    <tr>
                                        <th colspan="8"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_attendance_heading_day'];?>
</th>
                                    </tr>
                                    <tr>
                                        <th colspan="4" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['absence_day'];?>
 : <?php echo $_smarty_tpl->tpl_vars['from_date']->value;?>
 - <?php echo $_smarty_tpl->tpl_vars['to_date']->value;?>
</th>
                                        <th colspan="4" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['absence_month'];?>
 : <?php echo $_smarty_tpl->tpl_vars['translate']->value[strtolower(date('M',strtotime($_smarty_tpl->tpl_vars['search_from']->value)))];?>
 - <?php echo $_smarty_tpl->tpl_vars['year']->value;?>
</th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <th width="10%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['men'];?>
</th>
                                        <th width="10%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['women'];?>
</th>
                                        <th width="10%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['total'];?>
</th>
                                        <th></th>
                                        <th width="10%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['men'];?>
</th>
                                    ...
                                    <?php  $_smarty_tpl->tpl_vars['absence_data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['absence_data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['absence_datas']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['absence_data']->key => $_smarty_tpl->tpl_vars['absence_data']->value){
$_smarty_tpl->tpl_vars['absence_data']->_loop = true;
?>
                                        <tr>
                                            <?php  $_smarty_tpl->tpl_vars['absence'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['absence']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['absence_data']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['absence']->key => $_smarty_tpl->tpl_vars['absence']->value){
$_smarty_tpl->tpl_vars['absence']->_loop = true;
?>
                                                <td><?php echo $_smarty_tpl->tpl_vars['absence']->value;?>
</td>
                                            <?php } ?>
                                        </tr>
                                    <?php } ?>
                                    <tr>
                                        <th colspan="4" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['attendance_day'];?>
 : <?php echo $_smarty_tpl->tpl_vars['from_date']->value;?>
 - <?php echo $_smarty_tpl->tpl_vars['to_date']->value;?>
</th>
                                        <th colspan="4" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['attendance_month'];?>
 : <?php echo $_smarty_tpl->tpl_vars['translate']->value[strtolower(date('M',strtotime($_smarty_tpl->tpl_vars['search_from']->value)))];?>
 - <?php echo $_smarty_tpl->tpl_vars['year']->value;?>
</th>
                                    </tr>
                                    ...
                                    <?php  $_smarty_tpl->tpl_vars['attendance_data'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['attendance_data']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['attendance_datas']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['attendance_data']->key => $_smarty_tpl->tpl_vars['attendance_data']->value){
$_smarty_tpl->tpl_vars['attendance_data']->_loop = true;
?>
                                        <tr>
                                            <?php  $_smarty_tpl->tpl_vars['attendance'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['attendance']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['attendance_data']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['attendance']->key => $_smarty_tpl->tpl_vars['attendance']->value){
$_smarty_tpl->tpl_vars['attendance']->_loop = true;
?>
                                                <td><?php echo $_smarty_tpl->tpl_vars['attendance']->value;?>
</td>
                                            <?php } ?>
                                        </tr>
                                    <?php } ?>
