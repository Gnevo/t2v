<?php /* Smarty version Smarty-3.1.8, created on 2021-02-22 11:18:51
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3993405086033931b70a0d9-84048426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b1960f8652cd1a19b36c3e94c7d7cee565cb0bda' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_list.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3993405086033931b70a0d9-84048426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6033931ba8b748_21762841',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6033931ba8b748_21762841')) {function content_6033931ba8b748_21762841($_smarty_tpl) {?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
 ...
 ( <?php echo $_smarty_tpl->tpl_vars['emp_count']->value;?>
...
" />
                                ...
                                <input type="hidden" name="sort_by" id="sort_by" value="<?php echo $_smarty_tpl->tpl_vars['sort_by']->value;?>
" />
                                <input type="hidden" name="search_alph" id="search_alph" value="<?php echo $_smarty_tpl->tpl_vars['search_alph']->value;?>
" />
                                <div class="pull-left" style="margin: 0px ! important; padding: 0px;">
                                    ...
                                    <div style="margin: 0px; float:left;" class="input-prepend span10"> <span class="add-on icon icon-search"></span>
                                        <input class="form-control span12" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
" name="search_emp" id="search_emp" type="text" /> 
                                    </div>

                                </div>
                                <div class="pull-left">
                                    <label class="span12" style="float: left;" for="search_cust"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
</label>
                                    <div style="margin: 0px; float:left;" class="input-prepend span10"> <span class="add-on icon icon-search"></span>
                                        <input class="form-control span12" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
" name="search_cust" id="search_cust" type="text"> 
                                    </div>
                                </div>
                                <div class="pull-left" style="padding-top: 20px;">
                                    <ol class="radio-group">
                                        <li>
                                            <input name="active" value="act" id="active" <?php if ($_smarty_tpl->tpl_vars['action']->value=="act"){?>checked=checked <?php }?> title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['active_employees'];?>
"  type="radio">
                                            <label class="label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['active'];?>
  </label>
                                        </li>
                                        <li>  <input name="active" value="inact" id="ssn" <?php if ($_smarty_tpl->tpl_vars['action']->value=="inact"){?>checked=checked <?php }?> title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['inactive_employees'];?>
"  type="radio"><label class="label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['inactive'];?>
</label>
                                        </li>
                                    </ol>
                                </div>
                                ...
                                <div class="pull-right" style="padding-top: 15px;">
                                    <a class="btn btn-default btn-margin-set btn-option-panel pull-right btn-margin-lft" style="text-align: center;" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/employee/<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
/"><span class="icon-arrow-left"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</a>
                                    <?php if ($_smarty_tpl->tpl_vars['privileges_general']->value['add_employee']){?>
                                        <a class="btn btn-default btn-margin-set btn-option-panel pull-right btn-margin-lft" style="text-align: center;" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/add/" class="add"><span class="icon-plus"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new_employee'];?>
</a>
                                    <?php }?>
                                </div>
...
?>
                                                        <li><a href="javascript:void(0)" onclick="select_employee('<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
                                        ...
                                        <div class="pull-right">
                                            <div class="pagination pagination-mini pagination-right pagin margin-none">
                                                <?php if ($_smarty_tpl->tpl_vars['count']->value>1){?>
                                                    <ul id="pagination">
                                                        <li><a  class="active" href="javascript:void(0)" onclick="paginateDisplay('<?php echo $_smarty_tpl->tpl_vars['page']->value;?>
...
employee/checklist/',' ','width=800,height=600,top=50,left=200');
        ...
        function select_employee(action, name, page) {
            ...
            if (view == '<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
' || view == "") { 
                $("#temp_search_emp").val('');
            }
...
ajax_employee_list_page.php?page=" + page + "&search=" + name + "&cust=" + cust + "&action=" + action);
                var url2 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_employee_listing.php?page=" + page + "&search=" + name + "&cust=" + cust + "&action=" + action + "&sort_by=" + sort_by);
                $("#pagination").load(url1);
                $("#table_val").load(url2);

            } else {
                window.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/employee/' + action + '/' + name + '/';
            }
        }
...
' || view == "") {
            ...
            if (view1 == '<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
' || view1 == "") {
                $("#cust").val('');
            }
            var search = $("#temp_search_emp").val();
...
ajax_employee_list_page.php?page=" + page + "&search=" + search + "&cust=" + cust + "&action=" + action + "&sort_by=" + sort_by);
...
' || view == "") {
            ...
            var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_employee_listing.php?page=" + page + "&search=" + search + "&cust=" + cust + "&action=" + action + "&sort_by=" + sort_by + "&sort_direction=" + sort_direction );
            /*$("#header-fixed").remove();
            $("#table_val").empty();*/
            $.ajax({
                url: urls,
