<?php /* Smarty version Smarty-3.1.8, created on 2020-12-07 09:31:08
         compiled from "/home/time2view/public_html/cirrus/templates/pdf_customer_work_report_summery_editing_kn.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11248285775fcdf65c14f113-08907343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6f87f933b59ac58e69fcf54366fc76f23e38c52' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/pdf_customer_work_report_summery_editing_kn.tpl',
      1 => 1567153806,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11248285775fcdf65c14f113-08907343',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcdf65c59f996_69408204',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcdf65c59f996_69408204')) {function content_5fcdf65c59f996_69408204($_smarty_tpl) {?><!DOCTYPE html>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left" width="50%" valign="top" scope="col"> <b>Period <?php echo $_smarty_tpl->tpl_vars['year']->value;?>
                                    ...
                                    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="tbl_border">
                                        <tr>
                                            <td width="50%" align="left" valign="top" scope="col">Antal beviljade timmar och minuter per vecka
                                                <?php  $_smarty_tpl->tpl_vars['cust_contract'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['cust_contract']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cust_contract_in_this_year_month']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['cust_contract']->key => $_smarty_tpl->tpl_vars['cust_contract']->value){
$_smarty_tpl->tpl_vars['cust_contract']->_loop = true;
?>
                                                    <span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['cust_contract']->value['weekly_hours'];?>
</span>
                                                <?php } ?>
                                            </td>
...
$_smarty_tpl->tpl_vars['cust_contract']->_loop = true;
?>
                                                    <span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['cust_contract']->value['date_from'];?>
 -- <?php echo $_smarty_tpl->tpl_vars['cust_contract']->value['date_to'];?>
</span>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:0px;"><table width="100%" cellspacing="0" cellpadding="0" style="padding-top:0px;">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="padding:0px;" width="5%"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['no_of_employees_have_slots']->value;?>
 </span></td>
...
<?php }?>" name="hospital_time_to3"></span>
                                                    ...
                                                    <tr>
                                                        <td colspan="5" class="minus_padding">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td width="8%" align="left" valign="middle"><label><input type="radio" name="rd_have_received_personal_assistance" value="1" <?php if ($_smarty_tpl->tpl_vars['reports']->value['have_received_personal_assistance']==1){?>checked="checked"<?php }?> /> &nbsp;Ja</label></td>
                                                                    <td width="85%" align="left" valign="middle"><label><input type="radio" name="rd_have_received_personal_assistance" value="2" <?php if ($_smarty_tpl->tpl_vars['reports']->value['have_received_personal_assistance']==2){?>checked="checked"<?php }?> /> &nbsp;Nej</label><br /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" align="left" valign="top"><label>
                                                            <p style="float:left"><input type="checkbox" name="have_u_contact_with_assistant_counselors" value="1" <?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['reports']->value['have_u_contact_with_assistant_counselors']==1){?>checked="checked"<?php }?>/></p>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div style="margin: 0px ! important;height: auto;" class="span12">
                                                                ...
                                                                <div style="margin: 0px; float: left;padding: 0px;" class="input-prepend date hasDatepicker span12 datepicker">
                                                                    <span class="add-on icon-calendar"></span>
                                                                    <input class="form-control span11" id="hired_assistant_date_from" value="<?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['sec3_check_values']->value[3]==1){?><?php echo $_smarty_tpl->tpl_vars['reports']->value['hired_assistant_date_from'];?>
<?php }?>" name="hired_assistant_date_from" type="text" readonly="readonly" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div style="margin: 0px ! important;height: auto;" class="span12">
                                                                ...
                                                                <div style="margin: 0px; float: left;padding: 0px;" class="input-prepend date hasDatepicker span12 datepicker">
                                                                    <span class="add-on icon-calendar"></span>
                                                                    <input class="form-control span11" id="hired_assistant_date_to" value="<?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['sec3_check_values']->value[3]==1){?><?php echo $_smarty_tpl->tpl_vars['reports']->value['hired_assistant_date_to'];?>
<?php }?>" name="hired_assistant_date_to" type="text" readonly="readonly" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td width="10%" align="left" valign="top" scope="col">
                                                            ...
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn no-mt no-mb"><input type="text" class="form-control" maxlength="20" value="<?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['sec3_check_values']->value[3]==1){?><?php echo $_smarty_tpl->tpl_vars['reports']->value['hired_assistant_normal_hours'];?>
<?php }?>" name="hired_assistant_normal_hours"></span>
                                                            </div>
                                                        </td>
                                                        <td width="10%" align="left" valign="top" scope="col">
                                                            <div class="secondary-font span12 no-ml no-min-height">Väntetid, faktiska timmar <br/>(Timmar och minuter)</div>
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn no-mt no-mb"><input type="text" class="form-control" maxlength="20" value="<?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['sec3_check_values']->value[3]==1){?><?php echo $_smarty_tpl->tpl_vars['reports']->value['hired_assistant_oncall_hours'];?>
<?php }?>" name="hired_assistant_oncall_hours"></span>
                                                            </div>
                                                        </td>
                                                        <td width="10%" align="left" valign="top" scope="col">
                                                            <div class="secondary-font span12 no-ml no-min-height">Beredskapstid, faktiska timmar <br/>(Timmar och minuter)</div>
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn no-mt no-mb"><input type="text" class="form-control" maxlength="20" value="<?php if ($_smarty_tpl->tpl_vars['edit']->value=='true'&&$_smarty_tpl->tpl_vars['sec3_check_values']->value[3]==1){?><?php echo $_smarty_tpl->tpl_vars['reports']->value['hired_assistant_standby_hours'];?>
<?php }?>" name="hired_assistant_standby_hours"></span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table class="tbl_border" width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    <tr>
                                                        <td width="50%" align="left" valign="top" scope="col"> 
                                                            ...
                                                            <div class="span12 no-ml">
                                                                <span class="span6 no-min-height special_spn"><?php echo $_smarty_tpl->tpl_vars['company_details']->value['name'];?>
</span><span class="span6 no-min-height special_spn"><?php echo $_smarty_tpl->tpl_vars['company_organization_no_formated']->value;?>
</span>
                                                            </div></td>
                                                        <td width="50%" align="left" valign="top" scope="col">
                                                            <div class="span12 no-min-height">Telefon nummer</div>
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn"><?php echo $_smarty_tpl->tpl_vars['company_phone_formated']->value;?>
</span>
                                                            </div></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="50%" align="left" valign="top" scope="col"> 
                                                            ...
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn"><?php echo $_smarty_tpl->tpl_vars['company_details']->value['email'];?>
</span>
                                                            </div></td>
                                                        <td width="50%" align="left" valign="top" scope="col">
                                                            <div class="span12 no-min-height">Ersättningen betalas ut till kontonummer inklusive clearingnummer</div>
                                                            <div class="span12 no-ml">
                                                                <span class="span12 no-min-height special_spn"><?php echo $_smarty_tpl->tpl_vars['company_details']->value['bank_account'];?>
</span>
                                                            </div></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="5" class="minus_padding">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                ...
                                                                <tr>
                                                                    <td width="8%" align="left" valign="middle"><label><input type="radio" name="rd_permission_from_care_inspectorate" value="1" <?php if ($_smarty_tpl->tpl_vars['reports']->value['permission_from_care_inspectorate']==1){?>checked="checked"<?php }?> /> &nbsp;Ja</label></td>
                                                                    <td width="85%" align="left" valign="middle"><label><input type="radio" name="rd_permission_from_care_inspectorate" value="2" <?php if ($_smarty_tpl->tpl_vars['reports']->value['permission_from_care_inspectorate']==2){?>checked="checked"<?php }?> /> &nbsp;Nej</label><br /></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
