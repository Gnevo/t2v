<?php /* Smarty version Smarty-3.1.8, created on 2020-12-17 12:31:13
         compiled from "/home/time2view/public_html/cirrus/templates/documents_sign_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2982002785fdb4f910e5945-47067878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb7eb2c7420a1d167c394612bf5d26818187277e' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/documents_sign_report.tpl',
      1 => 1564737758,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2982002785fdb4f910e5945-47067878',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fdb4f914d7823_76083351',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fdb4f914d7823_76083351')) {function content_5fdb4f914d7823_76083351($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
...
images/sgo-loading.gif"  />
    ...
    <div style="margin: 15px 0px 0px;" class="widget-header span12">
      <div class="span4 day-slot-wrpr-header-left">
         <h1 style="margin: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['document_sign_report'];?>
</h1>
      </div>
      <div class="pull-right day-slot-wrpr-header-left span6" style="padding: 5px;">
        <button class="btn btn-default btn-normal pull-right btn-cancel-category" type="button" style="margin-left: 2px;" onclick="goBack()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['back'];?>
</button>
      </div>
    </div>
        ...
        <div class="option_strip clearfix" style="padding-bottom: 10px;">
            <form id="search_form" name="search_form" action="" method="post">
                <div class="workreportform_left"  style="float:inherit;">
                    ...
                    <span style="padding-left: 15px">
                        <input type="checkbox" value="1" <?php if ($_smarty_tpl->tpl_vars['flag_signed']->value){?>checked="checked"<?php }?> name="signed" id="signed" style="margin-right: 3px;"/>  
                        <span style="padding-left: 5px; padding-top: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['signed'];?>
</span>
                    </span> 
                    <span style="padding-left: 15px"></span> 
                    <span style="margin: 0 3px 0 2px;">
                        <input type="submit" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['get'];?>
" name="btn_get" />
                    </span> 
                </div>
            </form>
            ...
            <table id="header-fixed" style="margin: 0px;" class="table table-striped order-column table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_date'];?>
</th>
                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['signed'];?>
</th>
                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['sign_date'];?>
</th>
                    </tr>
                </thead>    
                <tbody >
                    <?php  $_smarty_tpl->tpl_vars['sign_documents'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['sign_documents']->_loop = false;
 $_smarty_tpl->tpl_vars['username'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['signed_documents']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['sign_documents']->key => $_smarty_tpl->tpl_vars['sign_documents']->value){
$_smarty_tpl->tpl_vars['sign_documents']->_loop = true;
 $_smarty_tpl->tpl_vars['username']->value = $_smarty_tpl->tpl_vars['sign_documents']->key;
?>
                        <?php  $_smarty_tpl->tpl_vars['document'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['document']->_loop = false;
 $_smarty_tpl->tpl_vars['document_id'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['sign_documents']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['document']->key => $_smarty_tpl->tpl_vars['document']->value){
$_smarty_tpl->tpl_vars['document']->_loop = true;
 $_smarty_tpl->tpl_vars['document_id']->value = $_smarty_tpl->tpl_vars['document']->key;
?>
                            <tr>
                                <td><?php echo $_smarty_tpl->tpl_vars['document']->value['name'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['document']->value['document'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['document']->value['document_upload_date'];?>
</td>
                                <td><?php if ($_smarty_tpl->tpl_vars['document']->value['sign']){?><img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/banck_id_signing.jpg" style="height: 18px;"><?php }?></td>
                                <td><?php echo $_smarty_tpl->tpl_vars['document']->value['sign_date'];?>
</td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
