<?php /* Smarty version Smarty-3.1.8, created on 2020-12-05 12:38:35
         compiled from "/home/time2view/public_html/cirrus/templates/gdschema_start_employee.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8372616475fcb7f4b341f90-06920573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c6837bf1f8534b76c8e210ede1fd3c4647636018' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/gdschema_start_employee.tpl',
      1 => 1514964866,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8372616475fcb7f4b341f90-06920573',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcb7f4b66ccb5_59109680',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcb7f4b66ccb5_59109680')) {function content_5fcb7f4b66ccb5_59109680($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12 main-left slot-form">
            ...
            <div class="row-fluid">
                <div class="span12 tablet-column-reset">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['expire_days']->value<=15){?>
                        <div class="expiry">
                            ...
                            <div class="widget widget-heading-simple widget-body-white" data-toggle="collapse-widget " style="margin-bottom: 0px !important">
                                <div class="widget-body table-1">
                                    <?php if ($_smarty_tpl->tpl_vars['user_role']->value!=3){?>
                                        <div class="table-head-min table-head-min-employee"> <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_list'];?>
...
employee/gdschema/<?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['first_date'];?>
/<?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['employee_id'];?>
/',1);" href="javascript:void(0);" title="<?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['code'];?>
"><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['employee_name_ff'];?>
<?php }elseif($_smarty_tpl->tpl_vars['sort_by_name']->value==2){?><?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['employee_name'];?>
<?php }?></a></td>
                                                        <td style="width:100px;"><a onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/gdschema/<?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['first_date'];?>
/<?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['employee_id'];?>
/',1);" href="javascript:void(0);"><span><?php echo $_smarty_tpl->tpl_vars['employee_to_allocate']->value['total_hours'];?>
h</span></a></td>
                                                    </tr>
                                                    <?php } ?>
                                               </tbody>
...
/1/')"><span class="btn btn-block btn-default span12"><i class="icon-double-angle-left"></i></span></th>
...
/<?php echo $_smarty_tpl->tpl_vars['day']->value;?>
/1/')"><span class="btn btn-block btn-default span12"><i class="icon-angle-left"></i></span></th>
...
/1/')"><?php echo $_smarty_tpl->tpl_vars['translate']->value[$_smarty_tpl->tpl_vars['month_label']->value];?>
...
/<?php echo $_smarty_tpl->tpl_vars['day']->value;?>
/1/')"><span class="btn btn-block btn-default span12"><i class="icon-angle-right "></i></span></th>
                                        <th onclick="navigateCalender('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax/calender/<?php echo $_smarty_tpl->tpl_vars['year']->value+1;?>
/<?php echo $_smarty_tpl->tpl_vars['month']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['day']->value;?>
/1/')"><span class="btn btn-block btn-default span12"><i class="icon-double-angle-right"></i></span></th>
                                    </tr>
                                </thead>
                                <thead>
                                    <tr>
...
/<?php echo $_smarty_tpl->tpl_vars['day']->value;?>
/1/');" class="table-col-center weeks-small-calender" style="width:40px;"><?php echo $_smarty_tpl->tpl_vars['month_week']->value['week']['week'];?>
</td>
                                            <?php  $_smarty_tpl->tpl_vars['week_day'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['week_day']->_loop = false;
...
all/employee/gdschema/<?php echo $_smarty_tpl->tpl_vars['week_day']->value['year'];?>
|<?php echo $_smarty_tpl->tpl_vars['week_day']->value['week'];?>
/<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
/',1);" class="table-col-center <?php if ($_smarty_tpl->tpl_vars['week_day']->value['type']=='old'){?>coming-days<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='current'){?>today-small-calender<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='holiday'){?>off-days<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='redday'){?>off-days<?php }elseif($_smarty_tpl->tpl_vars['week_day']->value['type']=='bigday'){?>off-days<?php }?>"><?php echo $_smarty_tpl->tpl_vars['week_day']->value['day'];?>
</td>
                                            <?php } ?>
                                        </tr>
                                    <?php } ?>
                        ...
                        <div class="row-fluid">
                            <div class="span12 customer-dtls-home" style="height: auto !important;">
                                <div class="widget widget-heading-simple widget-body-white no-mb" data-toggle="collapse-widget " style="padding-top:0; margin-top:0 !important;">
                                    <div  id="gdschema_kund" style="height: 335px; overflow-y: auto;">
                                        <div class="span12 ">
                                            <table class="footable table table-striped table-bordered table-white table-primary table-list-customers table-list-employees">
                                                <thead>
                                                    <tr>
                                                        <th class="footable-employee"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
&nbsp;(<?php echo count($_smarty_tpl->tpl_vars['week_shedules']->value);?>
 st)
                                                            <span class="btn btn-mini btn-info pull-right mr" onclick="go_to_cust_gdschema_summary();"><?php echo $_smarty_tpl->tpl_vars['translate']->value['customer_summary_view'];?>
</span>
                                                        </th>
...
?>
                                                            <th class="footable-employee"><?php if ($_smarty_tpl->tpl_vars['user_role']->value==4||$_smarty_tpl->tpl_vars['user_role']->value==3){?><a onclick="navigatePage('<?php if ($_smarty_tpl->tpl_vars['user_role']->value==4){?><?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
" type="text" onemptied="refresh_summery_employee()" oninput="refresh_summery_employee()" style="min-height: 20px;" />
...
" type="text/javascript" ></script>
    ...
    <script>
        ...
        $( "#customer_search" ).autocomplete({
            source: <?php echo $_smarty_tpl->tpl_vars['customers']->value;?>
,
            select: function( event, ui ) {
                ...
                if(selected_user != ''){
                    var obj_process = { action: 'get_employees', related_customer: selected_user, view: 'employee', 'year_week': '<?php echo $_smarty_tpl->tpl_vars['year_week']->value;?>
'};
        ...
        $( "#employee_search" ).autocomplete({
            source: <?php echo $_smarty_tpl->tpl_vars['ac_employees']->value;?>
,
            select: function( event, ui ) {
                var selected_user = ui.item.uname;
                //console.log(selected_user);
                if(selected_user != ''){
                    ...
                    var obj_process = { action: 'get_employees', employee_search_query: selected_user, view: 'employee', 'year_week': '<?php echo $_smarty_tpl->tpl_vars['year_week']->value;?>
'};
                    filter_summery_data(selected_user, obj_process);
                }
            }
    ...
    function filter_summery_data(user, reqest_data){
        //var obj_process = { action: 'get_employees', related_customer: user, view: 'employee', 'year_week': '<?php echo $_smarty_tpl->tpl_vars['year_week']->value;?>
'};
...
month/gdschema/employee/<?php echo $_smarty_tpl->tpl_vars['cur_year']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['cur_month']->value;?>
...
">'+$data.full_name+'</a>';
                    ...
                    if($data.summery_values.length > 0){
                        $.each($data.summery_values, function(i, $summery) {
                            ...
                            $tbl_data += '<a onclick="navigatePage(\'<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/gdschema/'+$summery.year_week+'/'+$data.username+'/\',1);" href="javascript:void(0);" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['tltp_goto_week'];?>
">';
    ...
    function refresh_summery(){
        ...
        if(emp_search_qry == ''){
            var obj_process = { action: 'get_employees', related_customer: emp_search_qry, view: 'employee', 'year_week': '<?php echo $_smarty_tpl->tpl_vars['year_week']->value;?>
'};
    ...
    function refresh_summery_employee(){
        ...
        if(emp_search_qry == '' && previously_filtered_by_employee){
            ...
            var obj_process = { action: 'get_employees', employee_search_query: emp_search_qry, view: 'employee', 'year_week': '<?php echo $_smarty_tpl->tpl_vars['year_week']->value;?>
'};
            filter_summery_data(emp_search_qry, obj_process);
        }
    }
...
all/employee/gdschema/'+year+'|'+week+'/'+month_first_date+'/',1);
