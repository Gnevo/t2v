<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 11:09:38
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_cv_report.tpl" */ ?>
<?php /*%%SmartyHeaderCode:309068793603633f20ea043-54632212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ceb2f5e0f79815700e9704c0662abb4fd23cd506' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/employee_cv_report.tpl',
      1 => 1613804739,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '309068793603633f20ea043-54632212',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_603633f2338d58_62216394',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_603633f2338d58_62216394')) {function content_603633f2338d58_62216394($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/function.html_options.php';
	        ...
	        <div class="panel panel-default span12 no-ml" style="margin: 5px 0px 0px ! important;">
	            <div class="panel-heading" style="">
	                <h4 class="panel-title no-mb clearfix" style="border-radius: 0px;">
	                	<?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_skill_report'];?>

	                    <ul class="pull-right">
	                        <li> <i class="icon-arrow-left"></i> <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
reports/"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</span></a></li>
	                        <!-- <li> <i class="icon-refresh"></i> <a href="javascript:void(0);" onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/cv/report/',8);"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['translate']->value['reset'];?>
</span></a></li> -->
	                        <!-- <li> <i colspans="icon-print"></i><a href="javascript:void(0);" onclick="print_pdf()"><span class="special_spn"><?php echo $_smarty_tpl->tpl_vars['translate']->value['print'];?>
</span></a></li> -->
	                    </ul>
	                </h4>
	            </div>
	        ...
	        <div class="span12 no-ml" id="forms_container" style="border: 1px solid #dcdcdc;padding: 5px;">
	        	<form method="post" id="show_cv_form">
	        	  <div class="row ml">
	        	  	<div class="span3">
	        	  		<label for="employee_name"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_employee_name'];?>
</label>
	        	  		<input type="text" class="" name="employee_name" id="employee_name" maxlength="150"  autocomplete="off" aria-haspopup="true" aria-autocomplete="list" role="textbox" autocomplete="off" class="ui-autocomplete-input" value="<?php echo $_smarty_tpl->tpl_vars['employee_name']->value;?>
">
	        	  	</div>
	        	  	<div class="span3">
	        	  		<label for="cv_title"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_title'];?>
/<?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_description'];?>
</label>
	        	  		<input type="text" name="cv_title" id="cv_title" value="<?php echo $_smarty_tpl->tpl_vars['cv_title']->value;?>
">
	        	  	</div>
	        	  	<!-- <div class="span3">
	        	  		<label for="cv_description"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_description'];?>
</label>
	        	  		<input type="text" name="cv_description" id="cv_description" value="<?php echo $_smarty_tpl->tpl_vars['cv_description']->value;?>
">
	        	  	</div> -->
	        	  	<div class="span2">
	        	  		<label for="cv_year"><?php echo $_smarty_tpl->tpl_vars['translate']->value['skill_date_of_exam'];?>
</label>
	        	  		<select id="cv_year" name="cv_year" class="span12">
	        	  			<option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select'];?>
</option>
                            <?php echo smarty_function_html_options(array('values'=>$_smarty_tpl->tpl_vars['years_combo']->value,'selected'=>$_smarty_tpl->tpl_vars['cv_year']->value,'output'=>$_smarty_tpl->tpl_vars['years_combo']->value),$_smarty_tpl);?>

	        	  		</select>
	        	  	</div>
	        	  	<div class="span1 mt">
	        	  		<input type="submit" class="btn btn-primary" name="show_cv" id="show_cv" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['show'];?>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <table class="table table-bordered table-primary table-striped table-vertical-center">
                                                <thead>
                                                    <tr>
                                                        <th class="header" width="5%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_serial_no'];?>
</th>
                                                        <th class="header" width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_employee_name'];?>
</th>
                                                        <th class="header" width="10%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['year'];?>
</th>
                                                    	<th class="header" width="15%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_title'];?>
</th>
                                                    	<th class="header" width="30%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_description'];?>
</th>
                                                    	<th class="header" width="20%"><?php echo $_smarty_tpl->tpl_vars['translate']->value['cv_attachments'];?>
</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                	<?php  $_smarty_tpl->tpl_vars['skills'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['skills']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['all_cv_details']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['skills']->key => $_smarty_tpl->tpl_vars['skills']->value){
$_smarty_tpl->tpl_vars['skills']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['skills']->key;
?>
                                                		<tr>
                                                			<td><?php echo $_smarty_tpl->tpl_vars['key']->value+1;?>
</td>
                                                			<td><a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
employee/add/<?php echo $_smarty_tpl->tpl_vars['skills']->value['username'];?>
/" target="_blank" style="color: #1414a5;text-decoration-line: underline;"><?php if ($_smarty_tpl->tpl_vars['company_sort_by']->value==1){?> <?php echo $_smarty_tpl->tpl_vars['skills']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['skills']->value['last_name'];?>
 <?php }else{ ?> <?php echo $_smarty_tpl->tpl_vars['skills']->value['last_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['skills']->value['first_name'];?>
 <?php }?> </a></td>
                                                			<td><?php echo $_smarty_tpl->tpl_vars['skills']->value['year'];?>
</td>
                                                			<td><?php echo $_smarty_tpl->tpl_vars['skills']->value['skill'];?>
</td>
                                                			<td><?php echo $_smarty_tpl->tpl_vars['skills']->value['description'];?>
</td>
                                                			<td>
                                                				<ul>
                                                					<?php if ($_smarty_tpl->tpl_vars['skills']->value['attachment1']){?><li title="<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment1'];?>
" onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment1'];?>
')" ><i class="icon icon-download"></i><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['skills']->value['attachment1'],18);?>
</li><?php }?>
                                                					<?php if ($_smarty_tpl->tpl_vars['skills']->value['attachment2']){?><li title="<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment2'];?>
" onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment2'];?>
')" ><i class="icon icon-download"></i><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['skills']->value['attachment2'],18);?>
</li><?php }?>
                                                					<?php if ($_smarty_tpl->tpl_vars['skills']->value['attachment3']){?><li title="<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment3'];?>
" onclick="download_skill('<?php echo $_smarty_tpl->tpl_vars['skills']->value['attachment3'];?>
')" ><i class="icon icon-download"></i><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['skills']->value['attachment3'],18);?>
</li><?php }?>
                                                				</ul>
                                                			</td>
                                            		...
                                            		<?php }
if (!$_smarty_tpl->tpl_vars['skills']->_loop) {
?>
	                                                    <tr class="gradeX">
...
</strong>:  <?php echo $_smarty_tpl->tpl_vars['translate']->value['no_cv_data_found'];?>
...
employee_cv_report.php?'+employee_name+'&'+cv_title+'&'+cv_description+'&'+cv_year+'',8);
	// }
...
/"+file;
 ...
 $_from = $_smarty_tpl->tpl_vars['employeeslist']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>  
                <?php if ($_smarty_tpl->tpl_vars['company_sort_by']->value==1){?>
                    {
...
"
                ...
                <?php }elseif($_smarty_tpl->tpl_vars['company_sort_by']->value==2){?>
                    {
                    value: "<?php echo $_smarty_tpl->tpl_vars['employee']->value['username'];?>
",
