<?php /* Smarty version Smarty-3.1.8, created on 2021-02-24 06:41:46
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/privilege_employee.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9746044766035f52a2b7d16-56887276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4490569bd06852235feebc9f9e40a64381cb736' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/privilege_employee.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9746044766035f52a2b7d16-56887276',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6035f52a535648_72492306',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6035f52a535648_72492306')) {function content_6035f52a535648_72492306($_smarty_tpl) {?><!DOCTYPE html>
...
administration/" class="icon-key"><i></i> <span class="hidden-label"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['administration'];?>
	...
	<br><p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_employee_atleast_one'];?>
</p>
</div> 
    <div class="row-fluid">
        <div class="span12 main-left" style="overflow-y:scroll !important">
            ...
            <div style="margin: 15px 0px 0px;" class="widget-header span12">
                <div class="span4 day-slot-wrpr-header-left span6">
                    <h1 style="margin: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee_privilege'];?>
</h1>
                </div>
                <div class="pull-right day-slot-wrpr-header-left" style="padding: 5px;">
                    <button style="" class="btn btn-default btn-normal pull-right" type="button" onclick="setPrivilege()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['set_privilege'];?>
</button>
                </div>
            </div>
                ...
                <div class="span12">
                    <div class="span12">
                        <div class="widget" style="margin: 0px 0px 10px ! important;">
                            <!--WIDGET BODY BEGIN-->
                            <div class="span12 widget-body-section input-group">
                                <form name="frm1" id="frm1" method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
add/privilege/employee/">
                                <div class="span12">

                                    <div class="span3" style="margin: 0px ! important;">
                                        <label style="float: left;" class="span12" for="pre_search"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
</label>
                                        <div style="margin: 0px; float:left;" class="input-prepend date hasDatepicker span10"> <span class="add-on icon-search"></span>
                                            <input class="form-control span10" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
" name="pre_search" type="text" id="pre_search"> </div>
                                    </div>

                                    <div class="span2" style="">
                                        <label style="float: left;" class="span12" for="exampleInputEmail1"><?php echo $_smarty_tpl->tpl_vars['translate']->value['role'];?>
</label>
                                        <div style="margin-left: 0px; float: left;" class="input-prepend span9"> <span class="add-on icon-pencil"></span>
                                            <select class="form-control span10" name="pre_role" id="pre_role">
                                                <option value="3" <?php if ($_smarty_tpl->tpl_vars['emp_roles']->value==3){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</option>
                                                <option value="2" <?php if ($_smarty_tpl->tpl_vars['emp_roles']->value==2){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['tl'];?>
</option>
                                                <!--
                                                <option value="5"><?php echo $_smarty_tpl->tpl_vars['translate']->value['trainee'];?>
</option>-->
                                                <option value="7" <?php if ($_smarty_tpl->tpl_vars['emp_roles']->value==7){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['super_tl'];?>
</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="span3" style="margin: 0px ! important;">
                                        <label style="float: left;" class="span12" for="search_cust"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
</label>
                                        <div style="margin: 0px; float:left;" class="input-prepend date hasDatepicker span9"> <span class="add-on icon-pencil"></span>
                                            <input class="form-control span10" placeholder="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
" type="text" name="search_cust" id="search_cust"> </div>
                                            <input type="hidden" id="selected_emp" name="selected_emp" value="<?php echo $_smarty_tpl->tpl_vars['selected_emp']->value;?>
" />
                                    ...
                                    <div class="pull-left" style="margin: 0px ! important;">
                                        <div style="margin: 20px 0px 0px ! important;" class="select-all-previlege-button" id="select_all_div"><input class="checkbox checkbox-select-all-previlege" type="checkbox" id="select_all_check" onclick="selectAll()"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['select_all'];?>
                                    ...
                                    <div class="pull-right" style="margin: 15px 0px 0px;">
                                        <button class="btn btn-default btn-margin-set" style="text-align: center;" type="button" onclick="clearAllPrivilege()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['clear_all'];?>
</button>
                                    </div
                                ></div>
                                        ...
                                        <div class="pagination pagination-mini pagination-right pagin margin-none" id="pages">
                                            <ul>
                                                <?php if ($_smarty_tpl->tpl_vars['page_count']->value>1){?>
                                                    <?php if ($_smarty_tpl->tpl_vars['page_count']->value>2){?>
                                                         <li class="active"><a  href="javascript:void(0)" onclick="paginateDisplay('1','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">1</a></li>
                                                         <li><a href="javascript:void(0)" onclick="paginateDisplay('2','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">2</a></li>
                                                         <li><a href="javascript:void(0)" onclick="paginateDisplay('2','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">&gt;</a></li>
                                                         <li><a href="javascript:void(0)" onclick="paginateDisplay('<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">&gt;&gt;</a></li>
                                                    <?php }elseif($_smarty_tpl->tpl_vars['page_count']->value==2){?>
                                                         <li class="active"><a href="javascript:void(0)" onclick="paginateDisplay('1','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">1</a></li>
                                                         <li><a href="javascript:void(0)" onclick="paginateDisplay('2','<?php echo $_smarty_tpl->tpl_vars['page_count']->value;?>
');">2</a></li> 
...
" />
                                                <div id="loader" style="display:none; height: 31px;width: 31px;margin: 0px auto;background: url('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/ajax-loader_new.gif');"></div>
...
(<?php echo $_smarty_tpl->tpl_vars['customer']->value['code'];?>
)",      
                 <?php }else{ ?>
                    "<?php echo $_smarty_tpl->tpl_vars['customer']->value['first_name'];?>
 <?php echo $_smarty_tpl->tpl_vars['customer']->value['last_name'];?>
(<?php echo $_smarty_tpl->tpl_vars['customer']->value['code'];?>
    ...
    function paginateDisplay(page,total){
        ...
        var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_employee_pages.php?name="+search_name+"&role="+search_role+"&cust="+search_customer+"&selected="+selected+"&page="+page+"&total="+total);
        $("#pages").load(urls);
        findEmployees(page);
    }
    ...
    function paginateDisplayAlphabet(alphabet,page){
        ...
        var selected = $('#selected_emp').val();
        var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_employee_alphabet_pages.php?name="+alphabet+"&role="+search_role+"&cust="+search_customer+"&selected="+selected+"&page="+page);
        $("#pages").load(urls);
    ...
    function findEmployees(page){
        ...
        var selected = $('#selected_emp').val();
        var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_employee_list.php?name="+search_name+"&role="+search_role+"&cust="+search_customer+"&selected="+selected+"&page="+page);
    ...
    function findEmployeesAlphabet(alphabet,page){
        ...
        var selected = $('#selected_emp').val();
        var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_privilege_employee_list_alphabet.php?name="+alphabet+"&role="+search_role+"&cust="+search_customer+"&selected="+selected+"&page="+page);
    ...
    function selectAll(){
        if($('#select_all_check').prop("checked")){
            ...
            var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?select_all=all&role_all="+role);
            ...
            var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?select_all=''");
            $("#selected_emp_to_privilege").load(urls);
        }
    }
...
ajax_selected_employee_privilege.php?select_all=''");
    ...
    function clearAllPrivilege(){
        ...
        var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?empl="+blank);
        $("#selected_emp_to_privilege").load(urls);
    ...
    //    alert(selected);
        if($('#check_user_'+user).attr('checked')) {
            ...
            var url1 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?empl="+selected);
           ...
           var tmp_emp = $('#selected_emp').val();
            ...
            var url2 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
...
')
            ...
            var urls1 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_selected_employee_privilege.php?empl="+selected);
