<?php /* Smarty version Smarty-3.1.8, created on 2020-12-05 12:21:53
         compiled from "/home/time2view/public_html/cirrus/templates/profile_photo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10488820685fcb7b619b8159-38362797%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd9c2be17d7abcb2f2e7aac67b83c546704b3dd19' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/profile_photo.tpl',
      1 => 1515747304,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10488820685fcb7b619b8159-38362797',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fcb7b61bc3fe6_96977584',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fcb7b61bc3fe6_96977584')) {function content_5fcb7b61bc3fe6_96977584($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12 main-left">
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div class="widget-header span12">
                    <div class="span2">
                        <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['profiles'];?>
</h1>
                    </div>
                </div>
            </div>
            <div class="span12 widget-body-section input-group">
                ...
                <div class="row-fluid">
                    <div class="<?php if ($_smarty_tpl->tpl_vars['uploaded']->value){?>span6<?php }else{ ?>span4<?php }?> center innerL innerTB active-border clearfix">
                        <?php if ($_smarty_tpl->tpl_vars['uploaded']->value){?>
                            <div class="span12"><div class="alert alert-warning" role="alert"><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_area_to_crop_image'];?>
</div></div>
                            <div align="center">
                                <div id="parent" style="position:relative;">
                                    <span id="thumbnail" style="display: inline-block;">
                                        <img id="image" style="width:80%;" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
<?php echo $_smarty_tpl->tpl_vars['large_image']->value;?>
?v=<?php echo filemtime($_smarty_tpl->tpl_vars['large_image']->value);?>
" />
                                    </span>
                                </div>
                                <form id="img_prof" name="img_prof" method="post">
                                    <input type="hidden" name="filename" value="<?php echo $_smarty_tpl->tpl_vars['large_image_name']->value;?>
" id="filename" />
                                    ...
                                    <button class="btn btn-success btn-normal btn-manage " name="upload_thumbnail" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
" id="save_thumb" style="margin: 8px;" type="submit"><?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</button>
                                </form>
                            </div>
                        <?php }else{ ?>
                            <?php if ($_smarty_tpl->tpl_vars['thumb_photo_exists']->value){?>
                                <div class="span12">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
<?php echo $_smarty_tpl->tpl_vars['thumbnail_image']->value;?>
?v=<?php echo filemtime($_smarty_tpl->tpl_vars['thumbnail_image']->value);?>
" id="thumbnail" alt="<?php echo $_smarty_tpl->tpl_vars['user_id']->value;?>
" />
                                </div>
                                <div class="span12">
                                    
                                    <button class="btn btn-danger btn-normal btn-manage " style="margin: 8px;" type="button" onclick="location.href='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
profile_photo.php?act=delete&user=<?php echo $_smarty_tpl->tpl_vars['user_id']->value;?>
';"><?php echo $_smarty_tpl->tpl_vars['translate']->value['delete'];?>
</button>
                                </div>
                            <?php }else{ ?>
                                <div class="span12">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/dashboard-avatar.png" alt="<?php echo $_smarty_tpl->tpl_vars['user_id']->value;?>
" id="thumbnail" />
                                </div>
                            <?php }?>
                        <?php }?>
                    </div>
                    <div class="<?php if ($_smarty_tpl->tpl_vars['uploaded']->value){?>span6<?php }else{ ?>span8<?php }?> center active-border">
                        <form id="photo" name="photo" method="post" enctype="multipart/form-data">
                            <div class="upload_form_cont">
                                <div>
                                    <div><label class="center" style="float: none;" for="image_file"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_newfile'];?>
</label></div>
                                    <div>
                                        <input name="image" id="image" type="file" required="true" />
                                        <button class="btn btn-success btn-normal btn-manage " name="upload" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_new_file'];?>
" type="submit"><?php echo $_smarty_tpl->tpl_vars['translate']->value['upload_new_file'];?>
</button>
                                    </div>
                                </div>
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/jquery.imgareaselect.min.js"></script>
<?php if ($_smarty_tpl->tpl_vars['uploaded']->value){?>
<script type="text/javascript">
    function preview(img, selection) { 
        var scaleX = <?php echo $_smarty_tpl->tpl_vars['thumb_width']->value;?>
; 
        var scaleY = <?php echo $_smarty_tpl->tpl_vars['thumb_height']->value;?>
; 

        $('#thumbnail + div > img').css({ 
                width: Math.round(scaleX * <?php echo $_smarty_tpl->tpl_vars['current_large_image_width']->value;?>
) + 'px', 
                height: Math.round(scaleY * <?php echo $_smarty_tpl->tpl_vars['current_large_image_height']->value;?>
) + 'px',
    ...
    $(window).load(function () { 
        $('#thumbnail').imgAreaSelect({ aspectRatio: '1:<?php echo $_smarty_tpl->tpl_vars['thumb_height']->value/$_smarty_tpl->tpl_vars['thumb_width']->value;?>
', handles: 'True', parent: '#parent', onSelectChange: preview }); 
    });
