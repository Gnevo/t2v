<?php /* Smarty version Smarty-3.1.8, created on 2021-03-08 10:07:50
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/export_lon-config.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7201764786045f776591c91-40299110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e5dbb5a8e6d7e0751ab5a1033acbe5e041caff1e' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/export_lon-config.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7201764786045f776591c91-40299110',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6045f776838229_08265659',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6045f776838229_08265659')) {function content_6045f776838229_08265659($_smarty_tpl) {?><!DOCTYPE html>
...
<link media="all" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/jquery.dataTables.min.css" type="text/css" rel="stylesheet">
<link media="all" href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
css/fixedColumns.dataTables.min.css" type="text/css" rel="stylesheet">
...
images/sgo-loading.gif"  />
    ...
    <div style="margin: 15px 0px 0px;" class="widget-header span12">
      <div class="span4 day-slot-wrpr-header-left">
         <h1 style="margin: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['configuration'];?>
</h1>
      </div>
      <?php if ($_smarty_tpl->tpl_vars['fkkn_split']->value){?>
          <div class="span2 day-slot-wrpr-header-left">
             <h1 style="margin: 11px ! important; background-color:#9da0a5;display:block; text-align: center; padding: 4px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['fkkn_split'];?>
</h1>
          </div>
      <?php }?>
      <div class="pull-right day-slot-wrpr-header-left span6" style="padding: 5px;">
         <button style="" class="btn btn-default btn-normal pull-right" type="button" onclick="submitForm()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</button>
         <button class="btn btn-default btn-normal pull-right no-ml" type="button" onclick="linkBack()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['back'];?>
</button>
         <button class="btn btn-default btn-normal pull-right" type="button" onclick="linkFromTemplate()"><?php echo $_smarty_tpl->tpl_vars['translate']->value['load_from_template'];?>
</button>
    ...
    <div class="span12 widget-body-section input-group">
        ...
        <div class="row-fluid" id="tble_list">
            <form method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
export_lon-config/" class="export_lon-config clearfix" id="export_form">
                ...
                <table id="header-fixed" style="margin: 0px;" class="table table-striped order-column table-bordered" cellspacing="0" width="100%">
                    <thead>
                        ...
                        <tr>
                            <th ><?php echo $_smarty_tpl->tpl_vars['translate']->value['internal'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_vacation_saving'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_vacation_paid'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_monthly'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_monthly_office'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_monthly_office_hour'];?>
</th>
                            <th colspan = "4" ><?php echo $_smarty_tpl->tpl_vars['translate']->value['external_no_name'];?>
</th>
                        </tr>
                        <tr>
                            <th data-orderable="false"></th>

                            <th data-orderable="false"><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_split_head'];?>
</th>
                            <th data-orderable="false" class="fkkn_class" <?php if ($_smarty_tpl->tpl_vars['fkkn_split']->value==0){?><?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['fk_head'];?>
</th>
                            <th data-orderable="false" class="fkkn_class" <?php if ($_smarty_tpl->tpl_vars['fkkn_split']->value==0){?><?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['kn_head'];?>
</th>
                            <th data-orderable="false" class="fkkn_class" <?php if ($_smarty_tpl->tpl_vars['fkkn_split']->value==0){?><?php }?>><?php echo $_smarty_tpl->tpl_vars['translate']->value['tu_head'];?>
</th>
            ...
            <form method="post" action="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
export_lon-config/" class="hide" id="frm_load_template">
...
<script src="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
js/dataTables.fixedColumns.min.js" type="text/javascript" ></script>
...
<script>
    $(document).ready(function () {
        ...
        var dt_table = $('#header-fixed').DataTable( {
            ...
            //bJQueryUI: true,
            "oLanguage": {
                "sSearch": "<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_filter'];?>
 "
            },
        ...
        if('<?php echo $_smarty_tpl->tpl_vars['fkkn_split']->value;?>
' == 0){
...
function submitForm(){
    ...
    if(check_flag == 1){
        ...
        bootbox.dialog("<?php echo $_smarty_tpl->tpl_vars['translate']->value['unfilled_salary_codes'];?>
", [{
