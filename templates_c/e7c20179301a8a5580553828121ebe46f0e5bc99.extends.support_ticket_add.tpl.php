<?php /* Smarty version Smarty-3.1.8, created on 2020-12-10 12:36:51
         compiled from "/home/time2view/public_html/cirrus/templates/support_ticket_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3499394325fd21663bf10c7-95223046%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e7c20179301a8a5580553828121ebe46f0e5bc99' => 
    array (
      0 => '/home/time2view/public_html/cirrus/templates/support_ticket_add.tpl',
      1 => 1578583128,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3499394325fd21663bf10c7-95223046',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd216641987d7_43514880',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd216641987d7_43514880')) {function content_5fd216641987d7_43514880($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/time2view/public_html/cirrus/libs/plugins/function.html_options.php';
?><!DOCTYPE html>
...
<div class="row-fluid">
    <div class="span12 main-left">
        <img src='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/ajax-loader_fb.gif' style="display: none;">
        ...
        <?php if ($_smarty_tpl->tpl_vars['msg']->value==1){?>
            ...
            <div class="span12 widget-body-section input-group">
                <div class="row-fluid">
                    <div class="span12"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_added_success'];?>
</div>
                    <div class="span12 no-ml" style="float:left;text-align:center;width:79%;">
                        <div>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/list/"><div style="float:right;margin-right:10px;margin-top:0px;width:240px;" class="week_num"><?php echo $_smarty_tpl->tpl_vars['translate']->value['go_to_ticket_list'];?>
</div></a>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/add/"><div style="float:right;margin-right:10px;margin-top:0px;width:240px;" class="week_num"><?php echo $_smarty_tpl->tpl_vars['translate']->value['add_another_ticket'];?>
</div></a>
                        </div>
                    </div>
                </div>
        ...
        <?php }else{ ?>
            <form name="ticket_form" id="ticket_form" method="post" onsubmit="return validate()" enctype="multipart/form-data" >
                <input type="hidden" id="user_role" name="user_role" value="<?php echo $_smarty_tpl->tpl_vars['user_role']->value;?>
">
                ...
                <div style="margin: 15px 0px 0px ! important;" class="widget">
                    <div style="" class="widget-header span12">
                        ...
                        <div class="pull-right day-slot-wrpr-header-left span8" style="padding: 5px;">
                            <button  style="margin: 0px 0px 0px 5px;" onclick="submit_form()" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['save'];?>
</button>
                            <button onclick="reset_form()" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['reset'];?>
</button>
                            <button onclick="javascript:location='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
supporttickets/list/';" style="margin: 0px 5px;" class="btn btn-default btn-normal pull-right btn-addnew-notes" type="button"><?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="span12">
                            <div style="margin: 0px ! important;" class="widget">
                                <div class="widget-header span12">
                                    <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['add_ticket'];?>
</h1>
                                </div>
                            </div>
                        </div>
                        <div class="span12 widget-body-section input-group">
                            <div class="span6 form-left">
                                <div class="span12" id="answer_ticket_category"  id="sel_customer_div">
                                    <label class="span12"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_category'];?>
:</label>
                                    <div style="margin-left: 0px; float: left;" class="span12 mt">
                                        <label class="pull-left"><input type="radio" name="category_type" id="category_type" class="category_type" value="1" <?php if ($_smarty_tpl->tpl_vars['category_type_radio']->value==1){?> checked="true" <?php }?> style="margin: 0px 7px 0px 0px ! important;"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_internal'];?>
</label> 

                                        <label class="pull-left"><input type="radio" name="category_type" id="category_type" class="category_type"  value="2" <?php if ($_smarty_tpl->tpl_vars['category_type_radio']->value==2){?> checked="true" <?php }?> style="margin: 0px 7px ! important;"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_external'];?>
</label>
                                ...
                                <div style="margin:0; display: none;" class="span12" id="support_type_div">
                                    <label style="float: left;" class="span12" for="sprt_ticket_type"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_type'];?>
:</label>
                                    <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                        <select name="sprt_ticket_type" id="sprt_ticket_type" class="span10 form-control">
                                            <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_ticket_type'];?>
</option>
                                            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_ticket_type']->value),$_smarty_tpl);?>
...
:</label>
                                        <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                            <select name="sprt_priority" id="sprt_priority" class="span10 form-control">
                                                <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_priority']->value,'selected'=>2),$_smarty_tpl);?>
                                ...
                                <div style="margin: 0px ! important;" class="span12"  id="ticket_admin_div">
                                    <label style="float: left;" class="span12" for="sprt_admin"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_admin'];?>
:</label>
                                    <div style="margin-left: 0px; float: left;" class="input-prepend span11"> <span class="add-on icon-pencil"></span>
                                        <select name="sprt_admin" id="sprt_admin" class="span10 form-control">
                                            <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_ticket_admin'];?>
</option>
                                            <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['support_admin_users']->value),$_smarty_tpl);?>
                                ...
                                <div class="span6 ticket_affected_user_div" style="margin: 0px ! important;">
                                    <label style="float: left;" class="span12" for="affected_user"><?php echo $_smarty_tpl->tpl_vars['translate']->value['affected_user'];?>
:</label>
                                ...
                                <div class="span6 ticket_affected_user_div" style="margin: 0px ! important;">
                                    <label class="span12 affected-user" style="" for="affected_user_phone"><?php echo $_smarty_tpl->tpl_vars['translate']->value['affected_user_phone'];?>
:</label>
                            ...
                            <div class="span6 form-right">
                                <div style="margin:0" class="span12">
                                    <label style="float: left;" class="span12" for="title"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_title'];?>
:</label>
                                    <div style="margin: 0px;" class="input-prepend span12"> <span class="add-on icon-pencil"></span>
                                        <input name="title" id="title" value_x="<?php echo $_smarty_tpl->tpl_vars['ticket_detail']->value['title'];?>
"  type="text" class="form-control span11" /> 
                                    </div>
                                </div>
                                <div class="span12 no-ml mt mb">
                                    <label for="description" class="span12" style="margin: 5px;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['ticket_discription'];?>
:</label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            if($('#category_type:checked').val() == 1){
                <?php echo $_smarty_tpl->tpl_vars['login_user_role']->value;?>
 == 3 ? $('#sel_customer_div').hide() : $('#sel_customer_div').show();
            }
...
ajax_support_ticket_category.php?category_type=2&company_id=<?php echo $_smarty_tpl->tpl_vars['company_id']->value;?>
");
...
images/ajax-loader_fb.gif'>");
                $('#support_category_div').load("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_support_ticket_category.php?company_id=<?php echo $_smarty_tpl->tpl_vars['company_id']->value;?>
&category_type=" + category_type);
            });
            
            $( "#affected_user" ).autocomplete({
                source: <?php echo $_smarty_tpl->tpl_vars['users_json']->value;?>
,
