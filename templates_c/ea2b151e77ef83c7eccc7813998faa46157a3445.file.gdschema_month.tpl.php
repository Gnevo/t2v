<?php /* Smarty version Smarty-3.1.8, created on 2021-03-24 09:37:18
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/gdschema_month.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11150283186034c5a25b38f2-06279970%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea2b151e77ef83c7eccc7813998faa46157a3445' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/gdschema_month.tpl',
      1 => 1616578617,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11150283186034c5a25b38f2-06279970',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_6034c5a31b8796_20599063',
  'variables' => 
  array (
    'url_path' => 0,
    'flag_cust_access' => 0,
    ...
    'customer_contract_period_hours' => 0,
    'period' => 0,
    'employee_work_summery_array' => 0,
    'summery' => 0,
    'selected_year' => 0,
    'selected_month' => 0,
    'month_label' => 0,
...
<?php if ($_valid && !is_callable('content_6034c5a31b8796_20599063')) {function content_6034c5a31b8796_20599063($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/time2view/public_html/cirrus-r/cirrus-r-new/libs/plugins/modifier.date_format.php';
...
background-position: 0 -103px !important;}
        .unmanned_slot{ background: linear-gradient(to bottom, #fff 0, #f6f6f6 47%, #ededed 100%);
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffffff', endColorstr='#ededed', GradientType=0);
    border: 1px solid #ccc; border-radius:4px; font-size:10px;float:left;padding:0px 4px;line-height:15px;}
...
<?php }?></span></a></li><?php }?>
                                        <?php if ($_smarty_tpl->tpl_vars['privileges_gd']->value['show_percentage_monthly']==1){?>
                                            <div class="pull-left no-print mr" style="margin-top: 1px;">
                                                <button  type="button" class="btn btn-default working_summery_btn no-margin"  onclick="popupWorkingSummery();" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['employees_work_summery'];?>
" style="padding: 3px 5px"><i class="icon-list icon-large"></i></button>
                                            </div>
                                        <?php }?>
                                        <div class="pull-left no-print"  style="margin-top: 1px;">
                                            <button  type="button" class="btn btn-default no-margin"  onclick="printSchedule();" title="<?php echo $_smarty_tpl->tpl_vars['translate']->value['print_schedule'];?>
"  style="padding: 3px 5px"><i class="icon-print icon-large"></i></button>
                                        </div>
                                    </ul>
                                </div>
                            </h4>
                ...
                <div class="span12 option-panel-wrpr" style="margin-left:0">
...
" <?php if ($_smarty_tpl->tpl_vars['s_customer']->value['username']==$_smarty_tpl->tpl_vars['selected_customer']->value){?>selected='selected'<?php }?>><?php if ($_smarty_tpl->tpl_vars['sort_by_name']->value==1){?><?php echo (($_smarty_tpl->tpl_vars['s_customer']->value['first_name']).(' ')).($_smarty_tpl->tpl_vars['s_customer']->value['last_name']);?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['login_user_role']->value!=3){?>
                                    <div class="pull-right count-info-switch-phone" id="count-info-switch">
                                        <a href="javascript:void(0)" class="widget-stats widget-stats-1 span12 " style="height:auto;" onclick="showcontractdet()">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>
                                            <?php if (in_array('1',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>
                                            <div class="pull-left mr">
                                                 <span class="glyphicons shield"><i></i><span class="txt"><?php echo $_smarty_tpl->tpl_vars['translate']->value['fk'];?>
</span></span>
                                                 <span class="count <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk']>$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']){?>overflow_contract<?php }elseif($_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk']<$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']){?>underflow_contract<?php }?>"><?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']!=0){?><span style="color: green;">(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk'];?>
h)</span><?php }?>
                                                 <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']>0){?><span style="color: red;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk'],2);?>
h)</span><?php }?>
                                                 <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']<0){?><span style="color: green;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['fk']-$_smarty_tpl->tpl_vars['customer_hours']->value['work']['fk'],2);?>
h)</span><?php }?>
                                                 </span>
                                            </div>
                                            <?php }?>
                                            <?php if (in_array('2',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>
                                            <div class="pull-left">
                                                 <span class="glyphicons shield"><i></i><span class="txt"><?php echo $_smarty_tpl->tpl_vars['translate']->value['kn'];?>
</span></span>
                                                 <span class="count <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn']>$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']){?>overflow_contract<?php }elseif($_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn']<$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']){?>underflow_contract<?php }?>"><?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']!=0){?><span style="color: green;">(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn'];?>
h)</span><?php }?>
                                                     <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']>0){?><span style="color: red;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn'],2);?>
h)</span><?php }?>
                                                     <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']<0){?><span style="color: green;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['kn']-$_smarty_tpl->tpl_vars['customer_hours']->value['work']['kn'],2);?>
h)</span><?php }?>     
                                                 </span>
                                            </div>
                                            <?php }?>
                                            <?php if (in_array('3',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>
                                            <div class="pull-left">
                                                 <span class="glyphicons shield"><i></i><span class="txt"><?php echo $_smarty_tpl->tpl_vars['translate']->value['tu'];?>
</span></span>
                                                 <span class="count <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']>$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']){?>overflow_contract<?php }elseif($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']<$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']){?>underflow_contract<?php }?>"><?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']!=0){?><span style="color: green;">(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu'];?>
h)</span><?php }?>
                                                     <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']>0){?><span style="color: red;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu'],2);?>
h)</span><?php }?>
                                                     <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu']-$_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']<0){?><span style="color: green;">(<?php echo number_format($_smarty_tpl->tpl_vars['customer_hours']->value['contract']['tu']-$_smarty_tpl->tpl_vars['customer_hours']->value['work']['tu'],2);?>
h)</span><?php }?>     
                                                 </span>
                                            </div>
                                            <?php }?>
                                    ...
                                    <div id="count-info-switch" class="pull-right span6">
                                            <a style="height:auto;" class="widget-stats widget-stats-1  pull-right" href="javascript:void(0)">
                                               <div class="pull-left span12 mt no-min-height">
                                                    <span style="text-align: left;" class="pull-left txt span12"><?php echo $_smarty_tpl->tpl_vars['translate']->value['total_work_hours_in_customer'];?>
 
                                                        <span style="float: right; line-height: inherit; margin-left: 5px ! important;" class="count overflow_contract pull-right"><?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['work']['customer_hours'];?>
h</span></span>
                                               </div>
                                                <div class="pull-left span12 no-ml no-min-height ">
                                                    <span class="pull-left txt span12" style="text-align: left;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['total_work_hours'];?>
 
                                                        <span class="count overflow_contract pull-right" style="float: right; line-height: inherit; margin-left: 5px ! important;"><?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['work']['total_hours'];?>
h</span></span>
                                                </div>
                                            </a>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12" style="margin: 5px 0px 0px;">
                                            ...
                                            <div class="span6 form-left">
                                                <div class="span12" style="margin: 5px 0px 0px;">
                                                    <label style="float: left;" class="span12 template_label" for="cmb_save_template_name"><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_template'];?>
</label>
                                                    <div style="margin-left: 0px; float: left;" class="input-prepend span11" > <span class="add-on icon-pencil"></span>
                                                        <select class="form-control span12" id="cmb_save_template_name" name="cmb_save_template_name" onchange="update_checker('cmb_save_template_name')">
                                                            <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['new_template'];?>
</option>
...
" data-from="<?php echo $_smarty_tpl->tpl_vars['schedule']->value['from_date'];?>
" data-to="<?php echo $_smarty_tpl->tpl_vars['schedule']->value['to_date'];?>
"><?php echo stripslashes($_smarty_tpl->tpl_vars['schedule']->value['temp_name']);?>
</option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                ...
                                                <div style="margin: 0px ! important;" class="span12 spanTemplateSaveNewName">
                                                    <label style="float: left;" class="span12 template_label" for="templateSaveNewName"><?php echo $_smarty_tpl->tpl_vars['translate']->value['template_name'];?>
</label>
                                            ...
                                            <div class="form-group span12" style="margin-left: 0px">
                                                ...
                                                <button type="button"  id="update_schedule_btn" class="btn btn-success"  style="margin:10px 0 0 0 !important " onclick="updateSchedule();"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['update_template'];?>
</button>
                                            </div>
                                        </div>
                                    </div>
                               ...
                               <div class="row-fluid" style="margin-top:15px">
                                <div  class="widget-header span12">
                                             <div class="span12">
                                    <h1 ><?php echo $_smarty_tpl->tpl_vars['translate']->value['preview_template'];?>
 :</h1>
                                             </div>
                                          </div>
                                      </div>     
                                            ...
                                            <div class="span12" style="margin: 5px 0px 0px;">
                                                ...
                                                <div style="margin-left: 0px; float: left;padding: 0px;" class="input-prepend span11" >
                                                    ...
                                                    <select class="form-control span12" id="cmb_template_name" name="cmb_template_name">
                                                        <option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select_template'];?>
</option>
                                                        <?php  $_smarty_tpl->tpl_vars['schedule'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['schedule']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['customer_schedules']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['schedule']->key => $_smarty_tpl->tpl_vars['schedule']->value){
...
"><?php echo $_smarty_tpl->tpl_vars['mIndex']->value;?>
</option>
                                                        <?php }} ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group span12" style="margin-left: 0px;">
                                            <button type="button" class="btn btn-success"  style="margin:10px 0 0 0 !important " onclick="applySchedule()"> <?php echo $_smarty_tpl->tpl_vars['translate']->value['preview'];?>
</button>
                                        </div>
                                    </div>
            ...
            <!-- <?php if ($_smarty_tpl->tpl_vars['contract_exist_flag']->value){?>   
                <div class="row-fluid no-print" >
                    <div class="span12 count-popup" style="display: none; z-index: 10;">
                        <?php if (isset($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk'])&&isset($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn'])&&isset($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu'])&&($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['oncall']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['oncall']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['oncall']!='0')){?>
                            ...
                            <table class="footable table table-striped table-bordered table-white table-primary" style="margin-bottom: 1px;">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['oncall']!='0'){?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['normal'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['oncall']!=0){?>(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['fk']['oncall'];?>
J)<?php }?></th>
                                        <?php }?>
                                        <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['oncall']!='0'){?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['normal'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['oncall']!=0){?>(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['kn']['oncall'];?>
J)<?php }?></th> 
                                        <?php }?>
                                        <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['normal']!='0'||$_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['oncall']!='0'){?>
                                            <th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['tu'];?>
 <?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['normal'];?>
h <?php if ($_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['oncall']!=0){?>(<?php echo $_smarty_tpl->tpl_vars['customer_hours']->value['actual_hours']['tu']['oncall'];?>
J)<?php }?></th> 
                                        <?php }?>
                                    </tr>
                                </thead>
                        ...
                        <?php }?>
                        <?php if (count($_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['fk'])>0||count($_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['kn'])>0||count($_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['tu'])>0){?>
                             <div class="table-responsive">
 ...
 $_from = $_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['fk']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
h<?php }?></td>
                                    ...
                                    <?php } ?>
                                    <?php  $_smarty_tpl->tpl_vars['period'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['period']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['kn']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['period']->key => $_smarty_tpl->tpl_vars['period']->value){
$_smarty_tpl->tpl_vars['period']->_loop = true;
?>
                                        <tr>
...
h<?php }?></td>  
                                    ...
                                    <?php } ?>
                                    <?php  $_smarty_tpl->tpl_vars['period'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['period']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['customer_contract_period_hours']->value['tu']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['period']->key => $_smarty_tpl->tpl_vars['period']->value){
$_smarty_tpl->tpl_vars['period']->_loop = true;
?>
                                        <tr>
...
h<?php }?></td>    
            ...
            <div class="row-fluid table-info hide table-info-mobile no-print" id="customer-summery-popup" style="margin-bottom:15px;">
                <div class="panel-body collapse-panel span12">
                    <div class="row-fluid">
                        <h4 class="pull-left" style="font-size:14px !important; "><?php echo $_smarty_tpl->tpl_vars['translate']->value['employees_work_summery'];?>
</h4>
                     ...
                     <div class="row-fluid">
                         <div class="table-responsive">
                            <table class="footable table table-striped table-bordered table-white table-primary" style="margin-bottom: 0px;">
                                <thead>
                                    <tr>
                                        <th data-class="expand"><?php echo $_smarty_tpl->tpl_vars['translate']->value['employee'];?>
</th>
                                        <th data-hide="phone,tablet"><?php echo $_smarty_tpl->tpl_vars['translate']->value['normal'];?>
</th>
                                        <th data-hide="phone,tablet"><?php echo $_smarty_tpl->tpl_vars['translate']->value['oncall'];?>
</th>
                                        <th data-hide="phone"><?php echo $_smarty_tpl->tpl_vars['translate']->value['normal_work_percent'];?>
</th>
                                        <th><?php echo $_smarty_tpl->tpl_vars['translate']->value['oncall_work_percent'];?>
</th>
                                        <th data-hide="phone"><?php echo $_smarty_tpl->tpl_vars['translate']->value['salary_time'];?>
</th>
                                        <th data-hide="phone"><?php echo $_smarty_tpl->tpl_vars['translate']->value['salary_total_time'];?>
</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php  $_smarty_tpl->tpl_vars['summery'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['summery']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['employee_work_summery_array']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['summery']->key => $_smarty_tpl->tpl_vars['summery']->value){
$_smarty_tpl->tpl_vars['summery']->_loop = true;
?>
                                        <tr>
                                            <td><?php echo $_smarty_tpl->tpl_vars['summery']->value['employee_name'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['summery']->value['normal'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['summery']->value['oncall'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['summery']->value['normal_percentage'];?>
%</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['summery']->value['oncall_percentage'];?>
%</td>
                                            <td><?php echo round(($_smarty_tpl->tpl_vars['summery']->value['normal']+($_smarty_tpl->tpl_vars['summery']->value['oncall']/4)),2);?>
</td>
                                            <td><?php echo round(($_smarty_tpl->tpl_vars['summery']->value['normal']+$_smarty_tpl->tpl_vars['summery']->value['oncall']),2);?>
</td>
                                        </tr>
                                    <?php }
if (!$_smarty_tpl->tpl_vars['summery']->_loop) {
?>
                                        <tr><td colspan='7' style='text-align:center;'><?php echo $_smarty_tpl->tpl_vars['translate']->value['no_data'];?>
</td></tr>
                                    <?php } ?>
                                </tbody>
                            </table>
...
month/gdschema/<?php echo $_smarty_tpl->tpl_vars['selected_year']->value-1;?>
...
month/gdschema/<?php echo $_smarty_tpl->tpl_vars['prv_year']->value;?>
...
month/gdschema/<?php echo $_smarty_tpl->tpl_vars['today_year']->value;?>
...
"><i></i><?php echo $_smarty_tpl->tpl_vars['translate']->value['today'];?>
                                ...
                                <th class="table-col-center"><span class="btn btn-block btn-default span12" onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
month/gdschema/<?php echo $_smarty_tpl->tpl_vars['next_year']->value;?>
...
' style="background:#CEF4FE !important;">
...
"><input class="btn-mini btn-default btn-collapse-table-row" type="button" value="-" /></li>
                                            <li onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
customer/gdschema/<?php echo $_smarty_tpl->tpl_vars['month_week']->value['week']['year'];?>
|<?php echo $_smarty_tpl->tpl_vars['month_week']->value['week']['week'];?>
/<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
...
' >
                                                <ul class="calender-col-header span12 monthlyslot_date clearfix">
                                                    <li onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_alloc_window.php?date=<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
...
<?php }?></li>
                                                    ...
                                                    <?php if (count($_smarty_tpl->tpl_vars['customer_running_tasks']->value)>0&&$_smarty_tpl->tpl_vars['today_date']->value==$_smarty_tpl->tpl_vars['week_day']->value['date']){?>
...
?>
                                                        ...
                                                        <?php } ?>
                                                        <li class="span3 pull-right pt no-print"><span class="cursor_help" title="<?php echo $_smarty_tpl->tpl_vars['customer_running_task_title']->value;?>
"><img src='<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
images/clock.gif'/></span></li>
                                                    <?php }?>
                                                    <li onclick="navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_day_customer.php?date=<?php echo $_smarty_tpl->tpl_vars['week_day']->value['date'];?>
&customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
...
"><i class="icon-bar-chart cursor_hand"/></li>
                                                ...
                                                <div class="monthly_strips clearfix">
                                                    <?php $_smarty_tpl->tpl_vars['table_count'] = new Smarty_variable('0', null, 0);?>
...
'
                                                                    ...
                                                                    <div class="<?php if ($_smarty_tpl->tpl_vars['slot']->value['signed']==1){?>striped<?php }?> span12 slot_bountery">
                                                                        ...
                                                                        <?php if ((int)$_smarty_tpl->tpl_vars['slot']->value['relation_id']>=1){?>
                                                                            <?php  $_smarty_tpl->tpl_vars['slotN'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['slotN']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['week_day']->value['slots']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['slotN']->key => $_smarty_tpl->tpl_vars['slotN']->value){
$_smarty_tpl->tpl_vars['slotN']->_loop = true;
?>
                                                                                <?php if ((int)$_smarty_tpl->tpl_vars['slot']->value['relation_id']==$_smarty_tpl->tpl_vars['slotN']->value['id']){?>
                                                                                    <div class="slot-notification-wrpr" style="background-color: <?php echo $_smarty_tpl->tpl_vars['slotN']->value['emp_color'];?>
;margin-right: 2px;">
...
)<?php if (trim($_smarty_tpl->tpl_vars['slot']->value['emp_name'])!=''){?> <br/><span class='spn-slot-emp-name' title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['slot']->value['emp_name']);?>
" style="margin-left: 0px;text-overflow: ellipsis; overflow: hidden;"><?php echo $_smarty_tpl->tpl_vars['slot']->value['emp_name'];?>
</span><?php }else{ ?><br/><label class="unmanned_slot"><?php echo $_smarty_tpl->tpl_vars['translate']->value['gdschema_unmanned_slot'];?>
</label><?php }?></div>
...
" class="check-box pull-right m_check hide-small-devices" /><?php }?>
                                                        ...
                                                        <?php }?>
                                                        <?php $_smarty_tpl->tpl_vars['table_count'] = new Smarty_variable($_smarty_tpl->tpl_vars['table_count']->value+1, null, 0);?>
                                                    <?php } ?>
                                                </div>
                                            </td>
                                        <?php }?>
...
"></li><?php }?>
        ...
        <div class="span4 main-right<?php if (!$_smarty_tpl->tpl_vars['show_right_panel']->value){?> hide<?php }?> no-print"  style="margin-top: 8px; padding: 10px;"  id="stickyPanelParent">
...
:</label>
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['privileges_gd']->value['no_pay_leave']==1&&$_smarty_tpl->tpl_vars['login_user_role']->value==1){?>
...
ajax_alloc_action_month.php",
            ...
            function make_day_refresh(data, date, $local_translate){
                ...
                if(data.selected_day_slots.length > 0){
                    $.each(data.selected_day_slots, function(i, $slot) 
                    {
                         var isvisible = false;
                         var empColor = '';
                        if(parseInt($slot.relation_id) >= 1)
                        {
                             $.each(data.selected_day_slots, function(i, $slotN) 
                             {
                                 if(parseInt($slot.relation_id) == parseInt($slotN.id))
                                 {
                                     isvisible = true;
                                     empColor = $slotN.emp_color;
                                     return false;
                                 }
                             });
                        }
                        if($login_user_role != 3 || ($login_user_role == 3 && ($privileges_gd.not_show_employees == 0 || ($privileges_gd.not_show_employees == 1 && $slot.employee == $login_user)))){
                            ...
                            new_content += '<span class="collapse-slot clearfix" id="slot_thread_'+$slot.id+'">\n\
                                                <div class="slot monthlyslotview monthlyslotview-draggable span12 '+special_slot_class_name+' '+($slot.signed == 1 ? 'signed_slot' : '')+' '+($swap_copied_slot == $slot.id ? 'objblink' : '')+'" \n\
                                                     onmouseover="tooltip.pop(this, \'#slot_details_'+$slot.id+'\', { position:0, offsetX:0, offsetY:20, effect:\'slade\' });" data-slot-id="'+$slot.id+'" >\n\
                                                    <input type="hidden" class="slot_details_hub" \n\
                                                           data-id="'+$slot.id+'"\n\
                                                           data-type="'+$slot.type+'"\n\
                                                           data-date="'+$slot.date+'"\n\
                                                    ...
                                                    '+(isvisible == true ? '<div class="slot-notification-wrpr" style="background-color: '+empColor+';margin-right: 2px;">\n\
                                                        ...
                                                        <div class="notification-info-customer">'+$slot.slot+' ('+ $slot.slot_hour +')<br/>'+( $.trim($slot.emp_name) != '' && $slot.emp_name != null ? '<span title="'+$slot.emp_name+'" style="white-space: normal;">'+$slot.emp_name+'</span>' : '<label class="unmanned_slot"><?php echo $_smarty_tpl->tpl_vars['translate']->value['gdschema_unmanned_slot'];?>
</label>')+'</div>\n\
            ...
            $('.refresh_day').click(function(){
                ...
                get_day_refresh(this_day, '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
');
            });
...
/<?php echo $_smarty_tpl->tpl_vars['selected_month']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
/<?php if ($_smarty_tpl->tpl_vars['rpt_page_url']->value!=''){?><?php echo $_smarty_tpl->tpl_vars['selected_employee']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['from_page']->value;?>
/<?php }?>',1, passing_data_object, true, _fn_callbak);
        }
...
ajax_alloc_action.php?customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
&gd_year=<?php echo $_smarty_tpl->tpl_vars['selected_year']->value;?>
&gd_month=<?php echo $_smarty_tpl->tpl_vars['selected_month']->value;?>
&req_from=monthly_view&slotid='+slot_id+'&action=clone_leaveslot';
                            navigatePage(url, 1);
                        }
                }]);
             }
...
ajax_alloc_action_month.php",
                ...
                success:function(data_process){
                    ...
                    if(data_process.result){    //excute if successfully created slot
                        ...
                        get_day_refresh(process_details_obj.date, '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
');
                            ...
                            //slot dragging
                                ...
                                if(this_slot_date != target_date){
                                    //$(ui.draggable).parents('.collapse-slot').fadeOut('slow', function() {
                                        ...
                                        var selected_employee = source_slot.find('input.slot_details_hub').attr("data-employee-id");                    

                                        var url_atl = 'date='+target_date+'&employee='+selected_employee+'&customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
'+
                                        ...
                                        check_atl_warning(url_atl, function(this_url){
                                            ...
                                            $('#div_alloc_action').load(this_url,function(response, status, xhr){
                                                ...
                                                if(typeof data.result !== 'undefined' && data.result === true){
                                                        ...
                                                        get_day_refresh(this_slot_date, '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
');
                                                        get_day_refresh(target_date, '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
');
                                                    }
...
"},
                    ...
                    //alert(included_non_incomplete_slots);
                    if(included_candg_slots && !included_none_candg_slots){
                        <?php if ($_smarty_tpl->tpl_vars['privileges_gd']->value['candg_approve']==1){?>
...
ajax_customers_employees_change.php",
 ...
 " + data, function(result){ });
            ...
            function saveChangeUserMultipleConfirm(){
                ...
                var url = "customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
...
', null, true);
        ...
        function copyMonthlySlot(){
            ...
            if(ids != ''){
                var url = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_slot_process.php?sel_year=<?php echo $_smarty_tpl->tpl_vars['selected_year']->value;?>
&sel_month=<?php echo $_smarty_tpl->tpl_vars['selected_month']->value;?>
&customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
...
&action=paste_select&type_check=8&to_single_day='+action_type;
            ...
            check_atl_warning(atl_req_data, function(this_url){ 
                                ...
                                $('#div_alloc_action').load(this_url,function(response, status, xhr){ 
                                    uwrapLoader("#external_wrapper"); 
                                    if(action_type == 'TRUE'){
                                        get_day_refresh(date, '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
', null, true);
                                    } 
                                    else
                                        navigatePageWithMaintainScrollPosition('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
    ...
    <script>
        ...
        <?php if ($_smarty_tpl->tpl_vars['privileges_general']->value['create_template']==1){?>
            function saveSchedule(){
                ...
                var customer = '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
'; 
                ...
                if(save_action == 'new' && new_name == ''){
                    bootbox.alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['enter_template_name'];?>
', function(result){ });
                    $('#manage-template #templateSaveNewName').focus();
                }
                else if(start_date == '')
...
', 'save_action': save_action, 'template_new_name': new_name, 'replaced_template': replaced_template, 'start_date': start_date, 'end_date': end_date };

                    wrapLoader('#external_wrapper');
                    $.ajax({
                        url:"<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_save_monthly_customer_schedule.php",
                        type:"POST",
                        dataType: 'json',
                        data: main_obj,
                        success:function(data){
                            ...
                            if(data.customer_schedules !== undefined && data.customer_schedules.length > 0){
                                $('#manage-template #cmb_template_name').html('<option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['select'];?>
</option>');
                                ...
                                $('#manage-template #cmb_save_template_name').html('<option value=""><?php echo $_smarty_tpl->tpl_vars['translate']->value['new_template'];?>
</option>');
                                $.each(data.customer_schedules, function(i, value) {
                            ...
                            if(data.transaction == true){
                                navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_month_apply_update_schedule.php?id='+schedule_id+'&year='+year+'&month='+month+'&customer='+customer+'', 1);
                            }
            ...
            function updateSchedule(){
                if($('#cmb_save_template_name').val() != ''){
                    ...
                    navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
gdschema_month_apply_update_schedule.php?id='+schedule_id+'&year='+PreviewDateYear+'&month='+PreviewDateMonth+'&customer=<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
', 1);
        ...
        <?php if ($_smarty_tpl->tpl_vars['privileges_general']->value['use_template']==1){?>
            function applySchedule(){
                ...
                if(schedule_id == ''){
                    bootbox.alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_template'];?>
', function(result){ });
                    $('#manage-template #cmb_template_name').focus();
                } 
                else if(PreviewStartDate == ''){
                    bootbox.alert('<?php echo $_smarty_tpl->tpl_vars['translate']->value['select_template_preview_start_date'];?>
', function(result){ });
...
/'+schedule_id+'/'+PreviewStartDate+'/'+no_of_times+'/', 1);
    ...
    <script>
        ...
        function showcontractdet(){
            var customer = '<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
';
            var year     = '<?php echo $_smarty_tpl->tpl_vars['selected_year']->value;?>
';
            var month    = '<?php echo $_smarty_tpl->tpl_vars['selected_month']->value;?>
';
...
ajax_contract_on_gdschema_customer.php',
 ...
 '+data.customer_hours.actual_hours.fk.normal+'h '+(data.customer_hours.actual_hours.fk.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.fk.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
 ...
 '+data.customer_hours.actual_hours.kn.normal+'h '+(data.customer_hours.actual_hours.kn.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.kn.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
                                                    if(data.customer_hours.actual_hours.tu.normal != 0 || data.customer_hours.actual_hours.tu.oncall != 0){
                                                        html += '<th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;"><?php echo $_smarty_tpl->tpl_vars['translate']->value['tu'];?>
 '+data.customer_hours.actual_hours.tu.normal+'h '+(data.customer_hours.actual_hours.tu.oncall != 0 ? '('+(Math.round(data.customer_hours.actual_hours.tu.oncall*100)/100)+'J)' : '')+'</th>';
                                                    }
                                 html +=                '<th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;"></th></tr>\n\
                                                     </thead>\n\
                                                </table>\n\
                                            </div>\n\
                                        </div>\n\
                                ...
                                <table class="footable table table-striped table-bordered table-white table-primary" style="margin-bottom: 0px;">\n\
                                    <thead>\n\
                                        <tr>\n\
                                            ...
                                            <th data-hide="phone,tablet"  class="table-col-center" style=" background:#fff; color:#7C7C7C;">Filter</th>\n\
                                        </tr>\n\
                                    </thead>';
                            html += '<tbody>'
 ...
 '+entry.period_to+'</td>\n\
                                            <td  class="table-col-center">'+entry.work_hours+'h ('+(Math.round(entry.contract_hours*100)/100)+'h)\n\
                                                '+(entry.contract_hours - entry.work_hours > 0 ? '(<span style="color: green;">'+(Math.round((entry.contract_hours - entry.work_hours)*100)/100)+'h</span>)' : '(<span style="color: red;">'+(Math.round((entry.contract_hours - entry.work_hours)*100)/100)+'h</span>)') +'\n\
                                            </td>\n\
                                            <td  class="table-col-center">'+(entry.unmanned_hour != null ? (Math.round(entry.unmanned_hour*100)/100)+'h' : '')+'</td>\n\
                                            <td  class="table-col-center"><input type="checkbox" value="1" name="values_of" id="tu_values" <?php if (in_array('1',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>checked<?php }?>></td>\n\
                                        </tr>';
                                });
 ...
 '+entry.period_to+'</td>\n\
                                            ...
                                            <td  class="table-col-center">'+(entry.unmanned_hour != null ? (Math.round(entry.unmanned_hour*100)/100)+'h' : '')+'</td>\n\
                                            <td  class="table-col-center"><input type="checkbox" value="2" name="values_of" id="tu_values" <?php if (in_array('2',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>checked<?php }?>></td>\n\
                                        </tr>';
                            });
                            ...
                            data.customer_contract_period_hours.tu.forEach(function(entry) {
                                html += '<tr>\n\
                                            ...
                                            <td  class="table-col-center">'+entry.period_from+' <?php echo $_smarty_tpl->tpl_vars['translate']->value['to_time'];?>
 '+entry.period_to+'</td>\n\
                                            <td  class="table-col-center">'+entry.work_hours+'h ('+(Math.round(entry.contract_hours*100)/100)+')\n\
                                                '+(entry.contract_hours - entry.work_hours > 0 ? '(<span style="color: green;">'+(Math.round((entry.contract_hours - entry.work_hours)*100)/100)+'h</span>)' : '(<span style="color: red;">'+(Math.round((entry.contract_hours - entry.work_hours)*100)/100)+'h</span>)') +'\n\
                                            </td>  \n\
                                            <td  class="table-col-center">'+(entry.unmanned_hour != null ? (Math.round(entry.unmanned_hour*100)/100)+'h' : '')+'</td>\n\
                                            <td  class="table-col-center"><input type="checkbox" value="3" name="values_of" id="tu_values" <?php if (in_array('3',$_smarty_tpl->tpl_vars['fkkn_ar']->value)){?>checked<?php }?>></td>\n\
                                        </tr>';
                            });    
...
';
        ...
        function selected_values(){
            var text = '';
            $('input[name=values_of]:checked').each(function () {
                text+= $(this).val()+',';
            });
            text+='fkkn';
                ...
                error: function (xhr, ajaxOptions, thrownError){
                    if(xhr.status == 527){
                        var msg_content = '<div class="alert alert-danger alert-dismissable no-ml no-mr">\n\
                                            ...
                                            <strong><i class="icon-remove-sign icon-large"></i> Error</strong>:  ' + thrownError + '\n\
                                        </div>';
...
/'+text+'/',1);
        ...
        $(document).on('change','#fk_values',function(){
            selected_values();
        });
        $(document).on('change','#kn_values',function(){
            selected_values();
        });
        $(document).on('change','#tu_values',function(){
            selected_values();
        });
...
',
                ...
                //if(ev.viewMode == 'months'){
                    ...
                    navigatePage('<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
month/gdschema/'+year+'/'+month+'/<?php echo $_smarty_tpl->tpl_vars['selected_customer']->value;?>
/',1);
                //}
            });
        });
