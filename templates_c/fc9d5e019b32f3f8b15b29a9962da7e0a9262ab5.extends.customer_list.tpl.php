<?php /* Smarty version Smarty-3.1.8, created on 2021-02-22 05:09:45
         compiled from "/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:182510666660333c99408168-82707652%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fc9d5e019b32f3f8b15b29a9962da7e0a9262ab5' => 
    array (
      0 => '/home/time2view/public_html/cirrus-r/cirrus-r-new/templates/customer_list.tpl',
      1 => 1613804740,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '182510666660333c99408168-82707652',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60333c996bc582_24048055',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60333c996bc582_24048055')) {function content_60333c996bc582_24048055($_smarty_tpl) {?><!DOCTYPE html>
        ...
        <div class="span12 main-left" style="overflow-y: hidden">
            <div style="margin: 15px 0px 0px ! important;" class="widget">
                <div class="widget-header span12">
                    <h1><?php echo $_smarty_tpl->tpl_vars['translate']->value['customers'];?>
(<?php echo $_smarty_tpl->tpl_vars['customer_count']->value;?>
 &nbsp;<?php if ($_smarty_tpl->tpl_vars['action']->value=="inact"){?><?php echo $_smarty_tpl->tpl_vars['translate']->value['inactive'];?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['translate']->value['active'];?>
<?php }?>)</h1>
                </div>
            </div>
...
list/employee/<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
/">
                                <div class="pull-left" style="margin: 0px ! important; padding: 0px;">

                                    <label class="span12" style="float: left;" for="search_emp"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
</label>
                                    <div style="margin: 0px; float:left;" class="input-prepend span10"> <span class="add-on icon icon-search"></span>
                                        <input  class="form-control span12 text-box" type="text" name="search_cust" id="search_cust" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
">
                                    </div>
...
" />
                                ...
                                <div class="pull-left">
                                    <label class="span12" style="float: left;" for="search_emp"><?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
</label>
                                    <div style="margin: 0px; float:left;" class="input-prepend span10"> <span class="add-on icon icon-search"></span>
                                        <input  class="form-control span12 text-box" type="text" name="search_emp" id="search_emp" value="<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
">
                                    </div>
                                </div>
                                ...
                                <div class="pull-left" style="padding-top: 20px;">
                                    <ol class="radio-group">
                                        <li><input type="radio" name="active" id="active" value="act" <?php if ($_smarty_tpl->tpl_vars['action']->value=="act"){?>checked=checked <?php }?> class="radio"/>
                                            <label class="radio label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['active'];?>
 </label></li>

                                        <li>  
                                            <input type="radio" name="active" id="inactive" value="inact" <?php if ($_smarty_tpl->tpl_vars['action']->value=="inact"){?>checked=checked <?php }?> class="radio"/>
                                            <label class="radio label-option-and-checkbox"><?php echo $_smarty_tpl->tpl_vars['translate']->value['inactive'];?>
</label></li>
                                    </ol>
                                </div> 
                                <div class="pull-right" style="padding-top: 15px;">
                                    <?php if ($_smarty_tpl->tpl_vars['privileges_general']->value['add_customer']){?>
                                        <button type="button" class="btn btn-default btn-margin-set btn-option-panel pull-right btn-margin-lft"  onclick="add_new_btn()"><span class="icon-plus"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['add_new'];?>
</button>
                                    <?php }?>

                                    <button type="button" class="btn btn-default btn-margin-set btn-option-panel pull-right" onclick="back_btn()"><span class="icon-arrow-left"></span> <?php echo $_smarty_tpl->tpl_vars['translate']->value['backs'];?>
</button>
                                </div>
                ...
                <div class="row-fluid" style="margin-top:10px; position: relative">
                    <input type="hidden" id="sort_order_direction" value="<?php echo $_smarty_tpl->tpl_vars['sort_direction']->value;?>
" />
...
?>    
                                            <li <?php if ($_smarty_tpl->tpl_vars['page_letter']->value==$_smarty_tpl->tpl_vars['row']->value){?>class="active"<?php }?>><a href="javascript:void(0)" onclick="select_customer('<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
','<?php echo $_smarty_tpl->tpl_vars['row']->value;?>
','1')"><?php echo $_smarty_tpl->tpl_vars['row']->value;?>
</a></li>
                                            <?php } ?>
                                    </ul>
                                </div>
                            ...
                            <div class="pull-right">
                                <div class="pagination pagination-mini pagination-right pagin margin-none">
                                    <div class="pagination" style=" margin: 0px;"><ul><?php echo $_smarty_tpl->tpl_vars['pagination']->value;?>
</ul></div>
                                </div>
                            </div>
                        </div>
...
var view = $("#search_cust").val();
   if(view == '<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
' || view == ""){
...
ajax_customer_list_page.php?page="+page+"&search="+name+"&emp="+emp+"&action="+action);
            var url2 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_customer_listing.php?page="+page+"&search="+name+"&emp="+emp+"&action="+action);
            $(".pagination").load(url1);
            $("#table_val").load(url2);
        
    }else{
        //document.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/customer/'+action+'/'+name+'/'+(sort_by != '' ? sort_by+'/' : '');
        document.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/customer/'+action+'/'+name+'/';
    }
}
    ...
    $("#search_cust").click(function(){
        ...
        if(fix == "<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
"){
           $("#search_cust").val('');
        }
   ...
   $("#search_cust").blur(function(){
        ...
        var fix = $("#search_cust").val();
        if(fix == ""){
           $("#search_cust").val('<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_customer'];?>
');
           paginateDisplay('1');
        }
    });
    $("#search_emp").click(function(){
        ...
        if(fix == "<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
"){
           $("#search_emp").val('');
...
'  || view == ""){
   ...
   if(view1 == '<?php echo $_smarty_tpl->tpl_vars['translate']->value['search_employee'];?>
'  || view1 == ""){
      $("#emp").val('');  
   }
   
   var sort_by = '<?php echo $_smarty_tpl->tpl_vars['sort_by']->value;?>
';
...
ajax_customer_list_page.php?page="+page+"&search="+search+"&emp="+emp+"&action="+action+ "&sort_by=" + sort_by);
...
' || view == ""){
    ...
    var urls = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_customer_listing.php?page="+page+"&search="+search+"&emp="+emp+"&action="+action+ "&sort_direction=" + sort_direction);
    //$("#table_val").load(urls);
    $.ajax({
        url: urls,
        success: function(data) {
...
' || view == ""){
    ...
    var name = '<?php echo $_smarty_tpl->tpl_vars['page_letter']->value;?>
';
    var search = $("#temp_search_cust").val();
    $("#temp_search_cust").val(name);
    ...
    if(search != "" || emp != ""){
            var url1 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_customer_list_page.php?page=1&search="+name+"&emp="+emp+"&action="+action+ "&sort_by=" + sort_by);
            var url2 = encodeURI("<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
ajax_customer_listing.php?page=1&search="+name+"&emp="+emp+"&action="+action+ "&sort_by=" + sort_by+ "&sort_direction=" + sort_direction);
            $(".pagination").load(url1);
            $("#table_val").load(url2);
        
    }else{
        document.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/customer/'+action+'/'+name+'/'+sort_by+'/'+sort_direction+'/';
    }
}
...
function back_btn(){ 
    document.location.href = '<?php echo $_smarty_tpl->tpl_vars['url_path']->value;?>
list/customer/<?php echo $_smarty_tpl->tpl_vars['action']->value;?>
/';
}
